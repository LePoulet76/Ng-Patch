...
public class AssistanceStaffGUI
extends AbstractAssistanceGUI {
    ...
    public AssistanceStaffGUI(NBTTagCompound tagCompound) {
        ...
        for (int i = 0; i < ranks.func_74745_c(); ++i) {
            ...
            if (i >= ranks.func_74745_c() - 1) continue;
    ...
    protected void drawGui(int mouseX, int mouseY, float partialTick) {
        this.field_73882_e.field_71466_p.func_78276_b(I18n.func_135053_a((String)"nationsgui.assistance.statsTitle"), this.guiLeft + 202, this.guiTop + 60, 0);
        ModernGui.drawNGBlackSquare(this.guiLeft + 202, this.guiTop + 70, 157, 34);
        this.func_73731_b(this.field_73886_k, I18n.func_135052_a((String)"nationsgui.assistance.openTicketStat", (Object[])new Object[]{this.ticketOpened}), this.guiLeft + 207, this.guiTop + 76, 0xFFFFFF);
        this.func_73731_b(this.field_73886_k, I18n.func_135052_a((String)"nationsgui.assistance.closedTicketStat", (Object[])new Object[]{this.ticketClosed}), this.guiLeft + 207, this.guiTop + 90, 0xFFFFFF);
        this.field_73882_e.field_71466_p.func_78276_b(I18n.func_135053_a((String)"nationsgui.assistance.staffTopTitle"), this.guiLeft + 215, this.guiTop + 112, 0);
    ...
    private void populate() {
        ...
        for (int i = 0; i < AssistanceListingPacket.ticketList.func_74745_c(); ++i) {
            ...
            if (ticketData.func_74767_n("closed") != (this.dropdownComponent != null && this.dropdownComponent.getSelectionIndex() == 1)) continue;
            this.ticketsScroller.addElement(new AssistanceTicketButton(ticketData.func_74762_e("id"), I18n.func_135053_a((String)ticketData.func_74779_i("category")), new Date(ticketData.func_74763_f("date")), ticketData.func_74767_n("closed"), ticketData.func_74779_i("player")));
    ...
    public void func_73866_w_() {
        ...
        this.dropdownComponent.getChoices().add(I18n.func_135053_a((String)"nationsgui.assistance.open"));
        this.dropdownComponent.getChoices().add(I18n.func_135053_a((String)"nationsgui.assistance.closed"));
