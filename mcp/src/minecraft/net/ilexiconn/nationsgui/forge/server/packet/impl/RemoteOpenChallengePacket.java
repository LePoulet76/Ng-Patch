...
public class RemoteOpenChallengePacket
implements IPacket,
IClientPacket {
    ...
    public void handleClientPacket(EntityPlayer player) {
        Minecraft.func_71410_x().func_71373_a((GuiScreen)new ChallengeGui(this.playerAtt, this.playerDef, this.isSetup, this.duelInfos));
    }
