...
public class EnterpriseBankGUI extends TabbedEnterpriseGUI {
   ...
   public void func_73866_w_() {
      ...
      this.salaryButton = new GuiButton(0, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.func_135053_a("enterprise.bank.btn.salary"));
      this.bonusButton = new GuiButton(1, this.guiLeft + 10, this.guiTop + 188, 100, 20, I18n.func_135053_a("enterprise.bank.btn.bonus"));
      this.capitalButton = new GuiButton(2, this.guiLeft + 10, this.guiTop + 211, 100, 20, I18n.func_135053_a("enterprise.bank.btn.capital"));
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      if(!this.salaryButton.field_73742_g) {
         if(mouseX > this.guiLeft + 10 && mouseX < this.guiLeft + 10 + 100 && mouseY > this.guiTop + 165 && mouseY < this.guiTop + 165 + 20) {
            tooltipToDraw = I18n.func_135053_a("enterprise.bank.btn_disabled");
            ...
            if(this.cachedLogs.size() == 0) {
               for(j = 0; j < ((ArrayList)enterpriseBankInfos.get("logs")).size(); ++j) {
                  ...
                  if(offsetY.split("##").length == 3) {
                     ...
                     String date = "\u00a78" + I18n.func_135053_a("faction.bank.date_1");
            ...
            if(EnterpriseGui.hasPermission("bank_log")) {
               ...
               for(j = 0; j < this.cachedLogs.size(); ++j) {
                  ...
                  if(mouseX > var27 + 104 && mouseX < var27 + 104 + 10 && (float)mouseY > var28.floatValue() + 5.0F && (float)mouseY < var28.floatValue() + 5.0F + 11.0F) {
                     ...
                     if(logType.contains("#")) {
                        tooltipToDraw = I18n.func_135053_a("enterprise.bank.transaction.type." + logType.split("#")[0]).replace("<player>", logType.split("#")[1]);
                     } else {
                        tooltipToDraw = I18n.func_135053_a("enterprise.bank.transaction.type." + logType);
                     }
                  }
               }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0 && EnterpriseGui.enterpriseInfos != null) {
         if(this.salaryButton.field_73742_g && EnterpriseGui.hasPermission("salary") && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 165 && mouseY <= this.guiTop + 165 + 20) {
            Minecraft.func_71410_x().func_71373_a(new EnterpriseSalaryGui(this));
         }
         ...
         if(this.bonusButton.field_73742_g && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 188 && mouseY <= this.guiTop + 188 + 20) {
            Minecraft.func_71410_x().func_71373_a(new EnterpriseBonusGui(this));
         }

         if(this.capitalButton.field_73742_g && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
            Minecraft.func_71410_x().func_71373_a(new EnterpriseCapitalGui(this));
         }
      }
