...
public class WorldTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      while(var3.hasNext()) {
         ...
         if((methodNode.name.equalsIgnoreCase("h") || methodNode.name.equalsIgnoreCase("updateEntities") || methodNode.name.equalsIgnoreCase("func_72939_s")) && methodNode.desc.equalsIgnoreCase("()V")) {
