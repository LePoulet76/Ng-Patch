...
public class TCSettingsGeneral extends TCSettingsGUI
{
    ...
    public void initGui()
    {
        ...
        this.timeStampStyle.labelX = this.timeStampStyle.xPosition - 10 - Minecraft.getMinecraft().fontRenderer.getStringWidth(this.timeStampStyle.description);
    ...
    {
        this.timeStampStyle.enabled = this.timeStampEnable.getTempValue().booleanValue();
    }
