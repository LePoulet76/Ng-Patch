...
class MainGUI$1 extends Thread
{
    ...
    public void run()
    {
        ...
        while (var4.hasNext())
        {
            ...
            if (server1.isVisible(Minecraft.getMinecraft()) && !server1.getIp().contains("event.nationsglory"))
            {
                ...
                try
                {
                    ...
                    server1.setSlots(Integer.parseInt(MainGUI.access$000(this.this$0, serverData.populationInfo)));
                }
