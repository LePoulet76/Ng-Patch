...
public class DiplomatieGUI extends TabbedFactionGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        if (loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            if (this.displayMode.equals("relations"))
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.relations"), (float)(this.guiLeft + 42 + 32), (float)(this.guiTop + 79), 7239406, 0.5F, "center", false, "georamaSemiBold", 28);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.requests"), (float)(this.guiLeft + 108 + 32), (float)(this.guiTop + 79), 14803951, 0.5F, "center", false, "georamaSemiBold", 28);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.allies"), (float)(this.guiLeft + 48), (float)(this.guiTop + 109), 0, 0.5F, "left", false, "georamaSemiBold", 30);
                ...
                if (i.size() > 0)
                {
                    ...
                    for (countryName = 0; countryName < i.size(); ++countryName)
                    {
                        ...
                        {
                            GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(countryName1)).getGlTextureId());
                ...
                {
                    ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.diplomatie.label.no_relation"), (float)(this.guiLeft + 43 + 5), (float)(this.guiTop + 104 + 24), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.enemies"), (float)(this.guiLeft + 189), (float)(this.guiTop + 109), 0, 0.5F, "left", false, "georamaSemiBold", 30);
                ...
                {
                    ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.diplomatie.label.no_relation"), (float)(this.guiLeft + 184 + 5), (float)(this.guiTop + 104 + 24), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.colonies"), (float)(this.guiLeft + 330), (float)(this.guiTop + 109), 0, 0.5F, "left", false, "georamaSemiBold", 30);
                ...
                {
                    ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.diplomatie.label.no_relation"), (float)(this.guiLeft + 325 + 5), (float)(this.guiTop + 104 + 24), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                }
            }
            else if (this.displayMode.equals("requests"))
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.relations"), (float)(this.guiLeft + 42 + 32), (float)(this.guiTop + 79), 14803951, 0.5F, "center", false, "georamaSemiBold", 28);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.requests"), (float)(this.guiLeft + 108 + 32), (float)(this.guiTop + 79), 7239406, 0.5F, "center", false, "georamaSemiBold", 28);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.received"), (float)(this.guiLeft + 48), (float)(this.guiTop + 108), 0, 0.5F, "left", false, "georamaSemiBold", 30);
                ...
                if (received.size() > 0)
                {
                    ...
                    for (var13 = 0; var13 < received.size(); ++var13)
                    {
                        ...
                        {
                            GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(var16)).getGlTextureId());
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.diplomatie.label.sent"), (float)(this.guiLeft + 254), (float)(this.guiTop + 108), 0, 0.5F, "left", false, "georamaSemiBold", 30);
                ...
                {
                    ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.diplomatie.label.no_relation"), (float)(this.guiLeft + 249 + 5), (float)(this.guiTop + 104 + 24), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                }
            }
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0 && !this.hoveredAction.isEmpty())
        {
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new FactionGUI(this.hoveredCountry));
            }
            else if (!this.hoveredAction.isEmpty() && !this.hoveredCountry.isEmpty())
            {
                ...
                {
                    Minecraft.getMinecraft().displayGuiScreen(new RefuseColonyConfirmGui(this, this.hoveredCountry, this.hoveredAction.replaceAll("relation_", ""), this.hoveredRelationType));
                }
                else
                {
