   ...
   private void drawGenericOverlay() {
      if(this.mw.miniMap.smallMapMode.heightPercent >= 20) {
         ...
         if(!ClientData.currentWarzone.isEmpty()) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("warzone.bonus." + (String)ClientData.currentWarzone.get("type") + ".value").toUpperCase(), (float)this.mapMode.x, (float)(offsetY + 8), 16777215, 0.35F, "left", false, "minecraftDungeons", 22);
            offsetY += 22;
            ...
            if(!((String)ClientData.countryTitleInfos.get("countryName")).toLowerCase().contains("wilderness")) {
               ...
               if(ClientProxy.flagsTexture.containsKey(ClientData.countryTitleInfos.get("countryName"))) {
                  GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(ClientData.countryTitleInfos.get("countryName"))).func_110552_b());
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.faction.relation.short." + (String)ClientData.countryTitleInfos.get("relation")).toUpperCase(), (float)(this.mapMode.x + colorTextDefault + 13), (float)(offsetY + 8), 16777215, 0.3F, "center", false, "minecraftDungeons", 23);
            offsetY += 22;
         } else {
         ...
         ModernGui.drawScaledStringCustomFont(this.getOrientation(Minecraft.func_71410_x().field_71439_g.field_70177_z), (float)(this.mapMode.x + this.mapMode.w), (float)offsetY, colorTextDefault1, 0.5F, "right", false, "georamaBold", 24);
         offsetY += 10;
         if(ClientProxy.clientConfig.specialEnabled) {
            ...
            ModernGui.drawScaledStringCustomFont(Minecraft.func_71410_x().field_71426_K.split(",")[0], (float)this.mapMode.x, (float)(offsetY + 14), colorTextDefault1, 0.5F, "left", false, "georamaSemiBold", 25);
         ...
         if(!ClientData.currentWarzone.isEmpty()) {
            ...
            if(((String)ClientData.currentWarzone.get("factionCapturingId")).equalsIgnoreCase("notcontested")) {
               ...
               diffTime = I18n.func_135053_a("warzone.capturing");
               areaPosition = true;
            } else if(!((String)ClientData.currentWarzone.get("percent")).equalsIgnoreCase("100") && ((String)ClientData.currentWarzone.get("factionCapturingId")).equals(ClientData.currentWarzone.get("factionId"))) {
               diffTime = I18n.func_135053_a("warzone.securisation");
            }
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.warzone.package"), (float)this.mapMode.x + 1.0F, (float)(offsetY + 11), 16000586, 0.5F, "left", true, "minecraftDungeons", 15);
            ModernGui.drawScaledStringCustomFont((String)ClientData.currentWarzone.get("nextTimeDropPackage"), (float)this.mapMode.x + 3.0F + minecraftDungeons15.getStringWidth(I18n.func_135053_a("overlay.warzone.package")) / 2.0F, (float)offsetY + 11.5F, 16777215, 0.5F, "left", true, "georamaSemiBold", 20);
            offsetY += 25;
            ...
            ModernGui.bindTextureOverlayMain();
            ModernGui.drawScaledCustomSizeModalRect((float)this.mapMode.x - 2.0F, (float)offsetY, (float)(25 * GenericOverride.GUI_SCALE), (float)(304 * GenericOverride.GUI_SCALE), 157 * GenericOverride.GUI_SCALE, 42 * GenericOverride.GUI_SCALE, this.mapMode.w + 5, 21, (float)(1920 * GenericOverride.GUI_SCALE), (float)(1033 * GenericOverride.GUI_SCALE), false);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.assault.label.package"), (float)this.mapMode.x + 1.0F, (float)(offsetY + 3), 16000586, 0.5F, "left", true, "minecraftDungeons", 15);
            ...
            ModernGui.drawScaledStringCustomFont(diffTime, (float)this.mapMode.x + 3.0F + minecraftDungeons15.getStringWidth(I18n.func_135053_a("overlay.assault.label.package")) / 2.0F, (float)(offsetY + 4), 16777215, 0.5F, "left", true, "georamaSemiBold", 18);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.assault.label.area"), (float)this.mapMode.x + 1.0F, (float)(offsetY + 11), 16000586, 0.5F, "left", true, "minecraftDungeons", 15);
            ...
            ModernGui.drawScaledStringCustomFont(areaPosition1, (float)this.mapMode.x + 3.0F + minecraftDungeons15.getStringWidth(I18n.func_135053_a("overlay.assault.label.area")) / 2.0F, (float)(offsetY + 12), 16777215, 0.5F, "left", true, "georamaSemiBold", 18);
            offsetY += 25;
         }
         ...
         if(ClientData.isCombatTagged) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.tag_combat"), (float)this.mapMode.x - 2.0F + (float)((this.mapMode.w + 5) / 2), (float)(offsetY + 3), 16000586, 0.5F, "center", true, "minecraftDungeons", 15);
         }
         ...
         if(System.currentTimeMillis() > 1734166800000L && System.currentTimeMillis() < 1736722800000L) {
            ...
            ModernGui.drawScaledStringCustomFont(Keyboard.getKeyName(ClientKeyHandler.KEY_BONUS.field_74512_d), (float)this.mapMode.x - 30.0F + 18.5F, (float)(this.mapMode.y - 5) + 17.0F, 12588865, 0.5F, "center", false, "georamaBold", 13);
            ...
            ModernGui.drawScaledStringCustomFont(Keyboard.getKeyName(ClientKeyHandler.KEY_BONUS.field_74512_d), (float)this.mapMode.x - 30.0F + 18.5F, (float)(this.mapMode.y - 5) + 17.0F, 15712091, 0.5F, "center", false, "georamaBold", 13);
         }
         ...
         if(ClientData.waitingServerName != null && !ClientData.waitingServerName.isEmpty() && !ClientData.waitingServerName.equalsIgnoreCase("null")) {
            ...
            ModernGui.drawScaledStringCustomFont(Keyboard.getKeyName(ClientKeyHandler.KEY_WAITING.field_74512_d), (float)this.mapMode.x - 93.0F - 7.0F + 2.0F, (float)(this.mapMode.y - 5) + 4.5F, 7239406, 0.5F, "center", false, "georamaBold", 13);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("waiting.server") + " " + ClientData.waitingServerName.toUpperCase(), (float)this.mapMode.x - 93.0F + 7.0F, (float)(this.mapMode.y - 2 + 5), 7239406, 0.5F, "left", false, "minecraftDungeons", 24);
            ModernGui.drawScaledStringCustomFont("\u00a7o" + (ClientData.waitingPriority?I18n.func_135053_a("waiting.list.priority"):I18n.func_135053_a("waiting.list.classic")), (float)this.mapMode.x - 93.0F + 7.0F, (float)(this.mapMode.y - 2 + 16), 14277081, 0.5F, "left", false, "georamaRegular", 24);
