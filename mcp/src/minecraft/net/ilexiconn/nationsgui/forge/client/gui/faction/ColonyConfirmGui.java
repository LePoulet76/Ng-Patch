...
extends ModalGui {
    ...
    public void func_73863_a(int mouseX, int mouseY, float par3) {
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.colony.text_1"), this.guiLeft + 53, this.guiTop + 30, 0x191919, 1.0f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.colony.text_2"), this.guiLeft + 53, this.guiTop + 40, 0x191919, 1.0f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.colony.text_3"), this.guiLeft + 53, this.guiTop + 55, 0x191919, 0.9f, false, false);
    ...
    protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0) {
            if (FactionGui_OLD.hasPermissions("relations") && mouseX > this.guiLeft + 53 && mouseX < this.guiLeft + 53 + 118 && mouseY > this.guiTop + 95 && mouseY < this.guiTop + 95 + 20) {
                ...
                PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionRelationActionPacket((String)FactionGui_OLD.factionInfos.get("name"), "colony")));
