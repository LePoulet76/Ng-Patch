...
public class ToTheMoonGUI$ToTheMoonModalGui extends ModalGui
{
    ...
    {
        super.initGui();
        this.confirmButton = new GuiButton(0, this.guiLeft + 53, this.guiTop + 95, 118, 20, I18n.getString("moon.modal.confirm"));
        this.cancelButton = new GuiButton(1, this.guiLeft + 183, this.guiTop + 95, 118, 20, I18n.getString("moon.modal.cancel"));
        ...
        this.amountInput.setMaxStringLength(7);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("moon.modal.title"), this.guiLeft + 53, this.guiTop + 16, 1644825, 1.3F, false, false);
        this.drawScaledString(I18n.getString("moon.modal.desc_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("moon.modal.desc_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            if (!this.amountInput.getText().isEmpty() && this.isNumeric(this.amountInput.getText()) && mouseX > this.guiLeft + 53 && mouseX < this.guiLeft + 53 + 118 && mouseY > this.guiTop + 95 && mouseY < this.guiTop + 95 + 20)
            {
                ...
                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new MoonConfirmDonationPacket(Double.parseDouble(this.amountInput.getText()))));
