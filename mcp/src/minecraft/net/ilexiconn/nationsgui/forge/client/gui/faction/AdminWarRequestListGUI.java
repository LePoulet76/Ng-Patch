    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (warsInfos.size() > 0)
        {
            ...
            while (i.hasNext())
            {
                ...
                if ((this.countrySearch.getText().isEmpty() || ((String)warInfos.get("factionATTName")).toLowerCase().contains(this.countrySearch.getText().toLowerCase()) || ((String)warInfos.get("factionDEFName")).toLowerCase().contains(this.countrySearch.getText().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)warInfos.get("status")).startsWith(this.selectedStatus)))
                {
                    ...
                    if (ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionATTName")))
                    {
                        GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionATTName"))).getGlTextureId());
                    ...
                    this.drawScaledString(" \u00a7cvs", offsetX + 28 + this.fontRenderer.getStringWidth((String)warInfos.get("factionATTName")), offsetY.intValue() + 7, 16777215, 1.0F, false, false);
                    ...
                    if (ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionDEFName")))
                    {
                        GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionDEFName"))).getGlTextureId());
                    ...
                    this.drawScaledString("\u00a7b" + simpleDateFormat.format(var13), offsetX + 253 - this.fontRenderer.getStringWidth(simpleDateFormat.format(var13)), offsetY.intValue() + 33, 16777215, 1.0F, false, false);
                    yOffset += 48;
                }
            }
            ...
            if (this.expandStatus)
            {
                ...
                for (int var12 = 0; var12 < availableStatus.size(); ++var12)
                {
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.status." + (String)availableStatus.get(var12)), this.guiLeft + 50, this.guiTop + 36 + 19 * var12 + 6, 16777215, 1.0F, false, false);
