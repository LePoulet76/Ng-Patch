...
public class CustomWorkbenchContainer
extends Container {
    ...
    public CustomWorkbenchContainer(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5) {
        ...
        this.posY = par4;
        this.posZ = par5;
        this.func_75146_a((Slot)new SlotCrafting(par1InventoryPlayer.field_70458_d, (IInventory)this.craftMatrix, this.craftResult, 0, 152, 103));
        for (l = 0; l < 3; ++l) {
            for (i1 = 0; i1 < 3; ++i1) {
                this.func_75146_a(new Slot((IInventory)this.craftMatrix, i1 + l * 3, i1 * 18 + 89, 67 + l * 18));
            }
        }
        for (l = 0; l < 3; ++l) {
            for (i1 = 0; i1 < 9; ++i1) {
                this.func_75146_a(new Slot((IInventory)par1InventoryPlayer, i1 + l * 9 + 9, i1 * 18 + 206, 60 + l * 18));
            }
        }
        for (l = 0; l < 9; ++l) {
            this.func_75146_a(new Slot((IInventory)par1InventoryPlayer, l, 25 + l * 18 + 181, 118));
        }
    ...
    public boolean func_75145_c(EntityPlayer par1EntityPlayer) {
        return this.worldObj.func_72798_a(this.posX, this.posY, this.posZ) != Block.field_72060_ay.field_71990_ca ? false : par1EntityPlayer.func_70092_e((double)this.posX + 0.5, (double)this.posY + 0.5, (double)this.posZ + 0.5) <= 64.0;
    }
