...
extends ItemSpade {
    ...
    public CustomShovel(String name, ItemData data) {
        super(data.getId(), EnumHelper.addToolMaterial((String)name, (int)data.getHarvestLevel(), (int)data.getDurability(), (float)data.getMiningSpeed(), (float)(data.getDamageVsEntities() - 1.0f), (int)data.getEnchantability()));
