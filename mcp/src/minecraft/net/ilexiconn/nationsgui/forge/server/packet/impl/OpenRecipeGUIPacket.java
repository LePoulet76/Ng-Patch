...
public class OpenRecipeGUIPacket implements IPacket, IServerPacket, IClientPacket
{
    ...
    {
        Minecraft.getMinecraft().displayGuiScreen(new RecipeListGUI(Minecraft.getMinecraft().currentScreen));
    }
    ...
    public void handleServerPacket(EntityPlayer player)
    {
        try
        {
            ...
            while (var6.hasNext())
            {
                ...
                list.appendTag(compound.writeNBT());
            }

            NBTTagCompound compound1 = new NBTTagCompound();
            compound1.setTag("recipes", list);
