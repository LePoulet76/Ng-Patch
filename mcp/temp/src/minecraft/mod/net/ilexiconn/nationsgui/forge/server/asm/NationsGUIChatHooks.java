...
public class NationsGUIChatHooks {
   ...
   public static void autocompleteTooltipEmote(int guiWidth, int guiHeight, GuiTextField textField) {
      ...
      if(m.find()) {
         ...
         if(emoteWhichMatch.size() > 0) {
            drawHoveringText(emoteWhichMatch, Minecraft.func_71410_x().field_71466_p.func_78256_a(textField.func_73781_b()), guiHeight - 14 - emoteWhichMatch.size() * 9, Minecraft.func_71410_x().field_71466_p);
         }
      }
   ...
   public static void drawChatMessagePost(ChatLine chatLine, String formattedText, int x, int y, int alpha) throws IOException {
         ...
         if(scale != null && !ClientProxy.SKIN_MANAGER.getPlayerActiveSkins(scale, SkinType.BADGES).isEmpty()) {
            ...
            for(Iterator k = ClientProxy.SKIN_MANAGER.getPlayerActiveSkins(scale, SkinType.BADGES).iterator(); k.hasNext(); ++it) {
               ...
               if(it < 3) {
                  ...
                  int chatOffsetY = Minecraft.func_71410_x().field_71466_p.func_78256_a(formattedText.split("  ")[0]) * 2 + it * 11 * 2 + 2;
      ...
      while(var22.hasNext()) {
         ...
         if(formattedText.contains((String)var23.getValue()) && NationsGUI.EMOTES_RESOURCES.containsKey((String)var23.getKey())) {
            Minecraft.func_71410_x().func_110434_K().func_110577_a((ResourceLocation)NationsGUI.EMOTES_RESOURCES.get((String)var23.getKey()));
            ...
            for(int var26 = 0; var26 < tooltipInfo.length - 1; ++var26) {
               ...
               offsetX = Double.valueOf((double)Minecraft.func_71410_x().field_71466_p.func_78256_a(var27) * (1.0D / var21.doubleValue()) - (double)Minecraft.func_71410_x().field_71466_p.func_78256_a((String)var23.getValue()) * (1.0D / var21.doubleValue()) - 3.0D);
   ...
   public static void drawGradientRect(int par1, int par2, int par3, int par4, int par5, int par6) {
      ...
      tessellator.func_78377_a((double)par3, (double)par2, 300.0D);
      tessellator.func_78377_a((double)par1, (double)par2, 300.0D);
      tessellator.func_78369_a(f5, f6, f7, f4);
      tessellator.func_78377_a((double)par1, (double)par4, 300.0D);
      tessellator.func_78377_a((double)par3, (double)par4, 300.0D);
