...
public class RecipeCarpentryWatcher
extends RecipeWatcher<RecipeCarpentry> {
    @Override
    public RecipeData watchRecipe(RecipeCarpentry recipe) {
        ...
        for (int y = 0; y < 3; ++y) {
            ...
            for (int x = 0; x < 3; ++x) {
                ...
                if (recipe.getCraftingItem(x + y * width) != null) {
                    ItemStack itemStack = recipe.getCraftingItem(x + y * width).func_77946_l();
