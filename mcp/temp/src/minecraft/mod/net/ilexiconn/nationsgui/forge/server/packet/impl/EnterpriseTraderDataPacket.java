...
import net.ilexiconn.nationsgui.forge.server.packet.impl.EnterpriseTraderDataPacket$1;
import net.ilexiconn.nationsgui.forge.server.packet.impl.EnterpriseTraderDataPacket$2;
...
public class EnterpriseTraderDataPacket implements IPacket, IClientPacket {

   private Map<String, Double> history = new LinkedHashMap();
   public HashMap<String, Object> traderInfos = new HashMap();
   public String enterpriseName;


   public EnterpriseTraderDataPacket(String targetName) {
      this.enterpriseName = targetName;
   }

   public void fromBytes(ByteArrayDataInput data) {
      this.traderInfos = (HashMap)(new Gson()).fromJson(data.readUTF(), (new EnterpriseTraderDataPacket$1(this)).getType());
      GsonBuilder gsonBuilder = new GsonBuilder();
      gsonBuilder.registerTypeAdapter(Date.class, new DateDeserializer());
      Gson gson = gsonBuilder.create();
      Type type = (new EnterpriseTraderDataPacket$2(this)).getType();
   ...
   public void handleClientPacket(EntityPlayer player) {
      XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(496)).height(190)).title(I18n.func_135053_a("enterprise.STATS_TEXTURE.title"))).build();
      ...
      this.loadChartTexture(chart, EnterpriseTraderGUI.STATS_TEXTURE);
      EnterpriseTraderGUI.enterpriseTraderInfos = this.traderInfos;
      EnterpriseTraderGUI.loaded = true;
   }
