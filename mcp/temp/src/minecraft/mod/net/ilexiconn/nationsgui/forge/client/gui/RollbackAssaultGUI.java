...
public class RollbackAssaultGUI extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.title").toUpperCase(), (float)(this.guiLeft + 13), (float)(this.guiTop + 10), 16316667, 0.75F, "left", false, "minecraftDungeons", 23);
      ModernGui.drawSectionStringCustomFont(I18n.func_135053_a("faction.rollback.desc"), (float)(this.guiLeft + 13), (float)(this.guiTop + 25), 12237530, 0.5F, "left", false, "georamaMedium", 24, 8, 500);
      if(loaded) {
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.informations").toUpperCase(), (float)(this.guiLeft + 22), (float)(this.guiTop + 62), 16316667, 0.5F, "left", false, "minecraftDungeons", 24);
         Date date = new Date(Long.parseLong((String)data.get("time")));
         SimpleDateFormat sdf = new SimpleDateFormat("dd/MM HH:mm");
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.assault_date").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 75), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         ModernGui.drawScaledStringCustomFont(sdf.format(date), (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.assault_date").toUpperCase() + " :") / 2.0F + 3.0F, (float)this.guiTop + 75.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.country_enemy").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 85), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         ModernGui.drawScaledStringCustomFont((String)data.get("enemyName"), (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.country_enemy").toUpperCase() + " :") / 2.0F + 3.0F, (float)this.guiTop + 85.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.block_count").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 105), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)data.get("blocksCount")}), (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.block_count").toUpperCase() + " :") / 2.0F + 3.0F, (float)this.guiTop + 105.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.price").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 115), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         ModernGui.drawScaledStringCustomFont("10$/bloc - 0.006 power/bloc", (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.price").toUpperCase() + " :") / 2.0F + 3.0F, (float)(this.guiTop + 115), 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.remaining_time").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 125), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         long endTime = Long.parseLong((String)data.get("time")) + 3600000L;
         ModernGui.drawScaledStringCustomFont(endTime > System.currentTimeMillis()?ModernGui.getFormattedTimeDiff(endTime, System.currentTimeMillis()):I18n.func_135053_a("faction.rollback.expired"), (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.remaining_time").toUpperCase() + " :") / 2.0F + 3.0F, (float)(this.guiTop + 125), 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.malus").toUpperCase() + " :", (float)(this.guiLeft + 22), (float)(this.guiTop + 145), 7961015, 0.5F, "left", false, "minecraftDungeons", 18);
         double malus = data.get("countRepair") != null?((Double)data.get("countRepair")).doubleValue() / 1000.0D:0.0D;
         ModernGui.drawScaledStringCustomFont("+" + String.format("%.0f", new Object[]{Double.valueOf(malus)}) + "% (+1%/1000 blocs)", (float)(this.guiLeft + 22) + dungeons18.getStringWidth(I18n.func_135053_a("faction.rollback.malus").toUpperCase() + " :") / 2.0F + 3.0F, (float)this.guiTop + 145.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.repair_percent"), (float)(this.guiLeft + 190) + dungeons24.getStringWidth(String.format("%.0f", new Object[]{Double.valueOf(this.repairPercent * 100.0D)}) + "%") / 2.0F + 2.0F, (float)(this.guiTop + 64), 7961015, 0.5F, "left", false, "minecraftDungeons", 16);
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.repair_cost"), (float)(this.guiLeft + 190) + dungeons24.getStringWidth(String.format("%.0f", new Object[]{Double.valueOf(pricePower)}) + " Pow + " + String.format("%.0f", new Object[]{Double.valueOf(priceDollars)}) + "$") / 2.0F + 2.0F, (float)(this.guiTop + 106), 7961015, 0.5F, "left", false, "minecraftDungeons", 16);
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.rollback.repair_button").toUpperCase(), (float)(this.guiLeft + 184 + 80), (float)(this.guiTop + 156), 2434373, 0.5F, "center", false, "minecraftDungeons", 21);
      }
