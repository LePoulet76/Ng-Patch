   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(warsInfos.size() > 0) {
         ...
         while(i.hasNext()) {
            ...
            if((this.countrySearch.func_73781_b().isEmpty() || ((String)warInfos.get("factionName")).toLowerCase().contains(this.countrySearch.func_73781_b().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)warInfos.get("status")).startsWith(this.selectedStatus))) {
               ...
               if(ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionName"))) {
                  GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionName"))).func_110552_b());
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.requests.see"), offsetX + 227, offsetY.intValue() + 32, 0, 1.0F, true, false);
               yOffset += 48;
            }
         }
         ...
         if(this.expandStatus) {
            ...
            for(int var11 = 0; var11 < availableStatus.size(); ++var11) {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.status." + (String)availableStatus.get(var11)), this.guiLeft + 50, this.guiTop + 36 + 19 * var11 + 6, 16777215, 1.0F, false, false);
