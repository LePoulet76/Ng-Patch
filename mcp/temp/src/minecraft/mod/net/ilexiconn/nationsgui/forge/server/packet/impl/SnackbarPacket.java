...
public class SnackbarPacket implements IPacket, IClientPacket {
   ...
   public void handleClientPacket(EntityPlayer player) {
      ClientProxy.SNACKBAR_LIST.add(new SnackbarGUI(StatCollector.func_74837_a(this.message.replace("<player>", Minecraft.func_71410_x().field_71439_g.func_96090_ax()), (Object[])this.extra)));
   }
