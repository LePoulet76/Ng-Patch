...
public class EnterpriseTraderGUI extends TabbedEnterpriseGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY)
    {
        ...
        if (loaded)
        {
            this.drawScaledString(I18n.getString("enterprise.trader.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
            ...
            ClientEventHandler.STYLE.bindTexture("enterprise_trader");
            this.drawScaledString(I18n.getString("enterprise.trader.label.my_investment"), this.guiLeft + 160, this.guiTop + 148, 11842740, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.getString("enterprise.trader.label.investors"), this.guiLeft + 288, this.guiTop + 148, 11842740, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.getString("enterprise.trader.label.sum_investment"), this.guiLeft + 160, this.guiTop + 199, 11842740, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.getString("enterprise.trader.label.total_generated"), this.guiLeft + 288, this.guiTop + 199, 11842740, 1.0F, false, false);
            ...
            if (enterpriseTraderInfos.containsKey("today_percent"))
            {
                ...
                {
                    tooltipToDraw = I18n.getString("enterprise.trader.tooltip.today_percent");
                }
            }
