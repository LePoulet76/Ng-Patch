...
public class RollbackAssaultDataPacket
implements IPacket,
IClientPacket {
    ...
    public void fromBytes(ByteArrayDataInput data) {
        this.rollbackInfos = (HashMap)new Gson().fromJson(data.readUTF(), new TypeToken<HashMap<String, Object>>(){}.getType());
    }
    ...
    public void handleClientPacket(EntityPlayer player) {
        Minecraft.func_71410_x().func_71373_a((GuiScreen)new RollbackAssaultGUI());
