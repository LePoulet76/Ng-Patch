...
public class SettingsGUI_OLD extends TabbedFactionGUI_OLD
{
    ...
    public void initGui()
    {
        ...
        this.inputDescription.setText((String)FactionGui_OLD.factionInfos.get("description"));
        this.inputDescription.setCursorPositionZero();
        this.disbandButton = new TexturedCenteredButtonGUI(1, this.guiLeft + 10, this.guiTop + 220, 100, 20, "faction_btn", 0, 0, I18n.getString("faction.settings.disband_button"));
        this.sellButton = new TexturedCenteredButtonGUI(2, this.guiLeft + 10, this.guiTop + 195, 100, 20, "faction_btn", 0, 0, ((Boolean)FactionGui_OLD.factionInfos.get("isForSale")).booleanValue() ? I18n.getString("faction.settings.sell_off_button") : I18n.getString("faction.settings.sell_button"));
    ...
    public void drawScreen(int mouseX, int mouseY)
    {
        ...
        if (((Boolean)FactionGui_OLD.factionInfos.get("isLeader")).booleanValue())
        {
            ...
            this.sellButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
        }
        ...
        this.drawScaledString(I18n.getString("faction.settings.edit_flag"), this.guiLeft + 292, this.guiTop + 52, 16777215, 1.0F, true, false);
        ...
        this.drawScaledString(I18n.getString("faction.settings.open_text"), this.guiLeft + 145, this.guiTop + 114, 1644825, 1.0F, false, false);
        ...
        for (int j = 0; j < var8.size(); ++j)
        {
            ...
            this.drawScaledString(((String)var8.get(j)).split("##")[0] + " " + I18n.getString("faction.settings.logs." + ((String)var8.get(j)).split("##")[1]).replace("#target#", ((String)var8.get(j)).split("##")[2]), offsetX + 6, offsetY.intValue() + 6, 11842740, 0.85F, false, false);
            ClientEventHandler.STYLE.bindTexture("faction_settings");
        ...
        {
            this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.settings.cant_sell_1"), I18n.getString("faction.settings.cant_sell_2"), I18n.getString("faction.settings.cant_sell_3")}), mouseX, mouseY, this.fontRenderer);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            if (mouseX >= this.guiLeft + 217 && mouseX <= this.guiLeft + 217 + 150 && mouseY >= this.guiTop + 47 && mouseY <= this.guiTop + 47 + 18)
            {
                ...
                Minecraft.getMinecraft().displayGuiScreen(new FlagGui(this.player, (String)FactionGui_OLD.factionInfos.get("name")));
            }
