...
public class SpartanWhiteOverride extends Gui implements ElementOverride {
   ...
   public void renderOverride(Minecraft client, ScaledResolution resolution, float partialTicks) {
      if(!ModernGui.cachedOverlayMainTexture.equalsIgnoreCase("overlay_main")) {
         ...
         tessellator.func_78374_a(0.0D, (double)screenHeight, 0.0D, 0.0D, 1.0D);
         tessellator.func_78374_a((double)screenWidth, (double)screenHeight, 0.0D, 1.0D, 1.0D);
         tessellator.func_78374_a((double)screenWidth, 0.0D, 0.0D, 1.0D, 0.0D);
         ...
         if(CommonEventHandler.isWearingFullSpartanWhiteArmor(client.field_71439_g) && chestplate != null && chestplate.func_77973_b() instanceof SpartanWhiteArmorItem) {
