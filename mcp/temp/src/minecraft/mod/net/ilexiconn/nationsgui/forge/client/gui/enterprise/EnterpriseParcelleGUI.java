...
public class EnterpriseParcelleGUI extends TabbedEnterpriseGUI {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
      ...
      if(parcellesInfos.size() > 0) {
         ...
         while(i.hasNext()) {
            ...
            if((this.parcelleSearch.func_73781_b().isEmpty() || ((String)offsetX.get("clientName")).toLowerCase().contains(this.parcelleSearch.func_73781_b().toLowerCase()) || ((String)offsetX.get("name")).toLowerCase().contains(this.parcelleSearch.func_73781_b().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)offsetX.get("status")).startsWith(this.selectedStatus))) {
               ...
               this.drawScaledString((String)offsetX.get("name"), offsetY + 249 - this.field_73886_k.func_78256_a((String)offsetX.get("name")), offsetY1.intValue() + 5, 16777215, 1.0F, false, false);
               if(((String)offsetX.get("status")).contains("rent#")) {
                  this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.status.rent") + " (" + ((String)offsetX.get("status")).split("#")[1] + "j)", offsetY + 4, offsetY1.intValue() + 24, 16777215, 1.0F, false, false);
               } else {
                  this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.status." + offsetX.get("status")), offsetY + 4, offsetY1.intValue() + 24, 16777215, 1.0F, false, false);
               }
               ...
               this.drawScaledString("\u00a78" + signCoords, offsetY + 249 - this.field_73886_k.func_78256_a(signCoords), offsetY1.intValue() + 24, 16777215, 1.0F, false, false);
               if(this.openedParcelleName != "" && this.openedParcelleName == offsetX.get("name")) {
                  ClientEventHandler.STYLE.bindTexture("enterprise_parcelle");
                  ...
                  if(!offsetX.get("status").equals("free")) {
                     this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.btn_label.cancel"), offsetY + 224, offsetY1.intValue() + 41, 16777215, 1.0F, true, false);
                  } else {
                     this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.btn_label.remove"), offsetY + 224, offsetY1.intValue() + 41, 16777215, 1.0F, true, false);
                     action = "remove";
                  }
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.status." + this.selectedStatus), this.guiLeft + 278, this.guiTop + 36, 16777215, 1.0F, false, false);
         if(this.expandStatus) {
            ClientEventHandler.STYLE.bindTexture("enterprise_parcelle");
            ...
            for(int var11 = 0; var11 < availableStatus.size(); ++var11) {
               ...
               this.drawScaledString(I18n.func_135053_a("enterprise.parcelle.status." + (String)availableStatus.get(var11)), var12 + 3, var13.intValue() + 5, 16777215, 1.0F, false, false);
