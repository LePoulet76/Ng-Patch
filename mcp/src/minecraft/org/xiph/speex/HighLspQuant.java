...
public class HighLspQuant extends LspQuant
{
    public final void quant(float[] var1, float[] var2, int var3, Bits var4)
    {
        ...
        {
            float var8 = 1.0F / (var2[var5] - var2[var5 - 1]);
        ...
        int var91 = lsp_quant(var2, 0, Codebook.high_lsp_cdbk, 64, var3);
        var4.pack(var91, 6);
        ...
        var91 = lsp_weight_quant(var2, 0, var9, 0, Codebook.high_lsp_cdbk2, 64, var3);
        var4.pack(var91, 6);
