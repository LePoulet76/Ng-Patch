...
public class WarGUI_OLD extends TabbedFactionGUI_OLD
{
    ...
    public void initGui()
    {
        ...
        this.assaultButton = new TexturedCenteredButtonGUI(0, this.guiLeft + 259, this.guiTop + 210, 125, 20, "faction_btn", 103, 0, "   " + I18n.getString("faction.war.assault_button"));
        this.warRequestsButton = new GuiButton(1, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.getString("faction.wars.button.requests"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY)
    {
        ...
        {
            this.warRequestsButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
        }

        this.drawScaledString(I18n.getString("faction.war.title"), this.guiLeft + 131, this.guiTop + 16, 1644825, 1.4F, false, false);

        if (loaded && this.currentWar != null)
        {
            if (this.assaultButton.enabled && !this.currentWar.get("canAssault").equals("true"))
            {
                this.assaultButton.enabled = false;
            }
            ...
            this.drawScaledString(I18n.getString("faction.war.duration_1") + " " + this.currentWar.get("duration") + " " + I18n.getString("faction.war.duration_2"), this.guiLeft + 255, this.guiTop + 35, 16777215, 0.7F, true, false);
            ...
            {
                String tooltipToDraw = I18n.getString("faction.war.summary.sentence").replace("#remainingPoints#", (String)this.currentWar.get("remainingPoints"));
            ...
            if (this.currentWar.containsKey("warId"))
            {
                ...
                this.drawScaledString(I18n.getString("faction.war.warRequestBtn"), this.guiLeft + 352, this.guiTop + 109, 16777215, 1.0F, true, false);
                ClientEventHandler.STYLE.bindTexture("faction_war");
                ...
                this.drawScaledString(I18n.getString("faction.war.warAgreementBtn"), this.guiLeft + 325, this.guiTop + 17, 16777215, 1.0F, true, false);
            }

            ArrayList var26 = new ArrayList();
            this.drawScaledString(I18n.getString("faction.war.missile_history"), this.guiLeft + 131, this.guiTop + 133, 1644825, 0.85F, false, false);
            int i;
            String mmr;
            int missileID;
            int diff;
            ...
            if (this.currentWar.containsKey("missiles") && ((ArrayList)this.currentWar.get("missiles")).size() > 0)
            {
                ...
                for (i = 0; i < ((ArrayList)this.currentWar.get("missiles")).size(); ++i)
                {
                    ...
                    this.itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), date1, diff + 7, (int)(helper1.floatValue() + 7.0F));
                    this.itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.getTextureManager(), date1, diff + 7, (int)(helper1.floatValue() + 7.0F));
                    ...
                    {
                        var26.add(I18n.getString("faction.war.missile_firedby") + " " + winnerHelpers + " - " + mmr);
                    }
                }
            ...
            if (this.cachedAssaults.size() == 0 && this.currentWar.containsKey("assaults") && ((ArrayList)this.currentWar.get("assaults")).size() > 0)
            {
                for (i = 0; i < ((ArrayList)this.currentWar.get("assaults")).size(); ++i)
                {
                    ...
                    String var43 = "\u00a78" + I18n.getString("faction.bank.date_1");
                    ...
                    if (days == 0L)
                    {
                        ...
                        if (hours == 0L)
                        {
                            ...
                            {
                                seconds = var41 / 1000L;
                                var43 = var43 + " " + seconds + " " + I18n.getString("faction.common.seconds") + " " + I18n.getString("faction.bank.date_2");
                            }
                            else
                            {
                                var43 = var43 + " " + minutes + " " + I18n.getString("faction.common.minutes") + " " + I18n.getString("faction.bank.date_2");
                            }
                        }
                        else
                        {
                            var43 = var43 + " " + hours + " " + I18n.getString("faction.common.hours") + " " + I18n.getString("faction.bank.date_2");
                        }
                    }
                    else
                    {
                        var43 = var43 + " " + days + " " + I18n.getString("faction.common.days") + " " + I18n.getString("faction.bank.date_2");
                    }
            ...
            this.drawScaledString(I18n.getString("faction.war.assault_history"), this.guiLeft + 260, this.guiTop + 133, 1644825, 0.85F, false, false);
            ...
            if (this.cachedAssaults.size() > 0)
            {
                ...
                for (i = 0; i < this.cachedAssaults.size(); ++i)
                {
                    ...
                    this.drawScaledString(((Boolean)var27.get("win")).booleanValue() ? I18n.getString("faction.common.victory").replace("#mmr#", (String)var27.get("mmr")) : I18n.getString("faction.common.defeat").replace("#mmr#", (String)var27.get("mmr")), var29 + 3, var30.intValue() + 3, 11842740, 0.85F, false, false);
                    ...
                    {
                        var26.add("\u00a72" + I18n.getString("faction.war.assaults.helpers.ally") + ":");
                        ...
                        var26.add("");
                        var26.add("\u00a7c" + I18n.getString("faction.war.assaults.helpers.ennemy") + ":");
            ...
            {
                this.assaultButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);

                if (!this.assaultButton.enabled && mouseX > this.guiLeft + 259 && mouseX < this.guiLeft + 259 + 125 && mouseY > this.guiTop + 210 && mouseY < this.guiTop + 210 + 20)
                {
                    if (((String)this.currentWar.get("canAssault")).contains("cooldown"))
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.war.assault.reason.cooldown").replace("#cooldown#", ((String)this.currentWar.get("canAssault")).replace("cooldown.", ""))}), mouseX, mouseY + 20, this.fontRenderer);
                    }
                    else if (((String)this.currentWar.get("canAssault")).contains("self.days.protection"))
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("self.days.protection").replace("#protection#", ((String)this.currentWar.get("canAssault")).replace("self.days.protection.", ""))}), mouseX, mouseY + 20, this.fontRenderer);
                    }
                    else if (((String)this.currentWar.get("canAssault")).contains("other.days.protection"))
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("other.days.protection").replace("#protection#", ((String)this.currentWar.get("canAssault")).replace("other.days.protection.", ""))}), mouseX, mouseY + 20, this.fontRenderer);
                    }
                    else
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.war.assault.reason." + this.currentWar.get("canAssault"))}), mouseX, mouseY + 20, this.fontRenderer);
                    }
                }
            }
        ...
        {
            Gui.drawRect(this.guiLeft + 124, this.guiTop + 15, this.guiLeft + 124 + 268, this.guiTop + 15 + 224, -1513240);
            this.drawScaledString(I18n.getString("faction.war.no_result"), this.guiLeft + 258, this.guiTop + 100, 328965, 1.1F, true, false);
        }
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0)
        {
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new WarRequestListGUI());
            }
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new WarRequestGUI(((Double)this.currentWar.get("warId")).intValue(), (GuiScreen)null));
            }
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new WarAgreementListGui(this.player, ((Double)this.currentWar.get("warId")).intValue(), (String)FactionGui_OLD.factionInfos.get("name"), (String)this.currentWar.get("name")));
            }
