...
public abstract class TabbedFactionGUI_OLD extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (FactionGui_OLD.factionInfos != null)
        {
            ...
            this.drawScaledString(I18n.getString("faction.common.age_1") + " " + FactionGui_OLD.factionInfos.get("age") + " " + I18n.getString("faction.common.age_2"), this.guiLeft + 60, this.guiTop + 43, 11842740, 0.65F, true, false);
            this.drawScaledString(I18n.getString("faction.common." + FactionGui_OLD.factionInfos.get("actualRelation")), this.guiLeft + 58, this.guiTop + 66, 1644825, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture("faction_main");
            int negativeOffsetX;
            ...
            else if (!((String)FactionGui_OLD.factionInfos.get("isColony")).isEmpty())
            {
                ...
                if (mouseX >= this.guiLeft + 105 - negativeOffsetX && mouseX <= this.guiLeft + 105 - negativeOffsetX + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10)
                {
                    this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.common.badge.colony") + " " + FactionGui_OLD.factionInfos.get("isColony")}), mouseX, mouseY, this.fontRenderer);
                }
            }
            ...
            for (int var8 = 0; var8 < FactionGui_OLD.TABS.size(); ++var8)
            {
                ...
                if (!var9.getClassReferent().equals(SettingsGUI_OLD.class))
                {
                    ...
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.tab." + var9.getClassReferent().getSimpleName())}), mouseX, mouseY, this.fontRenderer);
                    }
                }
