...
public class BadgesGUI extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.badges.title") + " " + this.targetName, this.guiLeft + 51, this.guiTop + 17, 1644825, 1.4F, false, false);
        ...
        if (loaded)
        {
            ...
            if (CLIENT_BADGES != null && CLIENT_BADGES.hasKey("AvailableBadges"))
            {
                ...
                for (int var7 = 0; var7 < var6; ++var7)
                {
                    ...
                    {
                        Minecraft.getMinecraft().getTextureManager().bindTexture((ResourceLocation)NationsGUI.BADGES_RESOURCES.get(availableBadge));
                        ...
                        if (CLICKED_BADGE != null && CLICKED_BADGE.equals(availableBadge))
                        {
                            ...
                            this.drawTexturedModalRect(offsetXSelect, offsetYSelect.intValue(), 18, 226, 24, 24);
                            this.zLevel = 0.0F;
                ...
                if (!this.hoveredBadge.isEmpty())
                {
                    ...
                    this.drawHoveringText(var15, mouseX, mouseY, this.fontRenderer);
                    this.hoveredBadge = "";
                }
            }
        }
