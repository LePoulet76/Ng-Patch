...
public class ChatScrollBar {
   ...
   public void handleMouse() {
      ...
      if(Mouse.getEventButton() == 0 && Mouse.isButtonDown(0)) {
         int adjX1 = Mouse.getEventX() * gc.field_73880_f / mc.field_71443_c;
         int adjY1 = gc.field_73881_g - Mouse.getEventY() * gc.field_73881_g / mc.field_71440_d - 1;
      ...
      int aY = gc.field_73881_g - Mouse.getEventY() * gc.field_73881_g / mc.field_71440_d - 1;
   ...
   private void update() {
      ...
      if(TabbyChat.instance.generalSettings.timeStampEnable.getValue().booleanValue()) {
         oX = MathHelper.func_76141_d((float)mc.field_71466_p.func_78256_a(((TimeStampEnum)TabbyChat.instance.generalSettings.timeStampStyle.getValue()).maxTime) * TabbyChat.gnc.getScaleSetting());
      }

      barHeight = MathHelper.func_76141_d(8.0F * TabbyChat.gnc.getScaleSetting());
      barWidth = MathHelper.func_76141_d(5.0F * TabbyChat.gnc.getScaleSetting());
      this.barX = 4 + this.offsetX + oX + (int)((float)TabbyChat.gnc.getWidthSetting() * TabbyChat.gnc.getScaleSetting());
      this.barMaxY = gc.field_73881_g - 34 + this.offsetY;
      this.barMinY = this.barMaxY + 2 - MathHelper.func_76141_d((float)((clines - 1) * 9) * TabbyChat.gnc.getScaleSetting());
   ...
   public void drawScrollBar() {
      ...
      if(TabbyChat.gnc.GetChatHeight() > maxlines) {
         var10000 = gc;
         GuiChat.func_73734_a(minX, this.scrollBarCenter - barHeight / 2, minX + barWidth, this.scrollBarCenter + barHeight / 2, 1442840575);
      }

      var10000 = gc;
      GuiChat.func_73734_a(this.barX, this.barMinY, this.barX + 1, this.barMaxY, -1711276033);
   }
   ...
   public void setOffset(int _x, int _y) {
      ...
      int clines = TabbyChat.gnc.GetChatHeight() < maxlines?TabbyChat.gnc.GetChatHeight():maxlines;
      this.barX = 324 + _x;
      this.barMinY = mc.field_71462_r.field_73881_g - ((clines - 1) * 9 + 8) - 35 + _y;
      this.barTopY = this.barMinY + barHeight / 2 + _y;
      this.barMaxY = mc.field_71462_r.field_73881_g - 45 + _y;
