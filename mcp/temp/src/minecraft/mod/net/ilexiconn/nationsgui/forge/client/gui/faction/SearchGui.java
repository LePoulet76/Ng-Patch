...
public class SearchGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.search.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.0F, false, false);
      ...
      this.drawScaledString(I18n.func_135053_a("faction.search.age"), this.guiLeft + 51 + 100, this.guiTop + 50, 1644825, 0.9F, false, false);
      this.drawScaledString(I18n.func_135053_a("faction.search.level"), this.guiLeft + 51 + 155, this.guiTop + 50, 1644825, 0.9F, false, false);
      this.drawScaledString(I18n.func_135053_a("faction.search.online_players"), this.guiLeft + 51 + 210, this.guiTop + 50, 1644825, 0.9F, false, false);
      this.drawScaledString(I18n.func_135053_a("faction.search.open_filter"), this.guiLeft + 64, this.guiTop + 227, 1644825, 0.9F, false, false);
      ClientEventHandler.STYLE.bindTexture("faction_search");
      if(this.open_filter) {
      ...
      if(loaded && countries.size() > 0) {
         ...
         for(int var8 = 0; var8 < countries.size(); ++var8) {
            if((!this.open_filter || this.open_filter && ((String)((HashMap)countries.get(var8)).get("open")).equals("true")) && (this.searchText.isEmpty() || !this.searchText.isEmpty() && ((String)((HashMap)countries.get(var8)).get("name")).toLowerCase().contains(this.searchText.toLowerCase()))) {
               ...
               this.drawScaledString((String)((HashMap)countries.get(var8)).get("age") + I18n.func_135053_a("faction.common.days.short"), offsetX + 100, var9.intValue() + 5, 16777215, 1.0F, false, false);
