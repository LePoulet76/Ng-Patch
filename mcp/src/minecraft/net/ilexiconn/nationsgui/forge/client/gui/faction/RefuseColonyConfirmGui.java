...
public class RefuseColonyConfirmGui extends ModalGui
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.refuse_colony.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.refuse_colony.text_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.refuse_colony.text_3"), this.guiLeft + 53, this.guiTop + 55, 1644825, 0.9F, false, false);
