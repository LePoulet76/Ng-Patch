...
public class IslandMainGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (loaded && islandInfos.size() > 0)
        {
            ...
            for (int titleOffsetY = 0; titleOffsetY < TABS.size(); ++titleOffsetY)
            {
                ...
                else
                {
                    ...
                    {
                        tooltipToDraw = Arrays.asList(new String[] {I18n.getString("island.tab." + line)});
                    }
                }
            }
        }
        ...
        if (loaded && islandInfos.size() > 0)
        {
            ...
            GL11.glPushMatrix();
            Double var14 = Double.valueOf((double)(this.guiTop + 45) + (double)this.fontRenderer.getStringWidth((String)islandInfos.get("name")) * 1.5D);
            ...
            if (loaded)
            {
                ...
                {
                    tooltipToDraw = Arrays.asList(new String[] {I18n.getString("island.list.tooltip.creation") + " " + (String)islandInfos.get("creationDate")});
                }
                ...
                for (offsetX = 0; offsetX < speed; ++offsetX)
                {
                    ...
                    if (this.fontRenderer.getStringWidth(var16 + offsetY) <= 128)
                    {
                        if (!var16.equals(""))
                        {
                            var16 = var16 + " ";
                ...
                this.drawScaledString(!((String)islandInfos.get("visit")).equals("0") && !((String)islandInfos.get("visit")).equals("1") ? islandInfos.get("visit") + " " + I18n.getString("island.main.label.visits") : (String)islandInfos.get("visit") + " " + I18n.getString("island.main.label.visit"), this.guiLeft + 104, this.guiTop + 75, 16777215, 1.0F, true, false);
                ...
                this.drawScaledString(I18n.getString("island.main.members"), this.guiLeft + 48, this.guiTop + 97, 0, 1.0F, false, false);
                ...
                this.drawScaledString(I18n.getString("island.main.visitors"), this.guiLeft + 164, this.guiTop + 97, 0, 1.0F, false, false);
                ...
                {
                    this.drawScaledString(I18n.getString("island.main.create.button.own"), this.guiLeft + 228, this.guiTop + 213, 16777215, 1.0F, true, false);
                }
                else
                {
                    this.drawScaledString(I18n.getString("island.main.create.button.other"), this.guiLeft + 228, this.guiTop + 213, 16777215, 1.0F, true, false);
                }

                if (((Boolean)islandInfos.get("playerIsCreator")).booleanValue())
                {
                    this.drawScaledString(I18n.getString("island.main.create.text.own"), this.guiLeft + 54, this.guiTop + 207, 16777215, 1.0F, false, false);
                    this.drawScaledString(I18n.getString("island.main.create.text.own_2"), this.guiLeft + 54, this.guiTop + 217, 16777215, 1.0F, false, false);
                }
                else
                {
                    this.drawScaledString(I18n.getString("island.main.create.text.other_1"), this.guiLeft + 54, this.guiTop + 207, 16777215, 1.0F, false, false);
                    this.drawScaledString(I18n.getString("island.main.create.text.other_2"), this.guiLeft + 54, this.guiTop + 217, 16777215, 1.0F, false, false);
                }
                ...
                {
                    this.drawScaledString(I18n.getString("island.main.creative"), this.guiLeft + 321, this.guiTop + 8, 0, 1.0F, true, false);
                }
                else
                {
                    this.drawScaledString(I18n.getString("island.main.survival"), this.guiLeft + 321, this.guiTop + 8, 0, 1.0F, true, false);
                }
                ...
                else
                {
                    ...
                    if ((!((Boolean)islandInfos.get("isCreative")).booleanValue() && !this.changedIsGamemode || this.changedIsGamemode && !this.newIsGamemode) && mouseX >= this.guiLeft + 291 && mouseX <= this.guiLeft + 291 + 60 && mouseY >= this.guiTop + 23 && mouseY <= this.guiTop + 23 + 15)
                    {
                        tooltipToDraw = Arrays.asList(new String[] {I18n.getString("island.main.flyspeed.blocked")});
                    }
                }
                ...
                this.drawScaledString(I18n.getString("island.main.flyspeed") + " " + var18.intValue(), this.guiLeft + 321, this.guiTop + 27, 0, 1.0F, true, false);
                ClientEventHandler.STYLE.bindTexture("island_main");
                ...
                this.drawScaledString(I18n.getString("island.main.clearinventory"), this.guiLeft + 321, this.guiTop + 46, 0, 1.0F, true, false);
