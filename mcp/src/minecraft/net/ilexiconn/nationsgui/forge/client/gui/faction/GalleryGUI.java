...
public class GalleryGUI extends TabbedFactionGUI
{
    ...
    {
        super.initGui();
        this.titleInput = new GuiTextField(this.fontRenderer, this.guiLeft + 248, this.guiTop + 53, 200, 10);
        this.titleInput.setEnableBackgroundDrawing(false);
        this.titleInput.setMaxStringLength(60);

        if (loaded && galleryImages.size() > 0)
        {
            this.titleInput.setText((String)((HashMap)galleryImages.get(selectedImageIndex)).get("title"));
        }

        this.descriptionInput = new GuiTextField(this.fontRenderer, this.guiLeft + 248, this.guiTop + 80, 200, 10);
        this.descriptionInput.setEnableBackgroundDrawing(false);
        this.descriptionInput.setMaxStringLength(150);

        if (loaded && galleryImages.size() > 0)
        {
            this.descriptionInput.setText((String)((HashMap)galleryImages.get(selectedImageIndex)).get("description"));
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        if (loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            else
            {
                ...
                if (this.editMode && FactionGUI.hasPermissions("gallery"))
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.edit.title"), (float)(this.guiLeft + 245), (float)(this.guiTop + 41), 16777215, 0.5F, "left", false, "georamaSemiBold", 32);
                    ClientEventHandler.STYLE.bindTexture("faction_gallery");
                    ...
                    this.titleInput.drawTextBox();
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.edit.description"), (float)(this.guiLeft + 246), (float)(this.guiTop + 68), 16777215, 0.5F, "left", false, "georamaSemiBold", 32);
                    ClientEventHandler.STYLE.bindTexture("faction_gallery");
                    ...
                    this.descriptionInput.drawTextBox();
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.edit.position"), (float)(this.guiLeft + 246), (float)(this.guiTop + 105), 16777215, 0.5F, "left", false, "georamaSemiBold", 32);
                    ClientEventHandler.STYLE.bindTexture("faction_gallery");
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.label.valid"), (float)(this.guiLeft + 335 + 26), (float)(this.guiTop + 207), 2234425, 0.5F, "center", false, "georamaSemiBold", 32);
                    ClientEventHandler.STYLE.bindTexture("faction_gallery");
                    ...
                    if (mouseX >= this.guiLeft + 390 && mouseX <= this.guiLeft + 390 + 51 && mouseY >= this.guiTop + 205 && mouseY <= this.guiTop + 205 + 13)
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.label.cancel"), (float)(this.guiLeft + 390 + 26), (float)(this.guiTop + 207), 2234425, 0.5F, "center", false, "georamaSemiBold", 32);
                    }
                    else
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("faction.gallery.label.cancel"), (float)(this.guiLeft + 390 + 26), (float)(this.guiTop + 207), 16777215, 0.5F, "center", false, "georamaSemiBold", 32);
                    }
                }
                else
                {
                    String index = (String)((HashMap)galleryImages.get(selectedImageIndex)).get("title");
                    index = index.isEmpty() ? "\u00a7o" + I18n.getString("faction.gallery.no_title") : index;
                    String i = (String)((HashMap)galleryImages.get(selectedImageIndex)).get("description");
                    i = i.isEmpty() ? "\u00a7o" + I18n.getString("faction.gallery.no_description") : i;
    ...
    {
        this.titleInput.updateCursorCounter();
        this.descriptionInput.updateCursorCounter();
    }
    ...
    {
        this.titleInput.textboxKeyTyped(typedChar, keyCode);
        this.descriptionInput.textboxKeyTyped(typedChar, keyCode);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0 && !this.hoveredAction.isEmpty())
        {
            ...
            else if (this.hoveredAction.equals("add_image"))
            {
                ...
                Minecraft.getMinecraft().thePlayer.sendChatToPlayer(ChatMessageComponent.createFromText(I18n.getString("faction.take_picture_gallery")));
            }

            this.hoveredAction = "";
        }

        this.titleInput.mouseClicked(mouseX, mouseY, mouseButton);
        this.descriptionInput.mouseClicked(mouseX, mouseY, mouseButton);
