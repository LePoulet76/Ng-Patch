...
public class EnterpriseBetCreateGui
extends ModalLargeGui {
    ...
    public void func_73866_w_() {
        ...
        this.yesButton = new GuiButton(0, this.guiLeft + 53, this.guiTop + 183, 118, 20, I18n.func_135053_a((String)"faction.common.confirm"));
        this.noButton = new GuiButton(1, this.guiLeft + 183, this.guiTop + 183, 118, 20, I18n.func_135053_a((String)"faction.common.cancel"));
    }

    @Override
    public void func_73863_a(int mouseX, int mouseY, float par3) {
        super.func_73863_a(mouseX, mouseY, par3);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.title"), this.guiLeft + 53, this.guiTop + 16, 0x191919, 1.3f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.question"), this.guiLeft + 54, this.guiTop + 29, 0x191919, 1.0f, false, false);
        ModernGui.drawNGBlackSquare(this.guiLeft + 53, this.guiTop + 38, 249, 20);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.option1"), this.guiLeft + 54, this.guiTop + 68, 0x191919, 1.0f, false, false);
        ModernGui.drawNGBlackSquare(this.guiLeft + 53, this.guiTop + 77, 249, 20);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.option2"), this.guiLeft + 54, this.guiTop + 106, 0x191919, 1.0f, false, false);
        ModernGui.drawNGBlackSquare(this.guiLeft + 53, this.guiTop + 115, 249, 20);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.duration"), this.guiLeft + 54, this.guiTop + 144, 0x191919, 1.0f, false, false);
        ModernGui.drawNGBlackSquare(this.guiLeft + 53, this.guiTop + 153, 120, 20);
        this.drawScaledString(I18n.func_135053_a((String)"enterprise.bet.create.betMin"), this.guiLeft + 183, this.guiTop + 144, 0x191919, 1.0f, false, false);
    ...
    protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0) {
            if (!this.inputQuestion.func_73781_b().isEmpty() && !this.inputOption1.func_73781_b().isEmpty() && !this.inputOption2.func_73781_b().isEmpty() && this.isNumeric(this.inputDuration.func_73781_b()) && this.isNumeric(this.inputBetMin.func_73781_b()) && mouseX > this.guiLeft + 53 && mouseX < this.guiLeft + 53 + 118 && mouseY > this.guiTop + 183 && mouseY < this.guiTop + 183 + 20) {
                ...
                PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new EnterpriseBetCreatePacket((String)EnterpriseGui.enterpriseInfos.get("name"), this.inputQuestion.func_73781_b(), this.inputOption1.func_73781_b(), this.inputOption2.func_73781_b(), Integer.parseInt(this.inputDuration.func_73781_b()), Integer.parseInt(this.inputBetMin.func_73781_b()))));
