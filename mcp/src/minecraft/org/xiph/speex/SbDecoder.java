...
public class SbDecoder extends SbCodec implements Decoder
{
                ...
                else
                {
                    ...
                    for (int var4 = 0; var4 < this.nbSubframes; ++var4)
                    {
                        ...
                        if (this.enhanced)
                        {
                            ...
                            Filters.bw_lpc(var12, this.interp_qlpc, this.awk3, this.lpcSize);
                        }
                        ...
                        var12 = Math.abs(0.01F + var15) / (0.01F + Math.abs(var14));
                        ...
                        {
                            var21 = var1.unpack(5);
                            var17 = (float)Math.exp(((double)var21 - 10.0D) / 8.0D);
                            var17 /= var12;
    ...
    public int decodeLost(float[] var1, boolean var2)
    {
        ...
        if (this.enhanced)
        {
            ...
            if (this.submodes[this.submodeID] != null)
            {
                var3 = this.submodes[this.submodeID].lpc_enh_k1;
            ...
            Filters.bw_lpc(var3, this.interp_qlpc, this.awk1, this.lpcSize);
        ...
        if (!var2)
        {
            for (var71 = 0; var71 < this.frameSize; ++var71)
            {
                this.excBuf[this.excIdx + var71] = (float)((double)this.excBuf[this.excIdx + var71] * 0.9D);
            }
        }

        for (var71 = 0; var71 < this.frameSize; ++var71)
        {
            this.high[var71] = this.excBuf[this.excIdx + var71];
        }
        ...
        {
            for (var71 = 0; var71 < this.lpcSize; ++var71)
            {
                this.mem_sp[this.lpcSize + var71] = 0.0F;
            }
        ...
        for (var71 = 0; var71 < this.fullFrameSize; ++var71)
        {
            var1[var71] = 2.0F * (this.y0[var71] - this.y1[var71]);
        }
