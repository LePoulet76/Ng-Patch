...
public class WildernessGui extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.playerSearch = new GuiTextField(this.fontRenderer, this.guiLeft + 208, this.guiTop + 28, 93, 10);
        this.playerSearch.setEnableBackgroundDrawing(false);
        this.playerSearch.setMaxStringLength(40);
    }
    ...
    {
        this.playerSearch.updateCursorCounter();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.search_players.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.search_players.pseudo"), this.guiLeft + 51 + 5, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search_players.country"), this.guiLeft + 51 + 80, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search_players.power"), this.guiLeft + 51 + 165, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search_players.wilderness_filter"), this.guiLeft + 64, this.guiTop + 227, 1644825, 0.9F, false, false);
        ClientEventHandler.STYLE.bindTexture("faction_search");
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0)
        {
            ...
            {
                this.mc.displayGuiScreen(new ProfilGui((String)this.hoveredPlayer.get("name"), ""));
            }
        ...
        this.playerSearch.mouseClicked(mouseX, mouseY, mouseButton);
    ...
    {
        if (this.playerSearch.textboxKeyTyped(typedChar, keyCode))
        {
            this.searchText = this.playerSearch.getText();
        }
