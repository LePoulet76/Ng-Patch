      ...
      if(tileEntity instanceof IDisableableMachine) {
         ...
         if(pl != null) {
            try {
               ...
               boolean res = ((Boolean)e.invoke(pl, new Object[]{player.field_71092_bJ, Integer.valueOf(this.posX), Integer.valueOf(this.posY), Integer.valueOf(this.posZ)})).booleanValue();
               if(res) {
