...
public class TCSettingTextBox extends TCSetting {
   ...
   public TCSettingTextBox(String theSetting, String theLabel, int theID) {
      ...
      this.textBox = new GuiTextField(mc.field_71466_p, 0, 0, this.field_73747_a, this.field_73745_b);
      this.textBox.func_73782_a(this.value);
   }

   private void reassignField() {
      String tmp = this.textBox.func_73781_b();
      this.textBox = new GuiTextField(mc.field_71466_p, this.field_73746_c, this.field_73743_d + 1, this.field_73747_a, this.field_73745_b + 1);
