...
public class CosmeticCategoryGUI extends CommonCosmeticGUI
{
    ...
    public void renderPlayer(int par0, int par1, int par2, float mouseX, float mouseY, EntityLivingBase par5EntityLivingBase)
    {
        ...
        float f21 = par5EntityLivingBase.renderYawOffset;
        ...
        GL11.glRotatef(-rotation1, 0.0F, 1.0F, 0.0F);
        par5EntityLivingBase.renderYawOffset = rotation1;
        par5EntityLivingBase.rotationYaw = rotation1;
        ...
        par5EntityLivingBase.renderYawOffset = f21;
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (mouseX >= this.guiLeft + 13 && (float)mouseX <= (float)(this.guiLeft + 21) + bold28.getStringWidth(I18n.getString("cosmetic.label.return")) && mouseY >= this.guiTop + 30 && mouseY <= this.guiTop + 30 + 9)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.return"), (float)(this.guiLeft + 21), (float)(this.guiTop + 31), COLOR_LIGHT_GRAY, 0.5F, "left", false, "georamaBold", 28);
        ...
        else
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.return"), (float)(this.guiLeft + 21), (float)(this.guiTop + 31), COLOR_LIGHT_BLUE, 0.5F, "left", false, "georamaBold", 28);
        }
        ...
        ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.category." + this.categoryTarget), (float)(this.guiLeft + 12), (float)(this.guiTop + 11), 12895428, 1.0F, "left", false, "georamaExtraBold", 28);
        ...
        if (!this.displayModal)
        {
            ...
            {
                this.renderPlayer(this.guiLeft + 125, this.guiTop + 185, 65, (float)mouseX, (float)mouseY, Minecraft.getMinecraft().thePlayer);
            }
        ...
        if (loaded)
        {
            ...
            if (categoriesData.containsKey(this.categoryTarget) && ((LinkedHashMap)categoriesData.get(this.categoryTarget)).size() > 0 && this.selectedGroupId != null && ((LinkedHashMap)categoriesData.get(this.categoryTarget)).get(this.selectedGroupId) != null)
            {
                ...
                if (((String)var21.get("skin_name")).equals(selectedSkinId))
                {
                    ...
                    if (((String)var21.get("owned")).equals("1"))
                    {
                        if (!((String)var21.get("by_default")).equals("1"))
                        {
                            ...
                            var26 = I18n.getString("cosmetic.label." + (((String)var21.get("active")).equals("1") ? "unequip" : "equip")).toUpperCase();
                        ...
                        {
                            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.by_default").toUpperCase(), (float)(this.guiLeft + 124), (float)(this.guiTop + 199), COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
                        }
                    }
                    else if (!((String)var21.get("price")).equals("0") && (((String)var21.get("unlock_type")).equals("null") || ((String)var21.get("unlock_type")).equals("ngprime") && ((Boolean)CosmeticGUI.data.get("ngprime")).booleanValue()) && (var21.get("availability_start") == null || Long.parseLong((String)var21.get("availability_start")) <= System.currentTimeMillis()) && (var21.get("availability_end") == null || Long.parseLong((String)var21.get("availability_end")) >= System.currentTimeMillis()))
                    {
                        if (!((String)var21.get("price")).equals("0"))
                        {
                            ...
                            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.get").toUpperCase(), (float)(this.guiLeft + 144), (float)(this.guiTop + 200), var24 && !var28 ? COLOR_WHITE : COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 24);
                            ...
                            {
                                this.tooltipToDraw.add(I18n.getString("cosmetic.label.not_enough_points"));
                            }
                        }
                    }
                    else
                    {
                        ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.not_buyable").toUpperCase(), (float)(this.guiLeft + 124 - 5), (float)(this.guiTop + 199), COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
                        ClientEventHandler.STYLE.bindTexture("cosmetic");
                        ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 122) + semiBold27.getStringWidth(I18n.getString("cosmetic.label.not_buyable").toUpperCase()) * 0.5F / 2.0F, (float)this.guiTop + 198.2F, (float)(594 * GUI_SCALE), (float)(236 * GUI_SCALE), 9 * GUI_SCALE, 8 * GUI_SCALE, 9, 8, (float)(1024 * GUI_SCALE), (float)(1024 * GUI_SCALE), false);

                        if ((float)mouseX >= (float)(this.guiLeft + 122) + semiBold27.getStringWidth(I18n.getString("cosmetic.label.not_buyable").toUpperCase()) * 0.5F / 2.0F && (float)mouseX <= (float)(this.guiLeft + 122) + semiBold27.getStringWidth(I18n.getString("cosmetic.label.not_buyable").toUpperCase()) * 0.5F / 2.0F + 9.0F && (float)mouseY >= (float)this.guiTop + 198.2F && (float)mouseY <= (float)this.guiTop + 198.2F + 8.0F)
                        {
                            this.tooltipToDraw.add(I18n.getString("cosmetic.unlock_type." + (var21.get("unlock_type") != null && (!((String)var21.get("unlock_type")).equals("ngprime") || !((Boolean)CosmeticGUI.data.get("ngprime")).booleanValue()) ? (String)var21.get("unlock_type") : "date")));
                        }
                    }
                }
                ...
                String label = I18n.getString("cosmetic.rarity." + var26);

                if (var26.equals("limited") && ((String)var21.get("owned")).equals("1"))
                {
                    if (!((String)var21.get("limited_copies")).equals("0"))
                    {
                        label = I18n.getString("cosmetic.rarity.limited") + " N\u00b0" + (String)var21.get("limited_copy_number") + "/" + (String)var21.get("limited_copies");
                    }
                    else
                    {
                        label = I18n.getString("cosmetic.rarity.limited") + " N\u00b0" + (String)var21.get("limited_copy_number");
                    }
                }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0)
        {
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new CosmeticGUI(this.playerTarget));
            }
