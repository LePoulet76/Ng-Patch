...
public class BuyCountryConfirmGui extends ModalGui
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.buy.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.buy.text_2").replace("#country#", (String)FactionGUI.factionInfos.get("name")).replace("#price#", (String)FactionGUI.factionInfos.get("sellPrice")), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
