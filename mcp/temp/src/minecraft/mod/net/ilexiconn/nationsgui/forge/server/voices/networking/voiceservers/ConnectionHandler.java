...
public class ConnectionHandler implements IConnectionHandler {
   ...
   public void playerLoggedIn(Player player, NetHandler netHandler, INetworkManager manager) {
      if(this.voiceChat.getVoiceServer() instanceof VoiceAuthenticatedServer) {
         ...
         it1.addHash(new EntityInfo(stream1.func_71114_r(), stream1.field_70157_k), pairs1);
      ...
      while(it11.hasNext()) {
         ...
         this.voiceChat.getVoiceServer().sendEntityData(player, stream11.id, entity.field_71092_bJ, entity.field_70165_t, entity.field_70163_u, entity.field_70161_v, entity.field_70159_w, entity.field_70181_x, entity.field_70179_y);
      }
