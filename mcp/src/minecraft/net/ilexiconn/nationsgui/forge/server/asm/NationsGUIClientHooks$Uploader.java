...
public class NationsGUIClientHooks$Uploader implements Runnable
{
    ...
    public void run()
    {
        ...
        if (me != null)
        {
            ...
            Session sess1 = Minecraft.getMinecraft().getSession();
            String data1 = "";
            ...
            try
            {
                ...
                data1 = data1 + "&" + URLEncoder.encode("username", "UTF-8") + "=" + URLEncoder.encode(sess1.getUsername(), "UTF-8");
                data1 = data1 + "&" + URLEncoder.encode("token", "UTF-8") + "=" + URLEncoder.encode(sess1.getSessionID(), "UTF-8");
                data1 = data1 + "&" + URLEncoder.encode("dated", "UTF-8") + "=" + URLEncoder.encode(NBTConfig.CONFIG.getCompound().getBoolean("DatedScreenshot") + "", "UTF-8");
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        me.addChatMessage(I18n.getString("screen.uploader.http_error"));
                    }
                }
            }
            ...
            try
            {
                ...
                while ((line = rd.readLine()) != null)
                {
                    try
                    {
                        ...
                        {
                            me.addChatMessage(I18n.getStringParams("screen.uploader.error", new Object[] {I18n.getString(e1.get("error").getAsString())}));
                        }
                        else if (e1.get("location") != null)
                        {
                            ...
                            {
                                me.addChatMessage(I18n.getStringParams("screen.uploader.uploaded", new Object[] {I18n.getString(e1.get("location").getAsString())}));
                            }
                        }
                    }
