...
public class BuyActionConfirmGui
extends ModalGui {
    ...
    public BuyActionConfirmGui(GuiScreen guiFrom, int index, String ownerFactionId, String price) {
        super(guiFrom);
    ...
    public void func_73863_a(int mouseX, int mouseY, float par3) {
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.actions.confirm.text1"), this.guiLeft + 53, this.guiTop + 40, 0x191919, 1.0f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.actions.confirm.text2").replace("##dollars##", this.price), this.guiLeft + 53, this.guiTop + 50, 0x191919, 1.0f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.actions.confirm.text3"), this.guiLeft + 53, this.guiTop + 60, 0x191919, 1.0f, false, false);
    ...
    protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0) {
            if (FactionGUI.hasPermissions("actions") && mouseX > this.guiLeft + 53 && mouseX < this.guiLeft + 53 + 118 && mouseY > this.guiTop + 95 && mouseY < this.guiTop + 95 + 20) {
                ...
                PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionBuyActionPacket((String)FactionGUI.factionInfos.get("id"), (String)FactionGUI.factionInfos.get("playerWhoSeeFactionId"), this.ownerFactionId, this.index, this.price)));
