...
public class EmoteAirGuitar extends EmoteBase
{
    ...
    {
        Timeline timeline = Timeline.createSequence().beginParallel().push(Tween.to(model, 0, 400.0F).target(0.4F)).push(Tween.to(model, 1, 400.0F).target(0.0F)).push(Tween.to(model, 2, 400.0F).target(0.0F)).push(Tween.to(model, 18, 400.0F).target(-2.8274333F)).push(Tween.to(model, 19, 400.0F).target(-((float)Math.PI / 2F))).push(Tween.to(model, 12, 400.0F).target(-0.77079636F)).push(Tween.to(model, 13, 400.0F).target(-1.0707964F)).end().beginParallel().push((Tween)Tween.to(model, 0, 100.0F).target(0.2F).repeatYoyo(18, 0.0F)).push((Tween)Tween.to(model, 12, 100.0F).target(-1.3707963F).repeatYoyo(18, 0.0F)).end().beginParallel().push(Tween.to(model, 0, 400.0F).target(0.0F)).push(Tween.to(model, 18, 400.0F).target(0.0F)).push(Tween.to(model, 19, 400.0F).target(0.0F)).push(Tween.to(model, 12, 400.0F).target(0.0F)).push(Tween.to(model, 13, 400.0F).target(0.0F)).end();
        return timeline;
    }
