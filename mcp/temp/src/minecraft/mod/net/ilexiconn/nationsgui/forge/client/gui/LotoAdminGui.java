...
public class LotoAdminGui extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      if(this.dataToEdit.containsKey("startTime")) {
         this.startDateDateInput.func_73782_a(LotoGui.dateFormat.format(new Date(((Double)this.dataToEdit.get("startTime")).longValue())));
      } else {
      ...
      if(this.dataToEdit.containsKey("startTime")) {
         this.startDateTimeInput.func_73782_a(LotoGui.timeFormat.format(new Date(((Double)this.dataToEdit.get("startTime")).longValue())));
      } else {
      ...
      if(this.dataToEdit.containsKey("endTime")) {
         this.endDateDateInput.func_73782_a(LotoGui.dateFormat.format(new Date(((Double)this.dataToEdit.get("endTime")).longValue())));
      } else {
      ...
      if(this.dataToEdit.containsKey("startTime")) {
         this.endDateTimeInput.func_73782_a(LotoGui.timeFormat.format(new Date(((Double)this.dataToEdit.get("endTime")).longValue())));
      } else {
      ...
      if(this.dataToEdit.containsKey("maxTicketsGlobal")) {
         this.limitGlobalInput.func_73782_a(((Double)this.dataToEdit.get("maxTicketsGlobal")).intValue() + "");
      } else {
      ...
      if(this.dataToEdit.containsKey("maxTicketsGlobal")) {
         this.limitPlayerInput.func_73782_a(((Double)this.dataToEdit.get("maxTicketsPlayer")).intValue() + "");
      } else {
      ...
      if(this.dataToEdit.containsKey("repetitionDays")) {
         this.repetitionInput.func_73782_a(((Double)this.dataToEdit.get("repetitionDays")).intValue() + "");
      } else {
      ...
      if(this.dataToEdit.containsKey("ticketPrice")) {
         this.ticketPriceInput.func_73782_a(((Double)this.dataToEdit.get("ticketPrice")).intValue() + "");
      } else {
      ...
      if(this.dataToEdit.containsKey("designLogo")) {
         this.customLogoInput.func_73782_a((String)this.dataToEdit.get("designLogo"));
      } else {
      ...
      if(this.dataToEdit.containsKey("cashPrice")) {
         this.cashPriceInput.func_73782_a(((Double)this.dataToEdit.get("cashPrice")).intValue() + "");
      } else {
      ...
      if(this.dataToEdit.containsKey("winnersCount")) {
         this.winnersCountInput.func_73782_a(((Double)this.dataToEdit.get("winnersCount")).intValue() + "");
      } else {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 13), 10395075, 0.5F, "left", false, "georamaMedium", 32);
      if(loaded) {
         int i;
         if(this.displayMode.equals("list")) {
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.to_come"), (float)(this.guiLeft + 43), (float)(this.guiTop + 23), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            for(Iterator index = ((ArrayList)data.get("lotteries")).iterator(); index.hasNext(); ++fieldOffsetY) {
               ...
               ModernGui.drawRoundedRectangle((float)i + 234.0F, itemStack.floatValue(), this.field_73735_i, 81.0F, 35.0F);
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               ClientEventHandler.STYLE.bindTexture("loto");
               ...
               if(System.currentTimeMillis() > ((Double)it.get("startTime")).longValue()) {
                  date = I18n.func_135053_a("lottery.label.in_progress") + " " + LotoGui.dateFormat.format(new Date(((Double)it.get("endTime")).longValue()));
               } else {
                  date = I18n.func_135053_a("lottery.label.incoming") + " " + LotoGui.dateFormat.format(new Date(((Double)it.get("startTime")).longValue()));
               }
               ...
               ModernGui.drawScaledStringCustomFont((((String)it.get("players")).isEmpty()?"0":Integer.valueOf(((String)it.get("players")).split(",").length)) + " " + I18n.func_135053_a("lottery.label.players"), (float)(i + 15), (float)(itemStack.intValue() + 15), 16514302, 0.5F, "left", false, "georamaMedium", 26);
               ClientEventHandler.STYLE.bindTexture("loto");
               ...
               ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)it.get("winnersCount")}) + " " + I18n.func_135053_a("lottery.label.winners"), (float)(i + 15), (float)(itemStack.intValue() + 26), 16514302, 0.5F, "left", false, "georamaMedium", 26);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.create"), (float)(this.guiLeft + 43), (float)(this.guiTop + 23), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.a_propos"), (float)(this.guiLeft + 42), (float)(this.guiTop + 44), 14803951, 0.5F, "left", false, "georamaSemiBold", 28);
            byte var11 = 65;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.start_date"), (float)(this.guiLeft + 48), (float)(this.guiTop + var11), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            var11 = 79;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.end_date"), (float)(this.guiLeft + 48), (float)(this.guiTop + var11), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 103), (float)(this.guiTop + var11 - 2), (float)(249 * GUI_SCALE), (float)(268 * GUI_SCALE), 30 * GUI_SCALE, 9 * GUI_SCALE, 30, 9, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
            ...
            var11 = 93;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.limit_global"), (float)(this.guiLeft + 48), (float)(this.guiTop + var11), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 103), (float)(this.guiTop + var11 - 2), (float)(249 * GUI_SCALE), (float)(268 * GUI_SCALE), 30 * GUI_SCALE, 9 * GUI_SCALE, 30, 9, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
            this.limitGlobalInput.func_73795_f();
            var11 = 107;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.limit_player"), (float)(this.guiLeft + 48), (float)(this.guiTop + var11), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 103), (float)(this.guiTop + var11 - 2), (float)(249 * GUI_SCALE), (float)(268 * GUI_SCALE), 30 * GUI_SCALE, 9 * GUI_SCALE, 30, 9, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.allow_donation"), (float)(this.guiLeft + 59), (float)(this.guiTop + var11 + 12 + 1), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.repeat"), (float)(this.guiLeft + 48), (float)(this.guiTop + 135), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.ticket_price"), (float)(this.guiLeft + 48), (float)(this.guiTop + 149), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.color_design"), (float)(this.guiLeft + 48), (float)(this.guiTop + 162), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            for(Iterator var13 = LotoGui.colors.entrySet().iterator(); var13.hasNext(); ++var12) {
               ...
               Gui.func_73734_a(this.guiLeft + 52 + var12 * 14, this.guiTop + 171, this.guiLeft + 52 + var12 * 14 + 8, this.guiTop + 171 + 8, ((Integer)var14.getValue()).intValue());
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.logo_design"), (float)(this.guiLeft + 48), (float)(this.guiTop + 187), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.rewards"), (float)(this.guiLeft + 205), (float)(this.guiTop + 44), 14803951, 0.5F, "left", false, "georamaSemiBold", 28);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.cashprice"), (float)(this.guiLeft + 214), (float)(this.guiTop + 59), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            for(i = 0; i < 9; ++i) {
               ...
               if(this.itemsPrice.size() > i) {
                  ...
                  this.itemRenderer.func_82406_b(this.field_73886_k, Minecraft.func_71410_x().func_110434_K(), var15, (this.guiLeft + 215 + 12 * i) * 2, (this.guiTop + 73) * 2);
                  GL11.glPopMatrix();
                  GL11.glDisable(2896);
                  GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               }
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(!this.itemsPrice.isEmpty()?"lottery.admin.remove_items":"lottery.admin.add_items"), (float)(this.guiLeft + 214 + 31), (float)(this.guiTop + 87), 2234425, 0.5F, "center", false, "georamaSemiBold", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.mode_poll"), (float)(this.guiLeft + 225), (float)(this.guiTop + 101), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.count_winners"), (float)(this.guiLeft + 214), (float)(this.guiTop + 116), 14803951, 0.5F, "left", false, "georamaMedium", 24);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.validate"), (float)(this.guiLeft + 205 + 22), (float)(this.guiTop + 196), 2234425, 0.5F, "center", false, "georamaSemiBold", 26);
            ClientEventHandler.STYLE.bindTexture("loto_staff");
            if(mouseX >= this.guiLeft + 252 && mouseX <= this.guiLeft + 252 + 62 && mouseY >= this.guiTop + 194 && mouseY <= this.guiTop + 194 + 10) {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.cancel"), (float)(this.guiLeft + 252 + 22), (float)(this.guiTop + 196), 2234425, 0.5F, "center", false, "georamaSemiBold", 26);
            } else {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.cancel"), (float)(this.guiLeft + 252 + 22), (float)(this.guiTop + 196), 14803951, 0.5F, "center", false, "georamaSemiBold", 26);
            }
            ...
            if(!this.dataToEdit.isEmpty()) {
               ...
               if(mouseX >= this.guiLeft + 299 && mouseX <= this.guiLeft + 299 + 62 && mouseY >= this.guiTop + 194 && mouseY <= this.guiTop + 194 + 10) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.delete"), (float)(this.guiLeft + 299 + 22), (float)(this.guiTop + 196), 2234425, 0.5F, "center", false, "georamaSemiBold", 26);
               } else {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("lottery.admin.delete"), (float)(this.guiLeft + 299 + 22), (float)(this.guiTop + 196), 15463162, 0.5F, "center", false, "georamaSemiBold", 26);
               }
            }
         }
      }
      ...
      if(mouseButton == 0) {
         ...
         if(this.hoveredAction.equals("close")) {
            ...
            if(this.itemsPrice.isEmpty()) {
               ...
               for(int e = 0; e < 9; ++e) {
                  ItemStack startDate = Minecraft.func_71410_x().field_71439_g.field_71071_by.func_70301_a(e);
                  if(startDate != null) {
            ...
            try {
               ...
               Date var9 = (new SimpleDateFormat("dd/MM/yy HH:mm")).parse(this.startDateDateInput.func_73781_b() + " " + this.startDateTimeInput.func_73781_b());
               ...
               if(endDate.getTime() < System.currentTimeMillis()) {
                  Minecraft.func_71410_x().field_71439_g.func_71035_c(I18n.func_135053_a("lotery.error.end_date_future"));
                  return;
               }

               var8.put("endTime", endDate.getTime() + "");
               var8.put("maxTicketsGlobal", this.limitGlobalInput.func_73781_b());
               var8.put("maxTicketsPlayer", this.limitPlayerInput.func_73781_b());
               var8.put("allowDonation", this.checkbox_donation + "");
               var8.put("repetitionDays", this.repetitionInput.func_73781_b());
               var8.put("ticketPrice", this.ticketPriceInput.func_73781_b());
               var8.put("designColor", this.selected_color);
               var8.put("designLogo", this.customLogoInput.func_73781_b());
               var8.put("cashPrice", this.cashPriceInput.func_73781_b());
               var8.put("poolMode", this.checkbox_pool + "");
               var8.put("winnersCount", this.winnersCountInput.func_73781_b());
   ...
   protected void drawHoveringText(List par1List, int par2, int par3, FontRenderer font) {
      if(!par1List.isEmpty()) {
         ...
         if(par3 + k1 + 6 > this.field_73881_g) {
