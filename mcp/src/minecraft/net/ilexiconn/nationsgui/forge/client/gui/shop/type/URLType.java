...
public class URLType implements ICategoryType
{
    ...
    public void render(int x, int y, int mouseX, int mouseY, ShopGUI gui, Category category, FontRenderer fontRenderer)
    {
        ...
        if (image != null)
        {
            ...
            int categoryX = x + 122;
            int categoryY = y + 35;
            tessellator.addVertexWithUV((double)categoryX, (double)(categoryY + 192), 0.0D, 0.0D, 1.0D);
            tessellator.addVertexWithUV((double)(categoryX + 162), (double)(categoryY + 192), 0.0D, 1.0D, 1.0D);
            tessellator.addVertexWithUV((double)(categoryX + 162), (double)categoryY, 0.0D, 1.0D, 0.0D);
            tessellator.addVertexWithUV((double)categoryX, (double)categoryY, 0.0D, 0.0D, 0.0D);
            tessellator.draw();
        }
    }
