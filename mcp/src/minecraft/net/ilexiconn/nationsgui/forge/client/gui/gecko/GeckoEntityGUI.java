...
extends GuiScreen {
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ModernGui.drawScaledString("Dialog interaction", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Dialog interaction") - 5, this.field_73881_g / 2 - 9 + 4, 0xFFFFFF, 1.0f, false, true);
        this.dialogInteractionField.func_73795_f();
        ModernGui.drawScaledString("Dialog walk by", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Dialog walk by") - 5, this.field_73881_g / 2 - 9 + 4 + 22, 0xFFFFFF, 1.0f, false, true);
        this.dialogWalkByField.func_73795_f();
        ModernGui.drawScaledString("Radius walk by", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Radius walk by") - 5, this.field_73881_g / 2 - 9 + 4 + 44, 0xFFFFFF, 1.0f, false, true);
    ...
    public void func_73874_b() {
        ...
        if (!(this.geckoEntity.getDialogInteraction().equals(this.dialogInteractionField.func_73781_b()) && this.geckoEntity.getDialogWalkBy().equals(this.dialogWalkByField.func_73781_b()) && this.geckoEntity.getDialogWalkBy().equals(this.radiusWalkByField.func_73781_b()))) {
            ...
            PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new GeckoEntityDialogSavePacket(this.geckoEntity)));
        }
    }
