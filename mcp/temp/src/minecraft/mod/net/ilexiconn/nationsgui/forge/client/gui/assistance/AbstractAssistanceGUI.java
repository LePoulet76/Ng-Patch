...
public abstract class AbstractAssistanceGUI extends AdvancedGui {
   ...
   public void func_73866_w_() {
      ...
      if(canBeAdmin) {
         ...
         if(ClientProxy.playersInAdminMode.containsKey(Minecraft.func_71410_x().field_71439_g.func_70005_c_())) {
            staffButton.setActive(((Boolean)ClientProxy.playersInAdminMode.get(Minecraft.func_71410_x().field_71439_g.func_70005_c_())).booleanValue());
         }
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTick) {
      ...
      ModernGui.drawScaledString(I18n.func_135053_a("nationsgui.assistance.title"), this.guiLeft + 40, this.guiTop + 13, 16777215, 1.5F, false, true);
