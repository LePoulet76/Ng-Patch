...
public class AssistanceNewTicketGUI extends AbstractAssistanceListedGUI
{
    ...
    public void initGui()
    {
        ...
        this.screenshot = new CheckboxComponent(this.guiLeft + 202, this.guiTop + 183, I18n.getString("nationsgui.assistance.takeScreenshot"));
        this.dropdownComponent = new DropdownComponent(this.guiLeft + 202, this.guiTop + 61, 157, I18n.getString("nationsgui.assistance.categoryDropdown"));
        Iterator var1 = categories.iterator();

        while (var1.hasNext())
        {
            String key = (String)var1.next();
            this.dropdownComponent.getChoices().add(I18n.getString(key));
        }

        this.addComponent(this.textAreaComponent);
        this.addComponent(this.screenshot);
        this.addComponent(this.dropdownComponent);
        this.sendButton = new AssistanceButton(0, this.guiLeft + 202, this.guiTop + 197, 157, 20, I18n.getString("nationsgui.assistance.sendTicket"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        {
            ScreenshotHelper.saveScreenshotToBase64(this.mc.displayWidth, this.mc.displayHeight);
    ...
    protected void drawGui(int mouseX, int mouseY, float partialTick)
    {
        ...
        this.fontRenderer.drawString(I18n.getString("nationsgui.assistance.createTicket"), this.guiLeft + 202, this.guiTop + 50, 1579032);
    }
        ...
        if (par1GuiButton.id == 0)
        {
            ...
            if (this.screenshot.isChecked() && this.base64 != null)
            {
                try
                {
                    ...
                    nvps.add(new BasicNameValuePair("target", this.mc.thePlayer.username));
