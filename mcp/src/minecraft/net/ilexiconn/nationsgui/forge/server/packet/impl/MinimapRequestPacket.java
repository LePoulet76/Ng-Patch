...
public class MinimapRequestPacket
implements IPacket,
IServerPacket {
    private int posX;
    private int posZ;
    ...
    public void handleServerPacket(EntityPlayer player) {
        if (!lastPlayerCall.containsKey(player.field_71092_bJ) || System.currentTimeMillis() - lastPlayerCall.get(player.field_71092_bJ) > 15000L) {
            lastPlayerCall.put(player.field_71092_bJ, System.currentTimeMillis());
                ...
                for (int x = 0; x < this.chunkWidth; ++x) {
                    ...
                    for (int z1 = 0; z1 < 16; ++z1) {
                        for (int x1 = 0; x1 < 16; ++x1) {
                            ...
                            do {
                                int blockID;
                                if ((blockID = chunk.func_76610_a(x1, y, z1)) == 0) continue;
            ...
            PacketDispatcher.sendPacketToPlayer((Packet)PacketRegistry.INSTANCE.generatePacket(new MinimapPacket(colors)), (Player)((Player)player));
        }
    }
