...
public class ClientHooks {
   ...
   public static boolean skipTileRender(TileEntity t, double x, double y, double z, float partialTick) {
      try {
         ...
         if(!ClientProxy.clientConfig.renderFurnitures && (blacklistClasses.contains(block.getClass()) || blacklistIDs.contains(Integer.valueOf(block.field_71990_ca)))) {
            block.func_71902_a(t.field_70331_k, t.field_70329_l, t.field_70330_m, t.field_70327_n);
   ...
   public static float getBlockReachDistance(PlayerControllerMP controller) {
      return controller.func_78758_h()?Math.max(ClientProxy.blockReach, 5.0F):ClientProxy.blockReach;
   }
   ...
   public static EntityPlayer getNearPlayerFromName(String targetUsername) {
      ...
      while(var1.hasNext()) {
         ...
         if(ent instanceof EntityPlayer) {
            ...
            if(player.field_71092_bJ.equalsIgnoreCase(targetUsername)) {
               return player;
            }
         }
      }
   ...
   public static int hookRenderDistance(int renderDistance) {
      RenderDistanceEvent event = new RenderDistanceEvent(renderDistance, Minecraft.func_71410_x().field_71439_g, Minecraft.func_71410_x().field_71441_e);
