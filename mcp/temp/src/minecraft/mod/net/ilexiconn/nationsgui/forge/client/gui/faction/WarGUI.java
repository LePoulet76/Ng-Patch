...
public class WarGUI extends TabbedFactionGUI {
   ...
   public void func_73866_w_() {
      ...
      for(var2 = this.availableConditions.iterator(); var2.hasNext(); ++index) {
         ...
         if(this.conditionsInput.containsKey(condition)) {
            data = ((GuiTextField)this.conditionsInput.get(condition)).func_73781_b();
         }
      ...
      for(var2 = this.availableRewards.iterator(); var2.hasNext(); ++index) {
         ...
         if(this.rewardsInput.containsKey(condition)) {
            data = ((GuiTextField)this.rewardsInput.get(condition)).func_73781_b();
         }
      ...
      for(var2 = this.agreementsAvailableConditions.iterator(); var2.hasNext(); ++index) {
         ...
         if(this.agreement_myConditionsInput.containsKey(condition)) {
            data = ((GuiTextField)this.agreement_myConditionsInput.get(condition)).func_73781_b();
         }
         ...
         if(this.agreement_otherConditionsInput.containsKey(condition)) {
            data = ((GuiTextField)this.agreement_otherConditionsInput.get(condition)).func_73781_b();
         }
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTick) {
      ...
      if(loaded) {
         if(factionsWarInfos.size() > 0 && currentWarIndex != -1) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.title_against") + " " + (String)currentWar.get("name"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.war_status") + ":", (float)(this.guiLeft + 43), (float)(this.guiTop + 32), ((Integer)FactionGUI.textColor.get(FactionGUI.factionInfos.get("actualRelation"))).intValue(), 0.5F, "left", false, "georamaMedium", 25);
            String agreement;
            if(currentWar.get("status").equals("in_progress") && currentWar.get("startTime") != null) {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.status.in_progress") + " " + agreement, (float)(this.guiLeft + 43), (float)(this.guiTop + 40), 10395075, 0.5F, "left", false, "georamaMedium", 25);
            } else {
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.status." + currentWar.get("status")).replace("#factionATT#", (String)currentWar.get("factionATTName")).replace("#factionDEF#", (String)currentWar.get("factionDEFName")).replace("#sender#", (String)currentWar.get("sender")), (float)(this.guiLeft + 43), (float)(this.guiTop + 40), 10395075, 0.5F, "left", false, "georamaMedium", 25);
            }

            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.reason") + ":", (float)(this.guiLeft + 43), (float)(this.guiTop + 48), ((Integer)FactionGUI.textColor.get(FactionGUI.factionInfos.get("actualRelation"))).intValue(), 0.5F, "left", false, "georamaMedium", 25);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.reason." + currentWarRequest.get("reason")) + (currentWarRequest.get("playerTarget") != null && !currentWarRequest.get("playerTarget").equals("")?" (" + ((String)currentWarRequest.get("playerTarget")).split(" ")[1] + ")":""), (float)(this.guiLeft + 45 + (int)this.cFontLabelHeader.getStringWidth(I18n.func_135053_a("faction.enemy.reason") + ":") / 2), (float)(this.guiTop + 48), 10395075, 0.5F, "left", false, "georamaMedium", 25);
            ...
            if(ClientProxy.flagsTexture.containsKey((String)currentWar.get("name"))) {
               GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)currentWar.get("name"))).func_110552_b());
            ...
            if(currentWarRequest.get("status").equals("in_progress")) {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.warAgreementBtn"), (float)(this.guiLeft + var21 + 28), (float)(this.guiTop + 61), 2826561, 0.5F, "center", false, "georamaSemiBold", 28);
               var21 += 61;
            }
            ...
            if(!((String)currentWarRequest.get("linkForum")).isEmpty()) {
               ...
               if(mouseX >= this.guiLeft + var21 && mouseX <= this.guiLeft + var21 + 83 && mouseY >= this.guiTop + 58 && mouseY <= this.guiTop + 58 + 13) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.linkForum"), (float)(this.guiLeft + var21 + 42), (float)(this.guiTop + 61), 2826561, 0.5F, "center", false, "georamaSemiBold", 28);
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.linkForum"), (float)(this.guiLeft + var21 + 42), (float)(this.guiTop + 61), 16777215, 0.5F, "center", false, "georamaSemiBold", 28);
               }
            ...
            if(currentWarRequest.get("status").equals("in_progress") && ((Boolean)FactionGUI.factionInfos.get("isInCountry")).booleanValue() && FactionGUI.hasPermissions("wars")) {
               ...
               if(mouseX >= this.guiLeft + var21 && mouseX <= this.guiLeft + var21 + 83 && mouseY >= this.guiTop + 58 && mouseY <= this.guiTop + 58 + 13) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.surrender"), (float)(this.guiLeft + var21 + 28), (float)(this.guiTop + 61), 2234425, 0.5F, "center", false, "georamaSemiBold", 28);
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.surrender"), (float)(this.guiLeft + var21 + 28), (float)(this.guiTop + 61), 15017020, 0.5F, "center", false, "georamaSemiBold", 28);
               }
            ...
            if(!this.agreementMode) {
               ...
               if(!currentWar.get("status").equals("waiting_validation") && !currentWar.get("status").equals("refused") && !currentWar.get("status").equals("cancelled") && (currentWar.get("status").equals("in_progress") || currentWar.get("status").equals("finished") || !currentWar.get("status").equals("waiting_conditions_att") || currentWarRequest.get("factionATT").equals(currentWarRequest.get("playerFaction")) && ((Boolean)currentWarRequest.get("hasWarPermInOwnCountry")).booleanValue())) {
                  ...
                  if(!currentWar.get("status").equals("waiting_conditions_att") && !currentWar.get("status").equals("waiting_conditions_def") && !currentWar.get("status").equals("waiting_conditions_att_second")) {
                     if(currentWar.get("status").equals("in_progress") || currentWar.get("status").equals("finished")) {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.missile_history"), (float)(this.guiLeft + 48), (float)(this.guiTop + 100), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war");
                        ...
                        if(currentWar.containsKey("missiles") && ((ArrayList)currentWar.get("missiles")).size() > 0) {
                           ...
                           for(var23 = 0; var23 < ((ArrayList)currentWar.get("missiles")).size(); ++var23) {
                              ...
                              if(ClientProxy.flagsTexture.containsKey(delay)) {
                                 GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(delay)).func_110552_b());
                              ...
                              if(mouseX >= this.guiLeft + 43 && mouseX <= this.guiLeft + 43 + 95 && mouseY >= this.guiTop + 113 && mouseY <= this.guiTop + 113 + 69 && mouseX >= var55 + 20 + (int)this.cFontLabel.getStringWidth(var37.split(" ")[0]) / 2 + 2 && mouseX <= var55 + 20 + (int)this.cFontLabel.getStringWidth(var37.split(" ")[0]) / 2 + 2 + 8 && mouseY >= offsetY.intValue() - 1 && mouseY <= offsetY.intValue() - 1 + 8) {
                                 tooltipToDraw.add(I18n.func_135053_a("faction.war.missile_firedby") + " " + var34);
                              }
                           }
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.assault_history"), (float)(this.guiLeft + 157), (float)(this.guiTop + 100), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war");
                        ...
                        if(this.cachedAssaults.size() > 0) {
                           ...
                           for(var23 = 0; var23 < this.cachedAssaults.size(); ++var23) {
                              ...
                              var34 = ((Boolean)var32.get("win")).booleanValue()?I18n.func_135053_a("faction.common.victory"):I18n.func_135053_a("faction.common.defeat");
                              ...
                              if(mouseX >= this.guiLeft + 152 && mouseX <= this.guiLeft + 152 + 95 && mouseY >= this.guiTop + 113 && mouseY <= this.guiTop + 113 + 69 && mouseX >= var29 + 20 + (int)this.cFontLabel.getStringWidth(var34) / 2 + 4 && mouseX <= var29 + 20 + (int)this.cFontLabel.getStringWidth(var34) / 2 + 4 + 8 && mouseY >= var46.intValue() - 1 && mouseY <= var46.intValue() - 1 + 8) {
                                 tooltipToDraw.add("\u00a72" + I18n.func_135053_a("faction.war.assaults.helpers.ally") + ":");
                                 ...
                                 tooltipToDraw.add("");
                                 tooltipToDraw.add("\u00a7c" + I18n.func_135053_a("faction.war.assaults.helpers.ennemy") + ":");
                              ...
                              if(var32.containsKey("rollback")) {
                                 ...
                                 if(mouseX >= var29 + 20 + (int)this.cFontLabel.getStringWidth(var34) / 2 + 4 + 5 + 3 && mouseX <= var29 + 20 + (int)this.cFontLabel.getStringWidth(var34) / 2 + 4 + 5 + 3 + 8 && mouseY >= var46.intValue() - 1 && mouseY <= var46.intValue() - 1 + 8) {
                                    tooltipToDraw.add("\u00a7a" + I18n.func_135053_a("faction.war.assaults.rollback"));
                        ...
                        if(currentWarRequest.get("status").equals("finished")) {
                           ...
                           ModernGui.drawScaledStringCustomFont(currentWarRequest.get("factionATTId").equals(currentWarRequest.get("winner"))?I18n.func_135053_a("faction.common.victory"):I18n.func_135053_a("faction.common.defeat"), (float)(this.guiLeft + 277 + 17), (float)(this.guiTop + 147), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                           ClientEventHandler.STYLE.bindTexture("faction_war");
                           ...
                           ModernGui.drawScaledStringCustomFont(currentWarRequest.get("factionDEFId").equals(currentWarRequest.get("winner"))?I18n.func_135053_a("faction.common.victory"):I18n.func_135053_a("faction.common.defeat"), (float)(this.guiLeft + 411 + 17), (float)(this.guiTop + 147), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                        }
                        ...
                        if(ClientProxy.flagsTexture.containsKey(currentWar.get("factionATTName"))) {
                           GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(currentWar.get("factionATTName"))).func_110552_b());
                        ...
                        if(ClientProxy.flagsTexture.containsKey(currentWar.get("factionDEFName"))) {
                           GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(currentWar.get("factionDEFName"))).func_110552_b());
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.victory"), (float)(this.guiLeft + 361), (float)(this.guiTop + 100), 10395075, 0.5F, "center", false, "georamaSemiBold", 24);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.inactivity"), (float)(this.guiLeft + 361), (float)(this.guiTop + 118), 10395075, 0.5F, "center", false, "georamaSemiBold", 24);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.missile_points"), (float)(this.guiLeft + 361), (float)(this.guiTop + 128), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.assaults_win"), (float)(this.guiLeft + 361), (float)(this.guiTop + 136), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.kills"), (float)(this.guiLeft + 361), (float)(this.guiTop + 144), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.mmr"), (float)(this.guiLeft + 361), (float)(this.guiTop + 152), 10395075, 0.5F, "center", false, "georamaMedium", 22);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.contitions_with_mode").replaceAll("#mode#", I18n.func_135053_a("faction.enemy.conditionsType." + currentWarRequest.get("conditionsType"))), (float)(this.guiLeft + 278), (float)(this.guiTop + 166), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war");
                        ...
                        if(currentWarRequest.get("conditions") != null) {
                           ...
                           for(conditionsOTHER = 0; conditionsOTHER < dateFormated; ++conditionsOTHER) {
                              ...
                              if(!var40.isEmpty() && var40.split("#").length == 2) {
                                 ...
                                 label = (((LinkedTreeMap)currentWarRequest.get("data_ATT")).containsKey(agreementCondition)?String.format("%.0f", new Object[]{((LinkedTreeMap)currentWarRequest.get("data_ATT")).get(agreementCondition)}):"0") + "/" + delay + " " + I18n.func_135053_a("faction.enemy.conditions." + agreementCondition);
                                 ...
                                 label = (((LinkedTreeMap)currentWarRequest.get("data_DEF")).containsKey(agreementCondition)?String.format("%.0f", new Object[]{((LinkedTreeMap)currentWarRequest.get("data_DEF")).get(agreementCondition)}):"0") + "/" + delay + " " + I18n.func_135053_a("faction.enemy.conditions." + agreementCondition);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards"), (float)(this.guiLeft + 50), (float)(this.guiTop + 196), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                              ...
                              if(!var40.isEmpty() && var40.split("#").length == 2) {
                                 ...
                                 if(Integer.parseInt(delay) > 0) {
                                    ...
                                    if(agreementCondition.equals("peace")) {
                                       valueType = I18n.func_135053_a("faction.enemy.rewards.valueType.day");
                                    }

                                    label = delay + valueType + " " + I18n.func_135053_a("faction.enemy.rewards." + agreementCondition);
                                 } else {
                                    label = I18n.func_135053_a("faction.enemy.rewards." + agreementCondition);
                                 }
                     ...
                     if(!currentWar.get("status").equals("waiting_conditions_att") && !this.defenserCounterPropositionMode) {
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.proposition").replaceAll("#country#", (String)currentWar.get(currentWar.get("status").equals("waiting_conditions_def")?"factionATTName":"factionDEFName")), (float)(this.guiLeft + 43), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.contitions_with_mode").replaceAll("#mode#", I18n.func_135053_a("faction.enemy.conditionsType." + currentWarRequest.get(currentWar.get("status").equals("waiting_conditions_def")?"conditionsType_ATT":"conditionsType_DEF"))), (float)(this.guiLeft + 48), (float)(this.guiTop + 112), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        var22 = 0;
                        ...
                        if(agreement != null) {
                           ...
                           for(var33 = 0; var33 < var29; ++var33) {
                              ...
                              if(!var34.isEmpty()) {
                                 ...
                                 ModernGui.drawScaledStringCustomFont(delay + " " + I18n.func_135053_a("faction.enemy.conditions." + agreementCondition), (float)(conditionsOTHER + 10), (float)(status + 1), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                                 ++var22;
                              }
                           }
                        }
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards"), (float)(this.guiLeft + 48), (float)(this.guiTop + 170), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        var22 = 0;
                        ...
                        if(var26 != null) {
                           ...
                           for(dateFormated = 0; dateFormated < var33; ++dateFormated) {
                              ...
                              if(!var37.isEmpty()) {
                                 ...
                                 ModernGui.drawScaledStringCustomFont(offSetX + " " + I18n.func_135053_a("faction.enemy.rewards." + delay), (float)(status + 10), (float)(var43 + 1), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                                 ++var22;
                              }
                           }
                        }
                        ...
                        if(currentWar.get("status").equals("waiting_conditions_def") && currentWarRequest.get("factionDEF").equals(currentWarRequest.get("playerFaction")) && ((Boolean)currentWarRequest.get("hasWarPermInOwnCountry")).booleanValue() || (currentWar.get("status").equals("waiting_conditions_att") || currentWar.get("status").equals("waiting_conditions_att_second")) && currentWarRequest.get("factionATT").equals(currentWarRequest.get("playerFaction")) && ((Boolean)currentWarRequest.get("hasWarPermInOwnCountry")).booleanValue()) {
                           if(!currentWar.get("status").equals("waiting_conditions_def") || agreement != null) {
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.accept_conditions_def"), (float)(this.guiLeft + 43 + 26), (float)(this.guiTop + 217), 2234425, 0.5F, "center", false, "georamaSemiBold", 28);
                           }
                           ...
                           if(mouseX >= this.guiLeft + 119 && mouseX <= this.guiLeft + 119 + 110 && mouseY >= this.guiTop + 214 && mouseY <= this.guiTop + 214 + 13) {
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(currentWar.get("status").equals("waiting_conditions_def")?"faction.enemy.refuse_conditions_def":"faction.enemy.refuse_conditions_att_second"), (float)(this.guiLeft + 119 + 55), (float)(this.guiTop + 217), 2234425, 0.5F, "center", false, "georamaSemiBold", 28);
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(currentWar.get("status").equals("waiting_conditions_def")?"faction.enemy.refuse_conditions_def":"faction.enemy.refuse_conditions_att_second"), (float)(this.guiLeft + 119 + 55), (float)(this.guiTop + 217), 14803951, 0.5F, "center", false, "georamaSemiBold", 28);
                           }
                        }
                     } else {
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.title.your_proposal").replaceAll("#country#", this.defenserCounterPropositionMode?(String)currentWar.get("factionDEFName"):(String)currentWar.get("factionATTName")), (float)(this.guiLeft + 43), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.contitions"), (float)(this.guiLeft + 48), (float)(this.guiTop + 114), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        var22 = 0;
                        ...
                        for(var25 = this.availableConditions.iterator(); var25.hasNext(); ++var22) {
                           ...
                           if(this.conditionsInput.containsKey(var26)) {
                              ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 49), (float)(this.guiTop + 128 - 1 + var22 * 12), (float)(((Integer)iconsConditionsRewards.get(var26)).intValue() * GUI_SCALE), (float)((FactionGUI.isNumeric(((GuiTextField)this.conditionsInput.get(var26)).func_73781_b(), false)?114:106) * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.conditions." + var26), (float)(this.guiLeft + 59), (float)(this.guiTop + 128 + var22 * 12), FactionGUI.isNumeric(((GuiTextField)this.conditionsInput.get(var26)).func_73781_b(), false)?7239406:16514302, 0.5F, "left", false, "georamaSemiBold", 25);
                              ((GuiTextField)this.conditionsInput.get(var26)).func_73795_f();
                              ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.contitions_added"), (float)(this.guiLeft + 48), (float)(this.guiTop + 202), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        ClientEventHandler.STYLE.bindTexture("faction_global");
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.true"), (float)(this.guiLeft + 57), (float)(this.guiTop + 214), this.conditionsCumulative?7239406:10395075, 0.5F, "left", false, "georamaSemiBold", 25);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.false"), (float)(this.guiLeft + 98), (float)(this.guiTop + 214), !this.conditionsCumulative?7239406:10395075, 0.5F, "left", false, "georamaSemiBold", 25);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards"), (float)(this.guiLeft + 141), (float)(this.guiTop + 114), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        var22 = 0;

                        for(var25 = this.availableRewards.iterator(); var25.hasNext(); ++var22) {
                           var26 = (String)var25.next();
                           if(this.rewardsInput.containsKey(var26)) {
                              var29 = FactionGUI.isNumeric(((GuiTextField)this.rewardsInput.get(var26)).func_73781_b(), false)?7239406:16514302;
                              var29 = !((GuiTextField)this.rewardsInput.get(var26)).func_73781_b().isEmpty() && (!FactionGUI.isNumeric(((GuiTextField)this.rewardsInput.get(var26)).func_73781_b(), true) || var26.equals("peace") && Integer.parseInt(((GuiTextField)this.rewardsInput.get(var26)).func_73781_b()) > 120)?15017020:var29;
                              ClientEventHandler.STYLE.bindTexture("faction_war");
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards." + var26), (float)(this.guiLeft + 152), (float)(this.guiTop + 128 + var22 * 12), var29, 0.5F, "left", false, "georamaSemiBold", 25);
                              ((GuiTextField)this.rewardsInput.get(var26)).func_73795_f();
                              ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        ...
                        if(currentWar.get("status").equals("waiting_conditions_def")) {
                           ...
                           if(mouseX >= this.guiLeft + 142 && mouseX <= this.guiLeft + 142 + 39 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 11) {
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.back"), (float)(this.guiLeft + 142 + 19), (float)(this.guiTop + 213), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                              ...
                              ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.back"), (float)(this.guiLeft + 142 + 19), (float)(this.guiTop + 213), 14803951, 0.5F, "center", false, "georamaSemiBold", 25);
                           }
                        }
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.send_request"), (float)(this.guiLeft + 185 + 19), (float)(this.guiTop + 213), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                     }

                     Gui.func_73734_a(this.guiLeft + 241, this.guiTop + 89, this.guiLeft + this.xSize, this.guiTop + this.ySize, -14279619);
                     if(this.defenserCounterPropositionMode) {
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(currentWar.get("status").equals("waiting_conditions_def")?"faction.war.label.received_proposition":"faction.war.label.my_proposition").replaceAll("#country#", this.defenserCounterPropositionMode?(String)currentWar.get("factionATTName"):(String)currentWar.get("factionDEFName")), (float)(this.guiLeft + 254), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        ...
                        if(currentWarRequest.get(currentWar.get("status").equals("waiting_conditions_def")?"conditions_ATT":"conditions_DEF") != null) {
                           ...
                           for(var29 = 0; var29 < var30; ++var29) {
                              ...
                              ModernGui.drawScaledStringCustomFont(agreementCondition + " " + I18n.func_135053_a("faction.enemy.conditions." + var40), (float)(dateFormated + 10), (float)(conditionsOTHER + 1), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                              ++var22;
                           }
                        }
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards"), (float)(this.guiLeft + 254 + 5), (float)(this.guiTop + 170), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                        var22 = 0;
                        if(currentWarRequest.get(currentWar.get("status").equals("waiting_conditions_def")?"rewards_ATT":"rewards_DEF") != null) {
                           ...
                           for(var29 = 0; var29 < var30; ++var29) {
                              ...
                              ClientEventHandler.STYLE.bindTexture("faction_war");
                              ModernGui.drawScaledCustomSizeModalRect((float)dateFormated, (float)conditionsOTHER, (float)(((Integer)iconsConditionsRewards.get(var40)).intValue() * GUI_SCALE), (float)(106 * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                              ModernGui.drawScaledStringCustomFont(agreementCondition + " " + I18n.func_135053_a("faction.enemy.rewards." + var40), (float)(dateFormated + 10), (float)(conditionsOTHER + 1), 10395075, 0.5F, "left", false, "georamaMedium", 28);
                              ++var22;
                           }
                        }
                     } else {
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.title.request_informations"), (float)(this.guiLeft + 254), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.war_for") + " " + I18n.func_135053_a("faction.enemy.reason." + currentWarRequest.get("reason")), (float)(this.guiLeft + 261), (float)(this.guiTop + 115), 14803951, 0.5F, "left", false, "georamaSemiBold", 30);
                        ModernGui.drawSectionStringCustomFont(I18n.func_135053_a("faction.enemy.reason.desc." + currentWarRequest.get("reason")), (float)(this.guiLeft + 261), (float)(this.guiTop + 125), 10395075, 0.5F, "left", false, "georamaMedium", 26, 8, 360);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.initiate_by_at").replaceAll("#date#", date).replaceAll("#player#", (String)currentWar.get("sender")), (float)(this.guiLeft + 261), (float)(this.guiTop + 142), 10395075, 0.5F, "left", false, "georamaMedium", 24);
                        simpleDateFormat = 1;
                        if(currentWar.get("status").equals("waiting_conditions_def")) {
                           simpleDateFormat = 2;
                        ...
                        for(dateFormated = 1; dateFormated <= 3; ++dateFormated) {
                           ...
                           ModernGui.drawSectionStringCustomFont(I18n.func_135053_a("faction.war.waiting_validation.step." + dateFormated).replaceAll("#factionATT#", (String)currentWar.get("factionATTName")).replaceAll("#factionDEF#", (String)currentWar.get("factionDEFName")), (float)(this.guiLeft + 254 + (dateFormated - 1) * 67 + 32), (float)(this.guiTop + 177), dateFormated < simpleDateFormat?16514302:(dateFormated == simpleDateFormat?2234425:10395075), 0.5F, "center", false, "georamaMedium", 22, 8, 105);
                        }
                     }
                  }
               } else {
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.status." + currentWar.get("status")).replaceAll("#factionATT#", (String)currentWar.get("factionATTName")).replaceAll("#factionDEF#", (String)currentWar.get("factionDEFName")), (float)(this.guiLeft + 43), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                  ClientEventHandler.STYLE.bindTexture("faction_war_2");
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.war_for") + " " + I18n.func_135053_a("faction.enemy.reason." + currentWarRequest.get("reason")), (float)(this.guiLeft + 50), (float)(this.guiTop + 115), 14803951, 0.5F, "left", false, "georamaSemiBold", 30);
                  ModernGui.drawSectionStringCustomFont(I18n.func_135053_a("faction.enemy.reason.desc." + currentWarRequest.get("reason")), (float)(this.guiLeft + 50), (float)(this.guiTop + 125), 10395075, 0.5F, "left", false, "georamaMedium", 26, 8, 400);
                  var24 = new Date(((Double)currentWarRequest.get("creationTime")).longValue());
                  agreementType = new SimpleDateFormat("dd/MM/yyyy");
                  date = agreementType.format(var24);
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.initiate_by_at").replaceAll("#date#", date).replaceAll("#player#", (String)currentWarRequest.get("sender")), (float)(this.guiLeft + 50), (float)(this.guiTop + 142), 10395075, 0.5F, "left", false, "georamaMedium", 24);
                  Gui.func_73734_a(this.guiLeft + 106, this.guiTop + 192, this.guiLeft + 387, this.guiTop + 194, -13950655);
                  simpleDateFormat = 0;
                  ...
                  for(dateFormated = 0; dateFormated <= 4; ++dateFormated) {
                     ...
                     ModernGui.drawSectionStringCustomFont(I18n.func_135053_a("faction.war.waiting_validation.step." + dateFormated).replaceAll("#factionATT#", (String)currentWar.get("factionATTName")).replaceAll("#factionDEF#", (String)currentWar.get("factionDEFName")), (float)(this.guiLeft + 43 + dateFormated * 85 + 32), (float)(this.guiTop + 177), dateFormated < simpleDateFormat?16514302:(dateFormated == simpleDateFormat?2234425:10395075), 0.5F, "center", false, "georamaMedium", 22, 8, 105);
                  }
               }
            } else {
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.list_agreements"), (float)(this.guiLeft + 43), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
               if(FactionGUI.hasPermissions("wars")) {
                  ClientEventHandler.STYLE.bindTexture("faction_war_2");
                  if(mouseX >= this.guiLeft + 48 + (int)this.cFontSemiBold28.getStringWidth(I18n.func_135053_a("faction.war.label.list_agreements")) / 2 && mouseX <= this.guiLeft + 48 + (int)this.cFontSemiBold28.getStringWidth(I18n.func_135053_a("faction.war.label.list_agreements")) / 2 + 8 && mouseY >= this.guiTop + 97 && mouseY <= this.guiTop + 97 + 8) {
                     ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 48 + (int)this.cFontSemiBold28.getStringWidth(I18n.func_135053_a("faction.war.label.list_agreements")) / 2), (float)(this.guiTop + 97), (float)(248 * GUI_SCALE), (float)(188 * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                     this.hoveredAction = "add_agreement";
                  } else {
                     ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 48 + (int)this.cFontSemiBold28.getStringWidth(I18n.func_135053_a("faction.war.label.list_agreements")) / 2), (float)(this.guiTop + 97), (float)(237 * GUI_SCALE), (float)(188 * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                  }
               }
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements_active"), (float)(this.guiLeft + 47), (float)(this.guiTop + 112), 2234425, 0.5F, "left", false, "georamaSemiBold", 30);
               ...
               for(var23 = 0; var23 < ((ArrayList)currentWar.get("agreements_active")).size(); ++var23) {
                  ...
                  if(ClientProxy.flagsTexture.containsKey(var34)) {
                     GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(var34)).func_110552_b());
                     ModernGui.drawScaledCustomSizeModalRect((float)(var30 + 5), (float)(var42.intValue() + 0), 0.0F, 0.0F, 156, 78, 17, 10, 156.0F, 78.0F, false);
                  }

                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.type.short." + var37), (float)(var30 + 26), (float)(var42.intValue() + 2), var52.intValue() == selectedAgreementId?16514302:10395075, 0.5F, "left", false, "georamaMedium", 28);
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements_waiting"), (float)(this.guiLeft + 145), (float)(this.guiTop + 112), 2234425, 0.5F, "left", false, "georamaSemiBold", 30);
               ...
               for(var23 = 0; var23 < ((ArrayList)currentWar.get("agreements_waiting")).size(); ++var23) {
                  ...
                  ModernGui.drawScaledStringCustomFont((var52.intValue() != selectedAgreementId && var40.equals("refused")?"\u00a7c":(var52.intValue() != selectedAgreementId && var40.equals("expired")?"\u00a7n":"")) + I18n.func_135053_a("faction.enemy.agreement.type.short." + var37), (float)(var30 + 26), (float)(var42.intValue() + 2), var52.intValue() == selectedAgreementId?16514302:10395075, 0.5F, "left", false, "georamaMedium", 28);
               ...
               if(this.agreementCreationMode || selectedAgreementId != -1) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.my_side"), (float)(this.guiLeft + 264), (float)(this.guiTop + 115), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.other_side"), (float)(this.guiLeft + 363), (float)(this.guiTop + 115), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
                  ClientEventHandler.STYLE.bindTexture("faction_war_2");
               ...
               if(!this.agreementCreationMode) {
                  if(((LinkedTreeMap)currentWar.get("agreements")).containsKey(selectedAgreementId + "")) {
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.details_agreements"), (float)(this.guiLeft + 258), (float)(this.guiTop + 97), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                     ...
                     for(Iterator var48 = this.agreementsAvailableConditions.iterator(); var48.hasNext(); ++var22) {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.conditions." + var38), (float)(this.guiLeft + 265 + 12), (float)(this.guiTop + 127 + 11 * var22), dateFormated != 0?7239406:10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.conditions." + var38), (float)(this.guiLeft + 364 + 12), (float)(this.guiTop + 127 + 11 * var22), conditionsOTHER != 0?15017020:10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.informations"), (float)(this.guiLeft + 357), (float)(this.guiTop + 173), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.status.short." + var47.get("status")), (float)(this.guiLeft + 357), (float)(this.guiTop + 183), 10395075, 0.5F, "left", false, "georamaSemiBold", 24);
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.type." + var47.get("type")) + " (" + String.format("%.0f", new Object[]{(Double)var47.get("value")}) + I18n.func_135053_a("faction.common.days.short") + ")", (float)(this.guiLeft + 357), (float)(this.guiTop + 190), 10395075, 0.5F, "left", false, "georamaSemiBold", 24);
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(var47.get("status").equals("active")?"faction.war.label.agreements.signed_at":"faction.war.label.agreements.received_at").replaceAll("#date#", var34), (float)(this.guiLeft + 357), (float)(this.guiTop + 197), 10395075, 0.5F, "left", false, "georamaSemiBold", 24);
                     if(FactionGUI.hasPermissions("wars") && var47.get("status").equals("waiting") && FactionGUI.hasPermissions("wars") && !FactionGUI.factionInfos.get("id").equals(var47.get("factionSender"))) {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.accept"), (float)(this.guiLeft + 357 + 20), (float)(this.guiTop + 208), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                        if(mouseX >= this.guiLeft + 400 && mouseX <= this.guiLeft + 400 + 39 && mouseY >= this.guiTop + 206 && mouseY <= this.guiTop + 206 + 11) {
                           ...
                           ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.refuse"), (float)(this.guiLeft + 400 + 20), (float)(this.guiTop + 208), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                           ...
                           ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.refuse"), (float)(this.guiLeft + 400 + 20), (float)(this.guiTop + 208), 14803951, 0.5F, "center", false, "georamaSemiBold", 25);
                        }
                        ...
                        if(mouseX >= this.guiLeft + 400 && mouseX <= this.guiLeft + 400 + 39 && mouseY >= this.guiTop + 206 && mouseY <= this.guiTop + 206 + 11) {
                           ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 400), (float)(this.guiTop + 206), (float)(191 * GUI_SCALE), (float)(202 * GUI_SCALE), 39 * GUI_SCALE, 11 * GUI_SCALE, 39, 11, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                           ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.cancel"), (float)(this.guiLeft + 400 + 20), (float)(this.guiTop + 208), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                           this.hoveredAction = "agreement_cancel#" + ((Double)var47.get("id")).intValue();
                        } else {
                           ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 400), (float)(this.guiTop + 206), (float)(237 * GUI_SCALE), (float)(202 * GUI_SCALE), 39 * GUI_SCALE, 11 * GUI_SCALE, 39, 11, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                           ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.cancel"), (float)(this.guiLeft + 400 + 20), (float)(this.guiTop + 208), 14803951, 0.5F, "center", false, "georamaSemiBold", 25);
                        }
                        ...
                        var34 = var60.format(var49);
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.end_at").replaceAll("#date#", var34), (float)(this.guiLeft + 357), (float)(this.guiTop + 210), 14803951, 0.5F, "left", false, "georamaSemiBold", 25);
                     }
                  }
                  ...
                  for(var25 = this.agreementsAvailableConditions.iterator(); var25.hasNext(); ++var22) {
                     ...
                     if(this.agreement_myConditionsInput.containsKey(var26)) {
                        ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 265), (float)(this.guiTop + 127 + 11 * var22), (float)(((Integer)iconsConditionsRewards.get(var26)).intValue() * GUI_SCALE), (float)((FactionGUI.isNumeric(((GuiTextField)this.agreement_myConditionsInput.get(var26)).func_73781_b(), false)?114:106) * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.conditions." + var26), (float)(this.guiLeft + 265 + 12), (float)(this.guiTop + 127 + 11 * var22), FactionGUI.isNumeric(((GuiTextField)this.agreement_myConditionsInput.get(var26)).func_73781_b(), false)?7239406:10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                        ((GuiTextField)this.agreement_myConditionsInput.get(var26)).func_73795_f();
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                     ...
                     if(this.agreement_otherConditionsInput.containsKey(var26)) {
                        ClientEventHandler.STYLE.bindTexture("faction_war");
                        ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 364), (float)(this.guiTop + 127 + 11 * var22), (float)(((Integer)iconsConditionsRewards.get(var26)).intValue() * GUI_SCALE), (float)((FactionGUI.isNumeric(((GuiTextField)this.agreement_otherConditionsInput.get(var26)).func_73781_b(), false)?130:106) * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), true);
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.conditions." + var26), (float)(this.guiLeft + 364 + 12), (float)(this.guiTop + 127 + 11 * var22), FactionGUI.isNumeric(((GuiTextField)this.agreement_otherConditionsInput.get(var26)).func_73781_b(), false)?15017020:10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                        ((GuiTextField)this.agreement_otherConditionsInput.get(var26)).func_73795_f();
                        ClientEventHandler.STYLE.bindTexture("faction_war_2");
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.type"), (float)(this.guiLeft + 264), (float)(this.guiTop + 174), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
                  var22 = 0;
                  ...
                  for(var25 = this.agreementsAvailableTypes.iterator(); var25.hasNext(); ++var22) {
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.type." + var26), (float)(this.guiLeft + 265 + 10), (float)(this.guiTop + 185 + 9 * var22), 10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                  }

                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.agreements.duration"), (float)(this.guiLeft + 363), (float)(this.guiTop + 174), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
                  ClientEventHandler.STYLE.bindTexture("faction_war_2");
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.rewards.valueType.dayLong") + " (max. 120)", (float)(this.guiLeft + 388), (float)(this.guiTop + 185), 10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                  if(FactionGUI.hasPermissions("wars")) {
                     ClientEventHandler.STYLE.bindTexture("faction_war_2");
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.enemy.agreement.submit"), (float)(this.guiLeft + 363 + 20), (float)(this.guiTop + 208), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                     ClientEventHandler.STYLE.bindTexture("faction_war_2");
                     if(mouseX >= this.guiLeft + 406 && mouseX <= this.guiLeft + 406 + 39 && mouseY >= this.guiTop + 206 && mouseY <= this.guiTop + 206 + 11) {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.back"), (float)(this.guiLeft + 406 + 20), (float)(this.guiTop + 208), 2234425, 0.5F, "center", false, "georamaSemiBold", 25);
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.common.back"), (float)(this.guiLeft + 406 + 20), (float)(this.guiTop + 208), 14803951, 0.5F, "center", false, "georamaSemiBold", 25);
                     }
                  }
               }
            }
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.war.label.no_war_in_progress"), (float)(this.guiLeft + 43), (float)(this.guiTop + 105), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
         }
   ...
   public void func_73876_c() {
      ...
      while(it.hasNext()) {
         pair = (Entry)it.next();
         ((GuiTextField)pair.getValue()).func_73780_a();
      }
   ...
   protected void func_73869_a(char typedChar, int keyCode) {
      ...
      while(it.hasNext()) {
         pair = (Entry)it.next();
         ((GuiTextField)pair.getValue()).func_73802_a(typedChar, keyCode);
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
         ...
         if(this.hoveredAction.equals("edit_photo")) {
            ...
            if(this.hoveredAction.equals("agreement_create")) {
               ...
               while(var6.hasNext()) {
                  ...
                  if(this.agreement_myConditionsInput.containsKey(reward) && FactionGUI.isNumeric(((GuiTextField)this.agreement_myConditionsInput.get(reward)).func_73781_b(), false)) {
                     var11 = var11 + reward + "#" + ((GuiTextField)this.agreement_myConditionsInput.get(reward)).func_73781_b() + "#" + FactionGUI.factionInfos.get("name") + ",";
                  } else if(this.agreement_otherConditionsInput.containsKey(reward) && FactionGUI.isNumeric(((GuiTextField)this.agreement_otherConditionsInput.get(reward)).func_73781_b(), false)) {
                     var11 = var11 + reward + "#" + ((GuiTextField)this.agreement_otherConditionsInput.get(reward)).func_73781_b() + "#" + var10 + ",";
                  }
               }

               PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionEnemyAgreementCreatePacket(Integer.valueOf(((Double)((TreeMap)factionsWarInfos.get(currentWarIndex)).get("warId")).intValue()), this.agreement_form_type, Integer.parseInt(this.agreement_form_duration.func_73781_b()), var11)));
               this.agreementCreationMode = false;
               ...
               while(var6.hasNext()) {
                  reward = (String)var6.next();
                  ((GuiTextField)this.agreement_myConditionsInput.get(reward)).func_73782_a("0");
                  ((GuiTextField)this.agreement_otherConditionsInput.get(reward)).func_73782_a("0");
               }
               ...
               if(this.hoveredAction.contains("open_forum")) {
                  ...
                  if(this.hoveredAction.contains("surrender")) {
                     this.field_73882_e.func_71373_a(new SurrenderConfirmGui(this, ((Double)((TreeMap)factionsWarInfos.get(currentWarIndex)).get("warId")).intValue(), (String)FactionGUI.factionInfos.get("name")));
               ...
               while(var6.hasNext()) {
                  reward = (String)var6.next();
                  if(this.conditionsInput.containsKey(reward) && FactionGUI.isNumeric(((GuiTextField)this.conditionsInput.get(reward)).func_73781_b(), false)) {
                     var10 = var10 + reward + "#" + Integer.parseInt(((GuiTextField)this.conditionsInput.get(reward)).func_73781_b()) + ",";
                  }
               }
               ...
               while(var6.hasNext()) {
                  reward = (String)var6.next();
                  if(this.rewardsInput.containsKey(reward) && FactionGUI.isNumeric(((GuiTextField)this.rewardsInput.get(reward)).func_73781_b(), false)) {
                     var11 = var11 + reward + "#" + Integer.parseInt(((GuiTextField)this.rewardsInput.get(reward)).func_73781_b()) + ",";
                     if(reward.equals("peace") && Integer.parseInt(((GuiTextField)this.rewardsInput.get(reward)).func_73781_b()) > 120) {
                        return;
                     }
                  }
               }
      ...
      while(var13.hasNext()) {
         ...
         ((GuiTextField)pair.getValue()).func_73793_a(mouseX, mouseY, mouseButton);
      }
