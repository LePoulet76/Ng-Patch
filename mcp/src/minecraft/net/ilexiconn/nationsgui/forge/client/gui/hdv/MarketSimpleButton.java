...
{
    public MarketSimpleButton(int par1, int par2, int par3, String par4Str)
    {
        super(par1, par2, par3, par4Str);
    }

    public MarketSimpleButton(int par1, int par2, int par3, int par4, int par5, String par6Str)
    {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3)
    {
        ...
        par1Minecraft.fontRenderer.drawString(this.displayString, this.xPosition + this.width / 2 - par1Minecraft.fontRenderer.getStringWidth(this.displayString) / 2, this.yPosition + this.height / 2 - 4, 16777215);
    }
}
