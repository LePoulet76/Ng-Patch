...
public class WarRequestGUI extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(loaded && warInfos.size() > 0) {
         ...
         this.drawScaledString(I18n.func_135053_a("faction.enemy.title"), this.guiLeft + 14, this.guiTop + 210, 16777215, 1.5F, false, false);
         GL11.glPopMatrix();
         ...
         if(ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionATT"))) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionATT"))).func_110552_b());
         ...
         if(ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionDEF"))) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionDEF"))).func_110552_b());
         ...
         if(!warInfos.get("status").equals("in_progress") && !warInfos.get("status").equals("finished")) {
            side = I18n.func_135053_a("faction.enemy.status." + warInfos.get("status") + ".att");
            this.drawScaledString(side, this.guiLeft + 108 + 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            if(side.startsWith("\u00a72")) {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 110, 251, 10, 11, 512.0F, 512.0F, false);
            } else if(side.startsWith("\u00a74")) {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 120, 251, 10, 11, 512.0F, 512.0F, false);
            } else {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 130, 251, 10, 11, 512.0F, 512.0F, false);
            }

            side = I18n.func_135053_a("faction.enemy.status." + warInfos.get("status") + ".def");
            this.drawScaledString(side, this.guiLeft + 244 + 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            if(side.startsWith("\u00a72")) {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 110, 251, 10, 11, 512.0F, 512.0F, false);
            } else if(side.startsWith("\u00a74")) {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 120, 251, 10, 11, 512.0F, 512.0F, false);
            } else {
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 - this.field_73886_k.func_78256_a(side) / 2 - 8), (float)(this.guiTop + 56), 130, 251, 10, 11, 512.0F, 512.0F, false);
            }
         } else if(this.winner == null) {
            side = I18n.func_135053_a("faction.enemy.inactivity") + ": " + (warInfos.get("inactivity_ATT") != null?warInfos.get("inactivity_ATT"):Integer.valueOf(0)) + "%";
            this.drawScaledString(side, this.guiLeft + 108 - 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2), (float)(this.guiTop + 56), 71, 251, 10, 11, 512.0F, 512.0F, false);
            if(mouseX >= this.guiLeft + 108 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2 && mouseX <= this.guiLeft + 108 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2 + 10 && mouseY >= this.guiTop + 56 && mouseY <= this.guiTop + 56 + 11) {
               tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.inactivity");
            }

            side = I18n.func_135053_a("faction.enemy.inactivity") + ": " + (warInfos.get("inactivity_DEF") != null?warInfos.get("inactivity_DEF"):Integer.valueOf(0)) + "%";
            this.drawScaledString(side, this.guiLeft + 244 - 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2), (float)(this.guiTop + 56), 71, 251, 10, 11, 512.0F, 512.0F, false);
            if(mouseX >= this.guiLeft + 244 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2 && mouseX <= this.guiLeft + 244 - 6 + this.field_73886_k.func_78256_a(side) / 2 + 2 + 10 && mouseY >= this.guiTop + 56 && mouseY <= this.guiTop + 56 + 11) {
               tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.inactivity");
            }
         } else if(this.winner.equals(warInfos.get("factionATT"))) {
            this.drawScaledString(I18n.func_135053_a("faction.enemy.winner"), this.guiLeft + 108 - 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.winner")) / 2 - 6 + 2), (float)(this.guiTop + 56), 330, 22, 11, 11, 512.0F, 512.0F, false);
            this.drawScaledString(I18n.func_135053_a("faction.enemy.looser"), this.guiLeft + 244 - 9, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.looser")) / 2 - 9 + 2), (float)(this.guiTop + 56), 329, 34, 16, 11, 512.0F, 512.0F, false);
         } else {
            this.drawScaledString(I18n.func_135053_a("faction.enemy.looser"), this.guiLeft + 108 - 6, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 108 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.looser")) / 2 - 6 + 2), (float)(this.guiTop + 56), 329, 34, 16, 11, 512.0F, 512.0F, false);
            this.drawScaledString(I18n.func_135053_a("faction.enemy.winner"), this.guiLeft + 244 - 9, this.guiTop + 58, 16777215, 1.0F, true, false);
            ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 244 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.winner")) / 2 - 9 + 2), (float)(this.guiTop + 56), 330, 22, 11, 11, 512.0F, 512.0F, false);
         }
         ...
         if(!warInfos.get("status").equals("waiting_validation") && !warInfos.get("status").equals("refused") && !warInfos.get("status").equals("cancelled") && (!warInfos.get("status").equals("waiting_conditions_att") || warInfos.get("factionATT").equals(warInfos.get("playerFaction")) && ((Boolean)warInfos.get("hasWarPermInOwnCountry")).booleanValue()) && (!warInfos.get("status").equals("waiting_conditions_def") || warInfos.get("factionDEF").equals(warInfos.get("playerFaction")) && ((Boolean)warInfos.get("hasWarPermInOwnCountry")).booleanValue()) && !warInfos.get("status").equals("waiting_conditions_att_second")) {
            ...
            if((!warInfos.get("status").equals("waiting_conditions_att") || !warInfos.get("factionATT").equals(warInfos.get("playerFaction"))) && (!warInfos.get("status").equals("waiting_conditions_def") || !warInfos.get("factionDEF").equals(warInfos.get("playerFaction")))) {
               if(warInfos.get("status").equals("in_progress") || warInfos.get("status").equals("finished")) {
                  ...
                  Gui.func_73734_a(this.guiLeft + 47, this.guiTop + 78, this.guiLeft + 47 + 130 + var29.intValue(), this.guiTop + 78 + 3, -15352550);
                  Gui.func_73734_a(this.guiLeft + 177 + var29.intValue(), this.guiTop + 78, this.guiLeft + 306, this.guiTop + 78 + 3, -3924707);
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.contitions") + " \u00a74(" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType")) + ")", this.guiLeft + 46, this.guiTop + 86, 0, 1.0F, false, false);
                  ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 48 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.contitions") + " \u00a74(" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType")) + ")")), (float)(this.guiTop + 84), 71, 251, 10, 11, 512.0F, 512.0F, false);
                  if(mouseX >= this.guiLeft + 48 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.contitions") + " \u00a74(" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType")) + ")") && mouseX <= this.guiLeft + 48 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.contitions") + " \u00a74(" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType")) + ")") + 10 && mouseY >= this.guiTop + 84 && mouseY <= this.guiTop + 84 + 11) {
                     tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.conditions");
                  }
                  ...
                  if(warInfos.get("conditions") != null) {
                     ...
                     for(var41 = 0; var41 < dateString; ++var41) {
                        ...
                        if(!finishReward.isEmpty() && finishReward.split("#").length == 2) {
                           ...
                           valueType = (this.data_ATT.containsKey(rewardName)?(Serializable)this.data_ATT.get(rewardName):"0") + "/" + rewardGoal + " " + I18n.func_135053_a("faction.enemy.conditions." + rewardName);
                           ...
                           valueType = (this.data_DEF.containsKey(rewardName)?(Serializable)this.data_DEF.get(rewardName):"0") + "/" + rewardGoal + " " + I18n.func_135053_a("faction.enemy.conditions." + rewardName);
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards"), this.guiLeft + 182, this.guiTop + 160, 0, 1.0F, false, false);
                  ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 184 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.rewards"))), (float)(this.guiTop + 158), 71, 251, 10, 11, 512.0F, 512.0F, false);
                  if(mouseX >= this.guiLeft + 184 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.rewards")) && mouseX <= this.guiLeft + 184 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.rewards")) + 10 && mouseY >= this.guiTop + 158 && mouseY <= this.guiTop + 158 + 11) {
                     tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.rewards");
                  }
                        ...
                        for(var41 = 0; var41 < dateString; ++var41) {
                           ...
                           if(!finishReward.isEmpty() && finishReward.split("#").length == 2) {
                              ...
                              if(Integer.parseInt(rewardGoal) > 0) {
                                 ...
                                 this.drawScaledString(rewardGoal + valueType + " " + I18n.func_135053_a("faction.enemy.rewards." + rewardName), offsetX + 4, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
                              } else {
                                 this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards." + rewardName), offsetX + 4, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
                              }
                  ...
                  this.drawScaledString(var42, this.guiLeft + 168 - this.field_73886_k.func_78256_a(var42), this.guiTop + 173, 16777215, 1.0F, false, false);
                  if(warInfos.get("playerTarget") != null && !((String)warInfos.get("playerTarget")).isEmpty()) {
                     ...
                     if(mouseX >= this.guiLeft + 159 && mouseX <= this.guiLeft + 159 + 10 && mouseY >= this.guiTop + 187 && mouseY <= this.guiTop + 187 + 11) {
                        tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.reason").replace("#target#", (String)warInfos.get("playerTarget"));
                     }

                     this.drawScaledString(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason")), this.guiLeft + 168 - this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason"))) - 14, this.guiTop + 189, 16777215, 1.0F, false, false);
                  } else {
                     this.drawScaledString(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason")), this.guiLeft + 168 - this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason"))), this.guiTop + 189, 16777215, 1.0F, false, false);
                  }
                  ...
                  this.drawScaledString(var41 + " kills", this.guiLeft + 168 - this.field_73886_k.func_78256_a(var41 + " kills"), this.guiTop + 205, 16777215, 1.0F, false, false);
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.linkForum"), this.guiLeft + 109, this.guiTop + 221, 0, 1.0F, true, false);
                  if(warInfos.get("status").equals("in_progress") && ((Boolean)warInfos.get("hasWarPermInOwnCountry")).booleanValue() && (warInfos.get("playerFaction").equals(warInfos.get("factionATT")) || warInfos.get("playerFaction").equals(warInfos.get("factionDEF")))) {
                     ...
                     GL11.glRotatef(-90.0F, 0.0F, 0.0F, 1.0F);
                     GL11.glTranslatef((float)(-(this.guiLeft + 325)), (float)(-(this.guiTop + 212)), 0.0F);
                     this.drawScaledString(I18n.func_135053_a("faction.enemy.surrender"), this.guiLeft + 325, this.guiTop + 212, 0, 1.0F, false, false);
                     GL11.glPopMatrix();
                     if(mouseX >= this.guiLeft + 319 && mouseX <= this.guiLeft + 319 + 23 && mouseY >= this.guiTop + 166 && mouseY <= this.guiTop + 166 + 64) {
                        if(warInfos.containsKey("enemyTime") && System.currentTimeMillis() - ((Double)warInfos.get("enemyTime")).longValue() < 604800000L) {
                           tooltipToDraw = I18n.func_135053_a("faction.enemy.tooltip.surrender_delay");
                        } else {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.contitions"), this.guiLeft + 46, this.guiTop + 84, 0, 1.0F, false, false);
               this.drawScaledString(I18n.func_135053_a("faction.enemy.conditionsType." + this.selectedConditionsType), this.guiLeft + 104, this.guiTop + 85, 16777215, 1.0F, false, false);
               this.conditionInput.func_73795_f();
               this.drawScaledString(I18n.func_135053_a("faction.enemy.conditions." + this.selectedCondition), this.guiLeft + 209, this.guiTop + 85, 16777215, 1.0F, false, false);
               ...
               for(var22 = this.conditions.entrySet().iterator(); var22.hasNext(); var23 += 23) {
                  ...
                  this.drawScaledString(var26.getValue() + " " + I18n.func_135053_a("faction.enemy.conditions." + var26.getKey()), var28 + 2, var29.intValue() + 7, 16777215, 1.0F, false, false);
                  ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
               ...
               if(this.conditionsTypeOpened) {
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.conditionsType.and"), this.guiLeft + 104, this.guiTop + 104, 16777215, 1.0F, false, false);
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.conditionsType.or"), this.guiLeft + 104, this.guiTop + 123, 16777215, 1.0F, false, false);
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards"), this.guiLeft + 46, this.guiTop + 156, 0, 1.0F, false, false);
               this.rewardInput.func_73795_f();
               this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards." + this.selectedReward), this.guiLeft + 209, this.guiTop + 157, 16777215, 1.0F, false, false);
               ...
               for(var22 = this.rewards.entrySet().iterator(); var22.hasNext(); var23 += 23) {
                  ...
                  if(((Integer)var26.getValue()).intValue() > 0) {
                     ...
                     if(var26.getKey().equals("peace")) {
                        var36 = I18n.func_135053_a("faction.enemy.rewards.valueType.day");
                     }

                     this.drawScaledString(var26.getValue() + var36 + " " + I18n.func_135053_a("faction.enemy.rewards." + var26.getKey()), var28 + 2, var29.intValue() + 7, 16777215, 1.0F, false, false);
                  } else {
                     this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards." + var26.getKey()), var28 + 2, var29.intValue() + 7, 16777215, 1.0F, false, false);
                  }
               ...
               if(warInfos.get("status").equals("waiting_conditions_att")) {
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.send_conditions_att"), this.guiLeft + 177, this.guiTop + 225, 16777215, 1.0F, true, false);
               } else {
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.send_conditions_def"), this.guiLeft + 177, this.guiTop + 225, 16777215, 1.0F, true, false);
               }
               ...
               if(warInfos.get("status").equals("waiting_conditions_def")) {
                  ...
                  this.drawScaledString("\u00a77\u00a7l" + I18n.func_135053_a("faction.enemy.contitions") + " \u00a74\u00a7l" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType_ATT")), this.guiLeft + 326, this.guiTop + 42, 16777215, 1.0F, false, false);
                  var30 = 1;
                  if(warInfos.get("conditions_ATT") != null) {
                     ...
                     for(var31 = 0; var31 < offset; ++var31) {
                        ...
                        this.drawScaledString("\u00a7f\u25cf " + var37.split("#")[1] + " " + I18n.func_135053_a("faction.enemy.conditions." + var37.split("#")[0]), this.guiLeft + 326, this.guiTop + 42 + 10 * var30, 16777215, 1.0F, false, false);
                        ++var30;
                     }
                  } else {
                     this.drawScaledString("\u00a7c\u2716 " + I18n.func_135053_a("faction.enemy.none"), this.guiLeft + 326, this.guiTop + 42 + 10, 16777215, 1.0F, false, false);
                  }

                  var28 = var30 * 10;
                  var30 = 1;
                  this.drawScaledString("\u00a77\u00a7l" + I18n.func_135053_a("faction.enemy.rewards"), this.guiLeft + 326, this.guiTop + 62 + var28, 16777215, 1.0F, false, false);
                     ...
                     for(simpleDateFormat = 0; simpleDateFormat < var31; ++simpleDateFormat) {
                        ...
                        if(Integer.parseInt(var42.split("#")[1]) > 0) {
                           ...
                           if(var42.split("#")[0].equals("peace")) {
                              totalKills = I18n.func_135053_a("faction.enemy.rewards.valueType.day");
                           }

                           this.drawScaledString("\u00a7f\u25cf " + var42.split("#")[1] + totalKills + " " + I18n.func_135053_a("faction.enemy.rewards." + var42.split("#")[0]), this.guiLeft + 326, this.guiTop + 62 + var28 + 10 * var30, 16777215, 1.0F, false, false);
                        } else {
                           this.drawScaledString("\u00a7f\u25cf " + I18n.func_135053_a("faction.enemy.rewards." + var42.split("#")[0]), this.guiLeft + 326, this.guiTop + 62 + var28 + 10 * var30, 16777215, 1.0F, false, false);
                        }

                        ++var30;
                     }
                  } else {
                     this.drawScaledString("\u00a7c\u2716 " + I18n.func_135053_a("faction.enemy.none"), this.guiLeft + 326, this.guiTop + 62 + var28 + 10 * var30, 16777215, 1.0F, false, false);
                  }
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.enemy.accept_conditions_def"), this.guiLeft + 368, this.guiTop + 213, 16777215, 1.0F, true, false);
               }
               ...
               if(this.rewardsOpened) {
                  ...
                  for(var34 = this.availableRewards.iterator(); var34.hasNext(); var23 += 19) {
                     ...
                     this.drawScaledString(I18n.func_135053_a("faction.enemy.rewards." + progressDEF), offset + 2, var43.intValue() + 5, 16777215, 1.0F, false, false);
               ...
               if(this.conditionsOpened) {
                  ...
                  for(var34 = this.availableConditions.iterator(); var34.hasNext(); var23 += 19) {
                     ...
                     ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
                     ModernGui.drawModalRectWithCustomSizedTexture((float)offset, var43.floatValue(), 433, 1, 74, 19, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("faction.enemy.conditions." + progressDEF), offset + 2, var43.intValue() + 5, 16777215, 1.0F, false, false);
                     if(mouseX >= offset && mouseX <= offset + 74 && (float)mouseY >= var43.floatValue() && (float)mouseY <= var43.floatValue() + 19.0F) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.enemy.reason"), this.guiLeft + 46, this.guiTop + 78, 0, 1.0F, false, false);
            this.drawScaledString(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason")), this.guiLeft + 50, this.guiTop + 94, 16777215, 1.0F, false, false);
            if(warInfos.get("playerTarget") != null && !((String)warInfos.get("playerTarget")).isEmpty()) {
               ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
            ...
            this.drawScaledString(I18n.func_135053_a("faction.enemy.linkForum"), this.guiLeft + 46, this.guiTop + 110, 0, 1.0F, false, false);
            if(!warInfos.get("reason").equals("under_power")) {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.noLinkForum"), this.guiLeft + 50, this.guiTop + 126, 16777215, 1.0F, false, false);
            }

            String[] progressATT = null;
            if(warInfos.get("reason").equals("under_power")) {
               progressATT = I18n.func_135053_a("faction.enemy.status.details.special.under_power").split(" ");
            } else if(!warInfos.get("status").equals("waiting_conditions_att_second")) {
               progressATT = I18n.func_135053_a("faction.enemy.status.details." + warInfos.get("status")).split(" ");
            } else if(warInfos.get("factionATT").equals(warInfos.get("playerFaction"))) {
               progressATT = I18n.func_135053_a("faction.enemy.status.details." + warInfos.get("status") + ".att").split(" ");
            } else {
               progressATT = I18n.func_135053_a("faction.enemy.status.details." + warInfos.get("status") + ".def").split(" ");
            }
            ...
            for(dateString = 0; dateString < simpleDateFormat; ++dateString) {
               ...
               if((double)this.field_73886_k.func_78256_a(progressDEF + totalKills) * 0.9D <= 190.0D) {
            ...
            if(warInfos.get("status").equals("waiting_conditions_att_second") && warInfos.get("factionATT").equals(warInfos.get("playerFaction"))) {
               ClientEventHandler.STYLE.bindTexture(MAIN_TEXTURE);
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 319), (float)(this.guiTop + 12), 319, 12, 102, 222, 512.0F, 512.0F, false);
               this.drawScaledString("\u00a77\u00a7l" + I18n.func_135053_a("faction.enemy.contitions") + " \u00a74\u00a7l" + I18n.func_135053_a("faction.enemy.conditionsType." + warInfos.get("conditionsType_DEF")), this.guiLeft + 326, this.guiTop + 42, 16777215, 1.0F, false, false);
               var31 = 1;
               if(warInfos.get("conditions_DEF") != null) {
                  ...
                  for(var41 = 0; var41 < dateString; ++var41) {
                     finishReward = var35[var41];
                     this.drawScaledString("\u00a7f\u25cf " + finishReward.split("#")[1] + " " + I18n.func_135053_a("faction.enemy.conditions." + finishReward.split("#")[0]), this.guiLeft + 326, this.guiTop + 42 + 10 * var31, 16777215, 1.0F, false, false);
                     ++var31;
                  }
               } else {
                  this.drawScaledString("\u00a7c\u2716 " + I18n.func_135053_a("faction.enemy.none"), this.guiLeft + 326, this.guiTop + 42 + 10, 16777215, 1.0F, false, false);
               ...
               var31 = 1;
               this.drawScaledString("\u00a77\u00a7l" + I18n.func_135053_a("faction.enemy.rewards"), this.guiLeft + 326, this.guiTop + 62 + simpleDateFormat, 16777215, 1.0F, false, false);
                  ...
                  for(int var44 = 0; var44 < var41; ++var44) {
                     ...
                     if(Integer.parseInt(rewardName.split("#")[1]) > 0) {
                        ...
                        if(rewardName.split("#")[0].equals("peace")) {
                           rewardGoal = I18n.func_135053_a("faction.enemy.rewards.valueType.day");
                        }

                        this.drawScaledString("\u00a7f\u25cf " + rewardName.split("#")[1] + rewardGoal + " " + I18n.func_135053_a("faction.enemy.rewards." + rewardName.split("#")[0]), this.guiLeft + 326, this.guiTop + 62 + simpleDateFormat + 10 * var31, 16777215, 1.0F, false, false);
                     } else {
                        this.drawScaledString("\u00a7f\u25cf " + I18n.func_135053_a("faction.enemy.rewards." + rewardName.split("#")[0]), this.guiLeft + 326, this.guiTop + 62 + simpleDateFormat + 10 * var31, 16777215, 1.0F, false, false);
                     }

                     ++var31;
                  }
               } else {
                  this.drawScaledString("\u00a7c\u2716 " + I18n.func_135053_a("faction.enemy.none"), this.guiLeft + 326, this.guiTop + 62 + simpleDateFormat + 10 * var31, 16777215, 1.0F, false, false);
               }
            ...
            if(warInfos.get("status").equals("waiting_validation") && warInfos.get("factionATT").equals(warInfos.get("playerFaction")) && ((Boolean)warInfos.get("hasWarPermInOwnCountry")).booleanValue()) {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.save_request"), this.guiLeft + 245, this.guiTop + 223, 16777215, 1.0F, true, false);
               ...
               this.drawScaledString(I18n.func_135053_a("faction.enemy.refuse_conditions_att_second"), this.guiLeft + 177, this.guiTop + 223, 16777215, 1.0F, true, false);
            }
         }
      }
      ...
      if(mouseButton == 0) {
         ...
         if(!this.hoveredAction.isEmpty()) {
            ...
            if(this.hoveredAction.equals("cancel")) {
               ...
               if(this.hoveredAction.equals("accept_conditions_def")) {
                  ...
                  PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionEnemyRequestUpdateForumPacket(Integer.valueOf(warRequestId), this.linkForumInput.func_73781_b())));
                  this.field_73882_e.func_71373_a(this.guiFrom);
         ...
         if(!this.linkForumInput.func_73781_b().isEmpty() && mouseX >= this.guiLeft + 286 && mouseX <= this.guiLeft + 286 + 20 && mouseY >= this.guiTop + 121 && mouseY <= this.guiTop + 121 + 16 && (this.linkForumInput.func_73781_b().contains("https://nationsglory.fr/forums") || this.linkForumInput.func_73781_b().contains("forum.nationsglory.fr"))) {
            try {
               conditionsString = Class.forName("java.awt.Desktop");
               rewardsString = conditionsString.getMethod("getDesktop", new Class[0]).invoke((Object)null, new Object[0]);
               conditionsString.getMethod("browse", new Class[]{URI.class}).invoke(rewardsString, new Object[]{URI.create(this.linkForumInput.func_73781_b())});
         ...
         if(this.hoveredAction.equals("add_condition") && !this.conditionInput.func_73781_b().isEmpty() && this.isNumeric(this.conditionInput.func_73781_b())) {
            conditionsString1 = Integer.parseInt(this.conditionInput.func_73781_b());
            ...
            this.conditions.put(this.selectedCondition, Integer.valueOf(Integer.parseInt(this.conditionInput.func_73781_b())));
            this.conditionInput.func_73782_a("0");
            this.selectedCondition = (String)this.availableConditions.get(0);
         }
         ...
         if(this.hoveredAction.equals("add_reward") && (!this.rewardInput.func_73781_b().isEmpty() && this.isNumeric(this.rewardInput.func_73781_b()) || this.selectedReward.equals("colonisation"))) {
            if(this.isNumeric(this.rewardInput.func_73781_b())) {
               conditionsString1 = Integer.parseInt(this.rewardInput.func_73781_b());
            ...
            this.rewards.put(this.selectedReward, Integer.valueOf(!this.selectedReward.equals("colonisation")?Integer.parseInt(this.rewardInput.func_73781_b()):0));
            this.rewardInput.func_73782_a("0");
            this.selectedReward = (String)this.availableRewards.get(0);
         }
