...
public class Ltp3Tap extends Ltp
{
    ...
    public final int unquant(float[] var1, int var2, int var3, float var4, int var5, float[] var6, Bits var7, int var8, int var9, float var10)
    {
        ...
        {
            float var17 = Math.abs(this.gain[1]);
            float var18 = var8 < 4 ? var10 : 0.4F * var10;
        ...
        for (var11 = 0; var11 < 3; ++var11)
        {
            ...
            for (var20 = 0; var20 < var181; ++var20)
            {
                this.e[var11][var20] = var1[var2 + var20 - var201];
            }

            for (var20 = var181; var20 < var191; ++var20)
            {
                this.e[var11][var20] = var1[var2 + var20 - var201 - var12];
            }

            for (var20 = var191; var20 < var5; ++var20)
            {
    ...
    private float pitch_gain_search_3tap(float[] var1, float[] var2, float[] var3, float[] var4, float[] var5, int var6, int var7, int var8, int var9, Bits var10, float[] var11, int var12, float[] var13, int[] var14)
    {
        ...
        {
            int var31 = var7 + 1 - var15;

            for (var16 = 0; var16 < var9; ++var16)
            {
                if (var16 - var31 < 0)
                {
                    this.e[var15][var16] = var11[var12 + var16 - var31];
                }
                else if (var16 - var31 - var7 < 0)
                {
                    this.e[var15][var16] = var11[var12 + var16 - var31 - var7];
                }
                else
                {
        ...
        for (var15 = 0; var15 < var20; ++var15)
        {
            var21 = 0.0F;
            int var22 = 3 * var15;
            float var28 = 0.015625F * (float)this.gain_cdbk[var22] + 0.5F;
            float var29 = 0.015625F * (float)this.gain_cdbk[var22 + 1] + 0.5F;
            float var30 = 0.015625F * (float)this.gain_cdbk[var22 + 2] + 0.5F;
            var21 += var301[0] * var28;
            var21 += var301[1] * var29;
            var21 += var301[2] * var30;
            var21 -= var301[3] * var28 * var29;
            var21 -= var301[4] * var30 * var29;
            var21 -= var301[5] * var30 * var28;
            var21 -= 0.5F * var301[6] * var28 * var28;
            var21 -= 0.5F * var301[7] * var29 * var29;
            var21 -= 0.5F * var301[8] * var30 * var30;

            if (var21 > var26 || var15 == 0)
            {
                var26 = var21;
                var25 = var15;
            }
        ...
        for (var15 = 0; var15 < var9; ++var15)
        {
            var311 += (var1[var15] - this.gain[2] * var17[0][var15] - this.gain[1] * var17[1][var15] - this.gain[0] * var17[2][var15]) * (var1[var15] - this.gain[2] * var17[0][var15] - this.gain[1] * var17[1][var15] - this.gain[0] * var17[2][var15]);
        }
