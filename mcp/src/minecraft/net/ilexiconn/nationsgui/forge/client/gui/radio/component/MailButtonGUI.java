...
extends GuiButton {
    ...
    public void func_73737_a(Minecraft mc, int mouseX, int mouseY) {
        ...
        this.func_73729_b(this.field_73746_c, this.field_73743_d, 41 + hoverState * this.field_73747_a, 213, this.field_73747_a, this.field_73745_b);
