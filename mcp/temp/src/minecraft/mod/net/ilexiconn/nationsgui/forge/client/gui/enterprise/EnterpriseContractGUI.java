...
public class EnterpriseContractGUI extends TabbedEnterpriseGUI {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      this.drawScaledString(I18n.func_135053_a("enterprise.contract.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
      ...
      if(contractsInfos.size() > 0) {
         ...
         while(i.hasNext()) {
            ...
            if((this.contractSearch.func_73781_b().isEmpty() || ((String)offsetX.get("clientName")).toLowerCase().contains(this.contractSearch.func_73781_b().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)offsetX.get("status")).equals(this.selectedStatus))) {
               ...
               try {
                  ResourceLocation diffText = AbstractClientPlayer.field_110314_b;
                  diffText = AbstractClientPlayer.func_110311_f((String)offsetX.get("clientName"));
                  AbstractClientPlayer.func_110304_a(diffText, (String)offsetX.get("clientName"));
                  Minecraft.func_71410_x().field_71446_o.func_110577_a(diffText);
                  this.field_73882_e.func_110434_K().func_110577_a(diffText);
               ...
               this.drawScaledString((String)offsetX.get("creationDate"), offsetY + 249 - this.field_73886_k.func_78256_a((String)offsetX.get("creationDate")), offsetY1.intValue() + 5, 16777215, 1.0F, false, false);
               this.drawScaledString(I18n.func_135053_a("enterprise.contract.status." + offsetX.get("status")), offsetY + 4, offsetY1.intValue() + 24, 16777215, 1.0F, false, false);
               String var24 = "";
               ...
               if(((Double)offsetX.get("deadlineTime")).doubleValue() > 0.0D) {
                  ...
                  if(description > 0L) {
                     ...
                     var24 = I18n.func_135053_a("enterprise.contract.ends_in") + var24;
                  } else {
                     var24 = I18n.func_135053_a("enterprise.contract.expired");
                     expired = true;
                  }

                  var24 = var24.trim();
               } else if(((Double)offsetX.get("deadlineTime")).doubleValue() == 0.0D) {
                  var24 = I18n.func_135053_a("enterprise.contract.at_end_assault");
               } else if(((Double)offsetX.get("deadlineTime")).doubleValue() == -10.0D) {
                  var24 = "-";
               }

               this.drawScaledString("\u00a78" + var24, offsetY + 249 - this.field_73886_k.func_78256_a(var24), offsetY1.intValue() + 24, 16777215, 1.0F, false, false);
               if(this.openedContractId.intValue() != -1 && this.openedContractId.intValue() == ((Double)offsetX.get("id")).intValue()) {
                  String var25 = (String)offsetX.get("description");
                  String descriptionWords;
                  if(var25.matches("PVP##.*")) {
                     descriptionWords = I18n.func_135053_a("enterprise.create.text_description.pvp");
                     ...
                     descriptionWords = descriptionWords.replace("<condition>", I18n.func_135053_a("enterprise.contract.condition." + var25.split("##")[6]));
                     var25 = descriptionWords;
                  } else if(var25.matches("REPAIR##.*")) {
                     descriptionWords = I18n.func_135053_a("enterprise.create.text_description.repair");
                     ...
                     descriptionWords = I18n.func_135053_a("enterprise.create.text_description.loan");
                     ...
                     descriptionWords = descriptionWords.replace("<waranty>", I18n.func_135053_a("enterprise.contract.loan.type." + var25.split("##")[5]));
                  ...
                  for(int validButton = 0; validButton < clientName; ++validButton) {
                     ...
                     if((double)this.field_73886_k.func_78256_a(line + invalidButton) * 0.9D <= 245.0D) {
                        if(!line.equals("")) {
                           line = line + " ";
                        }
                  ...
                  if(offsetX.containsKey("items")) {
                     ...
                     for(Iterator var28 = ((ArrayList)offsetX.get("items")).iterator(); var28.hasNext(); ++var26) {
                        ...
                        this.itemRenderer.func_82406_b(this.field_73886_k, Minecraft.func_71410_x().func_110434_K(), stack, offsetY + 4 + 18 * var26, offsetY1.intValue() + 38 + lineNumber * 10 + 10);
                        this.itemRenderer.func_94148_a(this.field_73886_k, Minecraft.func_71410_x().func_110434_K(), stack, offsetY + 4 + 18 * var26, offsetY1.intValue() + 38 + lineNumber * 10 + 10, stack.field_77994_a + "");
                  ...
                  if(var27.contains("dispute_open") && ((Boolean)EnterpriseGui.enterpriseInfos.get("canManageLitige")).booleanValue()) {
                     ...
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.dispute_for_client"), offsetY + 168, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var32 = true;
                     ...
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 140), (float)(offsetY1.intValue() + 82), 121, 270, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.accept"), offsetY + 168, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var32 = true;
                  } else if(var27.equals("in_progress") && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29)) {
                     if(!EnterpriseGui.enterpriseInfos.get("type").equals("trader") && !EnterpriseGui.enterpriseInfos.get("type").equals("repair") && !EnterpriseGui.enterpriseInfos.get("type").equals("loan")) {
                        ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 140), (float)(offsetY1.intValue() + 82), 121, 270, 55, 18, 512.0F, 512.0F, false);
                        this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.validate"), offsetY + 168, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                        var32 = true;
                     } else if(EnterpriseGui.enterpriseInfos.get("type").equals("loan")) {
                        ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 140), (float)(offsetY1.intValue() + 82), 121, 270, 55, 18, 512.0F, 512.0F, false);
                        this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.refund"), offsetY + 168, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                        var32 = true;
                        ...
                        if(this.lastInputX != offsetY + 196 + 3 || this.lastInputY != offsetY1.intValue() + 82 + 6) {
                           ...
                           this.refundInput = new GuiTextField(this.field_73886_k, offsetY + 196 + 3, offsetY1.intValue() + 82 + 6, 54, 10);
                           this.refundInput.func_73786_a(false);
                           this.refundInput.func_73804_f(7);
                  ...
                  } else if(var27.equals("waiting_garant") && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(offsetX.get("garant"))) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 140), (float)(offsetY1.intValue() + 82), 121, 270, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.sign"), offsetY + 168, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var32 = true;
                     this.drawScaledString("\u00a7c" + I18n.func_135053_a("enterprise.contract.label.garant_warning") + " \u00a74" + String.format("%.0f", new Object[]{Double.valueOf(((Double)offsetX.get("price")).doubleValue() / 2.0D)}) + "$", offsetY + 4, offsetY1.intValue() + 87, 16777215, 1.0F, false, false);
                  }
                  ...
                  if(var27.contains("dispute_open") && ((Boolean)EnterpriseGui.enterpriseInfos.get("canManageLitige")).booleanValue()) {
                     ...
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.dispute_for_enterprise"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("waiting_enterprise") && EnterpriseGui.hasPermission("contracts") && ((Boolean)EnterpriseGui.enterpriseInfos.get("isInEnterprise")).booleanValue()) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.decline"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if((var27.equals("waiting_enterprise") || var27.equals("waiting_garant")) && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29)) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.cancel"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("in_progress") && !EnterpriseGui.enterpriseInfos.get("type").equals("trader") && !EnterpriseGui.enterpriseInfos.get("type").equals("repair") && (!EnterpriseGui.enterpriseInfos.get("type").equals("loan") || expired && ((Boolean)EnterpriseGui.enterpriseInfos.get("isInEnterprise")).booleanValue() && EnterpriseGui.hasPermission("contracts")) && (Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29) || EnterpriseGui.hasPermission("contracts"))) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.dispute"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("dispute_open_enterprise") && EnterpriseGui.hasPermission("contracts")) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.cancel"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("dispute_open_client") && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29)) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.cancel"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("in_progress") && EnterpriseGui.enterpriseInfos.get("type").equals("trader") && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29)) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.retire"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if(var27.equals("in_progress") && EnterpriseGui.enterpriseInfos.get("type").equals("repair") && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29)) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.cancel"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                     ...
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.decline"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  } else if((var27.equals("refused") || var27.equals("done")) && Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equals(var29) && offsetX.containsKey("items") && ((ArrayList)offsetX.get("items")).size() > 0) {
                     ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetY + 196), (float)(offsetY1.intValue() + 82), 121, 251, 55, 18, 512.0F, 512.0F, false);
                     this.drawScaledString(I18n.func_135053_a("enterprise.contract.btn_label.get_items"), offsetY + 224, offsetY1.intValue() + 87, 16777215, 1.0F, true, false);
                     var34 = true;
                  }
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.contract.status." + this.selectedStatus), this.guiLeft + 278, this.guiTop + 36, 16777215, 1.0F, false, false);
         if(this.expandStatus) {
            ClientEventHandler.STYLE.bindTexture("enterprise_contract");
            ...
            for(int var21 = 0; var21 < availableStatus.size(); ++var21) {
               ...
               this.drawScaledString(I18n.func_135053_a("enterprise.contract.status." + (String)availableStatus.get(var21)), var22 + 3, var23.intValue() + 5, 16777215, 1.0F, false, false);
