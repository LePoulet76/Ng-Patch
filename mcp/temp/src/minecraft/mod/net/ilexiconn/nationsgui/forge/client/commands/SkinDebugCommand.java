...
public class SkinDebugCommand extends CommandBase {
   ...
   public void func_71515_b(ICommandSender icommandsender, String[] astring) {
      if(astring.length >= 1 && astring[0].equals("reload")) {
         icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("Reloading skins..."));
         ...
         if(skin == null) {
            icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("Skin not found"));
         } else if(astring.length >= 2 && astring[1].equals("reload")) {
            skin.reload();
            icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("Skin reloaded"));
            ...
            case 6:
               ...
               break;
            case 7:
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("S : " + transform.getScale()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("oX : " + transform.getOffsetX()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("oY : " + transform.getOffsetY()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("oZ : " + transform.getOffsetZ()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("rX : " + transform.getRotateX()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("rY : " + transform.getRotateY()));
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("rZ : " + transform.getRotateZ()));
               break;
            default:
               icommandsender.func_70006_a(ChatMessageComponent.func_111066_d("Parameter invalid"));
            }
