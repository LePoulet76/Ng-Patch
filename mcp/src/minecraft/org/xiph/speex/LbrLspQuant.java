...
extends LspQuant {
    ...
    public final void quant(float[] var1, float[] var2, int var3, Bits var4) {
        ...
        int var8 = LbrLspQuant.lsp_quant(var2, 0, Codebook.cdbk_nb, 64, var3);
        var4.pack(var8, 6);
        var5 = 0;
        while (var5 < var3) {
            int n = var5++;
        ...
        var8 = LbrLspQuant.lsp_weight_quant(var2, 0, var9, 0, Codebook.cdbk_nb_low1, 64, 5);
        var4.pack(var8, 6);
        var8 = LbrLspQuant.lsp_weight_quant(var2, 5, var9, 5, Codebook.cdbk_nb_high1, 64, 5);
        var4.pack(var8, 6);
        for (var5 = 0; var5 < var3; ++var5) {
