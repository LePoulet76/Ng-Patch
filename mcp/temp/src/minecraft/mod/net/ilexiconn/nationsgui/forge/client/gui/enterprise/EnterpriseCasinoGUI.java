...
public class EnterpriseCasinoGUI extends TabbedEnterpriseGUI {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      if(loaded) {
         this.drawScaledString(I18n.func_135053_a("enterprise.casino.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
         ...
         ClientEventHandler.STYLE.bindTexture("enterprise_casino");
         this.drawScaledString(I18n.func_135053_a("enterprise.casino.label.benef_moy"), this.guiLeft + 160, this.guiTop + 148, 11842740, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.casino.label.win_percent"), this.guiLeft + 288, this.guiTop + 148, 11842740, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.casino.label.total_play"), this.guiLeft + 160, this.guiTop + 199, 11842740, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.casino.label.total_reward"), this.guiLeft + 288, this.guiTop + 199, 11842740, 1.0F, false, false);
