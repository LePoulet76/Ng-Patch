...
public class DebugGenericGeckoItemRenderer
extends GenericItemGeckoRenderer {
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object ... data) {
        ...
        if (type.equals((Object)IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON)) {
            GL11.glRotated((double)-93.0, (double)0.0, (double)1.0, (double)0.0);
            GL11.glTranslated((double)0.2, (double)-0.2, (double)-0.3);
            ...
            GL11.glTranslated((double)-0.2, (double)-0.65, (double)0.0);
