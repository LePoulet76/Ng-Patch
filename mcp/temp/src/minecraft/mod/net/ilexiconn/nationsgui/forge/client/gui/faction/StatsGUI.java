...
public class StatsGUI extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.stats.title") + " " + this.targetName, this.guiLeft + 51, this.guiTop + 17, 1644825, 1.2F, false, false);
      ClientEventHandler.STYLE.bindTexture("player_stats");
      if(loaded && statsInfos != null && statsInfos.size() > 0) {
         ...
         while(it.hasNext()) {
            ...
            if(pair != null) {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.stats.type." + pair.getKey().toString().toLowerCase()), offsetX, offsetY, 11842740, 1.0F, false, false);
               if(pair.getValue() != null) {
                  ...
                  if(pair.getKey().toString().equals("PLAYTIME")) {
                     ...
                     if(diff < 18000000L) {
                        ...
                        value = "4-8" + I18n.func_135053_a("faction.common.days.short");
                     } else if(diff < 1728000000L) {
                        value = "8-20" + I18n.func_135053_a("faction.common.days.short");
                     } else if(diff < 3456000000L) {
                        value = "20-40" + I18n.func_135053_a("faction.common.days.short");
                     } else if(diff < 5184000000L) {
                        value = "40-60" + I18n.func_135053_a("faction.common.days.short");
                     } else if(diff < 10368000000L) {
                        value = "60-120" + I18n.func_135053_a("faction.common.days.short");
                     } else if(diff < 17280000000L) {
                        value = "120-200" + I18n.func_135053_a("faction.common.days.short");
                     } else {
                        value = "> 200" + I18n.func_135053_a("faction.common.days.short");
                     }
                  }

                  this.drawScaledString(value, offsetX + 193 - this.field_73886_k.func_78256_a(value), offsetY, 16777215, 1.0F, false, false);
               }
