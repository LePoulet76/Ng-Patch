   ...
   public int decode(Bits var1, float[] var2) throws StreamCorruptedException {
      ...
      if(var1 == null && this.dtx_enabled != 0) {
         ...
         while(true) {
            if(var1.unpack(1) != 0) {
               var3 = var1.unpack(3);
               var14 = SbCodec.SB_FRAME_SIZE[var3];
               if(var14 < 0) {
                  throw new StreamCorruptedException("Invalid sideband mode encountered (1st sideband): " + var3);
               }
               ...
               if(var1.unpack(1) != 0) {
                  ...
                  var14 = SbCodec.SB_FRAME_SIZE[var3];
                  if(var14 < 0) {
                     throw new StreamCorruptedException("Invalid sideband mode encountered. (2nd sideband): " + var3);
                  }
            ...
            if(var3 == 14) {
               ...
               throw new StreamCorruptedException("Invalid mode encountered: " + var3);
            }
      ...
      if(this.submodes[this.submodeID] == null) {
         ...
         if(this.count_lost != 0) {
            ...
            float var27 = (float)(0.6D * Math.exp(-0.2D * (double)var26));

            for(var3 = 0; var3 < 2 * this.lpcSize; ++var3) {
               this.mem_sp[var3] *= var27;
            }
         }
         ...
         for(int var4 = 0; var4 < this.nbSubframes; ++var4) {
            var271 = this.subframeSize * var4;
            int var16 = this.frmIdx + var271;
            int var17 = this.excIdx + var271;
            ...
            if(this.enhanced) {
               float var28 = 0.9F;
               float var29 = this.submodes[this.submodeID].lpc_enh_k1;
               var21 = this.submodes[this.submodeID].lpc_enh_k2;
               float var30 = (1.0F - (1.0F - var28 * var29) / (1.0F - var28 * var21)) / var28;
               Filters.bw_lpc(var29, this.interp_qlpc, this.awk1, this.lpcSize);
               Filters.bw_lpc(var21, this.interp_qlpc, this.awk2, this.lpcSize);
               Filters.bw_lpc(var30, this.interp_qlpc, this.awk3, this.lpcSize);
            }
            ...
            int var301;
            if(this.submodes[this.submodeID].lbr_pitch != -1) {
               var301 = this.submodes[this.submodeID].lbr_pitch;
               if(var301 != 0) {
                  var281 = var6 - var301 + 1;
                  if(var281 < this.min_pitch) {
                     var281 = this.min_pitch;
                  }

                  var291 = var6 + var301;
                  if(var291 > this.max_pitch) {
                     var291 = this.max_pitch;
                  }
               } else {
                  var281 = var6;
               }
            ...
            int var5 = this.submodes[this.submodeID].ltp.unquant(this.excBuf, var17, var281, var10, this.subframeSize, var8, var1, this.count_lost, var271, this.last_pitch_gain);
            ...
            if(this.submodes[this.submodeID].have_subframe_gain == 3) {
               var301 = var1.unpack(3);
               var23 = (float)((double)var9 * Math.exp((double)exc_gain_quant_scal3[var301]));
            } else if(this.submodes[this.submodeID].have_subframe_gain == 1) {
               var301 = var1.unpack(1);
               var23 = (float)((double)var9 * Math.exp((double)exc_gain_quant_scal1[var301]));
            } else {
               var23 = var9;
            }
