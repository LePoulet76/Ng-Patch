...
public class CFontRenderer extends CFont {
   ...
   public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
      return this.drawStringWithShadow(text, (double)(x - this.getStringWidth(text) / 2.0F), (double)y, color);
   }
            ...
            for(int i = 0; i < size; ++i) {
               ...
               if(character == 167 && i < size) {
                  ...
                  if(colorIndex < 16) {
                     ...
                     GL11.glColor4f((float)(colorcode >> 16 & 255) / 255.0F, (float)(colorcode >> 8 & 255) / 255.0F, (float)(colorcode & 255) / 255.0F, alpha);
