...
public class CustomShovel extends ItemSpade {
   ...
   public CustomShovel(String name, ItemData data) {
      super(data.getId(), EnumHelper.addToolMaterial(name, data.getHarvestLevel(), data.getDurability(), data.getMiningSpeed(), data.getDamageVsEntities() - 1.0F, data.getEnchantability()));
