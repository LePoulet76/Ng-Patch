...
public class SellCountryConfirmGui extends ModalGui {
   ...
   public void func_73866_w_() {
      super.func_73866_w_();
      this.cancelButton = new GuiButton(0, this.guiLeft + 53, this.guiTop + 95, 118, 20, I18n.func_135053_a("faction.sell.modal.action.cancel"));
      this.confirmButton = new GuiButton(1, this.guiLeft + 183, this.guiTop + 95, 118, 20, I18n.func_135053_a("faction.sell.modal.action.confirm"));
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.sell.modal.action.title"), this.guiLeft + 53, this.guiTop + 16, 1644825, 1.3F, false, false);
      this.drawScaledString(I18n.func_135053_a("faction.sell.modal.action.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
      this.drawScaledString(I18n.func_135053_a("faction.sell.modal.action.text_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(!this.amountInput.func_73781_b().isEmpty() && this.isNumeric(this.amountInput.func_73781_b()) && ((Boolean)FactionGUI.factionInfos.get("isLeader")).booleanValue() && mouseX > this.guiLeft + 183 && mouseX < this.guiLeft + 183 + 118 && mouseY > this.guiTop + 95 && mouseY < this.guiTop + 95 + 20) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionSellCountryPacket((String)FactionGUI.factionInfos.get("id"), Integer.parseInt(this.amountInput.func_73781_b()))));
