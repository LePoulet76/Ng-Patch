...
public class NbEncoder extends NbCodec implements Encoder {
   ...
   public int encode(Bits var1, float[] var2) {
      ...
      if(this.submodes[this.submodeID] != null && this.vbr_enabled == 0 && this.vad_enabled == 0 && this.submodes[this.submodeID].forced_pitch_gain == 0 && this.submodes[this.submodeID].lbr_pitch == -1) {
         ...
         Ltp.open_loop_nbest_pitch(this.swBuf, this.swIdx, this.min_pitch, this.max_pitch, this.frameSize, var11, var16, 6);
         var12 = var11[0];
         var13 = var16[0];

         for(var3 = 1; var3 < 6; ++var3) {
            if((double)var16[var3] > 0.85D * (double)var13 && (Math.abs((double)var11[var3] - (double)var12 / 2.0D) <= 1.0D || Math.abs((double)var11[var3] - (double)var12 / 3.0D) <= 1.0D || Math.abs((double)var11[var3] - (double)var12 / 4.0D) <= 1.0D || Math.abs((double)var11[var3] - (double)var12 / 5.0D) <= 1.0D)) {
               var12 = var11[var3];
            }
         }
      }
      ...
      for(var3 = 0; var3 < this.frameSize; ++var3) {
         var301 += this.excBuf[this.excIdx + var3] * this.excBuf[this.excIdx + var3];
      }

      var301 = (float)Math.sqrt((double)(1.0F + var301 / (float)this.frameSize));
      int var17;
      float var28;
      int var31;
      float var311;
      if(this.vbr != null && (this.vbr_enabled != 0 || this.vad_enabled != 0)) {
         ...
         if(this.vbr_enabled != 0) {
            ...
            for(var31 = 8; var31 > 0; --var31) {
               ...
               float var5;
               if(var17 == 10) {
                  var5 = Vbr.nb_thresh[var31][var17];
               } else {
                  var5 = (this.vbr_quality - (float)var17) * Vbr.nb_thresh[var31][var17 + 1] + ((float)(1 + var17) - this.vbr_quality) * Vbr.nb_thresh[var31][var17];
               }

               if(this.relative_quality > var5 && this.relative_quality - var5 < var311) {
                  var4 = var31;
                  var311 = this.relative_quality - var5;
               }
            }
      ...
      if(this.submodes[this.submodeID] == null) {
         ...
         var31 = (int)Math.floor(0.5D + 3.5D * Math.log((double)var301));
         if(var31 < 0) {
            var31 = 0;
         }
         ...
         var301 = (float)Math.exp((double)var31 / 3.5D);
         var1.pack(var31, 5);
         if(this.first != 0) {
            for(var3 = 0; var3 < this.lpcSize; ++var3) {
         ...
         float[] var321 = new float[this.subframeSize];
         float[] var331 = new float[this.subframeSize];
         ...
         for(var31 = 0; var31 < this.nbSubframes; ++var31) {
            ...
            Filters.filter_mem2(this.excBuf, var19, this.bw_lpc1, this.bw_lpc2, var321, 0, this.subframeSize, this.lpcSize, var6, 0);
            ...
            for(var3 = 0; var3 < this.subframeSize; ++var3) {
               var331[var3] = this.swBuf[var33 + var3] - var321[var3];
            }
            ...
            int var21 = this.submodes[this.submodeID].ltp.quant(var331, this.swBuf, var33, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.excBuf, var19, var22, var23, var13, this.lpcSize, this.subframeSize, var1, this.exc2Buf, var20, var7, this.complexity);
            this.pitch[var31] = var21;
            Filters.syn_percep_zero(this.excBuf, var19, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, var321, this.subframeSize, this.lpcSize);

            for(var3 = 0; var3 < this.subframeSize; ++var3) {
               var331[var3] -= var321[var3];
            }
            ...
            Filters.residue_percep_zero(var331, 0, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.buf2, this.subframeSize, this.lpcSize);
            ...
            if(this.submodes[this.submodeID].have_subframe_gain != 0) {
               ...
               if(this.submodes[this.submodeID].have_subframe_gain == 3) {
                  var26 = VQ.index(var25, exc_gain_quant_scal3, 8);
                  var1.pack(var26, 3);
                  var25 = exc_gain_quant_scal3[var26];
               } else {
                  var26 = VQ.index(var25, exc_gain_quant_scal1, 2);
                  var1.pack(var26, 1);
                  var25 = exc_gain_quant_scal1[var26];
               }
            ...
            var25 *= var301;
            float var341 = 1.0F / var25;

            for(var3 = 0; var3 < this.subframeSize; ++var3) {
               var331[var3] *= var341;
            }

            this.submodes[this.submodeID].innovation.quant(var331, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.lpcSize, this.subframeSize, this.innov, var24, var7, var1, this.complexity);
            ...
            if(this.submodes[this.submodeID].double_codebook != 0) {
               ...
               for(var3 = 0; var3 < this.subframeSize; ++var3) {
                  var331[var3] = (float)((double)var331[var3] * 2.2D);
               }

               this.submodes[this.submodeID].innovation.quant(var331, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.lpcSize, this.subframeSize, var34, 0, var7, var1, this.complexity);
         ...
         var311 = (float)(10.0D * Math.log((double)((var28 + 1.0F) / (var30 + 1.0F))));
         var2[0] = this.frmBuf[this.frmIdx] + this.preemph * this.pre_mem2;
   ...
   public void setAbr(int var1) {
      ...
      float var51 = (float)var2;
      if(var51 < 0.0F) {
         var51 = 0.0F;
      }

      this.setVbrQuality(var51);
      this.abr_count = 0.0F;
      this.abr_drift = 0.0F;
