...
public class ItemStackMarketStatsPacket implements IPacket, IClientPacket {
   ...
   public void handleClientPacket(EntityPlayer player) {
      XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(884)).height(225)).title(I18n.func_135053_a("hdv.CHART1_TEXTURE.title"))).build();
      ...
      CategoryChart chart2 = ((CategoryChartBuilder)((CategoryChartBuilder)((CategoryChartBuilder)(new CategoryChartBuilder()).width(884)).height(225)).title(I18n.func_135053_a("hdv.CHART2_TEXTURE.title"))).build();
      ...
      if(guiScreen instanceof MarketGui) {
         ...
         if(marketSale != null) {
            Minecraft.func_71410_x().func_71373_a(new StatsGui(sellItemGUI, marketSale.getItemStack()));
         }
      } else if(guiScreen instanceof SellItemGUI) {
         SellItemGUI sellItemGUI1 = (SellItemGUI)guiScreen;
         Minecraft.func_71410_x().func_71373_a(new StatsGui(guiScreen, sellItemGUI1.getItemStack()));
      }
