...
public class WarzonesGui_OLD extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      GL11.glTranslatef((float)(-(this.guiLeft + 14)), (float)(-(this.guiTop + 148)), 0.0F);
      this.drawScaledString(I18n.func_135053_a("warzones.title"), this.guiLeft + 14, this.guiTop + 148, 16777215, 1.5F, false, false);
      GL11.glPopMatrix();
      ...
      if(loaded && bateauInfos != null && petrolInfos != null) {
         ...
         ClientEventHandler.STYLE.bindTexture("warzones");
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 57 + this.field_73886_k.func_78256_a(bonus) + 5), (float)(this.guiTop + 90), 96, 175, 10, 11, 512.0F, 512.0F, false);
         if(mouseX >= this.guiLeft + 57 + this.field_73886_k.func_78256_a(bonus) + 5 && mouseX <= this.guiLeft + 57 + this.field_73886_k.func_78256_a(bonus) + 5 + 10 && mouseY >= this.guiTop + 90 && mouseY <= this.guiTop + 90 + 11) {
            tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("warzones.infos." + (String)bateauInfos.get("type") + "_1"), I18n.func_135053_a("warzones.infos." + (String)bateauInfos.get("type") + "_2"), I18n.func_135053_a("warzones.infos." + (String)bateauInfos.get("type") + "_3")});
         }

         this.drawScaledString(I18n.func_135053_a("warzones.claim_by"), this.guiLeft + 57, this.guiTop + 105, 11842740, 1.0F, false, false);
         ...
         if(mouseX >= this.guiLeft + 56 && mouseX <= this.guiLeft + 150 && mouseY >= this.guiTop + 133 && mouseY <= this.guiTop + 148) {
            if(!((String)bateauInfos.get("tpLeft")).equals("0")) {
               if(Integer.parseInt((String)bateauInfos.get("tpLeft")) <= 7) {
                  tooltipToDraw = Arrays.asList(new String[]{"\u00a7a" + (String)bateauInfos.get("tpLeft") + " " + I18n.func_135053_a("warzones.teleport_remaining")});
               }
            } else {
               tooltipToDraw = Arrays.asList(new String[]{"\u00a7c" + I18n.func_135053_a("warzones.teleport_unavailable")});
            }
         ...
         this.drawScaledString(I18n.func_135053_a("warzones.teleport"), this.guiLeft + 103, this.guiTop + 137, 16777215, 1.0F, true, false);
         ...
         ClientEventHandler.STYLE.bindTexture("warzones");
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 175 + this.field_73886_k.func_78256_a(bonus) + 5), (float)(this.guiTop + 90), 96, 175, 10, 11, 512.0F, 512.0F, false);
         if(mouseX >= this.guiLeft + 175 + this.field_73886_k.func_78256_a(bonus) + 5 && mouseX <= this.guiLeft + 175 + this.field_73886_k.func_78256_a(bonus) + 5 + 10 && mouseY >= this.guiTop + 90 && mouseY <= this.guiTop + 90 + 11) {
            tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("warzones.infos." + (String)petrolInfos.get("type") + "_1"), I18n.func_135053_a("warzones.infos." + (String)petrolInfos.get("type") + "_2"), I18n.func_135053_a("warzones.infos." + (String)petrolInfos.get("type") + "_3")});
         }

         this.drawScaledString(I18n.func_135053_a("warzones.claim_by"), this.guiLeft + 175, this.guiTop + 105, 11842740, 1.0F, false, false);
         ...
         if(mouseX >= this.guiLeft + 174 && mouseX <= this.guiLeft + 268 && mouseY >= this.guiTop + 133 && mouseY <= this.guiTop + 148) {
            if(!((String)petrolInfos.get("tpLeft")).equals("0")) {
               if(Integer.parseInt((String)petrolInfos.get("tpLeft")) <= 7) {
                  tooltipToDraw = Arrays.asList(new String[]{"\u00a7a" + (String)petrolInfos.get("tpLeft") + " " + I18n.func_135053_a("warzones.teleport_remaining")});
               }
            } else {
               tooltipToDraw = Arrays.asList(new String[]{"\u00a7c" + I18n.func_135053_a("warzones.teleport_unavailable")});
            }
         ...
         this.drawScaledString(I18n.func_135053_a("warzones.teleport"), this.guiLeft + 221, this.guiTop + 137, 16777215, 1.0F, true, false);
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(mouseX > this.guiLeft - 23 && mouseX < this.guiLeft - 23 + 23 && mouseY > this.guiTop + 61 && mouseY < this.guiTop + 61 + 30) {
            Minecraft.func_71410_x().func_71373_a(new WarzonesLeaderboardGui_OLD());
         }
