...
public abstract class AbstractActionTag extends AbstractChatTag
{
    ...
    public AbstractActionTag(Map<String, String> parameters) throws Exception
    {
        ...
        if (id != null)
        {
            ...
            this.tagCompound.setString("id", id);
            ...
            while (var4.hasNext())
            {
                ...
                data.setString((String)entry.getKey(), (String)entry.getValue());
            }

            this.tagCompound.setTag("data", data);
        }
    }
    ...
    protected void doAction()
    {
        ...
        {
            NotificationManager.executeAction(Minecraft.getMinecraft().thePlayer, this.tagCompound.getString("id"), this.tagCompound.getCompoundTag("data"));
        }
    }
}
