...
public class CountrySkillsGUI_OLD extends TabbedFactionGUI_OLD {
   ...
   public void func_73866_w_() {
      ...
      this.dashBoardButton = new GuiButton(0, this.guiLeft + 10, this.guiTop + 168, 100, 20, I18n.func_135053_a("faction.skills.button.dashboard"));
      this.playersLeaderboardButton = new GuiButton(1, this.guiLeft + 10, this.guiTop + 193, 100, 20, I18n.func_135053_a("faction.skills.button.players_leaderboard"));
      this.countriesLeaderboardButton = new GuiButton(2, this.guiLeft + 10, this.guiTop + 218, 100, 20, I18n.func_135053_a("faction.skills.button.countries_leaderboard"));
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.skills.title"), this.guiLeft + 131, this.guiTop + 16, 1644825, 1.4F, false, false);
      String playerName;
      int offsetX1;
      int var24;
      if(this.displayMode.equalsIgnoreCase("dashboard") && loaded_dashboard) {
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.label.score"), this.guiLeft + 137, this.guiTop + 40, 16777215, 0.8F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.label.leaderboard"), this.guiLeft + 197, this.guiTop + 40, 16777215, 0.8F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.label.global_note"), this.guiLeft + 137, this.guiTop + 70, 16777215, 0.8F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.label.country_type." + playerName), this.guiLeft + 137, this.guiTop + 103, 16777215, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("faction_skills");
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 141 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.skills.label.country_type." + playerName))), (float)(this.guiTop + 99), getSkillIonX(playerName), 287, 15, 15, 512.0F, 512.0F, false);
         var24 = 0;
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.label.top_members"), this.guiLeft + 340, this.guiTop + 132, 0, 1.0F, true, false);
         offsetX1 = 0;
         ...
         for(Iterator var28 = ((ArrayList)dashboardData.get("top5Members")).iterator(); var28.hasNext(); ++offsetX1) {
            ...
            if(!cacheHeadPlayer.containsKey(playerName1)) {
               try {
                  ResourceLocation e1 = AbstractClientPlayer.field_110314_b;
                  e1 = AbstractClientPlayer.func_110311_f(playerName1);
                  AbstractClientPlayer.func_110304_a(e1, playerName1);
                  cacheHeadPlayer.put(playerName1, e1);
               } catch (Exception var16) {
                  System.out.println(var16.getMessage());
               }
            } else {
               Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)cacheHeadPlayer.get(playerName1));
               this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)cacheHeadPlayer.get(playerName1));
         ...
         this.drawScaledString(I18n.func_135053_a("faction.skills.title." + this.displayMode), this.guiLeft + 131, this.guiTop + 39, 1644825, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("faction_skills");
         ...
         if(this.displayMode.equalsIgnoreCase("countries_leaderboard") && loaded_countries_leaderboard) {
            ...
            if(ClientProxy.flagsTexture.containsKey((String)FactionGui_OLD.factionInfos.get("name"))) {
               GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)FactionGui_OLD.factionInfos.get("name"))).func_110552_b());
            ...
            for(var18 = 0; var18 < ((List)countriesLeaderboard.get(this.selectedSkillLeaderboard)).size(); ++var18) {
               ...
               if(ClientProxy.flagsTexture.containsKey(offsetY)) {
                  GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(offsetY)).func_110552_b());
               ...
               this.drawScaledString(playerName, var24 + 253 - this.field_73886_k.func_78256_a(playerName) - 15, var25.intValue() + 6, 16777215, 1.0F, false, false);
            }
            ...
            if(!cacheHeadPlayer.containsKey(Minecraft.func_71410_x().field_71439_g.field_71092_bJ)) {
               try {
                  ResourceLocation i = AbstractClientPlayer.field_110314_b;
                  i = AbstractClientPlayer.func_110311_f(Minecraft.func_71410_x().field_71439_g.field_71092_bJ);
                  AbstractClientPlayer.func_110304_a(i, Minecraft.func_71410_x().field_71439_g.field_71092_bJ);
                  cacheHeadPlayer.put(Minecraft.func_71410_x().field_71439_g.field_71092_bJ, i);
               } catch (Exception var15) {
                  System.out.println(var15.getMessage());
               }
            } else {
               Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)cacheHeadPlayer.get(Minecraft.func_71410_x().field_71439_g.field_71092_bJ));
               this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)cacheHeadPlayer.get(Minecraft.func_71410_x().field_71439_g.field_71092_bJ));
               GUIUtils.drawScaledCustomSizeModalRect(this.guiLeft + 148, this.guiTop + 73, 8.0F, 16.0F, 8, -8, -12, -12, 64.0F, 64.0F);
            }

            this.drawScaledString(Minecraft.func_71410_x().field_71439_g.field_71092_bJ.toUpperCase(), this.guiLeft + 155, this.guiTop + 63, 16777215, 1.0F, false, false);
            ...
            this.drawScaledString(var17, this.guiLeft + 380 - this.field_73886_k.func_78256_a(var17), this.guiTop + 63, 16777215, 1.0F, false, false);
            GUIUtils.startGLScissor(this.guiLeft + 132, this.guiTop + 83, 253, 138);
            ...
            for(offsetX = 0; offsetX < ((List)playersLeaderboard.get(this.selectedSkillLeaderboard)).size(); ++offsetX) {
               ...
               if(!cacheHeadPlayer.containsKey(playerName)) {
                  ...
                  Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)cacheHeadPlayer.get(playerName));
                  this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)cacheHeadPlayer.get(playerName));
               ...
               this.drawScaledString(String.format("%.0f", new Object[]{Double.valueOf(Double.parseDouble(score))}), offsetX1 + 253 - this.field_73886_k.func_78256_a(String.format("%.0f", new Object[]{Double.valueOf(Double.parseDouble(score))})) - 15, offsetY1.intValue() + 6, 16777215, 1.0F, false, false);
            }
            ...
            this.drawScaledString(I18n.func_135053_a("faction.skills.label.only_country"), this.guiLeft + 145, this.guiTop + 228, 1644825, 1.0F, false, false);
         }
         ...
         this.drawScaledString(I18n.func_135053_a("skills.skill." + this.selectedSkillLeaderboard), this.guiLeft + 289, this.guiTop + 39, 16777215, 1.0F, false, false);
         if(this.skillSelectorOpen) {
            ...
            for(var18 = 0; var18 < skillsList.size(); ++var18) {
               ...
               this.drawScaledString(I18n.func_135053_a("skills.skill." + (String)skillsList.get(var18)), offsetX + 5, var22.intValue() + 5, 16777215, 1.0F, false, false);
