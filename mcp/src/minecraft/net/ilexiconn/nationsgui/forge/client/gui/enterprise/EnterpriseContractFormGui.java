...
import net.ilexiconn.nationsgui.forge.server.packet.impl.EnterpriseContractCreatePacket;
...
public class EnterpriseContractFormGui extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            GuiTextField lineTextField = new GuiTextField(this.fontRenderer, this.guiLeft + 200, this.guiTop + 65 + i * 10, 160, 10);
            lineTextField.setEnableBackgroundDrawing(false);
            lineTextField.setMaxStringLength(26);
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        String var9 = I18n.getString("enterprise.type." + ((String)EnterpriseGui.enterpriseInfos.get("type")).toLowerCase());
        ClientEventHandler.STYLE.bindTexture("enterprise_main");
        ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 280 - this.fontRenderer.getStringWidth(var9) / 2 - 7 - 4), (float)(this.guiTop + 23), EnterpriseGui.getTypeOffsetX((String)EnterpriseGui.enterpriseInfos.get("type")), 442, 16, 16, 512.0F, 512.0F, false);
        ...
        this.drawScaledString(I18n.getString("enterprise.contract.label.demand"), this.guiLeft + 197, this.guiTop + 53, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
        ...
        this.drawScaledString(I18n.getString("enterprise.contract.label.price"), this.guiLeft + 197, this.guiTop + 151, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
        ...
        this.drawScaledString(I18n.getString("enterprise.contract.label.delay"), this.guiLeft + 282, this.guiTop + 151, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
        ...
        {
            this.drawScaledString(I18n.getString("enterprise.contract.delay." + this.selectedDelay), this.guiLeft + 285, this.guiTop + 166, 16777215, 1.0F, false, false);
        }
        ...
        if (this.delayExpanded)
        {
            ...
            for (i = 0; i < this.delays.size(); ++i)
            {
                ...
                this.drawScaledString(I18n.getString("enterprise.contract.delay." + (String)this.delays.get(i)), offsetX + 2, var12.intValue() + 5, 16777215, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            if (this.validButton.enabled && !this.delayExpanded && this.isNumeric(this.priceInput.getText()) && mouseX > this.guiLeft + 282 && mouseX < this.guiLeft + 282 + 80 && mouseY > this.guiTop + 197 && mouseY < this.guiTop + 197 + 20)
            {
                this.mc.sndManager.playSoundFX("random.click", 1.0F, 1.0F);
                String description = "";
                GuiTextField lineTextField1;

                for (Iterator lineTextField = this.linesTextField.iterator(); lineTextField.hasNext(); description = description + " " + lineTextField1.getText())
                {
                ...
                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseContractCreatePacket((String)EnterpriseGui.enterpriseInfos.get("name"), description, Integer.valueOf(Integer.parseInt(this.priceInput.getText())), lineTextField2)));
        ...
        while (description1.hasNext())
        {
            ...
            lineTextField4.mouseClicked(mouseX, mouseY, mouseButton);
        }
