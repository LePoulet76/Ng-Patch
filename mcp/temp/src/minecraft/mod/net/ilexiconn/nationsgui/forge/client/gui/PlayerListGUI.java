...
public class PlayerListGUI extends Gui {
   ...
   public void renderPlayerList(ScaledResolution resolution) {
      ...
      List allInfoList = clientHandler.field_72559_c;
      ...
      while(offsetYStaff.hasNext()) {
         ...
         ScorePlayerTeam animDuration = this.mc.field_71441_e.func_96441_U().func_96509_i(totalHeight.field_78831_a);
         String offsetYCountry = ScorePlayerTeam.func_96667_a(animDuration, totalHeight.field_78831_a);
         ...
         for(xPos = 0; xPos < animDurationCountry.length(); ++xPos) {
            ...
            if(yPos == ChatTagManager.REF_CHAR) {
               if(i.length() > 0) {
                  xIndex += this.mc.field_71466_p.func_78256_a(i.toString());
                  i = new StringBuilder();
               }
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.tab.staff"), (float)(resolution.func_78326_a() / 2 - 240), 6.0F, 16777215, 0.5F, "left", true, "minecraftDungeons", 22);
      ModernGui.drawScaledStringCustomFont(orderedStaffInfoList.size() + "", (float)(resolution.func_78326_a() / 2 - 240 + 4) + this.dg22.getStringWidth(I18n.func_135053_a("overlay.tab.staff")) * 0.5F, 7.0F, 12237530, 0.5F, "left", true, "georamaSemiBold", 28);
      ModernGui.glColorHex(-1289411259, 1.0F);
      ModernGui.drawRoundedRectangle((float)(resolution.func_78326_a() / 2 - 240), 17.0F, this.field_73735_i, 119.0F, 107.0F);
      float var51 = 0.0F;
      ...
      for(int var54 = 0; var54 < Math.min(60, orderedStaffInfoList.size()); ++var54) {
         int var56 = resolution.func_78326_a() / 2 - 240 + 5;
         var58 = (float)(22 + var54 * 9) - var51;
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         GL11.glEnable(3042);
         GuiPlayerInfo var59 = (GuiPlayerInfo)orderedStaffInfoList.get(var54);
         String var62 = var59.field_78831_a.split(" ")[var59.field_78831_a.split(" ").length - 1];
         ScorePlayerTeam var61 = this.mc.field_71441_e.func_96441_U().func_96509_i(var59.field_78831_a);
         var64 = ScorePlayerTeam.func_96667_a(var61, var59.field_78831_a);
         ...
         for(int tuple = 0; tuple < var71.length(); ++tuple) {
            ...
            if(nameToDisplay == ChatTagManager.REF_CHAR) {
               if(playerName.length() > 0) {
                  ...
                  team += this.mc.field_71466_p.func_78256_a(stringBuilder);
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.tab.my_country"), (float)(resolution.func_78326_a() / 2 - 240), 128.0F, 16777215, 0.5F, "left", true, "minecraftDungeons", 22);
      ModernGui.drawScaledStringCustomFont(countryInfoList.size() + "", (float)(resolution.func_78326_a() / 2 - 240 + 4) + this.dg22.getStringWidth(I18n.func_135053_a("overlay.tab.my_country")) * 0.5F, 129.0F, 12237530, 0.5F, "left", true, "georamaSemiBold", 28);
      ModernGui.glColorHex(-1289411259, 1.0F);
      ModernGui.drawRoundedRectangle((float)(resolution.func_78326_a() / 2 - 240), 139.0F, this.field_73735_i, 119.0F, 67.0F);
      ...
      for(var60 = 0; var60 < Math.min(60, countryInfoList.size()); ++var60) {
         xIndex = resolution.func_78326_a() / 2 - 240 + 5;
         float var63 = (float)(143 + var60 * 9) - var55;
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         GL11.glEnable(3042);
         GuiPlayerInfo var67 = (GuiPlayerInfo)countryInfoList.get(var60);
         String var68 = var67.field_78831_a.split(" ")[var67.field_78831_a.split(" ").length - 1];
         ...
         if(ClientEventHandler.playersFaction.containsKey(var68) && !((String)ClientEventHandler.playersFaction.get(var68)).equals("")) {
            ...
            if(ClientProxy.flagsTexture.containsKey(ClientEventHandler.playersFaction.get(var68))) {
               GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(ClientEventHandler.playersFaction.get(var68))).func_110552_b());
               ModernGui.drawScaledCustomSizeModalRect((float)xIndex, var63, 0.0F, 0.0F, 156, 78, 11, 7, 156.0F, 78.0F, false);
               xIndex += 13;
            }
         }

         ScorePlayerTeam var72 = this.mc.field_71441_e.func_96441_U().func_96509_i(var67.field_78831_a);
         var74 = ScorePlayerTeam.func_96667_a(var72, var67.field_78831_a);
         ...
         for(xOffset = 0; xOffset < var76.length(); ++xOffset) {
            ...
            if(tagIndex == ChatTagManager.REF_CHAR) {
               if(var78.length() > 0) {
                  ...
                  var79 += this.mc.field_71466_p.func_78256_a(j);
      ...
      GUIUtils.endGLScissor();
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("overlay.tab.players"), (float)(resolution.func_78326_a() / 2 - 118), 6.0F, 16777215, 0.5F, "left", true, "minecraftDungeons", 22);
      ModernGui.drawScaledStringCustomFont(orderedPlayerInfoList.size() + "", (float)(resolution.func_78326_a() / 2 - 118 + 4) + this.dg22.getStringWidth(I18n.func_135053_a("overlay.tab.players")) * 0.5F, 6.7F, 12237530, 0.5F, "left", true, "georamaSemiBold", 28);
      ModernGui.glColorHex(-1289411259, 1.0F);
      ModernGui.drawRoundedRectangle((float)(resolution.func_78326_a() / 2 - 118), 17.0F, this.field_73735_i, 360.0F, 189.0F);

      for(var60 = 0; var60 < Math.min(60, var50.size()); ++var60) {
         xIndex = var60 % 3;
         yIndex = var60 / 3;
         xPos = resolution.func_78326_a() / 2 - 118 + 5 + xIndex * 115;
         int var70 = 22 + yIndex * 9;
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         GL11.glEnable(3042);
         GuiPlayerInfo var73 = (GuiPlayerInfo)var50.get(var60);
         var74 = var73.field_78831_a.split(" ")[var73.field_78831_a.split(" ").length - 1];
         ...
         if(ClientEventHandler.playersFaction.containsKey(var74) && !((String)ClientEventHandler.playersFaction.get(var74)).equals("")) {
            ...
            if(ClientProxy.flagsTexture.containsKey(ClientEventHandler.playersFaction.get(var74))) {
               GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(ClientEventHandler.playersFaction.get(var74))).func_110552_b());
               ModernGui.drawScaledCustomSizeModalRect((float)xPos, (float)var70, 0.0F, 0.0F, 156, 78, 11, 7, 156.0F, 78.0F, false);
               xPos += 13;
            }
         }

         ScorePlayerTeam var77 = this.mc.field_71441_e.func_96441_U().func_96509_i(var73.field_78831_a);
         var76 = ScorePlayerTeam.func_96667_a(var77, var73.field_78831_a);
         ...
         for(int var93 = 0; var93 < var85.length(); ++var93) {
            ...
            if(var94 == ChatTagManager.REF_CHAR) {
               if(var87.length() > 0) {
                  ...
                  xOffset += this.mc.field_71466_p.func_78256_a(chatTag);
      ...
      ModernGui.drawScaledStringCustomFont("NATIONSGLORY " + ClientProxy.currentServerName.toUpperCase(), (float)(resolution.func_78326_a() / 2 - 118 + 360), 6.0F, 16777215, 0.4F, "right", true, "minecraftDungeons", 30);
   }
   ...
   private void drawPing(int x, int width, int y, GuiPlayerInfo playerInfo) {
      ...
      if(playerInfo.field_78829_b == -42) {
         ...
         byte ping;
         if(playerInfo.field_78829_b < 0) {
            ping = 5;
         } else if(playerInfo.field_78829_b < 150) {
            ping = 0;
         } else if(playerInfo.field_78829_b < 300) {
            ping = 1;
         } else if(playerInfo.field_78829_b < 600) {
            ping = 2;
         } else if(playerInfo.field_78829_b < 1000) {
            ping = 3;
         } else {
            ping = 4;
         }
