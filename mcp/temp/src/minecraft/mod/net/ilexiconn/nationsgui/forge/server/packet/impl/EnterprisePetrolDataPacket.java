...
import net.ilexiconn.nationsgui.forge.server.packet.impl.EnterprisePetrolDataPacket$1;
import net.ilexiconn.nationsgui.forge.server.packet.impl.EnterprisePetrolDataPacket$2;
...
public class EnterprisePetrolDataPacket implements IPacket, IClientPacket {
   ...
   public EnterprisePetrolDataPacket(String targetName) {
      this.enterpriseName = targetName;
   }

   public void fromBytes(ByteArrayDataInput data) {
      this.infos = (HashMap)(new Gson()).fromJson(data.readUTF(), (new EnterprisePetrolDataPacket$1(this)).getType());
      GsonBuilder gsonBuilder = new GsonBuilder();
      gsonBuilder.registerTypeAdapter(Date.class, new DateDeserializer());
      Gson gson = gsonBuilder.create();
      Type type = (new EnterprisePetrolDataPacket$2(this)).getType();
   ...
   public void handleClientPacket(EntityPlayer player) {
      XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(496)).height(190)).title(I18n.func_135053_a("enterprise.STATS_TEXTURE.petrol.title"))).build();
      ...
      this.loadChartTexture(chart, EnterprisePetrolGUI.STATS_TEXTURE);
      EnterprisePetrolGUI.enterprisePetrolInfos = this.infos;
      EnterprisePetrolGUI.loaded = true;
   }
