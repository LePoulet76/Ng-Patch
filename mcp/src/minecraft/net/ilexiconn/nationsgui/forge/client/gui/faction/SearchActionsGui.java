...
extends GuiScreen {
    ...
    public SearchActionsGui() {
        loaded = false;
    }

    public void func_73866_w_() {
        super.func_73866_w_();
        PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionSearchActionsDataPacket()));
    ...
    public void func_73863_a(int mouseX, int mouseY, float par3) {
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.search_actions.title"), this.guiLeft + 50, this.guiTop + 20, 0x191919, 1.0f, false, false);
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.search.level"), this.guiLeft + 51 + 80, this.guiTop + 50, 0x191919, 0.9f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.search.nb_actions"), this.guiLeft + 51 + 130, this.guiTop + 50, 0x191919, 0.9f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.search.price_actions"), this.guiLeft + 51 + 195, this.guiTop + 50, 0x191919, 0.9f, false, false);
        if (loaded && countries.size() > 0) {
            ...
            for (int i = 0; i < countries.size(); ++i) {
                if ((!this.open_filter || this.open_filter && countries.get(i).get("open").equals("true")) && (this.searchText.isEmpty() || !this.searchText.isEmpty() && countries.get(i).get("name").toLowerCase().contains(this.searchText.toLowerCase()))) {
                    ...
                    this.drawScaledString(countries.get(i).get("name").length() < 14 ? countries.get(i).get("name") : countries.get(i).get("name").substring(0, 13) + "..", offsetX + 5, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
                    this.drawScaledString(countries.get(i).get("level"), offsetX + 80, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
                    this.drawScaledString(countries.get(i).get("nb_actions"), offsetX + 130, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
                    this.drawScaledString(countries.get(i).get("price_actions") + "$", offsetX + 195, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
    ...
    protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
        ...
        if (mouseButton == 0) {
            ...
            if (this.hoveredCountry != null && !this.hoveredCountry.isEmpty()) {
                ...
                PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionMainDataPacket(this.hoveredCountry.get("name"), true)));
                this.field_73882_e.func_71373_a((GuiScreen)new ActionsGUI((EntityPlayer)Minecraft.func_71410_x().field_71439_g));
            }
