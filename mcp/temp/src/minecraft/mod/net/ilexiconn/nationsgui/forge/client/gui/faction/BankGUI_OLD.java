...
public class BankGUI_OLD extends TabbedFactionGUI_OLD {
   ...
   public void func_73866_w_() {
      ...
      this.chestButton = new GuiButton(0, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.func_135053_a("faction.bank.chest_button"));
      this.actionButton = new GuiButton(1, this.guiLeft + 10, this.guiTop + 188, 100, 20, I18n.func_135053_a("faction.bank.action_button"));
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      if(loaded) {
         this.drawScaledString(I18n.func_135053_a("faction.bank.title") + " " + FactionGui_OLD.factionInfos.get("name"), this.guiLeft + 259, this.guiTop + 25, 3818599, 1.7F, true, false);
         this.drawScaledString(factionBankInfos.get("bank") + "$", this.guiLeft + 257, this.guiTop + 107, 16777215, 1.5F, true, false);
         this.drawScaledString(I18n.func_135053_a("faction.bank.members"), this.guiLeft + 130, this.guiTop + 132, 3818599, 0.8F, false, false);
         ...
         if(!this.chestButton.field_73742_g && mouseX > this.guiLeft + 10 && mouseX < this.guiLeft + 10 + 100 && mouseY > this.guiTop + 165 && mouseY < this.guiTop + 165 + 20) {
            this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.bank.chest_disabled_1"), I18n.func_135053_a("faction.bank.chest_disabled_2"), I18n.func_135053_a("faction.bank.chest_disabled_3"), I18n.func_135053_a("faction.bank.chest_disabled_4"), I18n.func_135053_a("faction.bank.chest_disabled_5")}), mouseX, mouseY + 20, this.field_73886_k);
         }
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0 && FactionGui_OLD.factionInfos != null) {
         ...
         if(mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 188 && mouseY <= this.guiTop + 188 + 20) {
            Minecraft.func_71410_x().func_71373_a(new BankActionGui(this.player, this));
         }
   ...
   public void drawTooltip(String playerName, int mouseX, int mouseY) {
      ...
      if(!playerName.contains("Action de")) {
         this.drawHoveringText(Arrays.asList(new String[]{playerName}), mouseX, mouseY, this.field_73886_k);
      } else {
         this.drawHoveringText(Arrays.asList(new String[]{playerName}), mouseX, mouseY, this.field_73886_k);
      }
