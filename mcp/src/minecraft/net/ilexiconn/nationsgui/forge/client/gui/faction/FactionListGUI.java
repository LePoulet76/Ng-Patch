...
public class FactionListGUI extends TabbedFactionListGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.list_countries"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
        ...
        for (int countryExtraData = 0; countryExtraData < addSeparatorForReferentCountries; ++countryExtraData)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.tab." + action.name().toLowerCase()), (float)(this.guiLeft + 42 + 55 * index + 26), (float)(this.guiTop + 39), this.activeTab.equals(action) ? 7239406 : 14342893, 0.5F, "center", false, "georamaSemiBold", 26);
        ...
        ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.list.label.countries"), (float)(this.guiLeft + 50), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
        ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.list.label.rank"), (float)(this.guiLeft + 147), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
        ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.list.label.level"), (float)(this.guiLeft + 179), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
        ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.getString("faction.list.label.column4." + this.activeTab.name().toLowerCase()), (float)(this.guiLeft + 222), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
        this.foundReferent = false;
        boolean var13 = false;
        boolean var14 = false;
        ...
        if (countriesData.size() > 0)
        {
            ...
            while (var15.hasNext())
            {
                ...
                if ((this.searchInput.getText().isEmpty() || ((String)var17.get("name")).toLowerCase().contains(this.searchInput.getText().toLowerCase())) && (!this.activeTab.equals(FactionListGUI$TAB.BUY) || !((String)var17.get("price")).equals("-1")) && (!this.activeTab.equals(FactionListGUI$TAB.JOIN) || ((String)var17.get("recruitment")).equals("true") && !((String)var17.get("recruter_online")).equals("true")) && (!this.activeTab.equals(FactionListGUI$TAB.ACTIONS) || !((String)var17.get("nb_actions")).equals("0")))
                {
                    ...
                    if (this.activeTab.equals(FactionListGUI$TAB.JOIN) || this.activeTab.equals(FactionListGUI$TAB.LIST))
                    {
                        if (((String)var17.get("isReferent")).equals("true"))
                        {
                            ...
                            {
                                var14 = true;
                                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.label.countries_referent"), (float)offsetX, (float)(offsetY.intValue() + 2), 16109642, 0.5F, "left", false, "georamaSemiBold", 28);
                                ClientEventHandler.STYLE.bindTexture("faction_global");
                                ModernGui.drawScaledCustomSizeModalRect((float)(offsetX + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.label.countries_referent")) / 2 + 2), (float)(offsetY.intValue() + 2), (float)(86 * GUI_SCALE), (float)(5 * GUI_SCALE), 8 * GUI_SCALE, 8 * GUI_SCALE, 8, 8, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);

                                if (mouseX >= offsetX + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.label.countries_referent")) / 2 + 2 && mouseX <= offsetX + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.label.countries_referent")) / 2 + 2 + 8 && mouseY >= offsetY.intValue() + 2 && mouseY <= offsetY.intValue() + 2 + 8)
                                {
                                    tooltipToDraw.addAll(Arrays.asList(I18n.getString("faction.common.badge.referent").split("##")));
                                }
                        ...
                        if (this.foundReferent && !((String)var17.get("isReferent")).equals("true"))
                        {
                            ...
                            {
                                var13 = true;
                                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.label.countries_classic"), (float)offsetX, (float)(offsetY.intValue() + 2), 10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                                Gui.drawRect(offsetX + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.label.countries_classic")) / 2 + 5, offsetY.intValue() + 7, offsetX + 260 - ((int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.label.countries_classic")) / 2 + 5), offsetY.intValue() + 8, -6382141);
                                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                            }
                    ...
                    if (offsetY.intValue() >= this.guiTop + 60 && offsetY.intValue() <= this.guiTop + 70 + 160)
                    {
                        ...
                        {
                            GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(var17.get("name"))).getGlTextureId());
                    ...
                    else if (var17.containsKey("isInPillage") && ((String)var17.get("isInPillage")).equals("true"))
                    {
                        ...
                        if (mouseX >= offsetX + 21 && mouseX <= offsetX + 21 + 13 && mouseY >= offsetY.intValue() + 1 && mouseY <= offsetY.intValue() + 1 + 13)
                        {
                            tooltipToDraw.addAll(Arrays.asList(I18n.getString("faction.common.badge.pillage").split("##")));
                        }
                    }
                    else
                    {
        ...
        if (selectedCountry != null && !selectedCountry.isEmpty())
        {
            ...
            else
            {
                ...
                {
                    GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(selectedCountry.get("name"))).getGlTextureId());
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.since").replaceAll("#day#", (String)var16.get("age")), (float)(this.guiLeft + 378), (float)(this.guiTop + 100), 10395075, 0.5F, "left", false, "georamaMedium", 26);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.country_leader"), (float)(this.guiLeft + 353), (float)(this.guiTop + 126), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                ...
                {
                    ModernGui.drawScaledStringCustomFont("(" + I18n.getString("faction.list.label.online") + ")", (float)(this.guiLeft + 355 + (int)this.cFontSemiBold28.getStringWidth((String)var16.get("leader")) / 2), (float)(this.guiTop + 133), 10395075, 0.5F, "left", false, "georamaMedium", 24);
                }
                ...
                if (!ClientProxy.cacheHeadPlayer.containsKey(var16.get("leader")))
                {
                    try
                    {
                        ResourceLocation var18 = AbstractClientPlayer.locationStevePng;
                        var18 = AbstractClientPlayer.getLocationSkin((String)var16.get("leader"));
                        AbstractClientPlayer.getDownloadImageSkin(var18, (String)var16.get("leader"));
                ...
                {
                    Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var16.get("leader")));
                    this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var16.get("leader")));
                ...
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.relation_my_country"), (float)(this.guiLeft + 353), (float)(this.guiTop + 151), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.common." + (String)selectedCountry.get("relation_my_country") + ".nocolor"), (float)(this.guiLeft + 353), (float)(this.guiTop + 157), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.recruitment"), (float)(this.guiLeft + 353), (float)(this.guiTop + 176), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.recruitment." + (String)selectedCountry.get("recruitment")), (float)(this.guiLeft + 353), (float)(this.guiTop + 182), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                ...
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.recruitment"), (float)(this.guiLeft + 353), (float)(this.guiTop + 151), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.recruitment." + (String)selectedCountry.get("recruitment")), (float)(this.guiLeft + 353), (float)(this.guiTop + 157), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.recruitmentThisWeek"), (float)(this.guiLeft + 353), (float)(this.guiTop + 176), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                ...
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.members_online"), (float)(this.guiLeft + 353), (float)(this.guiTop + 151), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ...
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                    ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 325), (float)(this.guiTop + 144), (float)(((Integer)iconsXPerRelation.get(selectedCountry.get("relation_my_country"))).intValue() * GUI_SCALE), (float)(((Integer)iconsYByName.get("people")).intValue() * GUI_SCALE), 30 * GUI_SCALE, 29 * GUI_SCALE, 30, 29, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.sell_country"), (float)(this.guiLeft + 353), (float)(this.guiTop + 176), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.price"), (float)(this.guiLeft + 353), (float)(this.guiTop + 182), 14342893, 0.5F, "left", false, "georamaSemiBold", 28);
                    ModernGui.drawScaledStringCustomFont((String)selectedCountry.get("price") + "$", (float)(this.guiLeft + 355 + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.price")) / 2), (float)(this.guiTop + 182), 14803951, 0.5F, "left", false, "georamaSemiBold", 28);
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                ...
                else if (this.activeTab.equals(FactionListGUI$TAB.ACTIONS))
                {
                    ...
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                    ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 325), (float)(this.guiTop + 144), (float)(((Integer)iconsXPerRelation.get(selectedCountry.get("relation_my_country"))).intValue() * GUI_SCALE), (float)(((Integer)iconsYByName.get("people")).intValue() * GUI_SCALE), 30 * GUI_SCALE, 29 * GUI_SCALE, 30, 29, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.sell_actions"), (float)(this.guiLeft + 353), (float)(this.guiTop + 176), ((Integer)FactionGUI.textColor.get(selectedCountry.get("relation_my_country"))).intValue(), 0.5F, "left", false, "georamaMedium", 22);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.price"), (float)(this.guiLeft + 353), (float)(this.guiTop + 182), 14342893, 0.5F, "left", false, "georamaSemiBold", 28);
                    ModernGui.drawScaledStringCustomFont(10000 + Integer.parseInt((String)selectedCountry.get("level")) * Integer.parseInt((String)selectedCountry.get("level")) * 100 + "$", (float)(this.guiLeft + 355 + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.price")) / 2), (float)(this.guiTop + 182), 14803951, 0.5F, "left", false, "georamaSemiBold", 28);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label.number"), (float)(this.guiLeft + 353), (float)(this.guiTop + 189), 14342893, 0.5F, "left", false, "georamaSemiBold", 28);
                    ModernGui.drawScaledStringCustomFont((String)selectedCountry.get("nb_actions"), (float)(this.guiLeft + 355 + (int)this.cFontSemiBold28.getStringWidth(I18n.getString("faction.list.label.number")) / 2), (float)(this.guiTop + 189), 14803951, 0.5F, "left", false, "georamaSemiBold", 28);
                    ClientEventHandler.STYLE.bindTexture("faction_list");
                    ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + 325), (float)(this.guiTop + 169), (float)(((Integer)iconsXPerRelation.get(selectedCountry.get("relation_my_country"))).intValue() * GUI_SCALE), (float)(((Integer)iconsYByName.get("bank")).intValue() * GUI_SCALE), 30 * GUI_SCALE, 29 * GUI_SCALE, 30, 29, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
                }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.list.label." + var19), (float)(this.guiLeft + 337 + 52), (float)(this.guiTop + 207), 2234425, 0.5F, "center", false, "georamaSemiBold", 28);
            }
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            if (!this.hoveredAction.isEmpty())
            {
                ...
                {
                    Minecraft.getMinecraft().displayGuiScreen(new FactionGUI((String)selectedCountry.get("name")));
                }
