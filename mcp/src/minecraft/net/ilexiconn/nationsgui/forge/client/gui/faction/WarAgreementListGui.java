...
public class WarAgreementListGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.enemy.agreement.title"), this.guiLeft + 12, this.guiTop + 190, 16777215, 1.5F, false, false);
        GL11.glPopMatrix();
        ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
        ...
        if (loaded)
        {
            ...
            {
                this.drawScaledString(I18n.getString("faction.enemy.agreement.status." + this.selectedStatus), this.guiLeft + 49, this.guiTop + 23, 16777215, 1.0F, false, false);
            }
            ...
            if (this.selectedAgreement == null)
            {
                ...
                while (dateFormatDay.hasNext())
                {
                    ...
                    if (this.selectedStatus.equals("all") || ((String)infoX.get("status")).startsWith(this.selectedStatus))
                    {
                        ...
                        this.drawScaledString(I18n.getString("faction.enemy.agreement.type." + infoX.get("type")), index + 35, offsetY.intValue() + 8, 16777215, 1.0F, false, false);
                        Date date = new Date(((Double)infoX.get("creationTime")).longValue());
                        SimpleDateFormat dateFormatDay1 = new SimpleDateFormat("dd/MM");
                        this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.send_date") + " " + dateFormatDay1.format(date), index + 35, offsetY.intValue() + 18, 16777215, 1.0F, false, false);
                        ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                        ...
                        this.drawScaledString(I18n.getString("faction.enemy.agreement.see"), index + 145, offsetY.intValue() + 13, 0, 1.0F, true, false);
                        i += 35;
                    }
                }
                ...
                if (canCreateAgreement)
                {
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.agreement.create"), this.guiLeft + 131, this.guiTop + 224, 16777215, 1.0F, true, false);
                }
            }
            else
            {
                ...
                this.drawScaledString(I18n.getString("faction.enemy.agreement.type." + this.selectedAgreement.get("type")), this.guiLeft + 82, this.guiTop + 48, 16777215, 1.0F, false, false);
                ...
                this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.send_date") + " " + var14.format(var13), this.guiLeft + 82, this.guiTop + 58, 16777215, 1.0F, false, false);
                ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                ...
                this.drawScaledString(I18n.getString("faction.enemy.agreement.back"), this.guiLeft + 192, this.guiTop + 53, 0, 1.0F, true, false);
                ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 54), (float)(this.guiTop + 84), 95, 251, 3, 3, 512.0F, 512.0F, false);
                this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.status") + " \u00a77> " + I18n.getString("faction.enemy.agreement.status.short." + this.selectedAgreement.get("status")), this.guiLeft + 64, this.guiTop + 82, 16777215, 1.0F, false, false);
                ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                ...
                if (this.selectedAgreement.get("status").equals("active") && this.selectedAgreement.containsKey("signatureTime"))
                {
                    ...
                    this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.end") + " \u00a77> \u00a7e" + var17.format(var15), this.guiLeft + 64, this.guiTop + 99, 16777215, 1.0F, false, false);
                }
                else
                {
                    this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.duration") + " \u00a77> \u00a7e" + ((Double)this.selectedAgreement.get("value")).intValue() + " " + I18n.getString("faction.enemy.rewards.valueType.dayLong"), this.guiLeft + 64, this.guiTop + 99, 16777215, 1.0F, false, false);
                }
                ...
                this.drawScaledString("\u00a77" + I18n.getString("faction.enemy.agreement.conditions"), this.guiLeft + 64, this.guiTop + 116, 16777215, 1.0F, false, false);
                int var16 = this.guiLeft + 64 + this.fontRenderer.getStringWidth(I18n.getString("faction.enemy.agreement.conditions")) + 3;
                ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                ...
                if (this.selectedAgreement.get("conditions") != null && !((String)this.selectedAgreement.get("conditions")).isEmpty())
                {
                    ...
                    for (int var20 = 0; var20 < var19; ++var20)
                    {
                        ...
                        if (ClientProxy.flagsTexture.containsKey(condition.split("#")[2]))
                        {
                            ...
                            GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(condition.split("#")[2])).getGlTextureId());
                            ...
                            this.drawScaledString(condition.split("#")[1] + " " + I18n.getString("faction.enemy.agreement.conditions." + condition.split("#")[0]), this.guiLeft + 83, this.guiTop + 131 + 12 * index, 16777215, 1.0F, false, false);
                        }
                ...
                {
                    this.drawScaledString("\u00a7c\u2716 " + I18n.getString("faction.enemy.none"), this.guiLeft + 53, this.guiTop + 129, 16777215, 1.0F, false, false);
                }
                ...
                if (canCreateAgreement && this.selectedAgreement.get("status").equals("waiting") && (playerFactionId.equals(this.selectedAgreement.get("factionATT")) || playerFactionId.equals(this.selectedAgreement.get("factionDEF"))) && !this.selectedAgreement.get("factionSender").equals(playerFactionId))
                {
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.agreement.accept"), this.guiLeft + 88, this.guiTop + 221, 16777215, 1.0F, true, false);
                    ClientEventHandler.STYLE.bindTexture("faction_war_agreement_list");
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.agreement.refuse"), this.guiLeft + 173, this.guiTop + 221, 16777215, 1.0F, true, false);
                }
                else if (canCreateAgreement && this.selectedAgreement.get("status").equals("waiting") && (playerFactionId.equals(this.selectedAgreement.get("factionATT")) || playerFactionId.equals(this.selectedAgreement.get("factionDEF"))) && this.selectedAgreement.get("factionSender").equals(playerFactionId))
                {
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.agreement.cancel"), this.guiLeft + 131, this.guiTop + 221, 16777215, 1.0F, true, false);
                }
            }
            ...
            if (this.statusExpanded)
            {
                for (i = 0; i < this.availableStatus.size(); ++i)
                {
                    ...
                    this.drawScaledString(I18n.getString("faction.enemy.agreement.status." + (String)this.availableStatus.get(i)), this.guiLeft + 49, this.guiTop + 37 + i * 19 + 5, 16777215, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            {
                this.mc.displayGuiScreen(new WarAgreementCreateGui(this.player, warId, this.faction1, this.faction2));
            }
