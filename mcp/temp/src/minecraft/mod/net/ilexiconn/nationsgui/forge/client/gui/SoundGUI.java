...
public class SoundGUI extends GuiScreen {
   ...
   public void func_73863_a(int par1, int par2, float par3) {
      this.func_73873_v_();
      this.func_73732_a(this.field_73886_k, I18n.func_135053_a("options.sounds"), this.field_73880_f / 2, 15, 16777215);
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(new SliderGUI(-1, this.field_73880_f / 2 - 155, this.field_73881_g / 6 + 12, "Radio", new SoundGUI$1(this)));
      this.field_73887_h.add(new GuiButton(100, this.field_73880_f / 2 - 100, this.field_73881_g / 6 + 50, I18n.func_135053_a("gui.done")));
      ...
      this.field_73887_h.add(new SliderGUI(-1, this.field_73880_f / 2 + 5, this.field_73881_g / 6 - 12 + 24, "Browser Volume", new SoundGUI$2(this)));
   }
