...
public class Filters
{
    ...
    public void comb_filter(float[] var1, int var2, float[] var3, int var4, int var5, int var6, float[] var7, float var8)
    {
        ...
        for (int var13 = var2; var9 < var5; ++var13)
        {
            var15 += var14;
            var3[var4 + var9] = var1[var13] + var8 * var15 * (var7[0] * var1[var13 - var6 + 1] + var7[1] * var1[var13 - var6] + var7[2] * var1[var13 - var6 - 1]) + var8 * (1.0F - var15) * (this.last_pitch_gain[0] * var1[var13 - this.last_pitch + 1] + this.last_pitch_gain[1] * var1[var13 - this.last_pitch] + this.last_pitch_gain[2] * var1[var13 - this.last_pitch - 1]);
            ++var9;
        }
        ...
        float var161 = (float)Math.sqrt((double)(var11 / (0.1F + var12)));
        ...
        for (var9 = var4; var9 < var4 + var5; ++var9)
        {
            this.smooth_gain = 0.96F * this.smooth_gain + 0.04F * var161;
