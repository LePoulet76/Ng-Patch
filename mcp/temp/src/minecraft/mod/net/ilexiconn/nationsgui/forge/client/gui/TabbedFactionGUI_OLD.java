...
public abstract class TabbedFactionGUI_OLD extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
      ...
      if(FactionGui_OLD.factionInfos != null) {
         if(!mapLoaded && FactionGui_OLD.factionInfos.size() > 0) {
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new MinimapRequestPacket(Integer.parseInt(((String)FactionGui_OLD.factionInfos.get("home")).split(",")[0]), Integer.parseInt(((String)FactionGui_OLD.factionInfos.get("home")).split(",")[1]), 6, 6)));
            mapLoaded = true;
         }
         ...
         if(((String)FactionGui_OLD.factionInfos.get("name")).length() <= 9) {
            this.drawScaledString((String)FactionGui_OLD.factionInfos.get("name"), this.guiLeft + 60, this.guiTop + 25, 16777215, 1.8F, true, true);
         } else {
            this.drawScaledString((String)FactionGui_OLD.factionInfos.get("name"), this.guiLeft + 60, this.guiTop + 25, 16777215, 1.0F, true, true);
         }

         this.drawScaledString(I18n.func_135053_a("faction.common.age_1") + " " + FactionGui_OLD.factionInfos.get("age") + " " + I18n.func_135053_a("faction.common.age_2"), this.guiLeft + 60, this.guiTop + 43, 11842740, 0.65F, true, false);
         this.drawScaledString(I18n.func_135053_a("faction.common." + FactionGui_OLD.factionInfos.get("actualRelation")), this.guiLeft + 58, this.guiTop + 66, 1644825, 1.0F, true, false);
         ClientEventHandler.STYLE.bindTexture("faction_main");

         int negativeOffsetX;
         for(negativeOffsetX = 0; negativeOffsetX < FactionGui_OLD.TABS.size(); ++negativeOffsetX) {
            GuiScreenTab i = (GuiScreenTab)FactionGui_OLD.TABS.get(negativeOffsetX);
            if(i.getClassReferent().equals(SettingsGUI_OLD.class)) {
               if(this.getClass() == i.getClassReferent()) {
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 398), (float)(this.guiTop + 200), 85, 251, 29, 30, 512.0F, 512.0F, false);
               ...
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               int type = negativeOffsetX % 5;
               int y = negativeOffsetX / 5;
               if(this.getClass() == i.getClassReferent()) {
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft - 23), (float)(this.guiTop + 20 + negativeOffsetX * 31), 23, 251, 29, 31, 512.0F, 512.0F, false);
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft - 23 + 4), (float)(this.guiTop + 20 + negativeOffsetX * 31 + 5), type * 20, 301 + y * 20, 20, 20, 512.0F, 512.0F, false);
               } else {
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft - 23), (float)(this.guiTop + 20 + negativeOffsetX * 31), 0, 251, 23, 31, 512.0F, 512.0F, false);
                  GL11.glBlendFunc(770, 771);
                  GL11.glEnable(3042);
                  GL11.glColor4f(1.0F, 1.0F, 1.0F, 0.75F);
                  ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft - 23 + 4), (float)(this.guiTop + 20 + negativeOffsetX * 31 + 5), type * 20, 301 + y * 20, 20, 20, 512.0F, 512.0F, false);
         ...
         if(((Boolean)FactionGui_OLD.factionInfos.get("isEmpire")).booleanValue()) {
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 105 - negativeOffsetX), (float)(this.guiTop + 50), 160, 251, 10, 10, 512.0F, 512.0F, false);
            ...
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 105 - negativeOffsetX), (float)(this.guiTop + 50), 172, 251, 10, 10, 512.0F, 512.0F, false);
            if(mouseX >= this.guiLeft + 105 - negativeOffsetX && mouseX <= this.guiLeft + 105 - negativeOffsetX + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10) {
               this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.colony") + " " + FactionGui_OLD.factionInfos.get("isColony")}), mouseX, mouseY, this.field_73886_k);
            }
         }
         ...
         for(int var8 = 0; var8 < FactionGui_OLD.TABS.size(); ++var8) {
            GuiScreenTab var9 = (GuiScreenTab)FactionGui_OLD.TABS.get(var8);
            if(!var9.getClassReferent().equals(SettingsGUI_OLD.class)) {
               if(mouseX >= this.guiLeft - 23 && mouseX <= this.guiLeft - 23 + 29 && mouseY >= this.guiTop + 20 + var8 * 31 && mouseY <= this.guiTop + 20 + 30 + var8 * 31) {
                  this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.tab." + var9.getClassReferent().getSimpleName())}), mouseX, mouseY, this.field_73886_k);
               }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         for(int i = 0; i < FactionGui_OLD.TABS.size(); ++i) {
            GuiScreenTab type = (GuiScreenTab)FactionGui_OLD.TABS.get(i);
