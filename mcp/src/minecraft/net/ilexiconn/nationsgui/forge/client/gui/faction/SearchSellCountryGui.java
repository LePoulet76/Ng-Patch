...
public class SearchSellCountryGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.search_sell.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.0F, false, false);
        ...
        this.drawScaledString(I18n.getString("faction.search_sell.nb_members"), this.guiLeft + 51 + 130, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search_sell.price"), this.guiLeft + 51 + 195, this.guiTop + 50, 1644825, 0.9F, false, false);
