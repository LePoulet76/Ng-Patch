...
public class FactionCreateEditPlotsGUI extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTick) {
      ...
      if(!editedPlot.isEmpty()) {
         ClientEventHandler.STYLE.bindTexture("faction_plots_3");
         hoveringClose = mouseX >= this.field_73880_f - 85 && mouseX < this.field_73880_f - 85 + 57 && mouseY >= 4 && mouseY < 20;
         ModernGui.drawScaledCustomSizeModalRect((float)(this.field_73880_f - 85), 4.0F, (float)(400 * GUI_SCALE), (float)((hoveringClose?235:215) * GUI_SCALE), 57 * GUI_SCALE, 16 * GUI_SCALE, 57, 16, (float)(512 * GUI_SCALE), (float)(512 * GUI_SCALE), false);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.return"), (float)(this.field_73880_f - 85 + 21), 9.0F, hoveringClose?3026518:16777215, 0.5F, "left", false, "georamaSemiBold", 24);
         if(hoveringClose) {
      ...
      ClientEventHandler.STYLE.bindTexture("faction_plots_3");
      hoveringClose = mouseX >= this.field_73880_f - 22 && mouseX < this.field_73880_f - 22 + 16 && mouseY >= 4 && mouseY < 20;
      ...
      ModernGui.drawScaledStringCustomFont(editedPlot.containsKey("name")?I18n.func_135053_a("faction.plots.plot") + " " + editedPlot.get("name"):I18n.func_135053_a("faction.plots.new_plot"), (float)(this.guiLeft + 0), (float)(this.guiTop + 0), 16777215, 1.0F, "left", false, "minecraftDungeons", 22);
      ...
      if(!editedPlot.isEmpty() && !editedPlot.get("owner").equals("") && FactionGUI.hasPermissions("locations")) {
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.editionMode." + this.editionMode), (float)(this.guiLeft + this.xSize - 65 + (this.editionMode.equals("owner")?20:10)), (float)(this.guiTop + 5), 16777215, 0.5F, "left", false, "georamaSemiBold", 24);
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.name"), (float)(this.guiLeft + 12), (float)(this.guiTop + 38), 16777215, 0.5F, "left", false, "georamaSemiBold", 24);
      this.inputName.func_73795_f();
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.price"), (float)(this.guiLeft + 112), (float)(this.guiTop + 38), 16777215, 0.5F, "left", false, "georamaSemiBold", 24);
      this.inputPrice.func_73795_f();
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.description"), (float)(this.guiLeft + 12), (float)(this.guiTop + 73), 16777215, 0.5F, "left", false, "georamaSemiBold", 24);
      ...
      if(!editedPlot.isEmpty() && (!FactionGUI.hasPermissions("locations") || !this.editionMode.equals("creator"))) {
         if(!editedPlot.isEmpty()) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.coowners"), (float)(this.guiLeft + 12), (float)(this.guiTop + 109), ((Boolean)editedPlot.get("canAddCoOwner")).booleanValue()?16777215:1118502, 0.5F, "left", false, "georamaSemiBold", 24);
            if(((Boolean)editedPlot.get("canAddCoOwner")).booleanValue()) {
               ...
               for(var17 = var16.iterator(); var17.hasNext(); ++var15) {
                  ...
                  if(!ClientProxy.cacheHeadPlayer.containsKey(var20)) {
                     try {
                        ResourceLocation hoveringKick = AbstractClientPlayer.field_110314_b;
                        hoveringKick = AbstractClientPlayer.func_110311_f(var20);
                        AbstractClientPlayer.func_110304_a(hoveringKick, var20);
                        ClientProxy.cacheHeadPlayer.put(var20, hoveringKick);
                     } catch (Exception var12) {
                        System.out.println(var12.getMessage());
                     }
                  } else {
                     Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var20));
                     this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var20));
               ...
               if(mouseX >= this.guiLeft + 12 && mouseX < this.guiLeft + 12 + 93 && mouseY >= this.guiTop + 117 && mouseY < this.guiTop + 117 + 64) {
                  tooltipToDraw.add(I18n.func_135053_a("faction.plots.tooltip.coowner_disabled"));
               }
            }
            ...
            if(editedPlot.get("buyType").equals("rent")) {
               ...
               ModernGui.drawScaledStringCustomFont(this.rentDaysToAdd + " " + I18n.func_135053_a("faction.plots.label.days"), (float)(this.guiLeft + 159), (float)(this.guiTop + 133), 16777215, 0.5F, "center", false, "georamaSemiBold", 22);
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.rent_duration"), (float)(this.guiLeft + 120), (float)(this.guiTop + 150), 7239406, 0.5F, "left", false, "georamaSemiBold", 24);
               ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)editedPlot.get("rent_left_days")}) + " " + I18n.func_135053_a("faction.plots.label.days"), (float)(this.guiLeft + 120 + 3) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.label.rent_duration")) / 2.0F, (float)(this.guiTop + 150), 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.rent_price"), (float)(this.guiLeft + 120), (float)(this.guiTop + 159), 7239406, 0.5F, "left", false, "georamaSemiBold", 24);
               ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)editedPlot.get("price")}) + "$", (float)(this.guiLeft + 120 + 3) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.label.rent_price")) / 2.0F, (float)(this.guiTop + 159), 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
               if(this.rentDaysToAdd > 0) {
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.rent_extend_price"), (float)(this.guiLeft + 120), (float)(this.guiTop + 168), 16000586, 0.5F, "left", false, "georamaSemiBold", 24);
                  ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{Double.valueOf(((Double)editedPlot.get("price")).doubleValue() * (double)this.rentDaysToAdd)}) + "$", (float)(this.guiLeft + 120 + 3) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.label.rent_extend_price")) / 2.0F, (float)(this.guiTop + 168), 14606061, 0.5F, "left", false, "georamaSemiBold", 24);
               }
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.type"), (float)(this.guiLeft + 12), (float)(this.guiTop + 110), 16777215, 0.5F, "left", false, "georamaSemiBold", 22);
         int var13 = 0;
         ...
         for(isHoveringAddImageBtn = types.iterator(); isHoveringAddImageBtn.hasNext(); ++var13) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.type." + hoveringBtnValidate), (float)(this.guiLeft + 28 + var13 / 2 * 50), (float)(this.guiTop + 123 + 1 + var13 % 2 * 14), 16777215, 0.5F, "left", false, "georamaSemiBold", 20);
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.usage"), (float)(this.guiLeft + 112), (float)(this.guiTop + 110), 16777215, 0.5F, "left", false, "georamaSemiBold", 22);
         var13 = 0;
         ...
         for(isHoveringAddImageBtn = usages.iterator(); isHoveringAddImageBtn.hasNext(); ++var13) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.usage." + hoveringBtnValidate), (float)(this.guiLeft + 120 + 8), (float)(this.guiTop + 123 + 1 + var13 % 2 * 14), 16777215, 0.5F, "left", false, "georamaSemiBold", 20);
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.coowner"), (float)(this.guiLeft + 12), (float)(this.guiTop + 153), 16777215, 0.5F, "left", false, "georamaSemiBold", 22);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.allow_coowner"), (float)(this.guiLeft + 20), (float)(this.guiTop + 169), 16777215, 0.5F, "left", false, "georamaSemiBold", 20);
         ClientEventHandler.STYLE.bindTexture("faction_plots_3");
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.mode"), (float)(this.guiLeft + 112), (float)(this.guiTop + 153), 16777215, 0.5F, "left", false, "georamaSemiBold", 22);
         var13 = 0;
         ...
         for(var17 = modes.iterator(); var17.hasNext(); ++var13) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.mode." + var20), (float)(this.guiLeft + 120 + 8 + var13 * 50), (float)(this.guiTop + 168 + 1), 16777215, 0.5F, "left", false, "georamaSemiBold", 20);
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.size") + ":", (float)(this.guiLeft + 245), (float)(this.guiTop + 45), 7961015, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(editedPlot.containsKey("size")?(String)editedPlot.get("size") + " blocs":"-", (float)(this.guiLeft + 245 + 5) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.size")) / 2.0F, (float)(this.guiTop + 45), 14606061, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.area") + ":", (float)(this.guiLeft + 245), (float)(this.guiTop + 55), 7961015, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(editedPlot.containsKey("area")?String.format("%.0f", new Object[]{(Double)editedPlot.get("area")}) + " blocs":"-", (float)(this.guiLeft + 245 + 5) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.area")) / 2.0F, (float)(this.guiTop + 55), 14606061, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.price_blocs") + ":", (float)(this.guiLeft + 245), (float)(this.guiTop + 65), 7961015, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(editedPlot.containsKey("price") && editedPlot.containsKey("area")?String.format("%.5f", new Object[]{Double.valueOf(((Double)editedPlot.get("price")).doubleValue() / ((Double)editedPlot.get("area")).doubleValue())}) + "$/bloc":"-", (float)(this.guiLeft + 245 + 5) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.price_blocs")) / 2.0F, (float)(this.guiTop + 65), 14606061, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.position") + ":", (float)(this.guiLeft + 245), (float)(this.guiTop + 75), 7961015, 0.5F, "left", false, "georamaSemiBold", 25);
      ModernGui.drawScaledStringCustomFont(editedPlot.containsKey("position")?((String)editedPlot.get("position")).replaceAll("#", ", ").replaceAll("world, ", ""):"-", (float)(this.guiLeft + 245 + 5) + semiBold24.getStringWidth(I18n.func_135053_a("faction.plots.position")) / 2.0F, (float)(this.guiTop + 75), 14606061, 0.5F, "left", false, "georamaSemiBold", 25);
      ...
      if(this.editionMode.equals("creator")) {
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.define"), (float)(this.guiLeft + 334 + 40), (float)(this.guiTop + 95), var14?(this.isFormValid()?7239406:0):16777215, 0.5F, "center", false, "georamaSemiBold", 25);
         if(var14) {
            if(this.isFormValid()) {
               this.hoveredAction = "define";
            } else {
               tooltipToDraw.add(I18n.func_135053_a("faction.plots.form.error"));
            }
         }
      }
      ...
      if(editedPlot.get("images") != null && !((ArrayList)editedPlot.get("images")).isEmpty()) {
         for(var15 = 0; var15 < Math.min(3, ((ArrayList)editedPlot.get("images")).size()); ++var15) {
            ...
            if(hoveringBtnCancel) {
               Gui.func_73734_a(var19.intValue(), this.guiTop + 123, var19.intValue() + 43, this.guiTop + 123 + 39, -2131483062);
      ...
      if(var14) {
         if(editedPlot.containsKey("images") && ((ArrayList)editedPlot.get("images")).size() < 3) {
            ...
            tooltipToDraw.add(I18n.func_135053_a("faction.plots.max_images"));
         }
      }
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a(this.rentDaysToAdd > 0?"faction.plots.validate_and_pay":"faction.plots.validate"), (float)(this.guiLeft + 225 + 51), (float)(this.guiTop + 186), var18?(this.isFormValid()?7239406:0):16777215, 0.5F, "center", false, "minecraftDungeons", 21);
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.btn." + var22), (float)(this.guiLeft + 333 + 51), (float)(this.guiTop + 186), hoveringBtnCancel?16777215:16000586, 0.5F, "center", false, "minecraftDungeons", 21);
      ...
      if(mouseButton == 0) {
         ...
         if(!this.hoveredAction.isEmpty()) {
            ...
            if(this.hoveredAction.equals("toggleEditionMode")) {
               ...
               this.field_73882_e.func_71373_a(new FactionPlotsGUI());
               ...
               if(this.hoveredAction.equals("validate")) {
                  if(this.isFormValid()) {
                     var5 = new HashMap();
                     var5.put("name", this.inputName.func_73781_b());
                     var5.put("description", this.inputDescription.func_73781_b());
                     var5.put("price", Double.valueOf(Double.parseDouble(this.inputPrice.func_73781_b())));
                  ...
                  if(this.hoveredAction.equals("define")) {
                     ...
                     if(this.hoveredAction.contains("addCoowner")) {
                        ...
                        Minecraft.func_71410_x().field_71439_g.func_70006_a(ChatMessageComponent.func_111066_d(I18n.func_135053_a("faction.plots.take_image")));
                     }
                  }
               } else {
   ...
   public boolean isFormValid() {
      return this.inputName.func_73781_b().isEmpty()?false:(!this.inputPrice.func_73781_b().isEmpty() && isValidNonNegativeInteger(this.inputPrice.func_73781_b())?(this.selectedType.isEmpty()?false:(this.selectedUsage.isEmpty()?false:!this.selectedMode.isEmpty())):false);
   }
