...
public class LotoGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (this.selectedLottery != null || this.displayMode.equals("past"))
        {
            ...
            if (mouseX >= this.guiLeft + 305 && mouseX <= this.guiLeft + 305 + 30 && mouseY >= this.guiTop + 20 && mouseY <= this.guiTop + 20 + 9)
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.label.return"), (float)(this.guiLeft + 315), (float)(this.guiTop + 21), 14803951, 0.5F, "left", false, "georamaSemiBold", 30);
            ...
            else
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.label.return"), (float)(this.guiLeft + 315), (float)(this.guiTop + 21), 10395075, 0.5F, "left", false, "georamaSemiBold", 30);
            }
        }
        ...
        if (loaded)
        {
            ...
            ModernGui.drawRectangle((float)this.guiLeft, (float)this.guiTop, this.zLevel, (float)this.xSize, 4.0F);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 0.5F);
            ModernGui.drawRectangle((float)this.guiLeft + 4.0F, (float)this.guiTop + 4.0F, this.zLevel, (float)(this.xSize - 8), 3.0F);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 1.0F);
            ModernGui.drawRectangle((float)this.guiLeft, (float)(this.guiTop + this.ySize - 4), this.zLevel, (float)this.xSize, 4.0F);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 0.5F);
            ModernGui.drawRectangle((float)this.guiLeft + 4.0F, (float)this.guiTop + (float)this.ySize - 7.0F, this.zLevel, (float)(this.xSize - 8), 3.0F);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 1.0F);
            ModernGui.drawRectangle((float)this.guiLeft, (float)this.guiTop, this.zLevel, 4.0F, (float)this.ySize);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 0.5F);
            ModernGui.drawRectangle((float)this.guiLeft + 4.0F, (float)this.guiTop + 4.0F, this.zLevel, 3.0F, (float)(this.ySize - 8));
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 1.0F);
            ModernGui.drawRectangle((float)this.guiLeft + (float)this.xSize - 4.0F, (float)this.guiTop, this.zLevel, 4.0F, (float)this.ySize);
            ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 0.5F);
            ModernGui.drawRectangle((float)this.guiLeft + (float)this.xSize - 7.0F, (float)this.guiTop + 4.0F, this.zLevel, 3.0F, (float)(this.ySize - 8));
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString(this.selectedLottery != null ? "lottery.player.informations" : (this.displayMode.equals("past") ? "lottery.player.past_lotteries" : "lottery.player.informations")), (float)(this.guiLeft + 25), (float)(this.guiTop + 30), 10395075, 0.5F, "left", false, "georamaSemiBold", 26);
            int e;
            int i;
            String winnerName;
            int var28;
            ...
            if (this.displayMode.equals("past") && this.selectedLottery == null)
            {
                ...
                for (Iterator var23 = ((ArrayList)data.get("lotteries_past")).iterator(); var23.hasNext(); ++e)
                {
                    ...
                    ModernGui.drawRoundedRectangle((float)var28 + 234.0F, winner.floatValue(), this.zLevel, 81.0F, 35.0F);
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    ClientEventHandler.STYLE.bindTexture("loto");
                    ...
                    ModernGui.drawScaledStringCustomFont((((String)var25.get("players")).isEmpty() ? "0" : Integer.valueOf(((String)var25.get("players")).split(",").length)) + " " + I18n.getString("lottery.label.players"), (float)(var28 + 15), (float)(winner.intValue() + 14), 16514302, 0.5F, "left", false, "georamaMedium", 26);
                    ClientEventHandler.STYLE.bindTexture("loto");
                    ...
                    ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[] {(Double)var25.get("winnersCount")}) + " " + I18n.getString("lottery.label.winners"), (float)(var28 + 15), (float)(winner.intValue() + 25), 16514302, 0.5F, "left", false, "georamaMedium", 26);
            ...
            {
                ModernGui.glColorHex(((Integer)colors.get(color)).intValue(), 1.0F);
                ModernGui.drawRoundedRectangle((float)this.guiLeft + 24.0F + 10.0F, (float)this.guiTop + 38.0F, this.zLevel, 322.0F, 76.0F);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont(((Double)currentCarouselLottery.get("ticketsPlayer")).intValue() + " " + I18n.getString("lottery.label.tickets.short") + " | " + String.format("%.3f", new Object[] {Double.valueOf(((Double)currentCarouselLottery.get("ticketsPlayer")).doubleValue() / Math.max(1.0D, ((Double)currentCarouselLottery.get("ticketsSold")).doubleValue()) * 100.0D)}) + "%", (float)(this.guiLeft + 325), (float)(this.guiTop + 34), 10395075, 0.5F, "center", false, "georamaMedium", 24);
                ...
                if (((Double)currentCarouselLottery.get("cashPrice")).doubleValue() <= 0.0D && (!currentCarouselLottery.containsKey("poolMode") || !((String)currentCarouselLottery.get("poolMode")).equals("true")))
                {
                    ...
                    {
                        ModernGui.drawScaledString(I18n.getString("lottery.player.items_lot"), this.guiLeft + 35, this.guiTop + 55, 16514302, 2.5F, false, true);
                        e += 22;
                    }
                }
                else
                ...
                if (!((String)currentCarouselLottery.get("itemsPrice")).isEmpty())
                {
                    ...
                    for (i = 0; i < e1.size(); ++i)
                    {
                        ...
                        GL11.glPushMatrix();
                        this.itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, Minecraft.getMinecraft().getTextureManager(), itemStack, this.guiLeft + 33 + 20 * i, this.guiTop + 55 + e);
                        GL11.glPopMatrix();
            ...
            else
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.no_lottery_inprogress"), (float)(this.guiLeft + 35), (float)(this.guiTop + 50), 16514302, 0.5F, "left", false, "georamaSemiBold", 30);
            }
            ...
            if (this.selectedLottery != null)
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.draw_on") + " " + dateTimeFormat.format(new Date(((Double)this.selectedLottery.get("endTime")).longValue())), (float)(this.guiLeft + 51), (float)(this.guiTop + 124), 16514302, 0.5F, "left", false, "georamaSemiBold", 26);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont((((String)this.selectedLottery.get("players")).isEmpty() ? "0" : Integer.valueOf(((String)this.selectedLottery.get("players")).split(",").length)) + " " + I18n.getString("lottery.label.players"), (float)(this.guiLeft + 51), (float)(this.guiTop + 139), 16514302, 0.5F, "left", false, "georamaSemiBold", 26);
                ModernGui.glColorHex(((Integer)colors.get(this.selectedLottery.get("designColor"))).intValue(), 1.0F);
                ModernGui.drawRoundedRectangle((float)this.guiLeft + 34.0F, (float)this.guiTop + 155.0F, this.zLevel, 150.0F, 35.0F);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont(String.format("%.3f", new Object[] {Double.valueOf(((Double)this.selectedLottery.get("ticketsPlayer")).doubleValue() / Math.max(1.0D, ((Double)this.selectedLottery.get("ticketsSold")).doubleValue()) * 100.0D)}) + "% " + I18n.getString("lottery.player.win_chance"), (float)(this.guiLeft + 51), (float)(this.guiTop + 177), 2826561, 0.5F, "left", false, "georamaSemiBold", 26);

                if (this.displayMode.equals("past"))
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.winners"), (float)(this.guiLeft + 196), (float)(this.guiTop + 118), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                    String[] var24;
                    String var29;
                    ...
                    if (!((String)this.selectedLottery.get("winners")).isEmpty() && ((String)this.selectedLottery.get("winners")).split(",").length == 1)
                    {
                        ...
                        for (var28 = 0; var28 < i; ++var28)
                        {
                            ...
                            {
                                ModernGui.drawScaledStringCustomFont(var29.split("#")[1] + " " + I18n.getString("lottery.label.tickets"), (float)(this.guiLeft + 219), (float)(this.guiTop + 158), 10395075, 0.5F, "left", false, "georamaSemiBold", 28);
                            }
                        }

                        if (this.cachedPlayerEntity != null && this.cachedPlayerEntity.username.equals(var26))
                        {
                        ...
                        else
                        {
                            try
                            {
                                this.cachedPlayerEntity = new EntityOtherPlayerMP(this.mc.theWorld, var26);
                            }
                    ...
                    else if (!((String)this.selectedLottery.get("winners")).isEmpty())
                    {
                        ...
                        for (var28 = 0; var28 < i; ++var28)
                        {
                            ...
                            if (!ClientProxy.cacheHeadPlayer.containsKey(winnerName))
                            {
                                try
                                {
                                    ResourceLocation e2 = AbstractClientPlayer.locationStevePng;
                                    e2 = AbstractClientPlayer.getLocationSkin(winnerName);
                                    AbstractClientPlayer.getDownloadImageSkin(e2, winnerName);
                            ...
                            {
                                Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(winnerName));
                                this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(winnerName));
                            ...
                            for (int var18 = 0; var18 < var17; ++var18)
                            {
                                ...
                                {
                                    ModernGui.drawScaledStringCustomFont(player.split("#")[1] + " " + I18n.getString("lottery.label.tickets"), (float)(offsetX + 132), (float)(offsetY.intValue() + 1), 10395075, 0.5F, "right", false, "georamaMedium", 26);
                                }
                            }
                    ...
                    if (((String)this.selectedLottery.get("players_itemsPrice")).matches("(,.*|^)" + Minecraft.getMinecraft().thePlayer.username + "(,.*|$)"))
                    {
                        ClientEventHandler.STYLE.bindTexture("loto");
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.label.get_items"), (float)(this.guiLeft + 244 + 27), (float)(this.guiTop + 183), 2234425, 0.5F, "center", false, "georamaSemiBold", 24);
                    }
                }
                else
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.participate"), (float)(this.guiLeft + 196), (float)(this.guiTop + 116), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.tickets"), (float)(this.guiLeft + 200), (float)(this.guiTop + 138), 15463162, 0.5F, "left", false, "georamaSemiBold", 26);
                    ClientEventHandler.STYLE.bindTexture("loto");
                    ...
                    this.ticketsInput.drawTextBox();

                    if (((String)this.selectedLottery.get("allowDonation")).equals("true"))
                    {
                        ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.donations"), (float)(this.guiLeft + 200), (float)(this.guiTop + 150), 15463162, 0.5F, "left", false, "georamaSemiBold", 26);
                        ClientEventHandler.STYLE.bindTexture("loto");
                        ...
                        this.donationInput.drawTextBox();
                    }

                    ModernGui.drawScaledStringCustomFont("TOTAL " + (FactionGUI.isNumeric(this.ticketsInput.getText(), true) && FactionGUI.isNumeric(this.donationInput.getText(), true) ? Integer.parseInt(this.ticketsInput.getText()) * ((Double)this.selectedLottery.get("ticketPrice")).intValue() + Integer.parseInt(this.donationInput.getText()) : 0) + "$", (float)(this.guiLeft + 271), (float)(this.guiTop + 170), 16514302, 0.5F, "center", false, "georamaSemiBold", 32);
                    ClientEventHandler.STYLE.bindTexture("loto");
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.label.buy"), (float)(this.guiLeft + 244 + 27), (float)(this.guiTop + 183), 2234425, 0.5F, "center", false, "georamaSemiBold", 24);
                    ClientEventHandler.STYLE.bindTexture("loto");
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.ticket_price") + " : " + ((Double)this.selectedLottery.get("ticketPrice")).intValue() + "$", (float)(this.guiLeft + 280), (float)(this.guiTop + 140), 10395075, 0.5F, "left", false, "georamaSemiBold", 24);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.remaining_tickets") + " : " + (((Double)this.selectedLottery.get("maxTicketsGlobal")).doubleValue() != 0.0D ? String.format("%.0f", new Object[] {Double.valueOf(Math.max(0.0D, ((Double)this.selectedLottery.get("maxTicketsGlobal")).doubleValue() - ((Double)this.selectedLottery.get("ticketsSold")).doubleValue()))}): "-"), (float)(this.guiLeft + 280), (float)(this.guiTop + 149), 10395075, 0.5F, "left", false, "georamaSemiBold", 24);
                }
            }
            else if (!this.displayMode.equals("past"))
            {
                if (currentCarouselLottery != null)
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.label.participate"), (float)(this.guiLeft + 33 + 27), (float)(this.guiTop + 100), 2234425, 0.5F, "center", false, "georamaSemiBold", 24);
                    ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.draw_on") + " " + dateTimeFormat.format(new Date(((Double)currentCarouselLottery.get("endTime")).longValue())), (float)(this.guiLeft + 352), (float)(this.guiTop + 107), 2234425, 0.5F, "right", false, "georamaSemiBold", 22);
                    ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.old_draws"), (float)(this.guiLeft + 25), (float)(this.guiTop + 122), 10395075, 0.5F, "left", false, "georamaSemiBold", 26);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.my_profil"), (float)(this.guiLeft + 196), (float)(this.guiTop + 122), 10395075, 0.5F, "left", false, "georamaSemiBold", 26);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                if (!ClientProxy.cacheHeadPlayer.containsKey(Minecraft.getMinecraft().thePlayer.username))
                {
                    try
                    {
                        ResourceLocation var27 = AbstractClientPlayer.locationStevePng;
                        var27 = AbstractClientPlayer.getLocationSkin(Minecraft.getMinecraft().thePlayer.username);
                        AbstractClientPlayer.getDownloadImageSkin(var27, Minecraft.getMinecraft().thePlayer.username);
                        ClientProxy.cacheHeadPlayer.put(Minecraft.getMinecraft().thePlayer.username, var27);
                    }
                ...
                {
                    Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(Minecraft.getMinecraft().thePlayer.username));
                    this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(Minecraft.getMinecraft().thePlayer.username));
                ...
                ModernGui.drawScaledStringCustomFont(Minecraft.getMinecraft().thePlayer.username, var10001, var10002, 15463162, 0.5F, "left", false, "georamaBold", 32);
                ClientEventHandler.STYLE.bindTexture("loto");
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.wins"), (float)(this.guiLeft + 216), (float)(this.guiTop + 156), 14342893, 0.5F, "left", false, "georamaSemiBold", 26);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.participations"), (float)(this.guiLeft + 216), (float)(this.guiTop + 167), 14342893, 0.5F, "left", false, "georamaSemiBold", 26);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("lottery.player.money_earn"), (float)(this.guiLeft + 216), (float)(this.guiTop + 178), 14342893, 0.5F, "left", false, "georamaSemiBold", 26);
    ...
    {
        this.ticketsInput.updateCursorCounter();
        this.donationInput.updateCursorCounter();
        super.updateScreen();
    }
    ...
    {
        this.ticketsInput.textboxKeyTyped(par1, par2);
        this.donationInput.textboxKeyTyped(par1, par2);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            {
                this.ticketsInput.setText("0");
                this.donationInput.setText("0");
            ...
            {
                if (this.ticketsInput.getText().isEmpty())
                {
                    this.ticketsInput.setText("0");
                }

                if (this.donationInput.getText().isEmpty())
                {
                    this.donationInput.setText("0");
                }

                if (!FactionGUI.isNumeric(this.ticketsInput.getText(), true) || !FactionGUI.isNumeric(this.donationInput.getText(), true) || Integer.parseInt(this.ticketsInput.getText()) == 0 && Integer.parseInt(this.donationInput.getText()) == 0)
                {
                    Minecraft.getMinecraft().thePlayer.addChatMessage(I18n.getString("lotery.error.wrong_data"));
                    return;
                }

                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new LotoBuyPacket(((Double)this.selectedLottery.get("id")).intValue(), Integer.parseInt(this.ticketsInput.getText()), Integer.parseInt(this.donationInput.getText()))));
                this.selectedLottery = null;
                this.ticketsInput.setText("0");
                this.donationInput.setText("0");
            }
            ...
            if (this.selectedLottery != null && !this.displayMode.equals("past"))
            {
                this.ticketsInput.mouseClicked(mouseX, mouseY, mouseButton);

                if (((String)this.selectedLottery.get("allowDonation")).equals("true"))
                {
                    this.donationInput.mouseClicked(mouseX, mouseY, mouseButton);
                }
            }
        }
