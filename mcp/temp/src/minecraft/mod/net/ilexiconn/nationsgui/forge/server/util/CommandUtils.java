...
public class CommandUtils {
   ...
   public static void writePlayerData(SaveHandler saveHandler, String username, NBTTagCompound playerData) throws IOException {
      ...
      try {
         Field file1 = SaveHandler.class.getDeclaredField(NationsGUITransformer.inDevelopment?"playersDirectory":"field_75771_c");
      ...
      CompressedStreamTools.func_74799_a(playerData, new FileOutputStream(file11));
      if(file2.exists()) {
         file2.delete();
      }
   ...
   public static List<String> getAllOps() {
      ...
      String[] var1 = MinecraftServer.func_71276_C().func_71213_z();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         String p = var1[var3];
         if(MinecraftServer.func_71276_C().func_71203_ab().func_72353_e(p)) {
            ops.add(p);
         }
      }
