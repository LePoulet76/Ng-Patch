...
public class AssistanceSimpleButton
extends GuiButton {
    private final int u;
    private final int v;
    ...
    public void func_73737_a(Minecraft par1Minecraft, int par2, int par3) {
        if (this.field_73748_h) {
            ...
            ModernGui.drawModalRectWithCustomSizedTexture(this.field_73746_c, this.field_73743_d, this.u + (this.field_82253_i ? 20 : 0), this.v, 20, 16, 512.0f, 512.0f, false);
        }
    }
}
