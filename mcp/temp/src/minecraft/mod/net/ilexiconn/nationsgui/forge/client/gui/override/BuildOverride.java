...
public class BuildOverride extends Gui implements ElementOverride {
   ...
   public void renderOverride(Minecraft client, ScaledResolution resolution, float partialTicks) {
      if(ClientProxy.serverType.equals("build") && !ClientData.currentIsland.isEmpty()) {
         ...
         func_73734_a(x, y + 16, x + 120, y + 16 + 59, 1996488704);
         func_73734_a(x, y + 16 + 59, x + 120, y + 16 + 59 + 20 + 20, -1157627904);
         ...
         this.drawSmallString(client.field_71466_p, I18n.func_135053_a("island.overlay.island") + " n\u00b0" + (String)ClientData.currentIsland.get("id"), x + 40, y + 4, 16777215);
         ClientEventHandler.STYLE.bindTexture("hud2");
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         String var17;
         if(ClientData.currentJumpStartTime.longValue() != -1L && System.currentTimeMillis() - ClientData.currentJumpStartTime.longValue() < 5400000L) {
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.jump_inprogress"), x + 5, y + 28, 16777215, 0.9F, false, false);
            String var16 = chronoTimeToStr(Long.valueOf(System.currentTimeMillis() - ClientData.currentJumpStartTime.longValue()), true);
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.time") + " \u00a77" + var16, x + 5, y + 43, 16777215, 0.9F, false, false);
            var17 = "-";
            ...
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a76Record: \u00a7e" + var17, x + 5, y + 58, 16777215, 0.9F, false, false);
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a7d" + (this.isNumeric(var18)?chronoTimeToStr(Long.valueOf(Long.parseLong(var18)), true):var18), x + 5, y + 68, 16777215, 0.9F, false, false);
         } else {
            int lineNumber;
            if(ClientData.currentIsland.containsKey("team")) {
               this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.team") + " " + (String)ClientData.currentIsland.get("team") + " \u00a7e(" + (String)ClientData.currentIsland.get("score") + ")", x + 5, y + 28, 16777215, 0.9F, false, false);
               List var14 = Arrays.asList(((String)ClientData.currentIsland.get("scores")).split(","));

               for(int line = 0; line < var14.size() && line < 3; ++line) {
                  lineNumber = line + 1;
                  this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a7e" + lineNumber + " \u00a77> \u00a7r" + ((String)var14.get(line)).split("##")[0] + " \u00a76(" + ((String)var14.get(line)).split("##")[1] + ")", x + 5, y + 43 + line * 10, 16777215, 0.9F, false, false);
               }
            } else {
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               ...
               for(int var12 = 0; var12 < var11; ++var12) {
                  ...
                  if(Minecraft.func_71410_x().field_71466_p.func_78256_a(var17 + descWord) <= 120) {
                     if(!var17.equals("")) {
                        var17 = var17 + " ";
                     }
                     ...
                     this.drawScaledString(Minecraft.func_71410_x().field_71466_p, var10002, x + 60, y + 28 + lineNumber * 10, 16777215, 0.9F, true, false);
                     ++lineNumber;
                     var17 = descWord;
                  }
               }
               ...
               this.drawScaledString(Minecraft.func_71410_x().field_71466_p, displayName?"\u00a76" + var17:var17 + "\"", x + 60, y + 28 + lineNumber * 10, 16777215, 0.9F, true, false);
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               this.drawSmallString(client.field_71466_p, I18n.func_135053_a("island.overlay.by") + " " + (String)ClientData.currentIsland.get("creator"), x + 5, y + 65, 16777215);
            }
         }
         ...
         if(ClientData.currentJumpStartTime.longValue() == -1L) {
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.infos"), x + 60, y + 83, 0, 0.8F, true, false);
         } else {
            this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.stop_jump").replaceAll("<key>", Keyboard.getKeyName(ClientKeyHandler.KEY_WARZONE_LEAVE.field_74512_d)), x + 60, y + 83, 0, 0.8F, true, false);
         }

         ClientEventHandler.STYLE.bindTexture("hud2");
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         this.func_73729_b(x + 13, y + 98, 33, 67, 94, 15);
         this.drawScaledString(Minecraft.func_71410_x().field_71466_p, I18n.func_135053_a("island.overlay.list"), x + 60, y + 103, 0, 0.8F, true, false);
      }
