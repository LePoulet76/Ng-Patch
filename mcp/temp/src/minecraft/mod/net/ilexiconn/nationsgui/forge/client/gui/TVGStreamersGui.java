...
public class TVGStreamersGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.title"), (float)(this.guiLeft + 14), (float)(this.guiTop + 12), 16777215, 1.0F, "left", false, "georamaExtraBold", 22);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.subtitle"), (float)(this.guiLeft + 14), (float)(this.guiTop + 24), 13513553, 1.0F, "left", false, "georamaMedium", 18);
      ClientEventHandler.STYLE.bindTexture("tvg_streamers");
      ...
      for(int bestTime = 0; bestTime < streamers.size(); ++bestTime) {
         ...
         this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)streamersLogo.get(streamers.get(bestTime)));
      ...
      if(!selectedStreamer.isEmpty() && !selectedStreamer.equals(playerStreamer)) {
         ...
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 170 - 7 + 2) + ModernGui.getCustomFont("georamaSemiBold", Integer.valueOf(20)).getStringWidth(I18n.func_135053_a("tvg.valid")) / 2.0F, (float)(this.guiTop + 212), 428, 245, 14, 11, 512.0F, 512.0F, false);
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.valid"), (float)(this.guiLeft + 170 - 7), (float)(this.guiTop + 213), 16777215, 1.0F, "center", false, "georamaSemiBold", 20);
      } else {
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.select"), (float)(this.guiLeft + 170), (float)(this.guiTop + 213), 16777215, 1.0F, "center", false, "georamaSemiBold", 20);
      }

      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.stats"), (float)(this.guiLeft + 339), (float)(this.guiTop + 58), 16777215, 1.0F, "left", false, "georamaSemiBold", 20);
      ClientEventHandler.STYLE.bindTexture("tvg_streamers");
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.bestTime"), (float)(this.guiLeft + 344), (float)(this.guiTop + 86), 13513553, 1.0F, "left", false, "georamaMedium", 15);
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.position"), (float)(this.guiLeft + 344), (float)(this.guiTop + 119), 13513553, 1.0F, "left", false, "georamaMedium", 15);
      ...
      if(loaded) {
         this.field_73882_e.func_110434_K().func_110577_a(!selectedStreamer.isEmpty()?(ResourceLocation)streamersLogo.get(selectedStreamer):unknowLogo);
         ...
         if(!selectedStreamer.isEmpty()) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.unknow1"), (float)(this.guiLeft + 344), (float)(this.guiTop + 148), 16777215, 1.0F, "left", false, "georamaMedium", 15);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("tvg.unknow2"), (float)(this.guiLeft + 344), (float)(this.guiTop + 155), 16777215, 1.0F, "left", false, "georamaMedium", 15);
         }
