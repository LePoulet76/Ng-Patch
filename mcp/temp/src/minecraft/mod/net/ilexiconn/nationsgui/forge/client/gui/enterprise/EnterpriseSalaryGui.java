...
public class EnterpriseSalaryGui extends ModalGui {
   ...
   public void func_73866_w_() {
      super.func_73866_w_();
      this.cancelButton = new GuiButton(0, this.guiLeft + 48, this.guiTop + 95, 118, 20, I18n.func_135053_a("enterprise.bank.modal.action.cancel"));
      this.validButton = new GuiButton(1, this.guiLeft + 190, this.guiTop + 95, 118, 20, I18n.func_135053_a("enterprise.bank.modal.action.valid"));
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("enterprise.bank.modal.salary.title"), this.guiLeft + 53, this.guiTop + 16, 1644825, 1.3F, false, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.bank.modal.salary.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.bank.modal.salary.text_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(this.validButton.field_73742_g && this.isNumeric(this.leaderInput.func_73781_b()) && this.isNumeric(this.cadreInput.func_73781_b()) && this.isNumeric(this.employeeInput.func_73781_b()) && EnterpriseGui.hasPermission("salary") && mouseX > this.guiLeft + 190 && mouseX < this.guiLeft + 190 + 118 && mouseY > this.guiTop + 95 && mouseY < this.guiTop + 95 + 20) {
            ...
            hashMapForPacket.put("leader", Integer.valueOf(Integer.parseInt(this.leaderInput.func_73781_b())));
            hashMapForPacket.put("cadre", Integer.valueOf(Integer.parseInt(this.cadreInput.func_73781_b())));
            hashMapForPacket.put("employee", Integer.valueOf(Integer.parseInt(this.employeeInput.func_73781_b())));
