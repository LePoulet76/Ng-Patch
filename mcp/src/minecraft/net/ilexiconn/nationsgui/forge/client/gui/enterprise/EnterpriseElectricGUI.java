...
public class EnterpriseElectricGUI extends TabbedEnterpriseGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY)
    {
        ...
        if (loaded)
        {
            ...
            {
                this.priceButton = new GuiButton(0, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.getString("enterprise.electric.btnPrice").replace("<price>", String.format("%.0f", new Object[] {(Double)enterpriseElectricInfos.get("price")})));
            }
            else
            {
                this.priceButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
            }

            this.drawScaledString(I18n.getString("enterprise.electric.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
            ...
            ClientEventHandler.STYLE.bindTexture("enterprise_electric");
            this.drawScaledString(I18n.getString("enterprise.electric.label.available"), this.guiLeft + 288, this.guiTop + 148, 11842740, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.getString("enterprise.electric.label.total"), this.guiLeft + 288, this.guiTop + 199, 11842740, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0 && this.priceButton != null && this.priceButton.enabled && EnterpriseGui.hasPermission("electric") && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 165 && mouseY <= this.guiTop + 165 + 20)
        {
            Minecraft.getMinecraft().displayGuiScreen(new EnterpriseElectricPriceGui(this));
        }
    }
