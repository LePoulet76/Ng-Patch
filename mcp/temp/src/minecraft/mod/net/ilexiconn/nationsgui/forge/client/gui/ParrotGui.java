...
public class ParrotGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("gui.parrot." + this.selectedTab), (float)(this.guiLeft + (this.selectedTab.equals("warps_spawn")?50:83)), (float)(this.guiTop + 32), this.selectedTab.equals("warps_spawn")?16171012:7258350, 0.5F, "left", true, "georamaSemiBold", 25);
      if(this.selectedTab.equals("world")) {
         ...
         for(Iterator var6 = var11.iterator(); var6.hasNext(); ++var12) {
            ...
            if(this.selectedTab.contains("warps")) {
               ModernGui.drawScaledStringCustomFont(element.split("#")[1].equals("0")?"\u00a7o" + I18n.func_135053_a("gui.parrot.warps.free"):"\u00a7o" + element.split("#")[1] + "$", (float)(offsetX + 46), offsetY.floatValue() + 17.0F, isHovered?1908021:12237530, 0.5F, "center", false, "georamaSemiBold", 23);
            }
      ...
      if(!this.selectedTab.equals("map")) {
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("gui.parrot.tickets.title").toUpperCase(), (float)(this.guiLeft + 374), (float)(this.guiTop + 160), 12237530, 0.5F, "left", true, "minecraftDungeons", 23);
         ClientEventHandler.STYLE.bindTexture("parrot_main");
         if(loaded) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("gui.parrot.tickets.1er"), (float)(this.guiLeft + 400), (float)(this.guiTop + 178), hasNGPrime?1908021:11431662, 0.5F, "left", false, "georamaBold", 27);
            ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.func_135053_a("gui.parrot.tickets.free"), (float)(this.guiLeft + 400) + georamaBold27.getStringWidth(I18n.func_135053_a("gui.parrot.tickets.1er")) / 2.0F + 5.0F, (float)this.guiTop + 177.5F, hasNGPrime?1908021:11431662, 0.5F, "left", false, "georamaMedium", 25);
            ClientEventHandler.STYLE.bindTexture("parrot_main");
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("gui.parrot.tickets.2nd"), (float)(this.guiLeft + 400), (float)(this.guiTop + 200), hasNGPrime?4868744:1908021, 0.5F, "left", false, "georamaBold", 27);
            if(!hasNGPrime) {
               ModernGui.drawScaledStringCustomFont(this.selectedTab.equals("world")?String.format("%.0f", new Object[]{(Double)data.get("price")}) + "$":I18n.func_135053_a("gui.parrot.tickets.variable"), (float)(this.guiLeft + 400) + georamaBold27.getStringWidth(I18n.func_135053_a("gui.parrot.tickets.2nd")) / 2.0F + 5.0F, (float)this.guiTop + 199.5F, 1908021, 0.5F, "left", false, "georamaSemiBold", 25);
            }
         }
      }
