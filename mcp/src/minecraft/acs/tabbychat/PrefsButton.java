...
extends GuiButton {
    ...
    public void func_73737_a(Minecraft mc, int cursorX, int cursorY) {
        if (this.field_73748_h) {
            ...
            PrefsButton.func_73734_a((int)this.field_73746_c, (int)this.field_73743_d, (int)(this.field_73746_c + this.field_73747_a), (int)(this.field_73743_d + this.field_73745_b), (int)this.bgcolor);
