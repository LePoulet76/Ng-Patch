...
public class EnterpriseContractForm_Repair_Gui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(loaded) {
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.contract.label.concerned_country"), this.guiLeft + 197, this.guiTop + 53, 1644825, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.contract.label.price_repair"), this.guiLeft + 197, this.guiTop + 131, 1644825, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.contract.label.amount_repair"), this.guiLeft + 282, this.guiTop + 131, 1644825, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
         ...
         this.drawScaledString("\u00a74" + I18n.func_135053_a("enterprise.contract.label.total_price") + " \u00a7c" + totalPrice + "$", this.guiLeft + 197, this.guiTop + 166, 1644825, 1.0F, false, false);
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(loaded && this.validButton.field_73742_g && this.isNumeric(this.priceInput.func_73781_b()) && this.isNumeric(this.qteInput.func_73781_b()) && mouseX > this.guiLeft + 282 && mouseX < this.guiLeft + 282 + 80 && mouseY > this.guiTop + 197 && mouseY < this.guiTop + 197 + 20) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            String description = "REPAIR##" + (String)data.get("factionName") + "##" + this.priceInput.func_73781_b() + "##" + this.qteInput.func_73781_b();
            EnterpriseGui.lastContractDemand = Long.valueOf(System.currentTimeMillis());
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseContractCreate_Repair_Packet((String)EnterpriseGui.enterpriseInfos.get("name"), description, Integer.valueOf(Integer.parseInt(this.priceInput.func_73781_b().replaceAll("^0", "")) * Integer.parseInt(this.qteInput.func_73781_b().replaceAll("^0", ""))), Integer.valueOf(Integer.parseInt(this.qteInput.func_73781_b().replaceAll("^0", ""))))));
