...
public class EnterpriseCreateGui extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.createButton = new GuiButton(0, this.guiLeft + 303 - 122, this.guiTop + 211, 122, 20, I18n.func_135053_a("enterprise.create.create"));
      ...
      if(loaded) {
         if(((Double)createInfos.get("count")).doubleValue() >= ((Double)createInfos.get("canCreate")).doubleValue()) {
            ...
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(I18n.func_135053_a("enterprise.create.disable.count").split("##"));
            }
         } else if(((Double)createInfos.get("canJoin")).doubleValue() <= 0.0D) {
            this.createButton.field_73742_g = false;
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(I18n.func_135053_a("enterprise.create.max_join.count").split("##"));
            }
         } else if(((List)createInfos.get("types")).contains(this.selectedType)) {
            this.createButton.field_73742_g = false;
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("enterprise.create.disable.type")});
            }
         } else if(((List)createInfos.get("forbiddenTypes")).contains(this.selectedType)) {
            this.createButton.field_73742_g = false;
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("enterprise.create.forbidden.type")});
            }
         } else if(((List)createInfos.get("blockedByResearchTypes")).contains(this.selectedType)) {
            this.createButton.field_73742_g = false;
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("enterprise.create.blockedByResearchTypes.type")});
            }
         } else if(((List)createInfos.get("notAvailableTypes")).contains(this.selectedType)) {
            this.createButton.field_73742_g = false;
            if(mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("enterprise.create.not_available.type")});
            }
         } else {
            this.createButton.field_73742_g = true;
         }

         this.drawScaledString(I18n.func_135053_a("enterprise.create.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.4F, false, false);
         if(errorMessage != null && !errorMessage.isEmpty()) {
            this.drawScaledString(I18n.func_135053_a("enterprise.create.error." + errorMessage), this.guiLeft + 50, this.guiTop + 36, 1644825, 1.0F, false, false);
         }

         this.drawScaledString(I18n.func_135053_a("enterprise.create.name"), this.guiLeft + 51, this.guiTop + 49, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("enterprise.create.type"), this.guiLeft + 51, this.guiTop + 94, 1644825, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("enterprise.type." + this.selectedType), this.guiLeft + 53 + 16 + 2, this.guiTop + 110, 16777215, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("enterprise_create");
         if(this.selectedType != null && !this.selectedType.isEmpty() && EnterpriseGui.availableTypes.contains(this.selectedType)) {
            ...
            String[] var12 = I18n.func_135053_a("enterprise.create.type.desc." + this.selectedType).split(" ");
            String var13 = "";
            offsetY = 0;
            String[] var17 = var12;
            ...
            for(int var10 = 0; var10 < var9; ++var10) {
               ...
               if((double)this.field_73886_k.func_78256_a(var13 + descWord) * 0.9D <= 175.0D) {
                  if(!var13.equals("")) {
                     var13 = var13 + " ";
                  }
         ...
         if(this.typesExpanded) {
            ...
            for(i = 0; i < EnterpriseGui.availableTypes.size(); ++i) {
               ...
               this.drawScaledString(I18n.func_135053_a("enterprise.type." + (String)EnterpriseGui.availableTypes.get(i)), var15 + 2 + 16 + 3, var16.intValue() + 5, 16777215, 1.0F, false, false);
               ClientEventHandler.STYLE.bindTexture("enterprise_create");
         ...
         ClientEventHandler.STYLE.bindTexture("enterprise_create");
         String var14 = "\u00a77" + I18n.func_135053_a("enterprise.create.fee") + ": \u00a7f" + (int)((((Double)createInfos.get("count")).doubleValue() + 1.0D) * 15000.0D) + "$";
         this.drawScaledString(var14, this.guiLeft + 168 - this.field_73886_k.func_78256_a(var14), this.guiTop + 217, 16777215, 1.0F, false, false);
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(!this.enterpriseNameField.func_73781_b().isEmpty() && this.createButton.field_73742_g && this.selectedType != null && !this.selectedType.isEmpty() && mouseX >= this.guiLeft + 181 && mouseX <= this.guiLeft + 181 + 122 && mouseY >= this.guiTop + 211 && mouseY <= this.guiTop + 211 + 20) {
            ...
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseCreatePacket(this.enterpriseNameField.func_73781_b(), this.selectedType, (int)((((Double)createInfos.get("count")).doubleValue() + 1.0D) * 15000.0D))));
         }
