...
public class SellItemGUI extends GuiScreen {
   ...
   public SellItemGUI(ItemStack itemStack, int slotID) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if(itemStackInInventory != null && itemStackInInventory.func_77969_a(itemStack) && ItemStack.func_77970_a(itemStackInInventory, itemStack)) {
   ...
   protected void func_73864_a(int mouseX, int mouseY, int par3) {
      if(mouseX >= this.posX + 5 && mouseY >= this.posY + 118 && mouseX <= this.posX + 5 + 183 && mouseY <= this.posY + 118 + 19) {
         Minecraft.func_71410_x().func_71373_a(new AuctionSellItemGUI(this.itemStack, this.slotID));
      }
   ...
   public void func_73866_w_() {
      ...
      this.sellButton = new GuiButton(0, this.posX + 187, this.posY + 83, 70, 20, I18n.func_135053_a("hdv.sell.action"));
      this.field_73887_h.add(this.sellButton);
      this.field_73887_h.add(new StatsButton(1, this.posX + 191, this.posY + 13));
      this.radioButton = new RadioButton(this.posX + 257 - this.field_73886_k.func_78256_a(I18n.func_135053_a("hdv.ad")) - 12, this.posY + 55);
      super.func_73866_w_();
   }
   ...
   public void func_73863_a(int par1, int par2, float par3) {
      ...
      this.field_73886_k.func_78276_b(I18n.func_135053_a("hdv.sell.toAuctions"), this.posX + 5 + 23 + 25 + 10, this.posY + 118 + 5, 16777215);
      ModernGui.drawScaledString(this.itemStack.func_82833_r(), this.posX + 47, this.posY + 17, 16777215, 0.75F, true, false);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("hdv.sell.price"), this.posX + 82, this.posY + 30, 16777215);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("hdv.sell.quantity"), this.posX + 82, this.posY + 65, 16777215);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("hdv.ad"), this.posX + 257 - this.field_73886_k.func_78256_a(I18n.func_135053_a("hdv.ad")), this.posY + 55, 16777215);
      String t = "...";
      ...
      String s = I18n.func_135052_a("hdv.sell.taxes", new Object[]{t});
      this.field_73886_k.func_78276_b(s, this.posX + 257 - this.field_73886_k.func_78256_a(s), this.posY + 70, 16777215);
      if(this.price != null) {
