...
public class EnterpriseGlobalMarketDataPacket implements IPacket, IClientPacket
{
    ...
    {
        XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(676)).height(266)).title(I18n.getString("globalmarket.chart.prices"))).build();
        ...
        chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(676)).height(266)).title(I18n.getString("globalmarket.chart.sales"))).build();
        ((XYStyler)chart.getStyler()).setLegendPosition(LegendPosition.OutsideE);
        ((XYStyler)chart.getStyler()).setAxisTitlesVisible(false);
        ((XYStyler)chart.getStyler()).setChartBackgroundColor(new Color(255, 255, 255));
        ((XYStyler)chart.getStyler()).setLegendVisible(true);
        ...
        chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(676)).height(266)).title(I18n.getString("globalmarket.chart.stocks"))).build();
        ((XYStyler)chart.getStyler()).setLegendPosition(LegendPosition.OutsideE);
        ((XYStyler)chart.getStyler()).setAxisTitlesVisible(false);
        ((XYStyler)chart.getStyler()).setChartBackgroundColor(new Color(255, 255, 255));
        ((XYStyler)chart.getStyler()).setLegendVisible(true);
