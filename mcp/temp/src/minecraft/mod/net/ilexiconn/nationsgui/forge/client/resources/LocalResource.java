...
public class LocalResource implements Resource {
   ...
   public LocalResource(File file) throws IOException {
      ...
      this.srMetadataSerializer = (MetadataSerializer)ObfuscationReflectionHelper.getPrivateValue(Minecraft.class, Minecraft.func_71410_x(), new String[]{"metadataSerializer_", "field_110452_an", "ap"});
   }
