...
public class LoginType implements IAuthType {
   ...
   public void init(int x, int y, AuthGUI gui, List<GuiButton> buttonList) {
      ...
      buttonList.add(this.buttonLogin = new GuiButton(1, x + 119, y + 108, 100, 20, StatCollector.func_74838_a("nationsgui.auth.login")));
   ...
   public void render(int x, int y, int mouseX, int mouseY, AuthGUI gui) {
      Minecraft.func_71410_x().field_71466_p.func_78276_b(StatCollector.func_74838_a("nationsgui.auth.password"), x + 13, y + 50, 4210752);
