...
public class NoelMegaGiftGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(this.stars.size() < 40) {
         ...
         String firstKeyId = newStars.nextInt(this.field_73880_f) + "#" + newStars.nextInt(this.field_73881_g) + "#" + System.currentTimeMillis() + "#" + (System.currentTimeMillis() + (long)(newStars.nextInt(2000) + 1000)) + "#" + (newStars.nextInt(3) + 1) + "#" + (newStars.nextInt(80) + 20);
      ...
      short var32 = 3738;
      boolean var33 = false;
      ItemStack[] var34 = Minecraft.func_71410_x().field_71439_g.field_71071_by.field_70462_a;
      int var37 = var34.length;

      int currentHour;
      for(currentHour = 0; currentHour < var37; ++currentHour) {
         ItemStack currentMinute = var34[currentHour];
         if(currentMinute != null && currentMinute.func_77973_b().field_77779_bT == 3747) {
            var33 = true;
            break;
         }
      }
      ...
      while(var35 < 10) {
         ...
         boolean var39 = false;
         ItemStack[] currentSecond = Minecraft.func_71410_x().field_71439_g.field_71071_by.field_70462_a;
         ...
         while(true) {
            if(index < isHovered) {
               ...
               if(line == null || line.func_77973_b().field_77779_bT != var32 + var35) {
                  ++index;
                  continue;
               }
      ...
      if(!history.isEmpty()) {
         ...
         for(index = 0; index < history.size(); ++index) {
            ...
            if(!ClientProxy.cacheHeadPlayer.containsKey(var46)) {
               try {
                  ResourceLocation dateString = AbstractClientPlayer.field_110314_b;
                  dateString = AbstractClientPlayer.func_110311_f(var46);
                  AbstractClientPlayer.func_110304_a(dateString, var46);
                  ClientProxy.cacheHeadPlayer.put(var46, dateString);
               } catch (Exception var29) {
                  System.out.println(var29.getMessage());
               }
            } else {
               Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var46));
               this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var46));
