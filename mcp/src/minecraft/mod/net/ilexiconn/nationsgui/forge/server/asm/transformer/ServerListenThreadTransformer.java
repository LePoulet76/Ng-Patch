...
public class ServerListenThreadTransformer implements Transformer
{
    ...
    private void injectServerSocketReplacement(MethodNode method)
    {
        ...
        {
            if (newInstructions.getOpcode() == 181 && newInstructions instanceof FieldInsnNode && ((FieldInsnNode)newInstructions).name.equals("myServerSocket"))
            {
        ...
        if (targetPutFieldNode != null)
        {
            ...
            newInstructions1.add(new FieldInsnNode(180, "net/minecraft/server/ServerListenThread", "myServerSocket", "Ljava/net/ServerSocket;"));
            ...
            newInstructions1.add(new FieldInsnNode(181, "net/minecraft/server/ServerListenThread", "myServerSocket", "Ljava/net/ServerSocket;"));
