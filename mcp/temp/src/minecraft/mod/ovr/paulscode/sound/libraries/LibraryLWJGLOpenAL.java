...
import ovr.paulscode.sound.libraries.LibraryLWJGLOpenAL$Exception;
...
public class LibraryLWJGLOpenAL extends Library {
   ...
   public void init() throws SoundSystemException {
      ...
      try {
         ...
         this.printStackTrace((Exception)var6);
         throw new LibraryLWJGLOpenAL$Exception(var6.getMessage(), 101);
      }
   ...
   public void quickPlay(boolean priority, boolean toStream, boolean toLoop, String sourcename, FilenameURL filenameURL, float x, float y, float z, int attModel, float distOrRoll, boolean temporary) {
      ...
      if(!toStream) {
         ...
         if((myBuffer = (IntBuffer)this.ALBufferMap.get(filenameURL.getFilename())) == null) {
