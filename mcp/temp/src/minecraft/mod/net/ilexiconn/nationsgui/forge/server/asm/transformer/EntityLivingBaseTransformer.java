   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      while(var3.hasNext()) {
         ...
         if(!methodNode.name.equals("onNewPotionEffect") && !methodNode.name.equals("func_70670_a")) {
            ...
            } else if(methodNode.name.equals("onFinishedPotionEffect") || methodNode.name.equals("func_70688_c")) {
               var6 = insnList.toArray();
               var7 = var6.length;
            ...
            } else if(!methodNode.name.equals("setArrowCountInEntity") && !methodNode.name.equals("func_85034_r")) {
               if(methodNode.name.equals("getArrowCountInEntity") || methodNode.name.equals("func_85035_bI")) {
                  insnList.clear();
