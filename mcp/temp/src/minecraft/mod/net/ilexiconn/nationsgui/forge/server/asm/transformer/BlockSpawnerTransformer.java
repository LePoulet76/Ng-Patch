...
public class BlockSpawnerTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      while(getDamageValue.hasNext()) {
         ...
         if(insnList.name.equals(dev?"idPicked":"func_71922_a")) {
            ...
            insnList1.add(new FieldInsnNode(180, "net/minecraft/item/Item", dev?"itemID":"field_77779_bT", "I"));
            insnList1.add(new InsnNode(172));
            break;
         }
      }

      MethodNode getDamageValue1 = new MethodNode(1, dev?"getDamageValue":"func_71873_h", "(Lnet/minecraft/world/World;III)I", (String)null, (String[])null);
