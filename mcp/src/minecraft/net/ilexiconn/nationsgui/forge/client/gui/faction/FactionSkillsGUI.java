...
public class FactionSkillsGUI extends TabbedFactionGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        if (FactionGUI.loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.button.dashboard"), (float)(this.guiLeft + 42 + 33), (float)(this.guiTop + 80), this.displayMode.equals("dashboard") ? 7239406 : 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.button.players_leaderboard"), (float)(this.guiLeft + 108 + 33), (float)(this.guiTop + 80), this.displayMode.equals("players_leaderboard") ? 7239406 : 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.button.countries_leaderboard"), (float)(this.guiLeft + 174 + 33), (float)(this.guiTop + 80), this.displayMode.equals("countries_leaderboard") ? 7239406 : 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            ...
            if (loaded_dashboard)
            {
                ...
                if (this.displayMode.equals("dashboard"))
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.top_members"), (float)(this.guiLeft + 253), (float)(this.guiTop + 111), 16777215, 0.5F, "left", false, "georamaSemiBold", 30);
                    var16 = 0;
                    ...
                    for (Iterator var20 = ((ArrayList)dashboardData.get("top5Members")).iterator(); var20.hasNext(); ++var16)
                    {
                        ...
                        if (!ClientProxy.cacheHeadPlayer.containsKey(offsetX))
                        {
                            try
                            {
                                ...
                                var26 = AbstractClientPlayer.getLocationSkin(offsetX);
                                AbstractClientPlayer.getDownloadImageSkin(var26, offsetX);
                        ...
                        {
                            Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(offsetX));
                            this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(offsetX));
                ...
                else
                {
                    ...
                    if (this.displayMode.equals("players_leaderboard") && loaded_players_leaderboard)
                    {
                        if (!ClientProxy.cacheHeadPlayer.containsKey(Minecraft.getMinecraft().thePlayer.username))
                        {
                            try
                            {
                                ResourceLocation var17 = AbstractClientPlayer.locationStevePng;
                                var17 = AbstractClientPlayer.getLocationSkin(Minecraft.getMinecraft().thePlayer.username);
                                AbstractClientPlayer.getDownloadImageSkin(var17, Minecraft.getMinecraft().thePlayer.username);
                                ClientProxy.cacheHeadPlayer.put(Minecraft.getMinecraft().thePlayer.username, var17);
                            }
                        ...
                        ModernGui.drawScaledStringCustomFont(Minecraft.getMinecraft().thePlayer.username, var10001, var10002, 7239406, 0.5F, "left", false, "georamaMedium", 28);
                        ...
                        for (var16 = 0; var16 < ((List)playersLeaderboard.get(this.selectedSkillLeaderboard)).size(); ++var16)
                        {
                            ...
                            if (!ClientProxy.cacheHeadPlayer.containsKey(var23))
                            {
                                try
                                {
                                    ...
                                    e = AbstractClientPlayer.getLocationSkin(var23);
                                    AbstractClientPlayer.getDownloadImageSkin(e, var23);
                            ...
                            {
                                Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var23));
                                this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var23));
                    ...
                    else if (this.displayMode.equals("countries_leaderboard") && loaded_countries_leaderboard)
                    {
                        ...
                        for (firstEntry = 0; firstEntry < ((List)countriesLeaderboard.get(this.selectedSkillLeaderboard)).size(); ++firstEntry)
                        {
                            ...
                            {
                                GL11.glBindTexture(GL11.GL_TEXTURE_2D, ((DynamicTexture)ClientProxy.flagsTexture.get(var21)).getGlTextureId());
                ...
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.filters"), (float)(this.guiLeft + 253), (float)(this.guiTop + 111), 16777215, 0.5F, "left", false, "georamaSemiBold", 30);
                    ...
                    if (this.displayMode.equals("players_leaderboard"))
                    {
                        ...
                        ModernGui.drawSectionStringCustomFont(I18n.getString("faction.skills.label.only_country"), (float)(this.guiLeft + 253 + 10), (float)(this.guiTop + 198), 14342893, 0.5F, "left", false, "georamaMedium", 24, 7, 120);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.score"), (float)(this.guiLeft + 363), (float)(this.guiTop + 115), 16777215, 0.5F, "left", false, "georamaMedium", 26);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.leaderboard"), (float)(this.guiLeft + 363), (float)(this.guiTop + 140), 16777215, 0.5F, "left", false, "georamaMedium", 26);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.global_note"), (float)(this.guiLeft + 363), (float)(this.guiTop + 165), 16777215, 0.5F, "left", false, "georamaMedium", 26);
                ...
                GUIUtils.endGLScissor();
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.type"), (float)(this.guiLeft + 363), (float)(this.guiTop + 190), 16777215, 0.5F, "left", false, "georamaMedium", 26);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.skills.label.country_type." + var19), (float)(this.guiLeft + 363), (float)(this.guiTop + 198), 16777215, 0.5F, "left", false, "georamaBold", 32);
            }
        }
