...
public class NationsGUI {
   ...
   public static Block RADIO = null;
   public static Block URL = null;
   public static Block IMAGE_HOLOGRAM = null;
   public static final Block SPEAKER = new SpeakerBlock();
   public static final Block INCUBATOR = new IncubatorBlock();
   public static final Block REPAIR_MACHINE = new RepairMachineBlock();
   public static final Item MOB_SPAWNER = new MobSpawnerItem();
   public static final Item CHRISTMAS_DISK = new ChristmasRecord();
   public static final Item ROTTEN_FOOD = new ItemRottenFood();
   public static final Item ITEM_BADGE = (new ItemBadge(5090)).func_77655_b("badgeItem");
   public static final Block HATBLOCK = new HatBlock();
   public static final Block PORTAL = new PortalBlock();
   public static final Item PORTAL_ITEM = new ItemBlockPortal(PORTAL);
   ...
   public static void addWaterInFeeder(String worldName, Integer posX, Integer posY, Integer posZ) {
      ...
      WorldServer[] tile = MinecraftServer.func_71276_C().field_71305_c;
      int var6 = tile.length;

      for(int var7 = 0; var7 < var6; ++var7) {
         WorldServer worldServer = tile[var7];
         if(worldServer.func_72912_H().func_76065_j().equalsIgnoreCase(worldName)) {
            world = worldServer;
         }
      }

      if(world != null) {
         TileEntity var9 = world.func_72796_p(posX.intValue(), posY.intValue(), posZ.intValue());
   ...
   public static void openCountryChest(EntityPlayer player, String factionId, int chestLevel) {
      ...
      if(pl != null) {
         try {
            ...
            boolean res = ((Boolean)e.invoke(pl, new Object[]{player.field_71092_bJ, factionId})).booleanValue();
            if(res) {
               ...
               player.openGui(INSTANCE, 666, player.field_70170_p, (int)player.field_70165_t, (int)player.field_70163_u, (int)player.field_70161_v);
            }
         } catch (InvocationTargetException var6) {
            var6.printStackTrace();
         }
   ...
   public static void setPlayerAvailableBadges(String player, String badges) {
      ...
      if(!user.func_74764_b("AvailableBadges")) {
         user.func_74782_a("AvailableBadges", new NBTTagString(""));
      }
            ...
            if(e != null) {
               try {
                  ...
                  try {
                     ...
                     WorldServer forgeWorld = MinecraftServer.func_71276_C().func_71218_a(m);
                     if(forgeWorld != null) {
                        e1 = forgeWorld.func_72912_H().func_76065_j();
                     }
   ...
   public static void placeMobSpawnerAt(String world, int x, int y, int z, String mobId) {
      ...
      WorldServer[] var8 = MinecraftServer.func_71276_C().field_71305_c;
      int var7 = var8.length;

      for(int var81 = 0; var81 < var7; ++var81) {
         WorldServer worldServer1 = var8[var81];
         if(worldServer1.func_72912_H().func_76065_j().equals(world)) {
      ...
      if(worldServer != null) {
         ...
         TileEntityMobSpawner var10 = (TileEntityMobSpawner)worldServer.func_72796_p(x, y, z);
         if(var10 != null) {
            var10.func_98049_a().func_98272_a(mobId);
         }
      }
   ...
   public static boolean hasSiloEnoughCereal(int blockX, int blockY, int blockZ, String worldName, String cerealType, int quantity) {
      ...
      if(world != null) {
         TileEntity var11 = world.func_72796_p(blockX, blockY, blockZ);
   ...
   public static void deployPlayerParachute(String playerName) {
      EntityPlayerMP entityPlayerMP = MinecraftServer.func_71276_C().func_71203_ab().func_72361_f(playerName);
      if(entityPlayerMP != null) {
         EntityParachute var18 = new EntityParachute(entityPlayerMP.field_70170_p, ToolType.getType("mwParachute"), entityPlayerMP);
         entityPlayerMP.field_70170_p.func_72838_d(var18);
         entityPlayerMP.func_70078_a(var18);
      }
   ...
   public static void reduceBorder(String worldName, String borderName, double ratio, int duration) {
      WorldServer world = null;
      WorldServer[] worldExtension = MinecraftServer.func_71276_C().field_71305_c;
      int worldBorder = worldExtension.length;

      for(int data = 0; data < worldBorder; ++data) {
         WorldServer e = worldExtension[data];
         if(e.func_72912_H().func_76065_j().equalsIgnoreCase(worldName)) {
            world = e;
         }
      }
      ...
      if(world != null) {
         ...
         if(var11.getWorldBorders().containsKey(borderName)) {
            ...
            try {
               ...
               var11.func_76187_b(var14);
               CompressedStreamTools.func_74800_a(var14, var13);
   ...
   public void onPreInit(FMLPreInitializationEvent event) {
      ...
      GameRegistry.registerBlock(URL, "url");
      GameRegistry.registerBlock(IMAGE_HOLOGRAM, "imagehologram");
      GameRegistry.registerTileEntity(RadioBlockEntity.class, "radio_entity");
      GameRegistry.registerTileEntity(URLBlockEntity.class, "url_entity");
      GameRegistry.registerTileEntity(ImageHologramBlockEntity.class, "imagehologram_entity");
      GameRegistry.registerBlock(SPEAKER, SpeakerItem.class, "speaker");
      GameRegistry.registerTileEntity(SpeakerBlockEntity.class, "speaker_entity");
      GameRegistry.registerBlock(REPAIR_MACHINE, "repair_machine");
      GameRegistry.registerTileEntity(RepairMachineBlockEntity.class, "repair_machine_entity");
      ...
      GameRegistry.registerBlock(PORTAL, "island_portal");
      GameRegistry.registerTileEntity(PortalBlockEntity.class, "island_portal_entity");
      GameRegistry.registerItem(PORTAL_ITEM, "island_portal_item");
      GameRegistry.registerTileEntity(TileEntityHatBlock.class, "nggui:tileHatBlock");
      GameRegistry.registerBlock(HATBLOCK, HatBlockItem.class, "hatblock");
