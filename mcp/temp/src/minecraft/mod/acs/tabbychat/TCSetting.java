...
public class TCSetting extends GuiButton {
   ...
   protected Boolean hovered(int cursorX, int cursorY) {
      return Boolean.valueOf(cursorX >= this.field_73746_c && cursorY >= this.field_73743_d && cursorX < this.field_73746_c + this.field_73747_a && cursorY < this.field_73743_d + this.field_73745_b);
   }
