...
extends GuiScreen {
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ModernGui.drawScaledString("URL", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("URL") - 5, this.field_73881_g / 2 - 9 + 4, 0xFFFFFF, 1.0f, false, true);
        this.urlField.func_73795_f();
        ModernGui.drawScaledString("Image Width", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Image Width") - 5, this.field_73881_g / 2 - 9 + 26, 0xFFFFFF, 1.0f, false, true);
        this.imgWidth.func_73795_f();
        ModernGui.drawScaledString("Image Height", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Image Height") - 5, this.field_73881_g / 2 - 9 + 48, 0xFFFFFF, 1.0f, false, true);
        this.imgHeight.func_73795_f();
        ModernGui.drawScaledString("Size (%)", this.field_73880_f / 2 - 70 - this.field_73886_k.func_78256_a("Size (%)") - 5, this.field_73881_g / 2 - 9 + 70, 0xFFFFFF, 1.0f, false, true);
    ...
    public void func_73874_b() {
        ...
        if (!this.imgWidth.func_73781_b().isEmpty() && ImageHologramGUI.isNumeric(this.imgWidth.func_73781_b(), false)) {
            this.blockEntity.imgWidth = Integer.parseInt(this.imgWidth.func_73781_b());
        }
        if (!this.imgHeight.func_73781_b().isEmpty() && ImageHologramGUI.isNumeric(this.imgHeight.func_73781_b(), false)) {
            this.blockEntity.imgHeight = Integer.parseInt(this.imgHeight.func_73781_b());
        }
        if (!this.size.func_73781_b().isEmpty() && ImageHologramGUI.isNumeric(this.size.func_73781_b(), false)) {
            this.blockEntity.size = Integer.parseInt(this.size.func_73781_b());
        }
        PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new ImageHologramSavePacket(this.blockEntity)));
    }
}
