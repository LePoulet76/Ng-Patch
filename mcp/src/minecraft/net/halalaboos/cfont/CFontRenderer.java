...
import net.halalaboos.cfont.CFont;
...
extends CFont {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (character == '\u00a7' && i < size) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        GL11.glColor4f((float)((float)(colorcode >> 16 & 0xFF) / 255.0f), (float)((float)(colorcode >> 8 & 0xFF) / 255.0f), (float)((float)(colorcode & 0xFF) / 255.0f), (float)alpha);
                    } else if (colorIndex == 16) {
                        randomCase = true;
                    } else if (colorIndex == 17) {
                        bold = true;
                        if (italic) {
                            GL11.glBindTexture((int)3553, (int)this.texItalicBold.func_110552_b());
                            currentData = this.boldItalicChars;
                        } else {
                            GL11.glBindTexture((int)3553, (int)this.texBold.func_110552_b());
                        ...
                        if (bold) {
                            ...
                            GL11.glBindTexture((int)3553, (int)this.texItalic.func_110552_b());
    ...
    public float getStringWidth(String text) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (character >= currentData.length || character < '\u0000') continue;
            width += (float)(currentData[character].width - 8 + this.charOffset);
        }
        return width / 2.0f;
    }
