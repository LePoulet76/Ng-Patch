...
public class EnterpriseElectricDataPacket implements IPacket, IClientPacket {
   ...
   public void handleClientPacket(EntityPlayer player) {
      XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(496)).height(190)).title(I18n.func_135053_a("enterprise.STATS_TEXTURE.electric.title"))).build();
