...
public class CreateGui extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.createButton = new GuiButton(0, this.guiLeft + 186, this.guiTop + 201, 122, 20, I18n.getString("faction.create.create"));
        this.redirectButton = new GuiButton(1, this.guiLeft + 97, this.guiTop + 130, 160, 20, I18n.getString("faction.create.redirect"));
        this.leaveButton = new GuiButton(2, this.guiLeft + 97, this.guiTop + 140, 160, 20, I18n.getString("faction.create.leave"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (countries != null && countries.size() > 0)
        {
            ...
            if ((NationsGUIClientHooks.whitelistedStaff == null || !NationsGUIClientHooks.whitelistedStaff.contains(Minecraft.getMinecraft().thePlayer.getDisplayName())) && System.currentTimeMillis() - ClientProxy.clientConfig.currentServerTime.longValue() < 10800000L)
            {
                this.createButton.enabled = false;

                if (mouseX >= this.guiLeft + 186 && mouseX <= this.guiLeft + 186 + 122 && mouseY >= this.guiTop + 201 && mouseY <= this.guiTop + 201 + 20)
                {
                    this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("faction.create.cooldown")}), mouseX, mouseY, this.fontRenderer);
                }
            }
        }
        ...
        this.drawScaledString(I18n.getString("faction.create.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.4F, false, false);
        this.drawScaledString(I18n.getString("faction.create.map"), this.guiLeft + 51, this.guiTop + 83, 1644825, 0.8F, false, false);
        this.drawScaledString(I18n.getString("faction.create.location"), this.guiLeft + 187, this.guiTop + 83, 1644825, 0.8F, false, false);
        ClientEventHandler.STYLE.bindTexture("faction_create");

        if (playerHasCountry)
        {
            Gui.drawRect(this.guiLeft + 45, this.guiTop + 30, this.guiLeft + 45 + 266, this.guiTop + 30 + 209, -1513240);
            this.drawScaledString(I18n.getString("faction.create.hascountry_1"), this.guiLeft + 177, this.guiTop + 100, 328965, 1.1F, true, false);
            this.drawScaledString(I18n.getString("faction.create.hascountry_2"), this.guiLeft + 177, this.guiTop + 110, 328965, 1.1F, true, false);
        ...
        else if (countries != null && countries.size() > 0)
        {
            if (selectedCountry != null && !selectedCountry.isEmpty())
            {
                ...
                this.drawScaledString(I18n.getString("faction.create.announce"), this.guiLeft + 200, this.guiTop + 157, 1644825, 0.9F, false, false);
                ClientEventHandler.STYLE.bindTexture("faction_create");
        ...
        {
            Gui.drawRect(this.guiLeft + 45, this.guiTop + 30, this.guiLeft + 45 + 266, this.guiTop + 30 + 209, -1513240);
            this.drawScaledString(I18n.getString("faction.create.unavailable"), this.guiLeft + 177, this.guiTop + 100, 328965, 1.1F, true, false);
            this.redirectButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            {
                this.mc.displayGuiScreen(new SearchGui());
            }

            if ((NationsGUIClientHooks.whitelistedStaff != null && NationsGUIClientHooks.whitelistedStaff.contains(Minecraft.getMinecraft().thePlayer.getDisplayName()) || System.currentTimeMillis() - ClientProxy.clientConfig.currentServerTime.longValue() > 10800000L) && this.createButton.enabled && selectedCountry != null && !selectedCountry.isEmpty() && mouseX >= this.guiLeft + 186 && mouseX <= this.guiLeft + 186 + 122 && mouseY >= this.guiTop + 201 && mouseY <= this.guiTop + 201 + 20)
            {
