...
public class EnterpriseFarmDataPacket implements IPacket, IClientPacket {
   ...
   public void handleClientPacket(EntityPlayer player) {
      XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(536)).height(226)).title(I18n.func_135053_a("enterprise.STATS_TEXTURE.farm.title"))).build();
