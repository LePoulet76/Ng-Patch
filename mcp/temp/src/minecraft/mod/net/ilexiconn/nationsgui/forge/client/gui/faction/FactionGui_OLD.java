...
public class FactionGui_OLD extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.joinButton = new GuiButton(0, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.func_135053_a("faction.home.button.join"));
      this.tpHomeButton = new GuiButton(1, this.guiLeft + 10, this.guiTop + 165, 100, 20, I18n.func_135053_a("faction.home.button.tphome"));
      this.leaveButton = new TexturedCenteredButtonGUI(2, this.guiLeft + 10, this.guiTop + 220, 100, 20, "faction_btn", 0, 0, I18n.func_135053_a("faction.home.button.leave"));
      this.buyButton = new TexturedCenteredButtonGUI(3, this.guiLeft + 10, this.guiTop + 190, 100, 20, "faction_btn", 0, 0, I18n.func_135053_a("faction.home.button.buy"));
      if(factionInfos != null && ((Boolean)factionInfos.get("isLeader")).booleanValue()) {
         if(((String)factionInfos.get("name")).contains("Empire")) {
            this.empireButton = new GuiButton(4, this.guiLeft + 10, this.guiTop + 220, 100, 20, I18n.func_135053_a("faction.home.button.empire_down"));
         } else {
            this.empireButton = new GuiButton(4, this.guiLeft + 10, this.guiTop + 220, 100, 20, I18n.func_135053_a("faction.home.button.empire_up"));
      ...
      if(loaded && factionInfos != null && factionInfos.size() > 0 && !((String)factionInfos.get("name")).contains("Wilderness") && !((String)factionInfos.get("name")).contains("SafeZone") && !((String)factionInfos.get("name")).contains("WarZone")) {
         ...
         if(this.empireButton != null) {
            ...
            if(!this.empireButton.field_73742_g && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 220 && mouseY <= this.guiTop + 220 + 20) {
               toolTipLines = Arrays.asList(new String[]{I18n.func_135053_a("faction.home.tooltip.empire_under_level")});
            }
         }
         ...
         if(!((Boolean)factionInfos.get("isInCountry")).booleanValue() && ((Boolean)factionInfos.get("playerHasFaction")).booleanValue()) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.home.button.own_country"), this.guiLeft + 31, this.guiTop + 254, 16777215, 1.0F, false, false);
         }

         this.drawScaledString(I18n.func_135053_a("faction.tab.home"), this.guiLeft + 131, this.guiTop + 16, 1644825, 1.4F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.common.age_1") + " " + factionInfos.get("age") + " " + I18n.func_135053_a("faction.common.age_2"), this.guiLeft + 60, this.guiTop + 43, 11842740, 0.65F, true, false);
         if(hasPermissions("relations") && !((Boolean)factionInfos.get("isInCountry")).booleanValue()) {
            this.drawScaledString(I18n.func_135053_a("faction.common." + factionInfos.get("actualRelation")), this.guiLeft + 17, this.guiTop + 66, 1644825, 1.0F, false, false);
            ClientEventHandler.STYLE.bindTexture("faction_main");
            ...
            this.drawScaledString(I18n.func_135053_a("faction.common." + factionInfos.get("actualRelation")), this.guiLeft + 58, this.guiTop + 66, 1644825, 1.0F, true, false);
         }
         ...
         if(hasPermissions("relations") && this.relationExpanded && var22.size() > 0 && !((Boolean)factionInfos.get("isInCountry")).booleanValue()) {
            ...
            if(var22.size() > 0) {
               for(int descriptionWords = 0; descriptionWords < var22.size(); ++descriptionWords) {
                  ...
                  this.drawScaledString(I18n.func_135053_a("faction.common." + (String)var22.get(descriptionWords)), line + 6, lineNumber.intValue() + 5, 16777215, 1.0F, false, false);
               }
            }
         ...
         for(int tooltipToDraw = 0; tooltipToDraw < infosLength; ++tooltipToDraw) {
            ...
            if(this.field_73886_k.func_78256_a(var24 + countOfflinePlayers) <= 150) {
               if(!var24.equals("")) {
                  var24 = var24 + " ";
               }
         ...
         if(Integer.parseInt((String)factionInfos.get("age")) < 2) {
            ...
            if(mouseX >= this.guiLeft + 105 && mouseX <= this.guiLeft + 105 + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10) {
               this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.young")}), mouseX, mouseY, this.field_73886_k);
            }
         ...
         if(((Boolean)factionInfos.get("isEmpire")).booleanValue()) {
            ...
            if(mouseX >= this.guiLeft + 105 - var26 && mouseX <= this.guiLeft + 105 - var26 + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10) {
               this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.empire")}), mouseX, mouseY, this.field_73886_k);
            }
            ...
            if(mouseX >= this.guiLeft + 105 - var26 && mouseX <= this.guiLeft + 105 - var26 + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10) {
               if(!((Boolean)factionInfos.get("isInCountry")).booleanValue() && !factionInfos.get("playerWhoSeeFactionId").equals(factionInfos.get("colonizedByFactionId"))) {
                  this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.colony") + " " + factionInfos.get("isColony")}), mouseX, mouseY, this.field_73886_k);
               } else {
                  this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.colony") + " " + factionInfos.get("isColony"), I18n.func_135053_a("faction.common.badge.colony_tax") + " " + factionInfos.get("colonyTax") + "%"}), mouseX, mouseY, this.field_73886_k);
               }
            }
         ...
         if(((Boolean)factionInfos.get("isTopWarzone")).booleanValue()) {
            ...
            if(mouseX >= this.guiLeft + 105 - var26 && mouseX <= this.guiLeft + 105 - var26 + 10 && mouseY >= this.guiTop + 50 && mouseY <= this.guiTop + 50 + 10) {
               this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.common.badge.warzone")}), mouseX, mouseY, this.field_73886_k);
            }
         }

         ClientEventHandler.STYLE.bindTexture("faction_main");
         this.drawScaledString(I18n.func_135053_a("faction.home.infos_level") + " : " + factionInfos.get("level") + "  " + I18n.func_135053_a("faction.home.infos_mmr") + " : " + factionInfos.get("mmr") + "  " + I18n.func_135053_a("faction.home.infos_power") + " : " + factionInfos.get("power") + "/" + factionInfos.get("maxpower") + "  " + I18n.func_135053_a("faction.home.infos_claims") + " : " + factionInfos.get("claims"), this.guiLeft + 257, this.guiTop + 114, 11842740, 0.8F, true, false);
         Double var27 = Double.valueOf((double)this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.home.infos_level") + " : " + factionInfos.get("level") + "  " + I18n.func_135053_a("faction.home.infos_mmr") + " : " + factionInfos.get("mmr") + "  " + I18n.func_135053_a("faction.home.infos_power") + " : " + factionInfos.get("power") + "/" + factionInfos.get("maxpower") + "  " + I18n.func_135053_a("faction.home.infos_claims") + " : " + factionInfos.get("claims")) * 0.8D);
         ...
         if(Integer.parseInt((String)factionInfos.get("powerboost")) != 0) {
            Double var28 = Double.valueOf((double)this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.home.infos_level") + " : " + factionInfos.get("level") + "  " + I18n.func_135053_a("faction.home.infos_mmr") + " : " + factionInfos.get("mmr") + "  ") * 0.8D);
               ...
               if(!((String)factionInfos.get("powerboost_others")).isEmpty()) {
                  ...
                  for(x = 0; x < type; ++x) {
                     ...
                     if(y.split("#")[1].contains("-")) {
                        var30.add("\u00a7c" + I18n.func_135053_a("faction.home.tooltip.war_against") + " " + y.split("#")[0] + ": \u00a74" + y.split("#")[1]);
                     } else {
                        var30.add("\u00a7a" + I18n.func_135053_a("faction.home.tooltip.war_against") + " " + y.split("#")[0] + ": \u00a72" + y.split("#")[1]);
                     }
                  }
               }
         ...
         String var29 = "";
         this.hoveredPlayer = "";
         this.drawScaledString(I18n.func_135053_a("faction.home.players_online") + " (" + ((ArrayList)factionInfos.get("players_online")).size() + ")", this.guiLeft + 131, this.guiTop + 133, 1644825, 0.85F, false, false);
         int var31;
         String var33;
         if(((ArrayList)factionInfos.get("players_online")).size() > 0) {
            ...
            for(var31 = 0; var31 < ((ArrayList)factionInfos.get("players_online")).size(); ++var31) {
               ...
               try {
                  ResourceLocation offsetY = AbstractClientPlayer.field_110314_b;
                  offsetY = AbstractClientPlayer.func_110311_f(var32);
                  AbstractClientPlayer.func_110304_a(offsetY, var32);
                  Minecraft.func_71410_x().field_71446_o.func_110577_a(offsetY);
                  this.field_73882_e.func_110434_K().func_110577_a(offsetY);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.home.players_offline") + " (" + var31 + ")", this.guiLeft + 260, this.guiTop + 133, 1644825, 0.85F, false, false);
         int var34;
         int var37;
         if(((ArrayList)factionInfos.get("players_offline")).size() > 0) {
            ...
            for(var34 = 0; var34 < ((ArrayList)factionInfos.get("players_offline")).size(); ++var34) {
               ...
               try {
                  ...
                  resourceLocation = AbstractClientPlayer.func_110311_f(var33);
                  AbstractClientPlayer.func_110304_a(resourceLocation, var33);
         ...
         for(var34 = 0; var34 < TABS.size(); ++var34) {
            ...
            if(!var38.getClassReferent().equals(SettingsGUI_OLD.class)) {
               if(mouseX >= this.guiLeft - 23 && mouseX <= this.guiLeft - 23 + 29 && mouseY >= this.guiTop + 20 + var34 * 31 && mouseY <= this.guiTop + 20 + 30 + var34 * 31) {
                  this.drawHoveringText(Arrays.asList(new String[]{I18n.func_135053_a("faction.tab." + var38.getClassReferent().getSimpleName())}), mouseX, mouseY, this.field_73886_k);
               }
         ...
         if(!((List)toolTipLines).isEmpty()) {
            this.drawHoveringText((List)toolTipLines, mouseX, mouseY, this.field_73886_k);
         }
      ...
      if(mouseButton == 0) {
         ...
         if(factionInfos != null && (((Boolean)factionInfos.get("isInCountry")).booleanValue() || factionInfos.containsKey("isOp") && ((Boolean)factionInfos.get("isOp")).booleanValue()) && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 165 && mouseY <= this.guiTop + 165 + 20) {
            ...
            if(this.hoveredRelation.equals("enemy")) {
               Minecraft.func_71410_x().func_71373_a(new EnemyConfirmGui(this));
            } else if(this.hoveredRelation.equals("colony")) {
               Minecraft.func_71410_x().func_71373_a(new ColonyConfirmGui(this));
            } else {
            ...
            Minecraft.func_71410_x().func_71373_a(new LevelGui(this));
         }
      }
