   ...
   public void transform(ClassNode node, boolean dev) {
      if(!NationsGUITransformer.isServer) {
         ...
         while(var3.hasNext()) {
            ...
            if(m.name.equalsIgnoreCase("func_110544_b") && m.desc.equalsIgnoreCase("()V")) {
               ...
               for(int var8 = 0; var8 < var7; ++var8) {
                  ...
                  if(i instanceof MethodInsnNode) {
                     ...
                     if(insn.owner.equalsIgnoreCase("net/minecraft/client/resources/ResourceManagerReloadListener") && insn.name.equalsIgnoreCase("func_110549_a") && insn.desc.equalsIgnoreCase("(Lnet/minecraft/client/resources/ResourceManager;)V")) {
