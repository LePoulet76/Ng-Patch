...
public class TCSettingsFilters extends TCSettingsGUI {
   ...
   public void validateButtonStates() {
      this.inverseMatch.field_73742_g = !this.highlightBool.getTempValue().booleanValue();
      this.caseSensitive.field_73742_g = true;
      this.highlightBool.field_73742_g = !this.removeMatches.getTempValue().booleanValue() && !this.inverseMatch.getTempValue().booleanValue();
      this.audioNotificationBool.field_73742_g = !this.removeMatches.getTempValue().booleanValue();
      this.removeMatches.field_73742_g = !this.sendToTabBool.getTempValue().booleanValue() && !this.highlightBool.getTempValue().booleanValue() && !this.audioNotificationBool.getTempValue().booleanValue();
      this.sendToTabBool.field_73742_g = !this.removeMatches.getTempValue().booleanValue();
      this.highlightColor.field_73742_g = this.highlightBool.getTempValue().booleanValue();
      this.highlightFormat.field_73742_g = this.highlightBool.getTempValue().booleanValue();
      this.audioNotificationSound.field_73742_g = this.audioNotificationBool.getTempValue().booleanValue();
      this.sendToAllTabs.field_73742_g = this.sendToTabBool.getTempValue().booleanValue();
      ...
      for(int i = 0; i < this.field_73887_h.size(); ++i) {
         if(TCSetting.class.isInstance(this.field_73887_h.get(i))) {
            ...
            if(this.numTempFilters == 0) {
               ...
               ((TCSettingBool)tmp).setTempValue(Boolean.valueOf(((TCSettingBool)tmp).getTempValue().booleanValue() && tmp.field_73742_g));
            }
         }
      }
