...
public class CommandRefill extends CommandBase {
   ...
   public void func_71515_b(ICommandSender icommandsender, String[] astring) {
      if(icommandsender instanceof EntityPlayer) {
         ...
         if(itemStack == null) {
            entityPlayer.func_70006_a(ChatMessageComponent.func_111077_e("nationsgui.command.refill.refused"));
            return;
         }
         ...
         if(itemStack.field_77993_c == ICBMExplosion.itemMissile.field_77779_bT) {
            if(itemStack.func_77942_o()) {
               itemStack.func_77978_p().func_74776_a("missileFuel", ItemMissile.getMaxFuelQuantity(itemStack));
               done = true;
            }
         ...
         if(done) {
            entityPlayer.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.refill.done", new Object[]{itemStack.func_82833_r()}));
         } else {
            entityPlayer.func_70006_a(ChatMessageComponent.func_111077_e("nationsgui.command.refill.refused"));
         }
      }
