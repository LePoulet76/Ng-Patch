...
public class DiplomatieWishGUI extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.diplomatie_wish.title"), this.guiLeft + 51, this.guiTop + 17, 1644825, 1.2F, false, false);
      this.hoveredCountryFlag = "";
      this.hoveredCountry = "";
      this.hoveredAction = "";
      this.hoveredRelationType = "";
      this.drawScaledString(I18n.func_135053_a("faction.diplomatie_wish.received"), this.guiLeft + 57, this.guiTop + 44, 1644825, 0.9F, false, false);
      ...
      if(received != null && received.size() > 0) {
         ...
         for(int sent = 0; sent < received.size(); ++sent) {
            ...
            if(this.cachedFlags.containsKey(l.get("factionName")) && this.cachedFlags.get(l.get("factionName")) != null) {
               GL11.glBindTexture(3553, ((DynamicTexture)this.cachedFlags.get(l.get("factionName"))).func_110552_b());
            ...
            this.drawScaledString(I18n.func_135053_a("faction.common." + ((String)l.get("relationType")).toLowerCase()), paysInfos + 28, offsetX.intValue() + 6, 16777215, 1.0F, false, false);
      ...
      this.drawScaledString(I18n.func_135053_a("faction.diplomatie_wish.sent"), this.guiLeft + 188, this.guiTop + 44, 1644825, 0.9F, false, false);
      ...
      if(var11 != null && var11.size() > 0) {
         ...
         for(int var12 = 0; var12 < var11.size(); ++var12) {
            ...
            if(this.cachedFlags.containsKey(var13.get("factionName")) && this.cachedFlags.get(var13.get("factionName")) != null) {
               GL11.glBindTexture(3553, ((DynamicTexture)this.cachedFlags.get(var13.get("factionName"))).func_110552_b());
            ...
            this.drawScaledString(I18n.func_135053_a("faction.common." + ((String)var13.get("relationType")).toLowerCase()), var14 + 28, var15.intValue() + 6, 16777215, 1.0F, false, false);
            if(((Boolean)FactionGui_OLD.factionInfos.get("isInCountry")).booleanValue() && ((Boolean)FactionGui_OLD.factionInfos.get("isAtLeastOfficer")).booleanValue()) {
               ClientEventHandler.STYLE.bindTexture("faction_diplomatie_wish");
      ...
      if(!this.hoveredCountryFlag.isEmpty()) {
         this.drawHoveringText(Arrays.asList(new String[]{this.hoveredCountryFlag}), mouseX, mouseY, this.field_73886_k);
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         if(mouseX > this.guiLeft + 320 && mouseX < this.guiLeft + 320 + 9 && mouseY > this.guiTop - 6 && mouseY < this.guiTop - 6 + 10) {
            ...
            Minecraft.func_71410_x().func_71373_a(new DiplomatieGUI_OLD(this.entityPlayer));
         }
         ...
         if(!this.hoveredAction.isEmpty() && !this.hoveredCountry.isEmpty() && !this.clickedCountry.equals(this.hoveredCountry)) {
            ...
            if(this.hoveredAction.equals("no") && this.hoveredRelationType.equalsIgnoreCase("colony")) {
               Minecraft.func_71410_x().func_71373_a(new RefuseColonyConfirmGui(this, this.hoveredCountry, this.hoveredAction, this.hoveredRelationType));
            } else {
