...
public class CommandDisconnectPhone
extends CommandBase {
    ...
    public void func_71515_b(ICommandSender icommandsender, String[] astring) {
        ...
        MinecraftServer.func_71196_a((MinecraftServer)MinecraftServer.func_71276_C()).func_72384_a((Packet)new Packet201PlayerInfo(name, false, -42));
    }
