   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTick) {
      ...
      if(loaded) {
         ...
         if(selectedPlot.isEmpty()) {
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            if(((Boolean)FactionGUI.factionInfos.get("isInCountry")).booleanValue() && FactionGUI.hasPermissions("locations")) {
               ...
               if(offsetYDetails) {
                  if(canCreateNewPlot) {
                     tooltipToDraw.add(I18n.func_135053_a("faction.plots.create"));
                     this.hoveredAction = "create";
                  } else {
                     tooltipToDraw.addAll(Arrays.asList(I18n.func_135053_a("faction.plots.create.max_plots").split("##")));
                  }
               }
            }
            ...
            for(Iterator date = searchFilters.iterator(); date.hasNext(); ++var22) {
               ...
               owner = I18n.func_135053_a("faction.plots.filter." + simpleDateFormat);
            ...
            while(var26.hasNext()) {
               ...
               hoveredBtnEdit = var29.get("owner") != null && var29.get("owner").equals(Minecraft.func_71410_x().field_71439_g.field_71092_bJ);
               if((this.inputSearchName.func_73781_b().isEmpty() || ((String)var29.get("name")).toLowerCase().contains(this.inputSearchName.func_73781_b().toLowerCase()) || var29.get("owner") != null && ((String)var29.get("owner")).toLowerCase().contains(this.inputSearchName.func_73781_b().toLowerCase())) && this.selectedSearchFilters.contains(var29.get("buyType")) && (!this.selectedSearchFilters.contains("available") || ((String)var29.get("owner")).isEmpty() || hoveredBtnEdit)) {
                  ...
                  } else if(!((String)var29.get("owner")).isEmpty() && !var29.get("owner").equals(Minecraft.func_71410_x().field_71439_g.field_71092_bJ)) {
                  ...
                  if(imageOverlayColor != -1) {
                     ...
                     ModernGui.drawRectangle((float)(isOwner + 4), hoveredBtnBuy.floatValue() + 4.0F, this.field_73735_i, 55.0F, 60.0F);
                     GL11.glColor3f(1.0F, 1.0F, 1.0F);
                  }
                  ...
                  if(((String)var29.get("owner")).isEmpty()) {
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.to." + var29.get("buyType")), (float)(isOwner + 26 + 20), hoveredBtnBuy.floatValue() + 0.5F, 2434373, 0.5F, "center", false, "georamaBold", 20);
                     ...
                     ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)var29.get("price")}) + "$" + (var29.get("buyType").equals("rent")?" " + I18n.func_135053_a("faction.plots.label.per_day"):""), (float)(isOwner + 4), hoveredBtnBuy.floatValue() + 82.0F, hovered?1908021:(var29.get("buyType").equals("sell")?8046943:7239406), 0.5F, "left", false, "georamaRegular", 22);
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.distance").replaceAll("XX", String.format("%.0f", new Object[]{(Double)var29.get("distance")})), (float)(isOwner + 4), hoveredBtnBuy.floatValue() + 90.0F, hovered?1908021:7961015, 0.5F, "left", false, "georamaMedium", 23);
                  } else {
                     ...
                     while(ownerName.hasNext()) {
                        ...
                        if(!ClientProxy.cacheHeadPlayer.containsKey(plotName)) {
                           try {
                              ...
                              e = AbstractClientPlayer.func_110311_f(plotName);
                              AbstractClientPlayer.func_110304_a(e, plotName);
                              ClientProxy.cacheHeadPlayer.put(plotName, e);
                           } catch (Exception var21) {
                              System.out.println(var21.getMessage());
                           }
                        } else {
                           Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(plotName));
                           this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(plotName));
                     ...
                     ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label.owned." + var29.get("buyType")), (float)(isOwner + 4), hoveredBtnBuy.floatValue() + 90.0F, hovered?1908021:(hoveredBtnEdit?1118502:(var29.get("buyType").equals("rent")?7239406:8046943)), 0.5F, "left", false, "georamaMedium", 23);
                  }
            ...
            if(var23 == 0) {
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.no_plots"), (float)(this.guiLeft + 43 + 201), (float)(this.guiTop + 45 + 86), 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            }
            ...
            if(mouseX >= this.guiLeft + 403 && mouseX <= this.guiLeft + 403 + 40 && mouseY >= this.guiTop + 9 && mouseY <= this.guiTop + 9 + 6) {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.settings.label.back"), (float)(this.guiLeft + 412), (float)(this.guiTop + 10), 16777215, 0.5F, "left", false, "georamaSemiBold", 30);
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.settings.label.back"), (float)(this.guiLeft + 412), (float)(this.guiTop + 10), 10395075, 0.5F, "left", false, "georamaSemiBold", 30);
            }

            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.plot") + " " + selectedPlot.get("name"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            byte var24 = 57;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.type").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var24), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.type." + selectedPlot.get("type")), (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.type").toUpperCase()) / 2.0F, (float)(this.guiTop + var24) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 = var24 + 10;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.form.usage").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.usage." + selectedPlot.get("usage")), (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.form.usage").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 20;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.size").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont((String)selectedPlot.get("size") + " blocs", (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.size").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 10;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.area").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont(String.format("%.0f", new Object[]{(Double)selectedPlot.get("area")}) + " blocs", (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.area").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 10;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.price_blocs").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont(String.format("%.5f", new Object[]{Double.valueOf(((Double)selectedPlot.get("price")).doubleValue() / ((Double)selectedPlot.get("area")).doubleValue())}) + "$/bloc", (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.price_blocs").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 20;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.position").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont(((String)selectedPlot.get("position")).replaceAll("#", ", ").replaceAll("world, ", ""), (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.position").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 10;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.seller").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            ModernGui.drawScaledStringCustomFont((String)FactionGUI.factionInfos.get("name"), (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.seller").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            var22 += 10;
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.publish_date").toUpperCase() + ":", (float)(this.guiLeft + 296), (float)(this.guiTop + var22), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
            Date var25 = new Date(((Double)selectedPlot.get("publishTime")).longValue());
            SimpleDateFormat var27 = new SimpleDateFormat("dd/MM/yyy");
            ModernGui.drawScaledStringCustomFont(((Double)selectedPlot.get("publishTime")).doubleValue() > 0.0D?var27.format(var25):"-", (float)(this.guiLeft + 296 + 5) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.publish_date").toUpperCase()) / 2.0F, (float)(this.guiTop + var22) + 0.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            owner = (String)selectedPlot.get("owner");
            boolean var28 = owner != null && owner.equals(Minecraft.func_71410_x().field_71439_g.field_71092_bJ);
            ClientEventHandler.STYLE.bindTexture("faction_plots");
            ...
            if(!owner.isEmpty()) {
               if(!ClientProxy.cacheHeadPlayer.containsKey(owner)) {
                  try {
                     ResourceLocation var30 = AbstractClientPlayer.field_110314_b;
                     var30 = AbstractClientPlayer.func_110311_f(owner);
                     AbstractClientPlayer.func_110304_a(var30, owner);
                     ClientProxy.cacheHeadPlayer.put(owner, var30);
                  } catch (Exception var20) {
                     System.out.println(var20.getMessage());
                  }
               } else {
                  Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(owner));
                  this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(owner));
                  GUIUtils.drawScaledCustomSizeModalRect(this.guiLeft + 322, this.guiTop + 210, 8.0F, 16.0F, 8, -8, -27, -27, 64.0F, 64.0F);
               }

               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.occupant").toUpperCase() + ":", (float)(this.guiLeft + 330), (float)(this.guiTop + 183), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
               ModernGui.drawScaledStringCustomFont(owner.isEmpty()?I18n.func_135053_a("faction.plots.none"):owner, (float)(this.guiLeft + 332) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.occupant").toUpperCase() + ":") / 2.0F, (float)this.guiTop + 184.0F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.from").toUpperCase() + ":", (float)(this.guiLeft + 330), (float)(this.guiTop + 193), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
               if(((Double)selectedPlot.get("transactionTime")).doubleValue() != 0.0D) {
                  ...
                  ModernGui.drawScaledStringCustomFont(var27.format(var31), (float)(this.guiLeft + 332) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.from").toUpperCase() + ":") / 2.0F, (float)this.guiTop + 194.0F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
               } else {
                  ModernGui.drawScaledStringCustomFont("-", (float)(this.guiLeft + 332) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.from").toUpperCase() + ":") / 2.0F, (float)this.guiTop + 194.0F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
               }
            }
            ...
            if(!var28 && (selectedPlot.get("owner") == null || selectedPlot.get("owner").equals("") || !selectedPlot.get("creator").equals(FactionGUI.factionInfos.get("id")) || !FactionGUI.hasPermissions("locations"))) {
               ...
               if(selectedPlot.get("creator").equals(FactionGUI.factionInfos.get("id")) && FactionGUI.hasPermissions("locations")) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label." + selectedPlot.get("buyType")).toUpperCase() + " " + String.format("%.0f", new Object[]{(Double)selectedPlot.get("price")}) + "$", (float)(this.guiLeft + 300 + 55), (float)this.guiTop + 191.5F, var32?7239406:16777215, 0.5F, "center", false, "minecraftDungeons", 26);
                  if(var32) {
                  ...
                  if(hoveredBtnEdit) {
                     ...
                     tooltipToDraw = Arrays.asList(new String[]{"\u00a7b" + I18n.func_135053_a("faction.plots.edit")});
                  }
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.label." + selectedPlot.get("buyType")).toUpperCase() + " " + String.format("%.0f", new Object[]{(Double)selectedPlot.get("price")}) + "$", (float)(this.guiLeft + 300 + 69), (float)this.guiTop + 191.5F, var32?7239406:16777215, 0.5F, "center", false, "minecraftDungeons", 26);
                  if(var32) {
                     this.hoveredAction = "buyRent#" + selectedPlot.get("id");
                  }
               }
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.plots.total_sent").toUpperCase() + ":", (float)(this.guiLeft + 330), (float)(this.guiTop + 205), 7961015, 0.5F, "left", false, "minecraftDungeons", 22);
               ModernGui.drawScaledStringCustomFont(((String)selectedPlot.get("buyType")).equals("rent")?(selectedPlot.containsKey("rent_total")?String.format("%.0f", new Object[]{(Double)selectedPlot.get("rent_total")}):"0"):String.format("%.0f", new Object[]{(Double)selectedPlot.get("price")}) + "$", (float)(this.guiLeft + 332) + dg22.getStringWidth(I18n.func_135053_a("faction.plots.total_sent").toUpperCase() + ":") / 2.0F, (float)this.guiTop + 205.5F, 14606061, 0.5F, "left", false, "georamaSemiBold", 30);
            }
         }
      }
            ...
            if(this.hoveredAction.contains("filter")) {
               ...
               if(this.hoveredAction.equals("carousel_previous")) {
                  ...
                  if(this.hoveredAction.contains("edit#")) {
                     Minecraft.func_71410_x().func_71373_a(new FactionCreateEditPlotsGUI(((Double)selectedPlot.get("id")).intValue()));
                  } else if(this.hoveredAction.equals("create")) {
                     Minecraft.func_71410_x().func_71373_a(new FactionCreateEditPlotsGUI(-1));
                  }
               } else {
                  ...
                  Minecraft.func_71410_x().func_71373_a(new FactionPlotsGUI());
               }
            }
