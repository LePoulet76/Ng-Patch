...
public class AssistanceMessage extends AbstractAssistanceComponent implements GuiScrollerElement
{
    ...
    {
        float dateWidth = (float)Minecraft.getMinecraft().fontRenderer.getStringWidth(this.date) * 0.75F;
        ...
        this.drawString(Minecraft.getMinecraft().fontRenderer, this.date, 0, 0, 16777215);
        GL11.glPopMatrix();
