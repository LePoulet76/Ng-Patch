...
public class AuctionSellItemGUI extends GuiScreen {
   ...
   protected void func_73864_a(int mouseX, int mouseY, int par3) {
      if(mouseX >= this.posX + 5 && mouseY >= this.posY + 118 && mouseX <= this.posX + 5 + 183 && mouseY <= this.posY + 118 + 19) {
         Minecraft.func_71410_x().func_71373_a(new SellItemGUI(this.itemStack, this.slotID));
      }
   ...
   public void func_73866_w_() {
      ...
      this.sellButton = new GuiButton(0, this.posX + 173, this.posY + 83, 80, 20, I18n.func_135053_a("auctions.sell.action"));
   ...
   public void func_73863_a(int par1, int par2, float par3) {
      ...
      this.field_73886_k.func_78276_b(I18n.func_135053_a("auctions.sell.toHDV"), this.posX + 5 + 23 + 25 + 10, this.posY + 118 + 5, 16777215);
      ModernGui.drawScaledString(this.itemStack.func_82833_r(), this.posX + 47, this.posY + 17, 16777215, 0.75F, true, false);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("auctions.sell.price"), this.posX + 84, this.posY + 22, 16777215);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("auctions.sell.quantity"), this.posX + 84, this.posY + 44, 16777215);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("auctions.sell.time"), this.posX + 84, this.posY + 66, 16777215);
      this.field_73886_k.func_78276_b(I18n.func_135053_a("auctions.ad"), this.posX + 82 + 14, this.posY + 79, 16777215);
      String t = "...";
      this.taxe = 200;
      ...
      String s = I18n.func_135052_a("auctions.sell.taxes", new Object[]{t});
      this.field_73886_k.func_78276_b(s, this.posX + 82, this.posY + 92, 16777215);
