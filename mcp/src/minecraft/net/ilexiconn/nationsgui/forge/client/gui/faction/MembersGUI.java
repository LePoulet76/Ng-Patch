...
public class MembersGUI extends TabbedFactionGUI
{
    ...
    public void initGui()
    {
        ...
        this.searchInput = new GuiTextField(this.fontRenderer, this.guiLeft + 60, this.guiTop + 63, 97, 10);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        if (loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            while (it.hasNext())
            {
                ...
                else
                {
                    if (!this.entities.containsKey(officersPositionY))
                    {
                        try
                        {
                            this.entities.put(officersPositionY, new EntityOtherPlayerMP(this.mc.theWorld, officersPositionY));
                        }
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.button.members"), (float)(this.guiLeft + 42 + 33), (float)(this.guiTop + 80), this.displayMode.equals("members") ? 7239406 : 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.button.new_members"), (float)(this.guiLeft + 108 + 33), (float)(this.guiTop + 80), this.displayMode.equals("new_members") ? 7239406 : 16777215, 0.5F, "center", false, "georamaSemiBold", 24);
            ...
            if (this.displayMode.equals("members"))
            {
                ...
                while (multiplier.hasNext())
                {
                    ...
                    if (itMembers.toLowerCase().contains(this.searchInput.getText().toLowerCase()))
                    {
                        ...
                        if (rewardGiven.intValue() < this.guiTop + 103 + 115)
                        {
                            if (!ClientProxy.cacheHeadPlayer.containsKey(itMembers))
                            {
                                try
                                {
                                    ResourceLocation value = AbstractClientPlayer.locationStevePng;
                                    value = AbstractClientPlayer.getLocationSkin(itMembers);
                                    AbstractClientPlayer.getDownloadImageSkin(value, itMembers);
                            ...
                            {
                                Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(itMembers));
                                this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(itMembers));
                            ...
                            if (((Boolean)FactionGUI.factionInfos.get("isInCountry")).booleanValue())
                            {
                                ...
                                if (!itMembers.equals((String)FactionGUI.factionInfos.get("leader")))
                                {
                                    if (mouseX >= rewardPossiblePower + 153 && mouseX <= rewardPossiblePower + 153 + 8 && mouseY >= rewardGiven.intValue() + 1 && mouseY <= rewardGiven.intValue() + 1 + 8)
                                    {
                                        ...
                                        this.hoveredPlayer = itMembers;
                                        tooltipToDraw.add(I18n.getString("faction.members.action.demote").replaceAll("#rank#", FactionGUI.getRoleName(this.hoveredAction.replace("demote_", ""))));
                                    }
                                    else
                                    {
                                    ...
                                    if (mouseX >= rewardPossiblePower + 164 && mouseX <= rewardPossiblePower + 164 + 8 && mouseY >= rewardGiven.intValue() + 1 && mouseY <= rewardGiven.intValue() + 1 + 8)
                                    {
                                        ...
                                        this.hoveredPlayer = itMembers;
                                        tooltipToDraw.add(I18n.getString("faction.members.action.promote").replaceAll("#rank#", FactionGUI.getRoleName(this.hoveredAction.replace("promote_", ""))));
                                    }
                                    else
                                    {
                                    ...
                                    if (mouseX >= rewardPossiblePower + 175 && mouseX <= rewardPossiblePower + 175 + 8 && mouseY >= rewardGiven.intValue() + 1 && mouseY <= rewardGiven.intValue() + 1 + 8)
                                    {
                                        ...
                                        this.hoveredPlayer = itMembers;
                                        tooltipToDraw.add(I18n.getString("faction.members.action." + this.hoveredAction));
                                    }
                                    else
                                    {
                                    ...
                                    if (mouseX >= rewardPossiblePower + 186 && mouseX <= rewardPossiblePower + 186 + 8 && mouseY >= rewardGiven.intValue() + 1 && mouseY <= rewardGiven.intValue() + 1 + 8)
                                    {
                                        ...
                                        this.hoveredPlayer = itMembers;
                                        tooltipToDraw.add(I18n.getString("faction.members.action.exclude"));
                                    }
                                    else
                                    {
                ...
                if (!ClientProxy.cacheHeadPlayer.containsKey((String)FactionGUI.factionInfos.get("leader")))
                {
                    try
                    {
                        ResourceLocation var36 = AbstractClientPlayer.locationStevePng;
                        var36 = AbstractClientPlayer.getLocationSkin((String)FactionGUI.factionInfos.get("leader"));
                        AbstractClientPlayer.getDownloadImageSkin(var36, (String)FactionGUI.factionInfos.get("leader"));
                ...
                {
                    Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get((String)FactionGUI.factionInfos.get("leader")));
                    this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get((String)FactionGUI.factionInfos.get("leader")));
                ...
                for (rewardPossiblePower = 0; rewardPossiblePower < Math.min(10, officers.size()); ++rewardPossiblePower)
                {
                    if (!ClientProxy.cacheHeadPlayer.containsKey(officers.get(rewardPossiblePower)))
                    {
                        try
                        {
                            ResourceLocation var38 = AbstractClientPlayer.locationStevePng;
                            var38 = AbstractClientPlayer.getLocationSkin((String)officers.get(rewardPossiblePower));
                            AbstractClientPlayer.getDownloadImageSkin(var38, (String)officers.get(rewardPossiblePower));
                    ...
                    {
                        Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(officers.get(rewardPossiblePower)));
                        this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(officers.get(rewardPossiblePower)));
                ...
                for (var39 = 0; var39 < Math.min(30, members.size()); ++var39)
                {
                    if (!ClientProxy.cacheHeadPlayer.containsKey(members.get(var39)))
                    {
                        try
                        {
                            ResourceLocation var40 = AbstractClientPlayer.locationStevePng;
                            var40 = AbstractClientPlayer.getLocationSkin((String)members.get(var39));
                            AbstractClientPlayer.getDownloadImageSkin(var40, (String)members.get(var39));
                    ...
                    {
                        Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(members.get(var39)));
                        this.mc.getTextureManager().bindTexture((ResourceLocation)ClientProxy.cacheHeadPlayer.get(members.get(var39)));
            ...
            else
            {
                ...
                while (var42.hasNext())
                {
                    ...
                    if (playerName.toLowerCase().contains(this.searchInput.getText().toLowerCase()))
                    {
                        ...
                        if (var47.floatValue() >= (float)(this.guiTop + 95) && var47.floatValue() <= (float)(this.guiTop + 103 + 115))
                        {
                            ...
                            ModernGui.drawScaledStringCustomFont(I18n.getString("1"), (float)(var46 + 160), (float)var47.intValue() + 2.5F, amountPlayTime < 4.0D ? 10395075 : 7815169, 0.4F, "right", false, "georamaMedium", 31);
                            ...
                            ModernGui.drawScaledStringCustomFont(I18n.getString("2"), (float)(var46 + 172), (float)var47.intValue() + 2.5F, amountPlayTime < 8.0D ? 10395075 : 7815169, 0.4F, "right", false, "georamaMedium", 31);
                            ...
                            ModernGui.drawScaledStringCustomFont(I18n.getString("3"), (float)(var46 + 184), (float)var47.intValue() + 2.5F, amountPlayTime < 24.0D ? 10395075 : 7815169, 0.4F, "right", false, "georamaMedium", 31);
                            ...
                            ModernGui.drawScaledStringCustomFont(I18n.getString("4"), (float)(var46 + 196), (float)var47.intValue() + 2.5F, amountPlayTime < 48.0D ? 10395075 : 7815169, 0.4F, "right", false, "georamaMedium", 31);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.info.title"), (float)(this.guiLeft + 293), (float)(this.guiTop + 108), 15463162, 0.5F, "left", false, "georamaMedium", 32);
                ModernGui.drawSectionStringCustomFont(I18n.getString("faction.members.data.info.desc"), (float)(this.guiLeft + 293), (float)(this.guiTop + 120), 10395075, 0.5F, "left", false, "georamaMedium", 20, 6, 300);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.stats.title"), (float)(this.guiLeft + 293), (float)(this.guiTop + 164), 15463162, 0.5F, "left", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.stats.forma_progress"), (float)(this.guiLeft + 293), (float)(this.guiTop + 177), -856952070, 0.4F, "left", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("10"), (float)(this.guiLeft + 439), (float)(this.guiTop + 177), -2132020486, 0.4F, "right", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.stats.forma_finish"), (float)(this.guiLeft + 293), (float)(this.guiTop + 187), -856952070, 0.4F, "left", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("10"), (float)(this.guiLeft + 439), (float)(this.guiTop + 187), -2132020486, 0.4F, "right", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.stats.reward_possible"), (float)(this.guiLeft + 293), (float)(this.guiTop + 197), -856952070, 0.4F, "left", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString(var37 + " $ / " + rewardPossiblePower + " power"), (float)(this.guiLeft + 439), (float)(this.guiTop + 197), 16171012, 0.4F, "right", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.members.data.stats.reward_finish"), (float)(this.guiLeft + 293), (float)(this.guiTop + 207), -856952070, 0.4F, "left", false, "georamaMedium", 32);
                ModernGui.drawScaledStringCustomFont(I18n.getString(var39 + " $ / " + var41 + " power"), (float)(this.guiLeft + 439), (float)(this.guiTop + 207), 16171012, 0.4F, "right", false, "georamaMedium", 32);
            }
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0 && !this.hoveredAction.isEmpty())
        {
            ...
            {
                Minecraft.getMinecraft().displayGuiScreen(new LeaderConfirmGui(this, this.hoveredPlayer));
            }
            else
            {
