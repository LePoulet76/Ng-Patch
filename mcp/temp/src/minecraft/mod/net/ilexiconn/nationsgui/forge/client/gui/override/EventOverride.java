   ...
   public void renderOverride(Minecraft client, ScaledResolution resolution, float partialTicks) {
      ...
      if(ClientProxy.serverType.equals("ng")) {
         if(ClientData.eventsInfos.size() > 0) {
            ...
            Double y = Double.valueOf((double)resolution.func_78328_b() * 0.4D);
            x = y.intValue();
            chronoStr = resolution.func_78326_a() - 140;
            ArrayList recordName = (ArrayList)doubleY.get("scoreboard");
            if(recordName.size() > 10) {
               x -= (recordName.size() - 10) * 13;
            }

            func_73734_a(chronoStr + 30, x, chronoStr + 140, x + 16, -1157627904);
            ...
            if(!recordName.isEmpty()) {
               for(int playerName = 0; playerName < recordName.size(); ++playerName) {
                  ...
                  func_73734_a(chronoStr + 30, playerKills, chronoStr + 140, playerKills + 13, 1996488704);
         ...
         if(ClientProxy.currentServerName.equals("wonder")) {
            title = "\u00a76WONDER XI";
            var20 = Double.valueOf((double)resolution.func_78328_b() * 0.4D);
            var21 = var20.intValue();
            x = resolution.func_78326_a() - 140;
            func_73734_a(x + 30, var21, x + 140, var21 + 16, -1157627904);
            ModernGui.drawScaledStringCustomFont(title, (float)(x + 85), (float)(var21 + 4), 14803951, 0.5F, "center", false, "georamaSemiBold", 30);
            func_73734_a(x + 30, var21 + 16, x + 140, var21 + 16 + 50, 1996488704);
            ...
            func_73734_a(x + 30, var21, x + 140, var21 + 16, -1157627904);
            ModernGui.drawScaledStringCustomFont(title, (float)(x + 85), (float)(var21 + 4), 14803951, 0.5F, "center", false, "georamaSemiBold", 30);
            func_73734_a(x + 30, var21 + 16, x + 140, cachedSCBHeight, 1996488704);
            chronoStr = var21 + 20;
            ...
            if(display) {
               ...
               var21 = var20.intValue();
               x = resolution.func_78326_a() - 140;
               func_73734_a(x, var21, x + 140, var21 + 16, -1157627904);
               this.drawSmallString(client.field_71466_p, title, x + 75 - client.field_71466_p.func_78256_a(title) / 2, var21 + 4, 16777215);
               ClientEventHandler.STYLE.bindTexture("hud2");
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               func_73734_a(x, var21 + 16, x + 140, var21 + 16 + 80, 1996488704);
               if(ClientData.currentJumpStartTime.longValue() != -1L) {
                  this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a7a> Jump en cours", x + 5, var21 + 28, 16777215, 0.9F, false, false);
                  var22 = chronoTimeToStr(Long.valueOf(System.currentTimeMillis() - ClientData.currentJumpStartTime.longValue()), true);
                  this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a7cTemps: \u00a77" + var22, x + 5, var21 + 43, 16777215, 0.9F, false, false);
                  String var23 = "-";
                  ...
                  this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a76Record: \u00a7e" + var23, x + 5, var21 + 58, 16777215, 0.9F, false, false);
                  this.drawScaledString(Minecraft.func_71410_x().field_71466_p, "\u00a7d" + (this.isNumeric(var25)?chronoTimeToStr(Long.valueOf(Long.parseLong(var25)), true):var25), x + 5, var21 + 68, 16777215, 0.9F, false, false);
               }

               ClientEventHandler.STYLE.bindTexture("hud2");
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               func_73734_a(x, var21 + 16 + 80 - 16, x + 140, var21 + 16 + 80, 1996488704);
               if(ClientData.currentJumpStartTime.longValue() != -1L) {
                  this.drawSmallString(client.field_71466_p, I18n.func_135053_a("island.overlay.stop_jump").replaceAll("<key>", Keyboard.getKeyName(ClientKeyHandler.KEY_WARZONE_LEAVE.field_74512_d)), x + 75 - client.field_71466_p.func_78256_a(I18n.func_135053_a("island.overlay.stop_jump").replaceAll("<key>", Keyboard.getKeyName(ClientKeyHandler.KEY_WARZONE_LEAVE.field_74512_d))) / 2, var21 + 85, 16777215);
               }
            }
         }
      }
