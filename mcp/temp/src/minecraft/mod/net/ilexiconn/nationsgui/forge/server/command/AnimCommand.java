...
public class AnimCommand extends CommandBase {
   ...
   public void handleGive(ICommandSender sender, String to, String anim) {
      ...
      if(!user.func_74764_b("AvailableAnims")) {
         user.func_74782_a("AvailableAnims", new NBTTagString(""));
      } else if(user.func_74779_i("AvailableAnims").contains(anim.toLowerCase())) {
         sender.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.anim.has_already", new Object[]{to, anim}).func_111059_a(EnumChatFormatting.RED));
         return;
      }
      ...
      sender.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.anim.gave", new Object[]{anim, to}));
   ...
   public void handleRemove(ICommandSender sender, String to, String badge) {
      ...
      if(user.func_74779_i("AvailableAnims") != null) {
         if(user.func_74779_i("AvailableAnims").contains(badge)) {
            ...
            compound.func_74766_a(to, user);
            sender.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.anim.removed", new Object[]{badge, to}));
            NBTConfig.CONFIG.save();
         } else {
            sender.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.anim.not_found", new Object[]{to, badge}).func_111059_a(EnumChatFormatting.RED));
         }
      } else {
         sender.func_70006_a(ChatMessageComponent.func_111082_b("nationsgui.command.anim.not_found", new Object[]{to, badge}).func_111059_a(EnumChatFormatting.RED));
      }
