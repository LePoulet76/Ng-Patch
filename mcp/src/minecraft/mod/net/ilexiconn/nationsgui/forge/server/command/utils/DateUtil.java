...
public class DateUtil
{
    public static long parseDateDiff(String time, boolean future) throws Exception
    {
        ...
        {
            GregorianCalendar var14 = new GregorianCalendar();

            if (years > 0)
            {
                var14.add(1, years * (future ? 1 : -1));
            }

            if (months > 0)
            {
                var14.add(2, months * (future ? 1 : -1));
            }

            if (weeks > 0)
            {
                var14.add(3, weeks * (future ? 1 : -1));
            }

            if (days > 0)
            {
                var14.add(5, days * (future ? 1 : -1));
            }

            if (hours > 0)
            {
                var14.add(11, hours * (future ? 1 : -1));
            }

            if (minutes > 0)
            {
                var14.add(12, minutes * (future ? 1 : -1));
            }

            if (seconds > 0)
            {
                var14.add(13, seconds * (future ? 1 : -1));
            }
