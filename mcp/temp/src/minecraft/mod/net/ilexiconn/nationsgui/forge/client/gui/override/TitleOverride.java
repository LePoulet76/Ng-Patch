...
public class TitleOverride implements ElementOverride {
   ...
   public void renderOverride(Minecraft client, ScaledResolution res, float partialTicks) {
      if(this.titlesTimer > 0) {
         ...
         if(opacity > 8) {
            GL11.glPushMatrix();
            GL11.glTranslatef((float)(res.func_78326_a() / 2), (float)(res.func_78328_b() / 2), 0.0F);
            GL11.glPushMatrix();
            GL11.glScalef(4.0F, 4.0F, 4.0F);
            int l1 = opacity << 24 & -16777216;
            this.font.func_85187_a(this.displayedTitle, -this.font.func_78256_a(this.displayedTitle) / 2, -10, 16777215 | l1, true);
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            GL11.glScalef(2.0F, 2.0F, 2.0F);
            this.font.func_85187_a(this.displayedSubTitle, -this.font.func_78256_a(this.displayedSubTitle) / 2, 5, 16777215 | l1, true);
            GL11.glPopMatrix();
            GL11.glPopMatrix();
         } else {
            this.displayedTitle = "";
