...
public class CustomWorkbenchContainer extends Container
{
    ...
    public CustomWorkbenchContainer(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
        ...
        this.posY = par4;
        this.posZ = par5;
        this.addSlotToContainer(new SlotCrafting(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 152, 103));
        int l;
        int i1;
        ...
        for (l = 0; l < 3; ++l)
        {
            for (i1 = 0; i1 < 3; ++i1)
            {
                this.addSlotToContainer(new Slot(this.craftMatrix, i1 + l * 3, i1 * 18 + 89, 67 + l * 18));
            }
        }
        ...
        for (l = 0; l < 3; ++l)
        {
            for (i1 = 0; i1 < 9; ++i1)
            {
                this.addSlotToContainer(new Slot(par1InventoryPlayer, i1 + l * 9 + 9, i1 * 18 + 206, 60 + l * 18));
            }
        }

        for (l = 0; l < 9; ++l)
        {
            this.addSlotToContainer(new Slot(par1InventoryPlayer, l, 25 + l * 18 + 181, 118));
        }
