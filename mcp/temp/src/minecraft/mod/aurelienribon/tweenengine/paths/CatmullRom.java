...
public class CatmullRom implements TweenPath {
   ...
   public float compute(float t, float[] points, int pointsCnt) {
      ...
      return segment == 0?this.catmullRomSpline(points[0], points[0], points[1], points[2], t):(segment == pointsCnt - 2?this.catmullRomSpline(points[pointsCnt - 3], points[pointsCnt - 2], points[pointsCnt - 1], points[pointsCnt - 1], t):this.catmullRomSpline(points[segment - 1], points[segment], points[segment + 1], points[segment + 2], t));
   }
