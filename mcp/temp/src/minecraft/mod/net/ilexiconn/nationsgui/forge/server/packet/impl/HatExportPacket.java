...
public class HatExportPacket implements IPacket, IClientPacket {
   ...
   public void handleClientPacket(EntityPlayer player) {
      ClientProxy.SKIN_MANAGER.clearPlayerCachedSkins(player.field_71092_bJ, (SkinType)null);
      PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new CosmeticCategoryDataPacket("hats", player.field_71092_bJ)));
   }
}
