...
public class PlayerListGUI extends TabbedFactionListGUI {
   ...
   public void func_73863_a(int mouseX, int mouseY, float partialTick) {
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.list_players"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
      ...
      for(pair = 0; pair < action; ++pair) {
         ...
         ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.tab." + groupName.name().toLowerCase()), (float)(this.guiLeft + 42 + 55 * index + 26), (float)(this.guiTop + 39), this.activeTab.equals(groupName)?7239406:14342893, 0.5F, "center", false, "georamaSemiBold", 26);
      ...
      if(!this.activeTab.equals(PlayerListGUI$TAB.LIST_PLAYERS) && !this.activeTab.equals(PlayerListGUI$TAB.AVAILABLE)) {
         ...
         if(this.activeTab.equals(PlayerListGUI$TAB.STAFF)) {
            ...
            while(var25.hasNext()) {
               ...
               if(((ArrayList)var28.getValue()).size() > 0) {
                  ...
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("badge.title." + var30), (float)var31, (float)offsetY.intValue(), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                  var23 += 13;
                  offsetY = Float.valueOf((float)(this.guiTop + 58 + var23) + this.getSlideStaff());
                  playerIndex = 0;
                  x = false;
                  ...
                  while(var14.hasNext()) {
                     ...
                     if(this.searchInput.func_73781_b().isEmpty() || playerName.toLowerCase().contains(this.searchInput.func_73781_b().toLowerCase())) {
                        var32 = playerIndex % 8;
                        y = playerIndex / 8;
                        ...
                        if(!ClientProxy.cacheHeadPlayer.containsKey(playerName)) {
                           try {
                              ...
                              resourceLocation = AbstractClientPlayer.func_110311_f(playerName);
            ...
            while(var25.hasNext()) {
               ...
               if(((ArrayList)var28.getValue()).size() > 0) {
                  ...
                  var31 = this.guiLeft + 50;
                  offsetY = Float.valueOf((float)(this.guiTop + 58 + var23) + this.getSlideStaff());
                  ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("staff.interserver." + var30), (float)var31, (float)offsetY.intValue(), 16514302, 0.5F, "left", false, "georamaSemiBold", 32);
                  var23 += 13;
                  offsetY = Float.valueOf((float)(this.guiTop + 58 + var23) + this.getSlideStaff());
                  playerIndex = 0;
                  x = false;
         ...
         ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.func_135053_a("faction.list.label.skin"), (float)(this.guiLeft + 50), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
         ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.func_135053_a("faction.list.label.pseudo"), (float)(this.guiLeft + 93), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
         ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.func_135053_a("faction.list.label.countries"), (float)(this.guiLeft + 169), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
         ModernGui.drawScaledStringCustomFont("\u00a7o" + I18n.func_135053_a("faction.list.label.power"), (float)(this.guiLeft + 243), (float)(this.guiTop + 57), 10395075, 0.5F, "left", false, "georamaMedium", 28);
         ...
         if(playersData.size() > 0) {
            ...
            while(var22.hasNext()) {
               ...
               if((this.searchInput.func_73781_b().isEmpty() || ((String)var24.get("name")).toLowerCase().contains(this.searchInput.func_73781_b().toLowerCase())) && (!this.activeTab.equals(PlayerListGUI$TAB.AVAILABLE) || ((String)var24.get("country")).equals("") && ((String)var24.get("isOnline")).equals("true"))) {
                  if(var29.intValue() >= this.guiTop + 60 && var29.intValue() <= this.guiTop + 70 + 170) {
                     if(!ClientProxy.cacheHeadPlayer.containsKey(var24.get("name"))) {
                        try {
                           ...
                           offsetX = AbstractClientPlayer.func_110311_f((String)var24.get("name"));
                           AbstractClientPlayer.func_110304_a(offsetX, (String)var24.get("name"));
                           ClientProxy.cacheHeadPlayer.put(var24.get("name"), offsetX);
                        } catch (Exception var21) {
                           ;
                        }
                     } else {
                        Minecraft.func_71410_x().field_71446_o.func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var24.get("name")));
                        this.field_73882_e.func_110434_K().func_110577_a((ResourceLocation)ClientProxy.cacheHeadPlayer.get(var24.get("name")));
                     ...
                     if(!((String)var24.get("country")).isEmpty()) {
                        ...
                        if(ClientProxy.flagsTexture.containsKey(var24.get("country"))) {
                           GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(var24.get("country"))).func_110552_b());
      ...
      if(selectedPlayer != null && !selectedPlayer.isEmpty()) {
         if(!playersExtraData.containsKey(selectedPlayer.get("name"))) {
            ...
            if(!this.playersEntity.containsKey(selectedPlayer.get("name"))) {
               try {
                  this.playersEntity.put(selectedPlayer.get("name"), new EntityOtherPlayerMP(this.field_73882_e.field_71441_e, (String)selectedPlayer.get("name")));
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.label.playtime_interserv"), (float)(this.guiLeft + 353), (float)(this.guiTop + 131), ((Integer)FactionGUI.textColor.get("neutral")).intValue(), 0.5F, "left", false, "georamaMedium", 22);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.label.playtime").replaceAll("#server#", ClientProxy.currentServerName), (float)(this.guiLeft + 353), (float)(this.guiTop + 156), ((Integer)FactionGUI.textColor.get("neutral")).intValue(), 0.5F, "left", false, "georamaMedium", 22);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.label.top_skill"), (float)(this.guiLeft + 353), (float)(this.guiTop + 181), ((Integer)FactionGUI.textColor.get("neutral")).intValue(), 0.5F, "left", false, "georamaMedium", 22);
            ModernGui.drawScaledStringCustomFont(!((String)var27.get("topSkill")).isEmpty()?I18n.func_135053_a("skills.skill." + (String)var27.get("topSkill")):"-", (float)(this.guiLeft + 353), (float)(this.guiTop + 187), 16514302, 0.5F, "left", false, "georamaSemiBold", 28);
            ClientEventHandler.STYLE.bindTexture("faction_list");
            ...
            if(!((String)selectedPlayer.get("name")).equals(Minecraft.func_71410_x().field_71439_g.field_71092_bJ) && !((String)selectedPlayer.get("isOnline")).equals("false")) {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("faction.list.label." + var26), (float)(this.guiLeft + 337 + 52), (float)(this.guiTop + 207), 2234425, 0.5F, "center", false, "georamaSemiBold", 28);
         }
      }
      ...
      if(mouseButton == 0) {
         if(!this.hoveredAction.isEmpty()) {
            if(this.hoveredAction.equals("send_message")) {
               Minecraft.func_71410_x().func_71373_a(new GuiChatTC("/msg " + (String)selectedPlayer.get("name") + ""));
               ...
               Minecraft.func_71410_x().func_71373_a(new ProfilGui((String)selectedPlayer.get("name"), ""));
            }
