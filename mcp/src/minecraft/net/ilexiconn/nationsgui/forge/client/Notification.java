...
public class Notification extends Gui
{
    ...
    {
        return this.compound.getString("title");
    }
    ...
    {
        return this.compound.getString("content");
    }

    public NotificationManager$NColor getColor()
    {
        return NotificationManager$NColor.valueOf(this.compound.getString("color"));
    }

    public NotificationManager$NIcon getIcon()
    {
        return NotificationManager$NIcon.valueOf(this.compound.getString("icon"));
    }

    public NBTTagCompound getActions()
    {
        return this.compound.hasKey("actions") ? this.compound.getCompoundTag("actions") : null;
    }
    ...
    public void render(float partialTick, ScaledResolution resolution)
    {
        ...
        if (this.getActions() != null)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("global.open").toUpperCase(), offsetXNotif + 164.4F - 25.6F + 10.0F, this.posY + 39.2F + 1.0F, -1314054, 0.3F, "center", false, "minecraftDungeons", 20);
        }
    }

    public boolean isExpired()
    {
        return this.actionDone || this.spawnTime != -1L && System.currentTimeMillis() - this.spawnTime > this.compound.getLong("lifetime");
    }
}
