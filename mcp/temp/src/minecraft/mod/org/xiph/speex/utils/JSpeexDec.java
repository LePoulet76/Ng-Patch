         ...
         while(true) {
            ...
            if(var19 == 0) {
               if(this.srcFormat == 2) {
                  ...
                  String var201 = new String(var3, 0, 4);

                  for(var28 = readInt(var3, 4); !var201.equals("data"); var28 = readInt(var3, 4)) {
                     var20.readFully(var3, 0, var28);
                     if(var201.equals("fmt ")) {
                     ...
                     var20.readFully(var3, 0, 8);
                     var201 = new String(var3, 0, 4);
                  }

                  if(this.printlevel <= 0) {
                     System.out.println("Data size: " + var28);
                  }
               } else {
                  if(this.printlevel <= 0) {
