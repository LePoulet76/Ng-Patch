...
public class UploadScreenPacket$Screenshoter implements Runnable {
   ...
   public void run() {
      ...
      for(int image = 0; image < k; ++image) {
         System.arraycopy(this.array, image * mc.field_71443_c, aint1, 0, mc.field_71443_c);
         System.arraycopy(this.array, (mc.field_71440_d - 1 - image) * mc.field_71443_c, this.array, image * mc.field_71443_c, mc.field_71443_c);
         System.arraycopy(aint1, 0, this.array, (mc.field_71440_d - 1 - image) * mc.field_71443_c, mc.field_71443_c);
      }

      BufferedImage var18 = new BufferedImage(mc.field_71443_c, mc.field_71440_d, 1);
      var18.setRGB(0, 0, mc.field_71443_c, mc.field_71440_d, this.array, 0, mc.field_71443_c);
