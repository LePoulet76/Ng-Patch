...
public class BuyActionConfirmGui extends ModalGui
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.actions.confirm.text1"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.actions.confirm.text2").replace("##dollars##", this.price), this.guiLeft + 53, this.guiTop + 50, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.actions.confirm.text3"), this.guiLeft + 53, this.guiTop + 60, 1644825, 1.0F, false, false);
