...
public class CustomHoe extends ItemHoe {
   ...
   public CustomHoe(String name, ItemData data) {
      super(data.getId(), EnumHelper.addToolMaterial(name, data.getHarvestLevel(), data.getDurability(), data.getMiningSpeed(), data.getDamageVsEntities(), data.getEnchantability()));
