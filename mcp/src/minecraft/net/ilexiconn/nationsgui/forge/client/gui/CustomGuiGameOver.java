...
public class CustomGuiGameOver extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        else
        {
            ...
            {
                this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 72, 98, 20, I18n.getString("deathScreen.respawn.spawn")));
                this.buttonList.add(new GuiButton(0, this.width / 2 + 2, this.height / 4 + 72, 98, 20, I18n.getString("deathScreen.respawn.faction")));
            }
