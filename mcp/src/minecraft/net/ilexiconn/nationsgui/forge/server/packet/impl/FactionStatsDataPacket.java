...
public class FactionStatsDataPacket implements IPacket, IClientPacket
{
    ...
    public void handleClientPacket(EntityPlayer player)
    {
        ...
        chart.addSeries(I18n.getString("faction.stats.chart.label.rating"), new ArrayList(this.historyNotations.keySet()), new ArrayList(this.historyNotations.values()));
        ...
        chart.addSeries(I18n.getString("faction.stats.chart.label.members"), new ArrayList(this.historyPopulation.keySet()), new ArrayList(this.historyPopulation.values()));
        this.loadChartTexture(chart, (ResourceLocation)FactionStatsGUI.TEXTURES.get(FactionStatsGUI$TAB.POPULATION));
        chart = this.getDefaultChart();
        chart.addSeries(I18n.getString("faction.stats.chart.label.claims"), new ArrayList(this.historyTerritory.keySet()), new ArrayList(this.historyTerritory.values()));
        this.loadChartTexture(chart, (ResourceLocation)FactionStatsGUI.TEXTURES.get(FactionStatsGUI$TAB.TERRITORY));
        chart = this.getDefaultChart();
        chart.addSeries(I18n.getString("faction.stats.chart.label.mmr"), new ArrayList(this.historyWars.keySet()), new ArrayList(this.historyWars.values()));
        this.loadChartTexture(chart, (ResourceLocation)FactionStatsGUI.TEXTURES.get(FactionStatsGUI$TAB.WARS));
        chart = this.getDefaultChart();
        chart.addSeries(I18n.getString("faction.stats.chart.label.pib"), new ArrayList(this.historyEconomy.keySet()), new ArrayList(this.historyEconomy.values()));
