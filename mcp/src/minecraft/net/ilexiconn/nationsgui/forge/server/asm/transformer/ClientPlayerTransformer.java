...
public class ClientPlayerTransformer implements Transformer
{
    ...
    public void transform(ClassNode node, boolean dev)
    {
        ...
        while (var3.hasNext())
        {
            ...
            if (!methodNode.name.equals("getDownloadImageSkin") && !methodNode.name.equals("getDownloadImageSkin"))
            {
                if (methodNode.name.equals("getDownloadImageCape") || methodNode.name.equals("getDownloadImageCape"))
                {
