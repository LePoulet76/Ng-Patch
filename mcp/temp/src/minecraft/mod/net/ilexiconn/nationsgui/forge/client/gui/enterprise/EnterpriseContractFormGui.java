   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(this.validButton.field_73742_g && !this.delayExpanded && this.isNumeric(this.priceInput.func_73781_b()) && mouseX > this.guiLeft + 282 && mouseX < this.guiLeft + 282 + 80 && mouseY > this.guiTop + 197 && mouseY < this.guiTop + 197 + 20) {
            ...
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseContractCreatePacket((String)EnterpriseGui.enterpriseInfos.get("name"), description, Integer.valueOf(Integer.parseInt(this.priceInput.func_73781_b())), lineTextField2)));
