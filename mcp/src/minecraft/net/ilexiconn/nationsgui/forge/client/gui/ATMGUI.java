...
public class ATMGUI extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        ModernGui.drawScaledStringCustomFont(I18n.getString("gui.atm.title"), (float)(this.guiLeft + 9), (float)(this.guiTop + 3), COLOR_WHITE, 1.0F, "left", false, "georamaExtraBold", 28);
        ...
        if (loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("gui.atm.label.playtime").toUpperCase(), (float)(this.guiLeft + 20), (float)(this.guiTop + 33), COLOR_LIGHT_BLUE, 0.5F, "left", false, "georamaSemiBold", 27);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("gui.atm.label.convert"), (float)(this.guiLeft + 110), (float)(this.guiTop + 102), COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
            ...
            {
                this.tooltipToDraw.addAll(Arrays.asList(I18n.getString("gui.atm.tooltip.dollars_per_minute").split("#")));
            }
            ...
            ModernGui.drawSectionStringCustomFont(I18n.getString("gui.atm.label.convert_orb_to_playtime").replaceAll("<orbs>", balanceOrbs1 + ""), (float)(this.guiLeft + 64), (float)(this.guiTop + 144), ((Boolean)data.get("ngprime")).booleanValue() ? COLOR_LIGHT_BLUE : COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 30, 7, 120);
