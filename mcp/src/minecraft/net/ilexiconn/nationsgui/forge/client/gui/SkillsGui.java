...
public class SkillsGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        ModernGui.drawScaledStringCustomFont(Minecraft.getMinecraft().thePlayer.username.equalsIgnoreCase(this.playerTarget) ? I18n.getString("skills.title") : I18n.getString("skills.title_of").replace("#player#", this.playerTarget.toUpperCase()), (float)(this.guiLeft + 12), (float)(this.guiTop + 11), 12895428, 1.0F, "left", false, "georamaExtraBold", 28);
        ...
        if (loaded && skillsData.size() > 0)
        {
            ...
            for (Iterator it = skillsData.entrySet().iterator(); it.hasNext(); ++skillOffsetY)
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("skills.skill." + i), (float)(this.guiLeft + 38), (float)(this.guiTop + 50 + 31 * skillOffsetY), i.equals(selectedSkill) ? 16777215 : 12895428, 1.0F, "left", false, "georamaSemiBold", 20);
            ...
            if (displayMode.equals("personal"))
            {
                if (!selectedSkill.isEmpty())
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("skills.skill." + selectedSkill).toUpperCase(), (float)(this.guiLeft + 134), (float)(this.guiTop + 51), 7239406, 1.0F, "left", false, "georamaBold", 28);

                    for (var24 = 0; var24 <= 4; ++var24)
                    {
                        ModernGui.drawScaledStringCustomFont(I18n.getString("skills.skill." + selectedSkill + ".desc." + (var24 + 1)), (float)(this.guiLeft + 134), (float)(this.guiTop + 78 + var24 * 12), 16777215, 1.0F, "left", false, "georamaRegular", 20);
                    }
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("skills.how_to"), (float)(this.guiLeft + 153), (float)(this.guiTop + 148), 12895428, 1.0F, "left", false, "georamaRegular", 18);

                    if (mouseX >= this.guiLeft + 134 && mouseX <= this.guiLeft + 134 + 15 + this.fontRenderer.getStringWidth(I18n.getString("skills.how_to")) && mouseY >= this.guiTop + 145 && mouseY <= this.guiTop + 145 + 15)
                    {
                        tooltipToDraw = Arrays.asList(I18n.getString("skills.skill." + selectedSkill + ".tooltip.how_to").split("##"));
                    }
                    ...
                    if (mouseX >= this.guiLeft + 355 && mouseX <= this.guiLeft + 355 + 71 && mouseY >= this.guiTop + 142 && mouseY <= this.guiTop + 142 + 15)
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("skills.leaderboard"), (float)(this.guiLeft + 391), (float)(this.guiTop + 146), 7239406, 1.0F, "center", false, "georamaSemiBold", 18);
                    ...
                    else
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("skills.leaderboard"), (float)(this.guiLeft + 391), (float)(this.guiTop + 146), 16777215, 1.0F, "center", false, "georamaSemiBold", 18);
                    }
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("skills.level").toUpperCase(), (float)(this.guiLeft + 141), (float)(this.guiTop + 175), 16777215, 1.0F, "left", false, "georamaSemiBold", 20);
                    ...
                    for (int i1 = 1; i1 <= levels.size(); ++i1)
                    {
                        ...
                        if (offsetY.doubleValue() >= ((Double)levels.get(i1 - 1)).doubleValue())
                        {
                            if (mouseX >= this.guiLeft + 149 - 7 + levelDotInterval * i1 && mouseX <= this.guiLeft + 149 - 7 + levelDotInterval * i1 + 15 && mouseY >= this.guiTop + 194 && mouseY <= this.guiTop + 194 + 15)
                            {
                                ...
                                tooltipToDraw = Arrays.asList(I18n.getString("skills.skill." + selectedSkill + ".tooltip.level." + i1).split("##"));
                            }
                            else
                            {
            ...
            else
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("skills.return"), (float)(this.guiLeft + 401), (float)(this.guiTop + 13), 7239406, 1.0F, "center", false, "georamaRegular", 18);
                ClientEventHandler.STYLE.bindTexture("skills");
                ...
                {
                    if (this.topPlayerEntity == null || !((String)skillsTopInterServ.get(selectedSkill)).split("#")[0].equalsIgnoreCase(this.topPlayerEntity.username))
                    {
                        try
                        {
                            this.topPlayerEntity = new EntityOtherPlayerMP(this.mc.theWorld, ((String)skillsTopInterServ.get(selectedSkill)).split("#")[0]);
                        }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("skills.best") + " " + I18n.getString("skills.skill." + selectedSkill).toUpperCase() + " NG", (float)(this.guiLeft + 180), (float)(this.guiTop + 54), 0, 1.0F, "left", false, "georamaRegular", 13);
                ModernGui.drawScaledStringCustomFont(!((String)skillsTopInterServ.get(selectedSkill)).isEmpty() ? this.topPlayerEntity.username : "???", (float)(this.guiLeft + 180), (float)(this.guiTop + 61), 16777215, 1.0F, "left", false, "georamaSemiBold", 22);
                ...
                if (!cacheHeadPlayer.containsKey(this.playerTarget))
                {
                    try
                    {
                        ResourceLocation var23 = AbstractClientPlayer.locationStevePng;
                        var23 = AbstractClientPlayer.getLocationSkin(this.playerTarget);
                        AbstractClientPlayer.getDownloadImageSkin(var23, this.playerTarget);
                ...
                {
                    Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)cacheHeadPlayer.get(this.playerTarget));
                    this.mc.getTextureManager().bindTexture((ResourceLocation)cacheHeadPlayer.get(this.playerTarget));
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("skills.top_3"), (float)(this.guiLeft + 138), (float)(this.guiTop + 141), 12895428, 1.0F, "left", false, "georamaRegular", 13);
                String var29;
                ...
                for (var24 = 0; var24 < 3; ++var24)
                {
                    ...
                    if (mouseX >= this.guiLeft + 137 && mouseX <= this.guiLeft + 137 + 15 && mouseY >= this.guiTop + 153 + var24 * 21 && mouseY <= this.guiTop + 153 + var24 * 21 + 15)
                    {
                        ...
                        tooltipToDraw = Arrays.asList(I18n.getString("skills.rewards.server." + (var24 + 1)).split("##"));
                    }
                    else
                    {
                    ...
                    if (!cacheHeadPlayer.containsKey(var27))
                    {
                        try
                        {
                            var31 = AbstractClientPlayer.locationStevePng;
                            var31 = AbstractClientPlayer.getLocationSkin(var27);
                            AbstractClientPlayer.getDownloadImageSkin(var31, var27);
                    ...
                    {
                        Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)cacheHeadPlayer.get(var27));
                        this.mc.getTextureManager().bindTexture((ResourceLocation)cacheHeadPlayer.get(var27));
                ...
                if (((List)skillsLeaderBoard.get(selectedSkill)).size() > 3)
                {
                    ...
                    for (var24 = 3; var24 < ((List)skillsLeaderBoard.get(selectedSkill)).size(); ++var24)
                    {
                        ...
                        if (!cacheHeadPlayer.containsKey(var29))
                        {
                            ...
                            {
                                var31 = AbstractClientPlayer.locationStevePng;
                                var31 = AbstractClientPlayer.getLocationSkin(var29);
                                AbstractClientPlayer.getDownloadImageSkin(var31, var29);
                        ...
                        {
                            Minecraft.getMinecraft().renderEngine.bindTexture((ResourceLocation)cacheHeadPlayer.get(var29));
                            this.mc.getTextureManager().bindTexture((ResourceLocation)cacheHeadPlayer.get(var29));
