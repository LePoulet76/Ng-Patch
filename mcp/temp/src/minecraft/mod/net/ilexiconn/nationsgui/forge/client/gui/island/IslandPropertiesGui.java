...
public class IslandPropertiesGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      GL11.glPushMatrix();
      Double var11 = Double.valueOf((double)(this.guiTop + 45) + (double)this.field_73886_k.func_78256_a((String)IslandMainGui.islandInfos.get("name")) * 1.5D);
      ...
      GL11.glPopMatrix();
      ClientEventHandler.STYLE.bindTexture("island_properties");
      this.drawScaledString(I18n.func_135053_a("island.properties.biome"), this.guiLeft + 50, this.guiTop + 17, 0, 1.0F, false, false);
      ClientEventHandler.STYLE.bindTexture("island_properties");
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_biome")) {
         func_73734_a(this.guiLeft + 49, this.guiTop + 27, this.guiLeft + 49 + 225, this.guiTop + 27 + 50, -1157627904);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         ClientEventHandler.STYLE.bindTexture("island_properties");
      ...
      this.drawScaledString(I18n.func_135053_a("island.properties.flags"), this.guiLeft + 49, this.guiTop + 102, 0, 1.0F, false, false);
      ...
      for(i = 0; i < this.flagList.size(); ++i) {
         ...
         String flagString = I18n.func_135053_a("island.properties.flags.label." + (String)this.flagList.get(i));
         if(flagString.length() > 15) {
            ...
            if(mouseX > offsetX && mouseX < offsetX + 106 && mouseY > var13.intValue() && mouseY < var13.intValue() + 21) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.properties.flags.label." + (String)this.flagList.get(i))});
            }
         }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_flags")) {
         func_73734_a(this.guiLeft + 49, this.guiTop + 111, this.guiLeft + 49 + 112, this.guiTop + 111 + 98, -1157627904);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         ClientEventHandler.STYLE.bindTexture("island_properties");
      ...
      this.drawScaledString(I18n.func_135053_a("island.properties.actions"), this.guiLeft + 162, this.guiTop + 102, 0, 1.0F, false, false);
      ...
      for(i = 0; i < this.actions.size(); ++i) {
         ...
         this.drawScaledString(I18n.func_135053_a("island.properties.actions.label." + (String)this.actions.get(i)), offsetX + 4, var13.intValue() + 6, 16777215, 1.0F, false, false);
      }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("execute_actions")) {
         func_73734_a(this.guiLeft + 162, this.guiTop + 111, this.guiLeft + 162 + 112, this.guiTop + 111 + 98, -1157627904);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         ClientEventHandler.STYLE.bindTexture("island_properties");
      ...
      this.drawScaledString(I18n.func_135053_a("island.properties.time.label." + this.selectedTimeMode), this.guiLeft + 67, this.guiTop + 87, 16777215, 1.0F, false, false);
      if(this.expandTime) {
         for(i = 0; i < this.timeModes.size(); ++i) {
            ...
            this.drawScaledString(I18n.func_135053_a("island.properties.time.label." + (String)this.timeModes.get(i)), this.guiLeft + 68, this.guiTop + 98 + 15 * i + 3 + 2, 16777215, 1.0F, false, false);
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_time")) {
         func_73734_a(this.guiLeft + 49, this.guiTop + 83, this.guiLeft + 49 + 65, this.guiTop + 83 + 16, -1157627904);
      }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_weather")) {
         func_73734_a(this.guiLeft + 115, this.guiTop + 83, this.guiLeft + 115 + 46, this.guiTop + 83 + 16, -1157627904);
      }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_flags")) {
         func_73734_a(this.guiLeft + 162, this.guiTop + 83, this.guiLeft + 162 + 35, this.guiTop + 83 + 16, -1157627904);
      }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_flags")) {
         func_73734_a(this.guiLeft + 198, this.guiTop + 83, this.guiLeft + 198 + 35, this.guiTop + 83 + 16, -1157627904);
      }
      ...
      if(!((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("change_flags")) {
         func_73734_a(this.guiLeft + 234, this.guiTop + 83, this.guiLeft + 234 + 40, this.guiTop + 83 + 16, -1157627904);
      }
      ...
      if(this.resetStarted || System.currentTimeMillis() - Long.parseLong((String)IslandMainGui.islandInfos.get("regenTime")) < 300000L || !((ArrayList)IslandMainGui.islandInfos.get("playerPermissions")).contains("reset_island") || mouseX >= this.guiLeft + 48 && mouseX <= this.guiLeft + 48 + 113 && mouseY >= this.guiTop + 214 && mouseY <= this.guiTop + 214 + 18) {
         ...
         if((this.resetStarted || System.currentTimeMillis() - Long.parseLong((String)IslandMainGui.islandInfos.get("regenTime")) < 300000L) && mouseX >= this.guiLeft + 48 && mouseX <= this.guiLeft + 48 + 113 && mouseY >= this.guiTop + 214 && mouseY <= this.guiTop + 214 + 18) {
            tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.global.cooldown_1"), I18n.func_135053_a("island.global.cooldown_2")});
         }
      }

      this.drawScaledString(I18n.func_135053_a("island.properties.reset"), this.guiLeft + 104, this.guiTop + 219, 16777215, 1.0F, true, false);
      ClientEventHandler.STYLE.bindTexture("island_settings");
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(mouseX > this.guiLeft + 275 && mouseX < this.guiLeft + 275 + 9 && mouseY > this.guiTop - 8 && mouseY < this.guiTop - 8 + 10) {
            ...
            Minecraft.func_71410_x().func_71373_a(new ConfirmResetGui(this));
         }
      }
