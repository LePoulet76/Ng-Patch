...
public class EmoteGui extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      List emoteSkins = ClientProxy.SKIN_MANAGER.getPlayerActiveSkins(Minecraft.func_71410_x().field_71439_g.field_71092_bJ, SkinType.EMOTES);
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.field_73886_k.func_78276_b(emote, (this.field_73880_f - this.field_73886_k.func_78256_a(emote)) / 2, (this.field_73881_g - this.field_73886_k.field_78288_b) / 2, 16777215);
      GL11.glPopMatrix();
            ...
            while(true) {
               if(var16 < var15) {
                  label36: {
                     ...
                     if(ClientProxy.SKIN_MANAGER.playerHasSkin(Minecraft.func_71410_x().field_71439_g.field_71092_bJ, skin)) {
                        if(index == id) {
                           anim = skin.getId();
                           break label36;
                        }
