...
public class SearchSellCountryGui
extends GuiScreen {
    ...
    public void func_73866_w_() {
        super.func_73866_w_();
        PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionSearchSellCountryDataPacket()));
    ...
    public void func_73863_a(int mouseX, int mouseY, float par3) {
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.search_sell.title"), this.guiLeft + 50, this.guiTop + 20, 0x191919, 1.0f, false, false);
        ...
        this.drawScaledString(I18n.func_135053_a((String)"faction.search_sell.nb_members"), this.guiLeft + 51 + 130, this.guiTop + 50, 0x191919, 0.9f, false, false);
        this.drawScaledString(I18n.func_135053_a((String)"faction.search_sell.price"), this.guiLeft + 51 + 195, this.guiTop + 50, 0x191919, 0.9f, false, false);
        if (loaded && countries.size() > 0) {
            ...
            for (int i = 0; i < countries.size(); ++i) {
                if (countries.get(i) == null) continue;
                if (this.searchText.isEmpty() || !this.searchText.isEmpty() && countries.get(i).get("name").toLowerCase().contains(this.searchText.toLowerCase())) {
                    ...
                    this.drawScaledString(countries.get(i).get("nb_members"), offsetX + 130, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
                    this.drawScaledString(countries.get(i).get("price") + "$", offsetX + 195, offsetY.intValue() + 5, 0xFFFFFF, 1.0f, false, false);
