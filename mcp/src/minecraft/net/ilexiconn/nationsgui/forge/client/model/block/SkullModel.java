...
extends ModelBase {
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) {
        this.bipedHead.field_78796_g = this.bipedHeadwear.field_78796_g = (float)((double)rotationYaw / 57.29577951308232);
        this.bipedHead.field_78795_f = this.bipedHeadwear.field_78795_f = (float)((double)rotationPitch / 57.29577951308232);
    }
}
