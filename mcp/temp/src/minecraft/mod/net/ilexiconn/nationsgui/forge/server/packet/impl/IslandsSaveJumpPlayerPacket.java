...
public class IslandsSaveJumpPlayerPacket implements IPacket, IServerPacket, IClientPacket {
   ...
   public void handleServerPacket(EntityPlayer player) {
      if(this.time != -1L) {
         TileEntity tileEntity = player.field_70170_p.func_72796_p(Integer.parseInt(this.position.split("#")[0]), Integer.parseInt(this.position.split("#")[1]), Integer.parseInt(this.position.split("#")[2]));
