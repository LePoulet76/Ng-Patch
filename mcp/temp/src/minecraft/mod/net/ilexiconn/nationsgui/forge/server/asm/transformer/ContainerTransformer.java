...
public class ContainerTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      while(var3.hasNext()) {
         ...
         if(mn.name.equals(dev?"detectAndSendChanges":"func_75142_b") && mn.desc.equals("()V")) {
            ...
            var14.add(new FieldInsnNode(180, "net/minecraft/inventory/Container", dev?"inventorySlots":"field_75151_b", "Ljava/util/List;"));
         ...
         } else if(!mn.name.equals(dev?"mergeItemStack":"func_75135_a")) {
            ...
            if(mn.name.equals("func_94527_a")) {
               ...
               for(var17 = 0; var17 < var15; ++var17) {
                  ...
                  if(var19 instanceof MethodInsnNode) {
                     ...
                     if(var20.name.equals(dev?"areItemStackTagsEqual":"func_77970_a")) {
            ...
            } else if(mn.name.equals(dev?"slotClick":"func_75144_a")) {
               var13 = mn.instructions.toArray();
               var15 = var13.length;
            ...
            for(int methodInsnNode = 0; methodInsnNode < insnNode; ++methodInsnNode) {
               ...
               if(insnNode1 instanceof MethodInsnNode) {
                  ...
                  if(methodInsnNode1.getOpcode() == 182 && methodInsnNode1.name.equals(dev?"getStack":"func_75211_c")) {
   ...
   public static boolean areItemStackTagsEqual(ItemStack item, ItemStack item2) {
      if(item != null && item2 != null && item.func_77973_b() instanceof ItemFood && item2.func_77973_b() instanceof ItemFood) {
         ...
         return ItemStack.func_77970_a(item, item2);
      }
   }
   ...
   public static void updateItemIfFood(List listSlot) {
      ...
      while(var1.hasNext()) {
         ...
         if(slot != null) {
            ...
            if(stack != null && stack.func_77973_b() != null && stack.func_77973_b() instanceof ItemFood) {
               stack.func_77973_b().func_77663_a(stack, (World)null, (Entity)null, 0, false);
            }
         }
      }
