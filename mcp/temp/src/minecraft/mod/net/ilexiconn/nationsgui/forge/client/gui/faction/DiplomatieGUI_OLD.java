...
public class DiplomatieGUI_OLD extends TabbedFactionGUI_OLD {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      if(loaded) {
         this.drawScaledString(I18n.func_135053_a("faction.diplomatie.title"), this.guiLeft + 131, this.guiTop + 16, 1644825, 1.4F, false, false);
         if(factionDiplomatieInfos != null && factionDiplomatieInfos.size() > 0) {
            ...
            this.drawScaledString("\u00a7f[" + I18n.func_135053_a("faction.common." + this.selectedDiplomatieInfos.get("relationType")) + "\u00a7f] " + this.selectedDiplomatieInfos.get("factionName"), this.guiLeft + 137, this.guiTop + 37, 16777215, 1.0F, false, false);
            this.drawScaledString(I18n.func_135053_a("faction.common." + this.selectedDiplomatieInfos.get("relationType")), this.guiLeft + 255, this.guiTop + 80, 16777215, 1.7F, true, false);
            ...
            if(this.flagTexture1 != null) {
               GL11.glBindTexture(3553, this.flagTexture1.func_110552_b());
            ...
            if(this.flagTexture2 != null) {
               GL11.glBindTexture(3553, this.flagTexture2.func_110552_b());
            ...
            this.drawScaledString(I18n.func_135053_a("faction.diplomatie.online_players") + " (" + var7.size() + ")", this.guiLeft + 131, this.guiTop + 133, 1644825, 0.8F, false, false);
            ...
            this.drawScaledString(I18n.func_135053_a("faction.diplomatie.buttons.page_pays"), this.guiLeft + 321, this.guiTop + 146, 16777215, 1.0F, true, false);
            if(this.expanded) {
               ClientEventHandler.STYLE.bindTexture("faction_diplomatie");
               ...
               for(i = 0; i < factionDiplomatieInfos.size(); ++i) {
                  ...
                  this.drawScaledString("\u00a7f[" + I18n.func_135053_a("faction.common." + ((HashMap)factionDiplomatieInfos.get(i)).get("relationType")) + "\u00a7f] " + ((HashMap)factionDiplomatieInfos.get(i)).get("factionName"), offsetX + 6, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.diplomatie.buttons.wish_1"), this.guiLeft + 10 + 50, this.guiTop + 165 + 5, 16777215, 1.0F, true, true);
         this.drawScaledString(I18n.func_135053_a("faction.diplomatie.buttons.wish_2"), this.guiLeft + 10 + 50, this.guiTop + 165 + 15, 16777215, 1.0F, true, true);
      }
   ...
   public void drawTooltip(String text, int mouseX, int mouseY) {
      ...
      this.drawHoveringText(Arrays.asList(new String[]{text.substring(0, 1).toUpperCase() + text.substring(1)}), mouseX, mouseY, this.field_73886_k);
   }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      ...
      if(mouseButton == 0) {
         ...
         if(!this.expanded && mouseX >= this.guiLeft + 130 && mouseX <= this.guiLeft + 130 + 125 && mouseY >= this.guiTop + 140 && mouseY <= this.guiTop + 140 + 90 && !this.hoveredPlayer.isEmpty()) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            Minecraft.func_71410_x().func_71373_a(new ProfilGui(this.hoveredPlayer.split(" ")[0], ""));
         }
         ...
         if(!this.expanded && mouseX >= this.guiLeft + 258 && mouseX <= this.guiLeft + 258 + 126 && mouseY >= this.guiTop + 140 && mouseY <= this.guiTop + 140 + 20 && this.selectedDiplomatieInfos != null) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            Minecraft.func_71410_x().func_71373_a(new FactionGui_OLD((String)this.selectedDiplomatieInfos.get("factionName")));
         }
         ...
         if(!this.expanded && mouseX >= this.guiLeft + 10 && mouseX <= this.guiLeft + 10 + 100 && mouseY >= this.guiTop + 165 && mouseY <= this.guiTop + 165 + 30 && this.selectedDiplomatieInfos != null) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            Minecraft.func_71410_x().func_71373_a(new DiplomatieWishGUI(this.player));
         }
      }
