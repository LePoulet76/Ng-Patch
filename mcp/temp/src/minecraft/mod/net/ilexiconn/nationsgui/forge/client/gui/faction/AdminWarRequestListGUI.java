...
public class AdminWarRequestListGUI extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      warsInfos.clear();
      PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionAdminEnemyListPacket()));
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.enemy.requests.title"), this.guiLeft + 14, this.guiTop + 210, 16777215, 1.5F, false, false);
      GL11.glPopMatrix();
      ...
      if(warsInfos.size() > 0) {
         ...
         while(i.hasNext()) {
            ...
            if((this.countrySearch.func_73781_b().isEmpty() || ((String)warInfos.get("factionATTName")).toLowerCase().contains(this.countrySearch.func_73781_b().toLowerCase()) || ((String)warInfos.get("factionDEFName")).toLowerCase().contains(this.countrySearch.func_73781_b().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)warInfos.get("status")).startsWith(this.selectedStatus))) {
               ...
               if(!ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionATTName"))) {
                  if(!ClientProxy.base64FlagsByFactionName.containsKey((String)warInfos.get("factionATTName"))) {
                     ...
                     PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionGetImagePacket((String)warInfos.get("factionATTName"))));
                  } else if(ClientProxy.base64FlagsByFactionName.containsKey((String)warInfos.get("factionATTName")) && !((String)ClientProxy.base64FlagsByFactionName.get((String)warInfos.get("factionATTName"))).isEmpty()) {
                     date = ClientProxy.decodeToImage((String)ClientProxy.base64FlagsByFactionName.get((String)warInfos.get("factionATTName")));
                     ClientProxy.flagsTexture.put((String)warInfos.get("factionATTName"), new DynamicTexture(date));
                  }
               }

               if(ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionATTName"))) {
                  GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionATTName"))).func_110552_b());
               ...
               this.drawScaledString((String)warInfos.get("factionATTName"), offsetX + 28, offsetY.intValue() + 7, 16777215, 1.0F, false, false);
               this.drawScaledString(" \u00a7cvs", offsetX + 28 + this.field_73886_k.func_78256_a((String)warInfos.get("factionATTName")), offsetY.intValue() + 7, 16777215, 1.0F, false, false);
               if(!ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionDEFName"))) {
                  if(!ClientProxy.base64FlagsByFactionName.containsKey((String)warInfos.get("factionDEFName"))) {
                     ...
                     PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionGetImagePacket((String)warInfos.get("factionDEFName"))));
                  } else if(ClientProxy.base64FlagsByFactionName.containsKey((String)warInfos.get("factionDEFName")) && !((String)ClientProxy.base64FlagsByFactionName.get((String)warInfos.get("factionDEFName"))).isEmpty()) {
                     date = ClientProxy.decodeToImage((String)ClientProxy.base64FlagsByFactionName.get((String)warInfos.get("factionDEFName")));
                     ClientProxy.flagsTexture.put((String)warInfos.get("factionDEFName"), new DynamicTexture(date));
                  }
               }

               if(ClientProxy.flagsTexture.containsKey((String)warInfos.get("factionDEFName"))) {
                  GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get((String)warInfos.get("factionDEFName"))).func_110552_b());
                  ModernGui.drawScaledCustomSizeModalRect((float)(offsetX + 7), (float)(offsetY.intValue() + 17), 0.0F, 0.0F, 156, 78, 18, 10, 156.0F, 78.0F, false);
               }

               this.drawScaledString((String)warInfos.get("factionDEFName"), offsetX + 28, offsetY.intValue() + 19, 16777215, 1.0F, false, false);
               this.drawScaledString(I18n.func_135053_a("faction.enemy.status." + warInfos.get("status")), offsetX + 253 - this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.status." + warInfos.get("status"))), offsetY.intValue() + 7, 16777215, 1.0F, false, false);
               this.drawScaledString(I18n.func_135053_a("faction.enemy.reason." + warInfos.get("reason")), offsetX + 7, offsetY.intValue() + 33, 16777215, 1.0F, false, false);
               Date var13 = new Date(((Double)warInfos.get("creationTime")).longValue());
               SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd/MM/yyy HH:mm");
               this.drawScaledString("\u00a7b" + simpleDateFormat.format(var13), offsetX + 253 - this.field_73886_k.func_78256_a(simpleDateFormat.format(var13)), offsetY.intValue() + 33, 16777215, 1.0F, false, false);
               yOffset += 48;
            }
         }
         ...
         this.drawScaledString(I18n.func_135053_a("faction.enemy.status." + this.selectedStatus), this.guiLeft + 50, this.guiTop + 23, 16777215, 1.0F, false, false);
         if(this.expandStatus) {
            ClientEventHandler.STYLE.bindTexture("faction_war_requests");

            for(int var12 = 0; var12 < availableStatus.size(); ++var12) {
               ClientEventHandler.STYLE.bindTexture("faction_war_requests");
               ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 46), (float)(this.guiTop + 36 + 19 * var12), 0, 311, 120, 20, 512.0F, 512.0F, false);
               this.drawScaledString(I18n.func_135053_a("faction.enemy.status." + (String)availableStatus.get(var12)), this.guiLeft + 50, this.guiTop + 36 + 19 * var12 + 6, 16777215, 1.0F, false, false);
               if(mouseX > this.guiLeft + 46 && mouseX < this.guiLeft + 46 + 120 && mouseY > this.guiTop + 36 + 19 * var12 && mouseY < this.guiTop + 36 + 19 * var12 + 20) {
                  this.hoveredStatus = (String)availableStatus.get(var12);
               }
            }
         }
      }
   ...
   private float getSlideWars() {
      int countWars = 0;
      Iterator var2 = warsInfos.iterator();

      while(var2.hasNext()) {
         HashMap warInfos = (HashMap)var2.next();
         if((this.countrySearch.func_73781_b().isEmpty() || ((String)warInfos.get("factionATTName")).toLowerCase().contains(this.countrySearch.func_73781_b().toLowerCase()) || ((String)warInfos.get("factionDEFName")).toLowerCase().contains(this.countrySearch.func_73781_b().toLowerCase())) && (this.selectedStatus.equals("all") || ((String)warInfos.get("status")).startsWith(this.selectedStatus))) {
            ++countWars;
         }
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      ...
      if(mouseButton == 0) {
         ...
         if(!this.expandStatus && this.hoveredRequestId != -1) {
            this.field_73882_e.field_71416_A.func_77366_a("random.click", 1.0F, 1.0F);
            Minecraft.func_71410_x().func_71373_a(new WarRequestGUI(this.hoveredRequestId, this));
         }
