...
public class ModalLargeGui extends GuiScreen {
   ...
   public ModalLargeGui(GuiScreen guiFrom) {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(mouseX >= this.guiLeft + 304 && mouseX <= this.guiLeft + 304 + 9 && mouseY >= this.guiTop - 6 && mouseY <= this.guiTop - 6 + 10) {
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 304), (float)(this.guiTop - 6), 0, 227, 9, 10, 512.0F, 512.0F, false);
      } else {
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 304), (float)(this.guiTop - 6), 0, 217, 9, 10, 512.0F, 512.0F, false);
      }
