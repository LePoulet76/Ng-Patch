...
public class ServerSwitchExpressGui
extends GuiScreen {
    ...
    public void func_73876_c() {
        if (this.update < 2) {
            if (this.update == 1) {
                ...
                Minecraft.func_71410_x().func_71373_a((GuiScreen)new CustomConnectingGui((GuiScreen)new MainGUI(), this.address, this.port, this.serverName));
            }
            ++this.update;
        }
    }
