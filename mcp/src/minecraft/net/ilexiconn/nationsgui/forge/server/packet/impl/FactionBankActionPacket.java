...
public class FactionBankActionPacket
implements IPacket,
IClientPacket {
    ...
    public void handleClientPacket(EntityPlayer player) {
        PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new FactionBankDataPacket(this.bankName)));
    }
}
