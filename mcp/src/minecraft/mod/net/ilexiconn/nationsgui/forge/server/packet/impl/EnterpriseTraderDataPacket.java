...
public class EnterpriseTraderDataPacket implements IPacket, IClientPacket
{
    ...
    {
        XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)(new XYChartBuilder()).width(496)).height(190)).title(I18n.getString("enterprise.STATS_TEXTURE.title"))).build();
