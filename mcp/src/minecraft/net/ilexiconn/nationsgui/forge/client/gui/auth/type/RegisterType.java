...
implements IAuthType {
    ...
    public void init(int x, int y, AuthGUI gui, List<GuiButton> buttonList) {
        ...
        this.buttonRegister = new GuiButton(1, x + 119, y + 108, 100, 20, StatCollector.func_74838_a((String)"nationsgui.auth.register"));
        buttonList.add(this.buttonRegister);
    ...
    public void render(int x, int y, int mouseX, int mouseY, AuthGUI gui) {
        Minecraft.func_71410_x().field_71466_p.func_78276_b(StatCollector.func_74838_a((String)"nationsgui.auth.password"), x + 13, y + 40, 0x404040);
        Minecraft.func_71410_x().field_71466_p.func_78276_b(StatCollector.func_74838_a((String)"nationsgui.auth.password_confirm"), x + 13, y + 70, 0x404040);
    ...
    public void actionPerformed(GuiButton button, AuthGUI gui) {
        if (button.field_73741_f == 0) {
            ...
            if (this.password.func_73781_b().equals(this.passwordConfirm.func_73781_b())) {
                ...
                ClientProxy.SNACKBAR_LIST.add(new SnackbarGUI(StatCollector.func_74838_a((String)"nationsgui.auth.no_match")));
            }
        }
    }
