...
public class FactionStatsGUI extends TabbedFactionGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        if (loaded)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.stats.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            for (int var7 = 0; var7 < var6; ++var7)
            {
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.stats.tab." + tab.name().toLowerCase()), (float)(this.guiLeft + 42 + 66 * index + 32), (float)(this.guiTop + 80), this.activeTab.equals(tab) ? 7239406 : 14342893, 0.5F, "center", false, "georamaSemiBold", 26);
