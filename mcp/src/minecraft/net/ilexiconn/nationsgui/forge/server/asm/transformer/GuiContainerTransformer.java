...
public class GuiContainerTransformer implements Transformer
{
    ...
    public void transform(ClassNode node, boolean dev)
    {
        ...
        while (var3.hasNext())
        {
            ...
            {
                if (!methodNode.name.equals("drawItemStackTooltip") && !methodNode.name.equals("drawItemStackTooltip"))
                {
                    if ((methodNode.name.equals("drawScreen") || methodNode.name.equals("drawScreen")) && !NationsGUITransformer.inDevelopment)
                    {
                            ...
                            try
                            {
                                ...
                                if (future instanceof MethodInsnNode)
                                {
                                    ...
                                    if (mInsnNode.name.equals("renderToolTips"))
                                    {
                                        ...
                                        methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(182, "net/minecraft/entity/player/InventoryPlayer", dev ? "getItemStack" : "getItemStack", "()Lnet/minecraft/item/ItemStack;"));
                                        ...
                                        methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(180, "net/minecraft/client/gui/inventory/GuiContainer", dev ? "theSlot" : "theSlot", "Lnet/minecraft/inventory/Slot;"));
                                        methodNode.instructions.insertBefore(insnNode, new JumpInsnNode(198, l67));
                                        methodNode.instructions.insertBefore(insnNode, new VarInsnNode(25, 0));
                                        methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(180, "net/minecraft/client/gui/inventory/GuiContainer", dev ? "theSlot" : "theSlot", "Lnet/minecraft/inventory/Slot;"));
                                        methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(182, "net/minecraft/inventory/Slot", dev ? "getHasStack" : "getHasStack", "()Z"));
                                        methodNode.instructions.insertBefore(insnNode, new JumpInsnNode(153, l67));
                                        methodNode.instructions.insertBefore(insnNode, new VarInsnNode(25, 0));
                                        methodNode.instructions.insertBefore(insnNode, new FieldInsnNode(180, "net/minecraft/client/gui/inventory/GuiContainer", dev ? "theSlot" : "theSlot", "Lnet/minecraft/inventory/Slot;"));
                                        methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(182, "net/minecraft/inventory/Slot", dev ? "getStack" : "getStack", "()Lnet/minecraft/item/ItemStack;"));
                                        ...
                                        methodNode.instructions.insertBefore(insnNode, new MethodInsnNode(182, "net/minecraft/client/gui/inventory/GuiContainer", dev ? "drawItemStackTooltip" : "drawItemStackTooltip", "(Lnet/minecraft/item/ItemStack;II)V"));
