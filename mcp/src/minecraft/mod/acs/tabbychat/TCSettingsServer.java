...
public class TCSettingsServer extends TCSettingsGUI
{
    ...
    public void initGui()
    {
        ...
        this.delimiterChars.setButtonLoc(col1x + 20 + Minecraft.getMinecraft().fontRenderer.getStringWidth(this.delimiterChars.description), this.rowY(2));
        ...
        this.defaultChannels.setButtonLoc(col1x + 5 + Minecraft.getMinecraft().fontRenderer.getStringWidth(this.defaultChannels.description), this.rowY(5));
        ...
        this.ignoredChannels.setButtonLoc(col1x + 5 + Minecraft.getMinecraft().fontRenderer.getStringWidth(this.ignoredChannels.description), this.rowY(6));
    ...
    {
        if (!Minecraft.getMinecraft().isSingleplayer() && ServerSettings.getServerData() != null)
        {
