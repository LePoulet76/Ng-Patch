...
public class EnterpriseContractForm_Default_Gui extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            lineTextField.setMaxStringLength(32);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            if (this.validButton.enabled && !this.delayExpanded && this.isNumeric(this.priceInput.getText()) && mouseX > this.guiLeft + 282 && mouseX < this.guiLeft + 282 + 80 && mouseY > this.guiTop + 197 && mouseY < this.guiTop + 197 + 20)
            {
                ...
                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseContractCreate_Default_Packet((String)EnterpriseGui.enterpriseInfos.get("name"), description, Integer.valueOf(Integer.parseInt(this.priceInput.getText())), lineTextField2)));
