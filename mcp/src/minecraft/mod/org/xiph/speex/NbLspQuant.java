...
public class NbLspQuant extends LspQuant
{
    public final void quant(float[] var1, float[] var2, int var3, Bits var4)
    {
        ...
        {
            float var8 = 1.0F / ((0.15F + var2[var5] - var2[var5 - 1]) * (0.15F + var2[var5] - var2[var5 - 1]));
            float var7 = 1.0F / ((0.15F + var2[var5 + 1] - var2[var5]) * (0.15F + var2[var5 + 1] - var2[var5]));
            var9[var5] = var8 > var7 ? var8 : var7;
        }
        ...
        int var91 = lsp_quant(var2, 0, Codebook.cdbk_nb, 64, var3);
        var4.pack(var91, 6);
        ...
        var91 = lsp_weight_quant(var2, 0, var9, 0, Codebook.cdbk_nb_low1, 64, 5);
        var4.pack(var91, 6);
        ...
        var91 = lsp_weight_quant(var2, 0, var9, 0, Codebook.cdbk_nb_low2, 64, 5);
        var4.pack(var91, 6);
        var91 = lsp_weight_quant(var2, 5, var9, 5, Codebook.cdbk_nb_high1, 64, 5);
        var4.pack(var91, 6);
        ...
        var91 = lsp_weight_quant(var2, 5, var9, 5, Codebook.cdbk_nb_high2, 64, 5);
        var4.pack(var91, 6);
