...
public class CommonCosmeticGUI extends GuiScreen
{
    ...
    public static String formatTime(Long time)
    {
        ...
        {
            return I18n.getString("cosmetic.label.expired");
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (mouseX >= this.guiLeft + 381 && mouseX <= this.guiLeft + 381 + 57 && mouseY >= this.guiTop + 11 && mouseY <= this.guiTop + 11 + 14)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.store"), (float)(this.guiLeft + 381 + 29), (float)(this.guiTop + 15), COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
            this.hoveredAction = "store";
        }
        else
        {
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.store"), (float)(this.guiLeft + 381 + 29), (float)(this.guiTop + 15), COLOR_WHITE, 0.5F, "center", false, "georamaSemiBold", 27);
        }
        ...
        if (mouseX >= this.guiLeft + 300 && mouseX <= this.guiLeft + 300 + 65 && mouseY >= this.guiTop + 11 && mouseY <= this.guiTop + 11 + 14)
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.prime_wheel"), (float)(this.guiLeft + 301 + 32), (float)(this.guiTop + 15), COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
            this.hoveredAction = "open_ngprime";
        }
        else
        {
            ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.prime_wheel"), (float)(this.guiLeft + 301 + 32), (float)(this.guiTop + 15), COLOR_WHITE, 0.5F, "center", false, "georamaSemiBold", 27);
        }
        ...
        if (this.displayModal)
        {
            ...
            Gui.drawRect(this.guiLeft, this.guiTop, this.guiLeft + this.xSize, this.guiTop + this.ySize, -1090519040);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            String var10;
            String var11;
            ...
            if (!this.itemToBuy.isEmpty())
            {
                ...
                var11 = I18n.getString("cosmetic.rarity." + (String)this.itemToBuy.get("rarity"));
                ...
                if (mouseX >= this.guiLeft + 200 && mouseX <= this.guiLeft + 200 + 39 && mouseY >= this.guiTop + 145 && mouseY <= this.guiTop + 145 + 14)
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.return"), (float)(this.guiLeft + 200 + 19), (float)(this.guiTop + 145) + 4.0F, CosmeticGUI.COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 25);
                    this.hoveredAction = "close_modal";
                }
                else
                {
                ...
                if ((double)Integer.parseInt((String)this.itemToBuy.get("price")) <= ((Double)CosmeticGUI.data.get("player_points")).doubleValue())
                {
                    if (mouseX >= this.guiLeft + 245 && mouseX <= this.guiLeft + 245 + 46 && mouseY >= this.guiTop + 145 && mouseY <= this.guiTop + 145 + 14)
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.buy"), (float)(this.guiLeft + 245 + 23), (float)(this.guiTop + 145) + 4.0F, CosmeticGUI.COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 25);
                    ...
                    else
                    {
                        ...
                        ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.buy"), (float)(this.guiLeft + 245 + 23), (float)(this.guiTop + 145) + 4.0F, CosmeticGUI.COLOR_WHITE, 0.5F, "center", false, "georamaSemiBold", 25);
                    }
                }
                else
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.buy"), (float)(this.guiLeft + 245 + 23), (float)(this.guiTop + 145) + 4.0F, CosmeticGUI.COLOR_LIGHT_GRAY, 0.5F, "center", false, "georamaSemiBold", 25);
            ...
            else if (this.displayNGWheel)
            {
                ...
                {
                    this.currentWheelRotation = (int)(0.0D + (double)(this.targetWheelRotation - 0) * (1.0D - Math.cos(Math.PI * (double)(System.currentTimeMillis() - this.startWheelTime.longValue()) / 3500.0D)) / 2.0D);
                }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.wheel.title"), (float)(this.guiLeft + 243), (float)(this.guiTop + 69), COLOR_WHITE, 1.0F, "left", false, "georamaExtraBold", 28);

                if (this.targetWheelRotation != 0 && this.targetWheelRotation == this.currentWheelRotation)
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("cosmetic.label.prime_wheel.win"), (float)(this.guiLeft + 243), (float)(this.guiTop + 90), COLOR_PINK, 0.5F, "left", false, "georamaBold", 30);
                    ...
                    if (((LinkedTreeMap)CosmeticGUI.data.get("prizeInfos")).containsKey("skin_name"))
                    {
                        ...
                        var11 = I18n.getString("cosmetic.rarity." + (String)((LinkedTreeMap)CosmeticGUI.data.get("prizeInfos")).get("rarity"));
                ...
                {
                    ModernGui.drawSectionStringCustomFont(I18n.getString("cosmetic.wheel.description"), (float)(this.guiLeft + 243), (float)(this.guiTop + 90), COLOR_LIGHT_GRAY, 0.5F, "left", false, "georamaMedium", 26, 8, 240);
                }
                ...
                if (CosmeticGUI.loaded)
                {
                    ...
                    String var15 = I18n.getString("cosmetic.wheel.spin");

                    if (!var12)
                    {
                        var15 = I18n.getString("cosmetic.wheel.not_prime");
                    }
                    else if (!var13)
                    {
                        var15 = I18n.getString("cosmetic.wheel.play_cooldown") + " " + formatTime(Long.valueOf(Long.parseLong((String)CosmeticGUI.data.get("lastWheel")) + 86400000L));
                    }
