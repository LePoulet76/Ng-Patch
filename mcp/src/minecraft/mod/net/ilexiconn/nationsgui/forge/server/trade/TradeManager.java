...
public class TradeManager
{
    ...
    public static void sendCancel(EntityPlayer player, String trader)
    {
        ...
        PacketDispatcher.sendPacketToPlayer(PacketRegistry.INSTANCE.generatePacket(new PlayersInTradePacket(player.username, trader, false)), (Player)player);
    }

    public static void sendClose(EntityPlayer player)
    {
        PacketDispatcher.sendPacketToPlayer(PacketRegistry.INSTANCE.generatePacket(new TradeClosePacket(player.username)), (Player)player);
    }
