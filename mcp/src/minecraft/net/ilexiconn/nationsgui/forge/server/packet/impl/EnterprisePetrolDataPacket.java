...
public class EnterprisePetrolDataPacket
implements IPacket,
IClientPacket {
    ...
    public void handleClientPacket(EntityPlayer player) {
        XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)new XYChartBuilder().width(496)).height(190)).title(I18n.func_135053_a((String)"enterprise.STATS_TEXTURE.petrol.title"))).build();
        ...
        this.loadChartTexture((Chart)chart, EnterprisePetrolGUI.STATS_TEXTURE);
