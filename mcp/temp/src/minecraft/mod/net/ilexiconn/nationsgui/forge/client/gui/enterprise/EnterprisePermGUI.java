...
public class EnterprisePermGUI extends TabbedEnterpriseGUI {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      this.drawScaledString(I18n.func_135053_a("faction.perm.title"), this.guiLeft + 131, this.guiTop + 15, 1644825, 1.4F, false, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.role.leader"), this.guiLeft + 255, this.guiTop + 35, 0, 0.8F, true, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.role.cadre"), this.guiLeft + 302, this.guiTop + 35, 0, 0.8F, true, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.role.employee"), this.guiLeft + 349, this.guiTop + 35, 0, 0.8F, true, false);
      if(enterprisePermInfos.size() > 0) {
         ...
         for(Iterator var5 = enterprisePermInfos.iterator(); var5.hasNext(); ++index) {
            ...
            this.drawScaledString(I18n.func_135053_a("enterprise.perm.label." + permName), offsetX + 4, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
            ClientEventHandler.STYLE.bindTexture("enterprise_perm");
            ...
            if(mouseX > offsetX + 83 && mouseX < offsetX + 83 + 10 && (float)mouseY > offsetY.floatValue() + 5.0F && (float)mouseY < offsetY.floatValue() + 5.0F + 11.0F) {
               tooltipToDraw = I18n.func_135053_a("enterprise.perm.tooltip." + permName);
            }
         ...
         if(EnterpriseGui.hasPermission("perms")) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.perm.save"), this.guiLeft + 334, this.guiTop + 220, 16777215, 1.1F, true, false);
         }
      }
