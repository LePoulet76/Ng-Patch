...
public class EnterpriseCasinoDataPacket
implements IPacket,
IClientPacket {
    ...
    public void fromBytes(ByteArrayDataInput data) {
        this.casinoInfos = (HashMap)new Gson().fromJson(data.readUTF(), new TypeToken<HashMap<String, Object>>(){}.getType());
    ...
    public void handleClientPacket(EntityPlayer player) {
        XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)new XYChartBuilder().width(496)).height(190)).title(I18n.func_135053_a((String)"enterprise.STATS_TEXTURE.casino.title"))).build();
        ...
        this.loadChartTexture((Chart)chart, EnterpriseCasinoGUI.STATS_TEXTURE);
