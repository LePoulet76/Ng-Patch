...
public class RenderGlobalTransformer implements Transformer
{
    ...
    public void transform(ClassNode node, boolean dev)
    {
        ...
        while (var3.hasNext())
        {
            ...
            if (method.name.equals(dev ? "loadRenderers" : "loadRenderers"))
            {
                    ...
                    if (var8 < target)
                    {
                        label50:
                        {
                            ...
                            if (insnNode instanceof FieldInsnNode)
                            {
                                ...
                                else if (fieldInsnNode.getOpcode() == 180 && fieldInsnNode.name.equals(dev ? "renderDistance" : "renderDistance") && fieldInsnNode.owner.equals("net/minecraft/client/renderer/RenderGlobal"))
                                {
                                    targets.add(fieldInsnNode);
                                    break label50;
                                }
