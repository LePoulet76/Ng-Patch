...
public class LevelGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      GL11.glPushMatrix();
      GL11.glTranslatef((float)(this.guiLeft + 13), (float)(this.guiTop + 44 + (int)((double)this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.level.title") + " " + FactionGUI.factionInfos.get("name")) * 1.5D)), 0.0F);
      GL11.glRotatef(-90.0F, 0.0F, 0.0F, 1.0F);
      GL11.glTranslatef((float)(-(this.guiLeft + 13)), (float)(-(this.guiTop + 44 + (int)((double)this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.level.title") + " " + FactionGUI.factionInfos.get("name")) * 1.5D))), 0.0F);
      this.drawScaledString(I18n.func_135053_a("faction.level.title") + " \u00a77" + FactionGUI.factionInfos.get("name"), this.guiLeft + 13, this.guiTop + 44 + (int)((double)this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.level.title") + " " + FactionGUI.factionInfos.get("name")) * 1.5D), 16777215, 1.5F, false, false);
      GL11.glPopMatrix();
      this.drawScaledString("\u00a77" + I18n.func_135053_a("faction.level.palier"), this.guiLeft + 96, this.guiTop + 25, 16777215, 0.8F, true, false);
      this.drawScaledString("\u00a77" + I18n.func_135053_a("faction.level.actual"), this.guiLeft + 96, this.guiTop + 35, 16777215, 0.8F, true, false);
      this.drawScaledString("\u00a7l" + this.currentPalier, this.guiLeft + 98, this.guiTop + 54, 16777215, 1.5F, true, false);
      this.drawScaledString("\u00a77" + I18n.func_135053_a("faction.level.next"), this.guiLeft + 161, this.guiTop + 25, 16777215, 0.8F, true, false);
      ...
      Gui.func_73734_a(this.guiLeft + 56, this.guiTop + 80, (int)((float)(this.guiLeft + 56) + 150.0F * progress), this.guiTop + 83, -13849059);
      this.drawScaledString("\u00a77" + I18n.func_135053_a("faction.level.actual_level") + " : " + this.currentLevel, this.guiLeft + 131, this.guiTop + 89, 16777215, 0.8F, true, false);
      ClientEventHandler.STYLE.bindTexture("faction_level");
      ...
      this.drawScaledString(I18n.func_135053_a("faction.level.actual_advantages"), this.guiLeft + 46, this.guiTop + 104, 0, 1.0F, false, false);
      ...
      for(i = 0; i < ((List)this.rewards.get(Integer.valueOf(this.currentPalier))).size(); ++i) {
         ...
         this.drawScaledString(I18n.func_135053_a("faction.level.label." + ((String)((List)this.rewards.get(Integer.valueOf(this.currentPalier))).get(i)).split("#")[0]), offsetX + 22, offsetY.intValue() + 4, 16777215, 0.8F, false, false);
         if(this.isNumeric(((String)((List)this.rewards.get(Integer.valueOf(this.currentPalier))).get(i)).split("#")[1])) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.level.label." + ((String)((List)this.rewards.get(Integer.valueOf(this.currentPalier))).get(i)).split("#")[1]), offsetX + 22, offsetY.intValue() + 12, 16777215, 0.8F, false, false);
         }
      }
      ...
      this.drawScaledString(I18n.func_135053_a("faction.level.next_advantages"), this.guiLeft + 46, this.guiTop + 171, 0, 1.0F, false, false);
      if(this.nextPallier != this.currentPalier) {
         ...
         for(i = 0; i < ((List)this.rewards.get(Integer.valueOf(this.nextPallier))).size(); ++i) {
            ...
            ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetX + 2), (float)(offsetY.intValue() + 2), 94, 251, 17, 17, 512.0F, 512.0F, false);
            ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetX + 4), (float)(offsetY.intValue() + 4), 13 * i, 290, 13, 13, 512.0F, 512.0F, false);
            this.drawScaledString(I18n.func_135053_a("faction.level.label." + ((String)((List)this.rewards.get(Integer.valueOf(this.nextPallier))).get(i)).split("#")[0]), offsetX + 22, offsetY.intValue() + 4, 16777215, 0.8F, false, false);
            if(this.isNumeric(((String)((List)this.rewards.get(Integer.valueOf(this.nextPallier))).get(i)).split("#")[1])) {
               ...
               this.drawScaledString(I18n.func_135053_a("faction.level.label." + ((String)((List)this.rewards.get(Integer.valueOf(this.nextPallier))).get(i)).split("#")[1]), offsetX + 22, offsetY.intValue() + 12, 16777215, 0.8F, false, false);
            }
         }
