...
extends ItemPotion {
    ...
    public String func_77628_j(ItemStack par1ItemStack) {
        return ("" + StatCollector.func_74838_a((String)(this.func_77657_g(par1ItemStack) + ".name"))).trim();
    }

    public List func_77834_f(int par1) {
        ArrayList<PotionEffect> potionEffectList = new ArrayList<PotionEffect>();
        for (PotionEffectData effectData : this.data.getEffects()) {
    ...
    public ItemStack func_77654_b(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (!par2World.field_72995_K && (list = this.func_77832_l(par1ItemStack)) != null) {
