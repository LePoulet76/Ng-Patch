...
public class EnterpriseGlobalMarketGui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        GL11.glTranslatef((float)(-(this.guiLeft + 14)), (float)(-(this.guiTop + 170)), 0.0F);
        this.drawScaledString(I18n.getString("globalmarket.title"), this.guiLeft + 14, this.guiTop + 170, 16777215, 1.5F, false, false);
        GL11.glPopMatrix();
        ...
        this.drawScaledString(I18n.getString("globalmarket.label.prices"), this.guiLeft + 281, this.guiTop + 21, 0, 1.0F, true, false);
        ...
        this.drawScaledString(I18n.getString("globalmarket.label.sales"), this.guiLeft + 326, this.guiTop + 21, 0, 1.0F, true, false);
        ...
        this.drawScaledString(I18n.getString("globalmarket.label.stocks"), this.guiLeft + 371, this.guiTop + 21, 0, 1.0F, true, false);
        ...
        if (loaded)
        {
            ...
            Minecraft.getMinecraft().getTextureManager().bindTexture(chartTexture);
            ...
            for (int i = 0; i < cerealsPrice.size(); ++i)
            {
                ...
                this.drawScaledString(price, offsetX + 80 - this.fontRenderer.getStringWidth(price) - 4, offsetY + 5, 16777215, 1.0F, false, false);
                ClientEventHandler.STYLE.bindTexture("enterprise_globalmarket");
                ModernGui.drawModalRectWithCustomSizedTexture((float)(offsetX + 80 - this.fontRenderer.getStringWidth(price) - 12), (float)(offsetY + 6), ((String)cerealsPriceChange.get(cerealName)).equals("+") ? 70 : 77, 311, 6, 6, 512.0F, 512.0F, false);
                GL11.glEnable(GL11.GL_LIGHTING);
                ItemStack cereal = new ItemStack(NGContent.getCerealIdFromName(cerealName).intValue(), 1, 0);
                this.itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), cereal, offsetX + 3, offsetY + 1);
                ++indexX;
