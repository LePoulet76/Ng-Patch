...
public class IslandMembersGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      GL11.glTranslatef((float)(-(this.guiLeft + 337 + this.helpSectionOffsetX)), (float)(-(this.guiTop + 209)), 0.0F);
      this.drawScaledString(I18n.func_135053_a("island.list.help.title"), this.guiLeft + 337 + this.helpSectionOffsetX, this.guiTop + 209, 0, 1.0F, false, false);
      GL11.glPopMatrix();
      ClientEventHandler.STYLE.bindTexture("island_members");
      ...
      this.drawScaledString(I18n.func_135053_a("island.members.help.title"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 20, 0, 1.3F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_1"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 50, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_2"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 60, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_3"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 70, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_4"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 80, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_5"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 95, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_6"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 105, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_7"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 115, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_8"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 125, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_9"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 135, 0, 1.0F, true, false);
      this.drawScaledString(I18n.func_135053_a("island.members.help.text_10"), this.guiLeft + 381 - 107 + this.helpSectionOffsetX, this.guiTop + 145, 0, 1.0F, true, false);
      ...
      for(int titleOffsetY = 0; titleOffsetY < IslandMainGui.TABS.size(); ++titleOffsetY) {
         ...
         if(this.getClass() == l.getClassReferent()) {
            ...
            if(mouseX >= this.guiLeft - 23 && mouseX <= this.guiLeft - 23 + 29 && mouseY >= this.guiTop + 47 + titleOffsetY * 31 && mouseY <= this.guiTop + 47 + 30 + titleOffsetY * 31) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.tab." + offsetX)});
            }
         }
      }
      ...
      if(IslandMainGui.islandInfos != null && IslandMainGui.islandInfos.size() > 0) {
         GL11.glPushMatrix();
         Double var10 = Double.valueOf((double)(this.guiTop + 45) + (double)this.field_73886_k.func_78256_a((String)IslandMainGui.islandInfos.get("name")) * 1.5D);
         ...
         if(this.tabMode.equals("members")) {
            this.drawScaledString(I18n.func_135053_a("island.members.manager_teams"), this.guiLeft + 104, this.guiTop + 220, 16777215, 1.0F, true, false);
         } else {
            this.drawScaledString(I18n.func_135053_a("island.members.manager_members"), this.guiLeft + 104, this.guiTop + 220, 16777215, 1.0F, true, false);
         }
         ...
         int var11;
         if(this.tabMode.equals("members")) {
            this.drawScaledString(I18n.func_135053_a("island.main.members"), this.guiLeft + 48, this.guiTop + 25, 0, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.func_135053_a("island.main.visitors"), this.guiLeft + 203, this.guiTop + 25, 0, 1.0F, false, false);
            ...
            if(selectedTeamInfos != null) {
               ...
               Gui.func_73734_a(this.guiLeft + 54, this.guiTop + 45, this.guiLeft + 54 + 12, this.guiTop + 45 + 12, getColorFromString((String)selectedTeamInfos.get("color")));
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               ...
               this.drawScaledString(I18n.func_135053_a("island.members.scoreType." + selectedTeamInfos.get("scoreType")), this.guiLeft + 194, this.guiTop + 66, 16777215, 1.0F, false, false);
               this.drawScaledString(I18n.func_135053_a("island.members.label.players"), this.guiLeft + 53, this.guiTop + 96, 16777215, 1.0F, false, false);
               ...
               for(var11 = 0; var11 < teamFlags.size(); ++var11) {
                  ...
                  String flagString = I18n.func_135053_a("island.members.flags.label." + (String)teamFlags.get(var11));
                  if(flagString.length() > 15) {
                     ...
                     if(mouseX > offsetX && mouseX < offsetX + 106 && mouseY > offsetY.intValue() && mouseY < offsetY.intValue() + 21) {
                        tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.members.flags.label." + (String)teamFlags.get(var11))});
                     }
                  }
               ...
               for(var11 = 0; var11 < this.actions.size(); ++var11) {
                  ...
                  this.drawScaledString(I18n.func_135053_a("island.members.actions.label." + (String)this.actions.get(var11)), offsetX + 4, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
               }
               ...
               if(this.dropdownColors) {
                  ...
                  for(var11 = 0; var11 < this.availableColors.size(); ++var11) {
                     ...
                     Gui.func_73734_a(this.guiLeft + 60, offsetY.intValue() + 1, this.guiLeft + 60 + 12, offsetY.intValue() + 1 + 12, getColorFromString((String)this.availableColors.get(var11)));
                     GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               ...
               if(this.dropdownScoreType) {
                  ...
                  for(var11 = 0; var11 < this.availableScoreTypes.size(); ++var11) {
                     ...
                     this.drawScaledString(I18n.func_135053_a("island.members.scoreType." + (String)this.availableScoreTypes.get(var11)), this.guiLeft + 190 + 4, this.guiTop + 77 + var11 * 15 + 5, 16777215, 1.0F, false, false);
            ...
            this.drawScaledString(I18n.func_135053_a("island.global.save"), this.guiLeft + 259, this.guiTop + 220, 16777215, 1.0F, true, false);
         }
      }
