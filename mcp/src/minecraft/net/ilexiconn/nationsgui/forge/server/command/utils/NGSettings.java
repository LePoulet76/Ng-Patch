...
public class NGSettings {
    ...
    static {
        maxInPeriod = new NGSettings("maxInPeriod", 15, 0);
        repeaterPeriodDuration = new NGSettings("repeaterPeriodDuration", 10, 0);
        repeaterDelay = new NGSettings("repeaterDelay", 2, 0);
        maxPistonExtensionPerSecond = new NGSettings("maxPistonExtensionPerSecond", 4, 0);
        observerDelay = new NGSettings("observerDelay", 0, 0);
        settings = new NGSettings[]{maxInPeriod, repeaterPeriodDuration, repeaterDelay, maxPistonExtensionPerSecond, observerDelay};
    }
}
