...
{
    private final GuiTextMultiLines createTicketText = new GuiTextMultiLines(I18n.getString("nationsgui.assistance.createTicketText"), 147, true, 0.9F);
    private final GuiTextMultiLines supportSiteText = new GuiTextMultiLines(I18n.getString("nationsgui.assistance.supportSiteText"), 147, true, 0.9F);
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new AssistanceButton(0, this.guiLeft + 202 + 5, this.guiTop + 102, 147, 20, I18n.getString("nationsgui.assistance.createTicket")));
        this.buttonList.add(new AssistanceButtonIcon(1, this.guiLeft + 202 + 5, this.guiTop + 189, 147, 20, 227, 255, I18n.getString("nationsgui.assistance.supportSite")));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            case 0:
                this.mc.displayGuiScreen(new AssistanceNewTicketGUI());
                break;
