...
import net.ilexiconn.nationsgui.forge.client.gui.faction.SearchActionsGui$1;
import net.ilexiconn.nationsgui.forge.client.gui.faction.SearchActionsGui$2;
import net.ilexiconn.nationsgui.forge.client.gui.faction.SearchActionsGui$3;
import net.ilexiconn.nationsgui.forge.client.gui.faction.SearchActionsGui$4;
import net.ilexiconn.nationsgui.forge.client.gui.faction.SearchActionsGui$5;
...
public class SearchActionsGui extends GuiScreen
{
    ...
    {
        super.initGui();
        PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionSearchActionsDataPacket()));
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("faction.search_actions.title"), this.guiLeft + 50, this.guiTop + 20, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("faction.search.country"), this.guiLeft + 51 + 5, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search.level"), this.guiLeft + 51 + 80, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search.nb_actions"), this.guiLeft + 51 + 130, this.guiTop + 50, 1644825, 0.9F, false, false);
        this.drawScaledString(I18n.getString("faction.search.price_actions"), this.guiLeft + 51 + 195, this.guiTop + 50, 1644825, 0.9F, false, false);
        ...
        if (loaded && countries.size() > 0)
        {
            ...
            for (int var8 = 0; var8 < countries.size(); ++var8)
            {
                if ((!this.open_filter || this.open_filter && ((String)((HashMap)countries.get(var8)).get("open")).equals("true")) && (this.searchText.isEmpty() || !this.searchText.isEmpty() && ((String)((HashMap)countries.get(var8)).get("name")).toLowerCase().contains(this.searchText.toLowerCase())))
                {
                    ...
                    this.drawScaledString((String)((HashMap)countries.get(var8)).get("nb_actions"), offsetX + 130, var9.intValue() + 5, 16777215, 1.0F, false, false);
                    this.drawScaledString((String)((HashMap)countries.get(var8)).get("price_actions") + "$", offsetX + 195, var9.intValue() + 5, 16777215, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0)
        {
            ...
            if (this.hoveredCountry != null && !this.hoveredCountry.isEmpty())
            {
                ...
                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionMainDataPacket((String)this.hoveredCountry.get("name"), true)));
                this.mc.displayGuiScreen(new ActionsGUI(Minecraft.getMinecraft().thePlayer));
            }
    ...
    static
    {
        TABS.add(new SearchActionsGui$1());
        TABS.add(new SearchActionsGui$2());
        TABS.add(new SearchActionsGui$3());
        TABS.add(new SearchActionsGui$4());
        TABS.add(new SearchActionsGui$5());
    }
}
