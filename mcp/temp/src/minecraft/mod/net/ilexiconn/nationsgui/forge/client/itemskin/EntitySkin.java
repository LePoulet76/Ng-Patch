...
public class EntitySkin extends AbstractSkin {
   ...
   public void render(float partialTick) {
      try {
         if(this.entity == null) {
            this.entity = (Entity)this.constructor.newInstance(new Object[]{Minecraft.func_71410_x().field_71441_e});
         }

         GL11.glRotatef(180.0F, 0.0F, 0.0F, 1.0F);
         GL11.glEnable(2903);
         RenderManager.field_78727_a.func_78719_a(this.entity, 0.0D, 0.0D, 0.0D, 0.0F, partialTick);
