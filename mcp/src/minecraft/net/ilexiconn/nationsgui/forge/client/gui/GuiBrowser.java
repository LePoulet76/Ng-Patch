 ...
 *  fr.nationsglory.ngbrowser.client.gui.GuiBrowser
 *  fr.nationsglory.ngbrowser.client.gui.IBrowserGuiScreen
...
implements IBrowserGuiScreen {
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ...
        ModernGui.drawScaledCustomSizeModalRect(this.field_73880_f - 25, 10.0f, 1658 * GenericOverride.GUI_SCALE, (hoveringClose ? 215 : 153) * GenericOverride.GUI_SCALE, 52 * GenericOverride.GUI_SCALE, 52 * GenericOverride.GUI_SCALE, 14, 14, 1920 * GenericOverride.GUI_SCALE, 1033 * GenericOverride.GUI_SCALE, false);
        if (hoveringClose) {
