...
public class GuiScrollBar extends Gui
{
    ...
    protected void drawScroller()
    {
        ...
        this.drawTexturedModalRect((int)this.x, (int)(this.y + (float)(this.height - 15) * this.sliderValue), 182, 0, 9, 15);
    }
    ...
    public void draw(int mouseX, int mouseY, boolean scrollActive)
    {
        ...
        if (!Mouse.isButtonDown(0))
        {
            ...
            while (scrollActive && !Minecraft.getMinecraft().gameSettings.touchscreen && Mouse.next())
            {
