...
public class IslandBackupGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      for(int titleOffsetY = 0; titleOffsetY < IslandMainGui.TABS.size(); ++titleOffsetY) {
         ...
         if(this.getClass() == l.getClassReferent()) {
            ...
            if(mouseX >= this.guiLeft - 23 && mouseX <= this.guiLeft - 23 + 29 && mouseY >= this.guiTop + 47 + titleOffsetY * 31 && mouseY <= this.guiTop + 47 + 30 + titleOffsetY * 31) {
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.tab." + backupId)});
            }
         }
      }
      ...
      GL11.glPushMatrix();
      Double var17 = Double.valueOf((double)(this.guiTop + 45) + (double)this.field_73886_k.func_78256_a((String)IslandMainGui.islandInfos.get("name")) * 1.5D);
      ...
      GL11.glPopMatrix();
      this.drawScaledString(I18n.func_135053_a("island.backup.save_name"), this.guiLeft + 57, this.guiTop + 22, 16777215, 1.0F, false, false);
      ...
      if(!this.saveStarted) {
         if(System.currentTimeMillis() - Long.parseLong((String)IslandMainGui.islandInfos.get("regenTime")) < 300000L || mouseX >= this.guiLeft + 56 && mouseX <= this.guiLeft + 56 + 98 && mouseY >= this.guiTop + 54 && mouseY <= this.guiTop + 54 + 18) {
            ...
            if(System.currentTimeMillis() - Long.parseLong((String)IslandMainGui.islandInfos.get("regenTime")) < 300000L && mouseX >= this.guiLeft + 56 && mouseX <= this.guiLeft + 56 + 98 && mouseY >= this.guiTop + 54 && mouseY <= this.guiTop + 54 + 18) {
               ...
               tooltipToDraw = Arrays.asList(new String[]{I18n.func_135053_a("island.backup.limit_1"), I18n.func_135053_a("island.backup.limit_2"), I18n.func_135053_a("island.backup.limit_3")});
            }
         }

         this.drawScaledString(I18n.func_135053_a("island.global.save"), this.guiLeft + 105, this.guiTop + 59, 16777215, 1.0F, true, false);
      } else {
      ...
      this.drawScaledString(I18n.func_135053_a("island.backup.last_save"), this.guiLeft + 54, this.guiTop + 84, 16777215, 1.0F, false, false);
      String var23;
      ...
      this.drawScaledString(I18n.func_135053_a("island.backup.my_saves"), this.guiLeft + 49, this.guiTop + 102, 0, 1.0F, false, false);
      this.hoveredDelete = "";
      this.hoveredRestore = "";
      ClientEventHandler.STYLE.bindTexture("island_backup");
      ...
      if(!IslandMainGui.isPremium) {
         func_73734_a(this.guiLeft + 40, this.guiTop + 6, this.guiLeft + 40 + 247, this.guiTop + 6 + 236, -1157627904);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(mouseX > this.guiLeft + 276 && mouseX < this.guiLeft + 276 + 9 && mouseY > this.guiTop - 8 && mouseY < this.guiTop - 8 + 10) {
            ...
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new IslandSaveBackupPacket((String)IslandMainGui.islandInfos.get("id"), this.nameTextField.func_73781_b())));
