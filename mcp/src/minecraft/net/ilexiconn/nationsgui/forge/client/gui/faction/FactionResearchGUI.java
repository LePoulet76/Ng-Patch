...
public class FactionResearchGUI extends TabbedFactionGUI
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick)
    {
        ...
        {
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.title"), (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ModernGui.drawSectionStringCustomFont(I18n.getString("faction.research.desc"), (float)(this.guiLeft + 43), (float)(this.guiTop + 33), 10395075, 0.5F, "left", false, "georamaRegular", 26, 9, 500);
            ...
            if (loaded)
            {
                for (int research = 0; research < Math.min(5, ((LinkedTreeMap)data.get("researchesConfig")).size()); ++research)
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier") + " " + allConditionsValidated + "/" + String.format("%.0f", new Object[] {(Double)canStartNewResearch.get("maxLevel")}), (float)(this.guiLeft + 43 + 85 * research + 34), (float)(this.guiTop + 161), 3618661, 0.5F, "center", false, "georamaSemiBold", 24);
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.last_research").toUpperCase(), (float)(this.guiLeft + 49), (float)(this.guiTop + 191), 16777215, 0.5F, "left", false, "georamaSemiBold", 30);
                String[] var27;
                String var28;
                Long var32;
                ...
                if (data.get("currentResearch") != null && !((String)data.get("currentResearch")).isEmpty())
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(var28 + " - " + I18n.getString("faction.research.palier") + " " + var27[1], (float)(this.guiLeft + 49), (float)(this.guiTop + 202), 12237530, 0.5F, "left", false, "georamaMedium", 26);
                }
                else if (data.get("lastResearch") != null && !((String)data.get("lastResearch")).isEmpty())
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(var28 + " - " + I18n.getString("faction.research.palier") + " " + var27[1] + " \u00a7o(" + var36 + ")", (float)(this.guiLeft + 49), (float)(this.guiTop + 202), 12237530, 0.5F, "left", false, "georamaMedium", 26);
                }
                else
                {
                    ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.last_research.none"), (float)(this.guiLeft + 49), (float)(this.guiTop + 202), 12237530, 0.5F, "left", false, "georamaMedium", 26);
                }
                ...
                if (data.get("currentResearch") != null && !((String)data.get("currentResearch")).isEmpty())
                {
                    ...
                    ModernGui.drawScaledStringCustomFont(System.currentTimeMillis() < var35.longValue() ? ModernGui.getFormattedTimeDiff(var35.longValue(), System.currentTimeMillis()) + " " + I18n.getString("faction.research.last_research.remaining") : I18n.getString("faction.research.last_research.ending"), (float)(this.guiLeft + 216), (float)(this.guiTop + 187), 7239406, 0.5F, "left", false, "georamaSemiBold", 26);
                    ClientEventHandler.STYLE.bindTexture("faction_research");
        ...
        else
        {
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.selected.title") + " \"" + var29.get("name") + "\"", (float)(this.guiLeft + 43), (float)(this.guiTop + 16), 16777215, 0.75F, "left", false, "georamaSemiBold", 32);
            ...
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier").toUpperCase() + " " + this.selectedResearchLevel, (float)(this.guiLeft + 55), (float)(this.guiTop + 143), 16316667, 0.5F, "left", false, "georamaSemiBold", 30);
            ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier.infos.conditions").toUpperCase(), (float)(this.guiLeft + 55), (float)(this.guiTop + 152), 16316667, 0.5F, "left", false, "georamaMedium", 24);
            boolean var37 = false;
            ...
            if (((LinkedTreeMap)((LinkedTreeMap)((LinkedTreeMap)data.get("researchesConfig")).get(this.selectedResearch)).get("levels")).containsKey(this.selectedResearchLevel + ""))
            {
                ...
                for (i = 0; i < Math.min(4, var40.size()); ++i)
                {
                    ...
                    else
                    {
                        ...
                        {
                            tooltipToDraw = Arrays.asList(I18n.getString("faction.research.tooltip.pay").split("##"));
                        }
                    }

                    conditionString = I18n.getString("faction.research.conditions.label." + conditionName);
                    ...
                    if (conditionName.matches("(craft|priceitem|blockbreak|crush|drop)_[\\d]+:[\\d]+"))
                    {
                        ...
                        conditionString = I18n.getString("faction.research.conditions.label." + conditionStringFormat) + " " + stack.getDisplayName();
                    }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier.infos.search_time").replaceAll("<time>", minutesToHumanText(isHovered.doubleValue())).toUpperCase(), (float)(this.guiLeft + 270), (float)(this.guiTop + 143), 16316667, 0.5F, "left", false, "georamaSemiBold", 30);
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier.infos.rewards").toUpperCase(), (float)(this.guiLeft + 258), (float)(this.guiTop + 152), 16316667, 0.5F, "left", false, "georamaMedium", 24);
                i = 0;
                String[] var42 = I18n.getString("faction.research.rewards." + this.selectedResearch + "." + this.selectedResearchLevel).split("#");
                y = var42.length;
            ...
            if (this.selectedResearchLevel > var31 && ((Boolean)FactionGUI.factionInfos.get("isInCountry")).booleanValue() && ((Boolean)FactionGUI.factionInfos.get("isAtLeastOfficer")).booleanValue())
            {
                ...
                if (this.selectedResearchLevel != var31 + 1)
                {
                    ...
                    if (var41)
                    {
                        hoveringText = I18n.getString("faction.research.palier.wrong.level");
                    }
                }
                else if (!var37)
                {
                    ...
                    if (var41)
                    {
                        hoveringText = I18n.getString("faction.research.palier.wrong.conditions");
                    }
                }
                else if (data.get("currentResearch") != null)
                {
                    ...
                    if (var41)
                    {
                        hoveringText = I18n.getString("faction.research.palier.wrong.already");
                    }
                }
                ...
                ModernGui.drawScaledStringCustomFont(I18n.getString("faction.research.palier.infos.start_research"), (float)(this.guiLeft + 190 + 56), (float)(this.guiTop + 204 + 3), var37 && var39 && !var41 ? 15463162 : 3026518, 0.5F, "center", false, "georamaSemiBold", 26);
            }

            if (!hoveringText.isEmpty())
            {
                this.drawHoveringText(Arrays.asList(new String[] {hoveringText}), mouseX, mouseY, this.fontRenderer);
            }
        }
