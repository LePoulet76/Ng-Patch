...
public class ChangePageButton extends GuiButton {
   ...
   public void func_73737_a(Minecraft par1Minecraft, int par2, int par3) {
      if(this.field_73748_h) {
         ...
         ModernGui.drawModalRectWithCustomSizedTexture((float)this.field_73746_c, (float)this.field_73743_d, 348 + (this.direction?12:0), textureOffset, 12, 12, 372.0F, 400.0F, false);
