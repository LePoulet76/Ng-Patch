...
public class RecipeContainer extends Container {
   ...
   private void setFoundRecipe(int index) {
      if(!this.foundRecipes.isEmpty()) {
         ...
         this.inventory.func_70299_a(54, (ItemStack)entry.getKey());
   ...
   public int displayResults(int skip) {
      ...
      for(start = 0; start < 5; ++start) {
         for(i = 0; i < 9; ++i) {
            this.inventory.func_70299_a(i + 9 * start, (ItemStack)null);
         }
      }
      ...
      for(i = 0; i < 45; ++i) {
         if(i + start < this.foundResults.size()) {
            this.inventory.func_70299_a(i, (ItemStack)this.foundResults.get(i + start));
         }
      }
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if(item != null) {
            ...
            while(var8.hasNext()) {
               ...
               if(filter.equals("") || this.idEqual(filter, itemStack) || StringUtils.containsIgnoreCase(itemStack.func_82833_r(), filter)) {
                  Iterator var10 = CraftingManager.func_77594_a().func_77592_b().iterator();
                  ...
                  } while(!displayAll && (iRecipe.func_77571_b() == null || !iRecipe.func_77571_b().func_77969_a(itemStack) || !ClientProxy.recipeWatcherMap.containsKey(iRecipe.getClass())));
   ...
   private boolean idEqual(String filter, ItemStack itemStack) {
      try {
         ...
         return itemStack.field_77993_c == ignore;
   ...
   public ItemStack func_75144_a(int par1, int par2, int par3, EntityPlayer par4EntityPlayer) {
      if(par1 == 54 && this.inventory.func_70301_a(54) != null) {
         RecipeListGUI var11 = (RecipeListGUI)Minecraft.func_71410_x().field_71462_r;
         if(var11.getPrev() instanceof CustomCraftingGUI) {
            CustomCraftingGUI var12 = (CustomCraftingGUI)var11.getPrev();

            for(int var13 = 0; var13 < 10; ++var13) {
               var12.selectedRecipe[var13] = this.inventory.func_70301_a(45 + var13);
            }

            Minecraft.func_71410_x().func_71373_a(var12);
         }
      } else if(par1 != -999) {
         ...
         Iterator i = CraftingManager.func_77594_a().func_77592_b().iterator();

         while(i.hasNext()) {
            Object object = i.next();
            IRecipe iRecipe = (IRecipe)object;
            if(iRecipe.func_77571_b() != null && iRecipe.func_77571_b().func_77969_a(target) && ClientProxy.recipeWatcherMap.containsKey(iRecipe.getClass())) {
               if(!cleared) {
                  this.foundRecipes.clear();

                  for(int recipeWatcher = 0; recipeWatcher < 9; ++recipeWatcher) {
                     this.inventory.func_70299_a(45 + recipeWatcher, (ItemStack)null);
                  }
               ...
               this.foundRecipes.put(iRecipe.func_77571_b(), var14.watchRecipe(iRecipe));
            }
         }
