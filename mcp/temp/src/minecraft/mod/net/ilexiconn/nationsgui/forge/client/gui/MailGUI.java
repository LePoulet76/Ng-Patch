...
public class MailGUI extends TabbedGUI {
   ...
   public void func_73866_w_() {
      ...
      this.replyButton = new TexturedButtonGUI(2, this.guiLeft + 83 + 15, this.guiTop + 196, 74, 19, "mail_open", 182, 15, I18n.func_135053_a("gui.mail.reply"));
      this.writeButton = new TexturedButtonGUI(3, this.guiLeft + 98 + 21, this.guiTop + 52, 31, 19, "mail", 182, 15, "");
      this.sendButton = new TexturedButtonGUI(4, this.guiLeft + 98, this.guiTop + 197, 74, 19, "mail_send", 182, 15, I18n.func_135053_a("gui.mail.send"));
      this.joinButton = new TexturedButtonGUI(5, this.guiLeft + 83 + 15, this.guiTop + 196, 74, 19, "mail_open", 182, 15, I18n.func_135053_a("gui.mail.join"));
   ...
   public void drawScreen(int mouseX, int mouseY) {
      if(this.openMail != null) {
         ...
         this.field_73882_e.func_110434_K().func_110577_a(AbstractClientPlayer.func_110311_f(this.openMail.sender));
         ...
         this.field_73886_k.func_85187_a(this.openMail.sender, this.guiLeft + 34, this.guiTop + 56, 16777215, true);
         this.field_73886_k.func_85187_a(this.openMail.title, this.guiLeft + 16, this.guiTop + 80, 16777215, true);
         Gui.func_73734_a(this.guiLeft + 15, this.guiTop + 93, this.guiLeft + 152 + 15, this.guiTop + 94, -12303292);
         this.field_73886_k.func_78279_b(this.openMail.content, this.guiLeft + 16, this.guiTop + 99, 152, 11842740);
         ...
         if(this.receiverName != null) {
            i = AbstractClientPlayer.func_110305_h(this.receiverName);
            AbstractClientPlayer.func_110304_a(i, this.receiverName);
         }

         this.field_73882_e.func_110434_K().func_110577_a(i);
         drawScaledCustomSizeModalRect(this.guiLeft + 13, this.guiTop + 52, 8.0F, 8.0F, 8, 8, 16, 16, 64.0F, 64.0F);
         drawScaledCustomSizeModalRect(this.guiLeft + 13, this.guiTop + 52, 40.0F, 8.0F, 8, 8, 16, 16, 64.0F, 64.0F);
      } else {
         ClientEventHandler.STYLE.bindTexture("mail");
         this.func_73729_b(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);
         this.func_73732_a(this.field_73886_k, I18n.func_135053_a("gui.mail.inbox"), this.guiLeft + 52 + 11, this.guiTop + 59, 16777215);
         if(loaded) {
            ...
            for(int var8 = 0; var8 < ClientData.getMail().size(); ++var8) {
               ...
               Gui.func_73734_a(this.guiLeft + x - 1, this.guiTop + y - 1, this.guiLeft + x + 16 + 1, this.guiTop + y + 16 + 1, -4605511);
               Gui.func_73734_a(this.guiLeft + x - 1, this.guiTop + y + 25, this.guiLeft + x + 134, this.guiTop + y + 26, -12303292);
               GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
               ResourceLocation skin = AbstractClientPlayer.func_110305_h(mail.sender);
               AbstractClientPlayer.func_110304_a(skin, mail.sender);
               ...
               this.field_73886_k.func_85187_a(mail.title, this.guiLeft + x + 20, this.guiTop + y - 1, 16777215, true);
               this.field_73886_k.func_85187_a(mail.sender, this.guiLeft + x + 20, this.guiTop + y + 10, 8355711, true);
               GL11.glColor3f(1.0F, 1.0F, 1.0F);
               if(mouseX >= this.guiLeft + x - 6 && mouseX <= this.guiLeft + x + 139 && mouseY >= this.guiTop + y - 9 && mouseY <= this.guiTop + y + 24) {
                  Gui.func_73734_a(this.guiLeft + x - 6, this.guiTop + y - 9, this.guiLeft + x + 139, this.guiTop + y + 25, 553648127);
               }
            }

            GUIUtils.endGLScissor();
         } else {
            this.field_73886_k.func_85187_a(I18n.func_135053_a("gui.mail.loading"), this.guiLeft + 12 + 71 - this.field_73886_k.func_78256_a(I18n.func_135053_a("gui.mail.loading")) / 2, this.guiTop + 85, 6645612, false);
            GL11.glColor3f(1.0F, 1.0F, 1.0F);
         }
   ...
   protected void func_73875_a(GuiButton button) {
      if(button == this.backButton) {
         ...
         ClientData.getMail().clear();
         Minecraft.func_71410_x().func_71373_a(this);
      } else if(button == this.writeButton) {
         this.setWritingMail(true);
      } else if(button == this.sendButton) {
         PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new NewMailPacket(this.receiverName, this.titleText.func_73781_b(), this.contentText.func_73781_b())));
         this.setWritingMail(false);
      } else {
         Mail mail;
         if(button == this.replyButton) {
            ...
            this.closeMail();
            this.setWritingMail(true);
            this.receiverText.func_73782_a(mail.sender);
            ...
            if(mail != null) {
               ...
               Minecraft.func_71410_x().func_71373_a(new FactionGui_OLD(mail.title.split(" ")[1]));
            }
         }
      }
