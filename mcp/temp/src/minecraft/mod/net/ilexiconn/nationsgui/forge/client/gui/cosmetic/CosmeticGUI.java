...
public class CosmeticGUI extends CommonCosmeticGUI {
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      ...
      if(mouseButton == 0 && this.hoveredAction.contains("tab#")) {
         ...
         Minecraft.func_71410_x().func_71373_a(new CosmeticCategoryGUI(this.hoveredAction.replaceAll("tab#", ""), this.playerTarget));
      }
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      ModernGui.drawScaledStringCustomFont(Minecraft.func_71410_x().field_71439_g.field_71092_bJ.equalsIgnoreCase(this.playerTarget)?I18n.func_135053_a("cosmetic.title"):I18n.func_135053_a("cosmetic.title_of").replace("#player#", this.playerTarget.toUpperCase()), (float)(this.guiLeft + 12), (float)(this.guiTop + 11), 12895428, 1.0F, "left", false, "georamaExtraBold", 28);
      ...
      if(!cachedDataMainMenu.isEmpty()) {
         ...
         if(!((LinkedTreeMap)cachedDataMainMenu.get("news")).get("link_button").equals("")) {
            ...
            if(mouseX >= this.guiLeft + 205 && mouseX <= this.guiLeft + 205 + 46 && mouseY >= this.guiTop + 123 && mouseY <= this.guiTop + 123 + 14) {
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("cosmetic.label.get").toUpperCase(), (float)(this.guiLeft + 205 + 23), (float)this.guiTop + 126.5F, COLOR_LIGHT_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
               ...
               ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("cosmetic.label.get").toUpperCase(), (float)(this.guiLeft + 205 + 23), (float)this.guiTop + 126.5F, COLOR_WHITE, 0.5F, "center", false, "georamaSemiBold", 27);
            }
         }
      }
      ...
      String var15 = "";
      if(loaded) {
         var15 = String.format("%.0f", new Object[]{data.get("ownedCount")}) + "/" + String.format("%.0f", new Object[]{maxCounters.get("total")}) + " " + I18n.func_135053_a("cosmetic.unlocked");
      ...
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("cosmetic.rarity.limited"), (float)(offsetX + 15), (float)(var14 - 1), COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
      offsetX += 34;
      if(loaded) {
         var15 = (rarityCounters.containsKey("limited")?String.format("%.0f", new Object[]{rarityCounters.get("limited")}):"0") + "/" + (maxCounters.containsKey("limited")?String.format("%.0f", new Object[]{maxCounters.get("limited")}):"?") + " " + I18n.func_135053_a("cosmetic.unlocked");
         ModernGui.drawScaledStringCustomFont(var15, (float)offsetX, (float)var14, COLOR_LIGHT_GRAY, 0.5F, "left", false, "georamaSemiBold", 25);
         offsetX = (int)((float)offsetX + semiBold25.getStringWidth(var15) / 2.0F + 12.0F);
      }
      ...
      ModernGui.drawRoundedRectangle((float)offsetX, (float)(var14 - 2), 0.0F, 30.0F, 9.0F);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("cosmetic.rarity.epic"), (float)(offsetX + 15), (float)(var14 - 1), COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
      offsetX += 34;
      if(loaded) {
         var15 = (rarityCounters.containsKey("epic")?String.format("%.0f", new Object[]{rarityCounters.get("epic")}):"0") + "/" + (maxCounters.containsKey("epic")?String.format("%.0f", new Object[]{maxCounters.get("epic")}):"?") + " " + I18n.func_135053_a("cosmetic.unlocked");
         ModernGui.drawScaledStringCustomFont(var15, (float)offsetX, (float)var14, COLOR_LIGHT_GRAY, 0.5F, "left", false, "georamaSemiBold", 25);
         offsetX = (int)((float)offsetX + semiBold25.getStringWidth(var15) / 2.0F + 12.0F);
      }
      ...
      ModernGui.drawRoundedRectangle((float)offsetX, (float)(var14 - 2), 0.0F, 30.0F, 9.0F);
      ModernGui.drawScaledStringCustomFont(I18n.func_135053_a("cosmetic.rarity.rare"), (float)(offsetX + 15), (float)(var14 - 1), COLOR_DARK_BLUE, 0.5F, "center", false, "georamaSemiBold", 27);
      offsetX += 34;
      if(loaded) {
         var15 = (rarityCounters.containsKey("rare")?String.format("%.0f", new Object[]{rarityCounters.get("rare")}):"0") + "/" + (maxCounters.containsKey("rare")?String.format("%.0f", new Object[]{maxCounters.get("rare")}):"?") + " " + I18n.func_135053_a("cosmetic.unlocked");
         ModernGui.drawScaledStringCustomFont(var15, (float)offsetX, (float)var14, COLOR_LIGHT_GRAY, 0.5F, "left", false, "georamaSemiBold", 25);
         offsetX = (int)((float)offsetX + semiBold25.getStringWidth(var15) / 2.0F + 12.0F);
      }
