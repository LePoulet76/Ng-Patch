...
public class IslandListGui extends GuiScreen
{
    ...
    {
        this.islandSearch.updateCursorCounter();
    }
    ...
    public void initGui()
    {
        ...
        this.islandSearch = new GuiTextField(this.fontRenderer, this.guiLeft + 180, this.guiTop + 25, 95, 10);
        this.islandSearch.setEnableBackgroundDrawing(false);
        this.islandSearch.setMaxStringLength(40);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        GL11.glTranslatef((float)(-(this.guiLeft + 300 + this.helpSectionOffsetX)), (float)(-(this.guiTop + 195)), 0.0F);
        this.drawScaledString(I18n.getString("island.list.help.title"), this.guiLeft + 300 + this.helpSectionOffsetX, this.guiTop + 195, 0, 1.0F, false, false);
        GL11.glPopMatrix();
        ClientEventHandler.STYLE.bindTexture("island_list");
        ...
        this.drawScaledString("\u00a74" + I18n.getString("island.list.help.title"), this.guiLeft + 344 - 107 + this.helpSectionOffsetX, this.guiTop + 20, 0, 1.3F, true, false);

        for (int tooltipToDraw = 1; tooltipToDraw <= 16; ++tooltipToDraw)
        {
            this.drawScaledString(I18n.getString("island.list.help.text_" + tooltipToDraw), this.guiLeft + 344 - 107 + this.helpSectionOffsetX, this.guiTop + 45 + (tooltipToDraw - 1) * 10, 0, 0.9F, true, false);
        }

        ClientEventHandler.STYLE.bindTexture("island_list");
        ModernGui.drawModalRectWithCustomSizedTexture((float)this.guiLeft, (float)this.guiTop, 0, 0, this.xSize, this.ySize, 512.0F, 512.0F, false);
        Object var18 = new ArrayList();
        this.islandSearch.drawTextBox();
        ClientEventHandler.STYLE.bindTexture("island_list");
        ...
        if (loaded)
        {
            ...
            GL11.glRotatef(-90.0F, 0.0F, 0.0F, 1.0F);
            GL11.glTranslatef((float)(-(this.guiLeft + 14)), (float)(-(this.guiTop + 128)), 0.0F);
            this.drawScaledString(I18n.getString("island.list.title"), this.guiLeft + 14, this.guiTop + 128, 16777215, 1.5F, false, false);
            GL11.glPopMatrix();
            ClientEventHandler.STYLE.bindTexture("island_list");
            ...
            if (loaded && islands.size() > 0)
            {
                ...
                while (i.hasNext())
                {
                    ...
                    {
                        boolean offsetY = ((String)offsetX.get("creator")).equals(Minecraft.getMinecraft().thePlayer.getDisplayName()) || ((String)offsetX.get("members")).contains("#" + Minecraft.getMinecraft().thePlayer.getDisplayName() + "#");
                        ...
                        if ((!((String)offsetX.get("isPrivate")).equals("true") || isOp || offsetY || ((String)offsetX.get("name")).toLowerCase().equalsIgnoreCase(this.searchText.toLowerCase()) || ((String)offsetX.get("id")).toLowerCase().equalsIgnoreCase(this.searchText.toLowerCase())) && (this.searchText.length() >= 3 && ((String)offsetX.get("name")).toLowerCase().contains(this.searchText.toLowerCase()) || this.searchText.length() >= 3 && ((String)offsetX.get("creator")).toLowerCase().contains(this.searchText.toLowerCase()) || this.searchText.length() >= 3 && ((String)offsetX.get("id")).toLowerCase().contains(this.searchText.toLowerCase()) || onlyMyIslands && offsetY || !((String)offsetX.get("playersOnline")).equals("0") && this.searchText.length() == 0 || !this.selectedFilter.equals("connected") && index < 50))
                        {
                            ...
                            {
                                GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.imagesTexture.containsKey((String)offsetX.get("id") + "#" + (String)offsetX.get("serverNumber")) ? ((DynamicTexture)this.imagesTexture.get((String)offsetX.get("id") + "#" + (String)offsetX.get("serverNumber"))).getGlTextureId() : this.defaultImage.getGlTextureId());
                            ...
                            this.drawScaledString(I18n.getString("island.list.created_by") + " " + (String)offsetX.get("creator"), offsetX1 + 43, offsetY1.intValue() + 20, 11842740, 0.9F, false, false);
                            ...
                            if (mouseX > this.guiLeft + 50 && mouseX < this.guiLeft + 50 + 222 && mouseY > this.guiTop + 43 && mouseY < this.guiTop + 43 + 158 && mouseX > offsetX1 + 186 && mouseX < offsetX1 + 186 + 32 && mouseY > offsetY1.intValue() + 11 && mouseY < offsetY1.intValue() + 11 + 15)
                            {
                                ...
                                if (haveToWait)
                                {
                                    var18 = Arrays.asList(new String[] {I18n.getString("island.list.tooltip.waiting")});
                                }
                            }
                ...
                ClientEventHandler.STYLE.bindTexture("island_list");
                this.drawScaledString(I18n.getString("island.list.filter." + this.selectedFilter), this.guiLeft + 49 + 6, this.guiTop + 26, 16777215, 1.0F, false, false);
                ClientEventHandler.STYLE.bindTexture("island_list");
                ...
                if (this.filterExpanded)
                {
                    ...
                    if (this.filters.size() > 0)
                    {
                        for (int var19 = 0; var19 < this.filters.size(); ++var19)
                        {
                            ...
                            this.drawScaledString(I18n.getString("island.list.filter." + (String)this.filters.get(var19)), var20 + 6, var21 + 5, 16777215, 1.0F, false, false);
                        }
                    }
                }
                ...
                {
                    var18 = Arrays.asList(new String[] {"\u00a77" + (String)this.hoveredInfoIsland.get("description"), "", "\u00a79" + I18n.getString("island.list.tooltip.creation") + " \u00a77" + (String)this.hoveredInfoIsland.get("creationDate"), "\u00a79" + I18n.getString("island.list.tooltip.visits") + " \u00a77" + (String)this.hoveredInfoIsland.get("visit"), "\u00a79" + I18n.getString("island.list.tooltip.votes") + " \u00a7a" + (String)this.hoveredInfoIsland.get("voteUp") + "\u00a77/\u00a7c" + (String)this.hoveredInfoIsland.get("voteDown"), "\u00a79" + I18n.getString("island.list.tooltip.server") + " \u00a77" + (String)this.hoveredInfoIsland.get("serverNumber")});
                }
            ...
            if (!onlyMyIslands)
            {
                this.drawScaledString(I18n.getString("island.list.my_islands"), this.guiLeft + 85, this.guiTop + 216, 16777215, 1.0F, true, false);
            }
            else
            {
                this.drawScaledString(I18n.getString("island.list.all_islands"), this.guiLeft + 85, this.guiTop + 216, 16777215, 1.0F, true, false);
            }
            ...
            if (!serverNumber.equals("0"))
            {
                ...
                this.drawScaledString(I18n.getString("island.list.create_island"), this.guiLeft + 232, this.guiTop + 215, 16777215, 1.0F, true, false);

                if (!this.canPlayerCreateIsland() && mouseX >= this.guiLeft + 175 && mouseX <= this.guiLeft + 175 + 103 && mouseY >= this.guiTop + 206 && mouseY <= this.guiTop + 206 + 27)
                {
                    if (isPremium)
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("island.create.disable.premium")}), mouseX, mouseY, this.fontRenderer);
                    }
                    else
                    {
                        this.drawHoveringText(Arrays.asList(new String[] {I18n.getString("island.create.disable.non_premium_1"), I18n.getString("island.create.disable.non_premium_2"), I18n.getString("island.create.disable.non_premium_3")}), mouseX, mouseY, this.fontRenderer);
                    }
                }
            }
        }
        ...
        {
            this.drawHoveringText((List)var18, mouseX, mouseY, this.fontRenderer);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            else if (this.hoveredIsland != null && !this.hoveredIsland.isEmpty() && mouseX > this.guiLeft + 50 && mouseX < this.guiLeft + 50 + 222 && mouseY > this.guiTop + 43 && mouseY < this.guiTop + 43 + 158)
            {
                ...
                if (((String)this.hoveredIsland.get("password")).equals("true") && !((String)this.hoveredIsland.get("creator")).equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.username) && !((String)this.hoveredIsland.get("members")).contains("#" + Minecraft.getMinecraft().thePlayer.getDisplayName() + "#"))
                {
                    Minecraft.getMinecraft().displayGuiScreen(new IslandPasswordGui(this.player, this, (String)this.hoveredIsland.get("id"), (String)this.hoveredIsland.get("passwordValue"), (String)this.hoveredIsland.get("serverNumber")));
                }
                else
                {
                    Minecraft.getMinecraft().displayGuiScreen((GuiScreen)null);
            ...
            {
                this.mc.sndManager.playSoundFX("random.click", 1.0F, 1.0F);
                Minecraft.getMinecraft().displayGuiScreen(new IslandCreateGui(isPremium, serverNumber));
            }
        ...
        this.islandSearch.mouseClicked(mouseX, mouseY, mouseButton);
    ...
    {
        if (this.islandSearch.textboxKeyTyped(typedChar, keyCode))
        {
            this.searchText = this.islandSearch.getText();
            this.scrollBar.reset();
        }
