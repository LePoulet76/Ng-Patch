...
public class Stereo {
   ...
   public static void encode(Bits var0, float[] var1, int var2) {
      ...
      for(int var8 = 0; var8 < var2; ++var8) {
         var5 += var1[2 * var8] * var1[2 * var8];
         var6 += var1[2 * var8 + 1] * var1[2 * var8 + 1];
         var1[var8] = 0.5F * (var1[2 * var8] + var1[2 * var8 + 1]);
         var7 += var1[var8] * var1[var8];
      }

      float var91 = (var5 + 1.0F) / (var6 + 1.0F);
      float var9 = var7 / (1.0F + var5 + var6);
      var0.pack(14, 5);
      var0.pack(9, 4);
      var91 = (float)(4.0D * Math.log((double)var91));
      if(var91 > 0.0F) {
         var0.pack(0, 1);
      } else {
         var0.pack(1, 1);
      ...
      var91 = (float)Math.floor((double)(0.5F + Math.abs(var91)));
      if(var91 > 30.0F) {
         var91 = 31.0F;
      }

      var0.pack((int)var91, 5);
