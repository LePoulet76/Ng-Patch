...
public class EnterprisePetrolPriceGui extends ModalLargeGui
{
    ...
    public void initGui()
    {
        ...
        this.priceInput.setText(((Double)EnterprisePetrolGUI.enterprisePetrolInfos.get("price")).intValue() + "");
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.title"), this.guiLeft + 53, this.guiTop + 16, 1644825, 1.3F, false, false);
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.text_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.text_3"), this.guiLeft + 53, this.guiTop + 55, 1644825, 1.0F, false, false);
        ...
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.avg") + " \u00a72" + String.format("%.1f", new Object[] {(Double)EnterprisePetrolGUI.enterprisePetrolInfos.get("avgPrice")}) + "$/100L", this.guiLeft + 180, this.guiTop + 76, 0, 1.0F, false, false);
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.restrict"), this.guiLeft + 53, this.guiTop + 100, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("faction_modal_large");
        ...
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.all"), this.guiLeft + 66, this.guiTop + 117, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("faction_modal_large");
        ...
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.country").replace("<country>", (String)EnterprisePetrolGUI.enterprisePetrolInfos.get("associatedCountry")), this.guiLeft + 66, this.guiTop + 132, 1644825, 1.0F, false, false);
        ClientEventHandler.STYLE.bindTexture("faction_modal_large");
        ...
        this.drawScaledString(I18n.getString("enterprise.petrol.modal.price.ally").replace("<country>", (String)EnterprisePetrolGUI.enterprisePetrolInfos.get("associatedCountry")), this.guiLeft + 66, this.guiTop + 147, 1644825, 1.0F, false, false);
