...
public class EnterpriseTraderDataPacket
implements IPacket,
IClientPacket {
    ...
    public void fromBytes(ByteArrayDataInput data) {
        this.traderInfos = (HashMap)new Gson().fromJson(data.readUTF(), new TypeToken<HashMap<String, Object>>(){}.getType());
    ...
    public void handleClientPacket(EntityPlayer player) {
        XYChart chart = ((XYChartBuilder)((XYChartBuilder)((XYChartBuilder)new XYChartBuilder().width(496)).height(190)).title(I18n.func_135053_a((String)"enterprise.STATS_TEXTURE.title"))).build();
        ...
        if (!this.history.isEmpty()) {
            chart.addSeries("a", new ArrayList<String>(this.history.keySet()), new ArrayList<Double>(this.history.values()));
        }
        this.loadChartTexture((Chart)chart, EnterpriseTraderGUI.STATS_TEXTURE);
