...
public class EnterpriseLeaderConfirmGui extends ModalGui {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      this.drawScaledString(I18n.func_135053_a("enterprise.leader.text_1"), this.guiLeft + 53, this.guiTop + 30, 1644825, 1.0F, false, false);
      this.drawScaledString(I18n.func_135053_a("enterprise.leader.text_2"), this.guiLeft + 53, this.guiTop + 40, 1644825, 1.0F, false, false);
