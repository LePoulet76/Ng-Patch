...
public class WarAgreementCreateGui extends GuiScreen {
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      GL11.glTranslatef((float)(-(this.guiLeft + 12)), (float)(-(this.guiTop + 180)), 0.0F);
      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.create.title"), this.guiLeft + 12, this.guiTop + 180, 16777215, 1.5F, false, false);
      GL11.glPopMatrix();
      ClientEventHandler.STYLE.bindTexture("faction_war_agreement_create");
      ...
      if(!this.selectedAgreementType.equals("")) {
         this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.type." + this.selectedAgreementType), this.guiLeft + 50, this.guiTop + 23, 16777215, 1.0F, false, false);
      }

      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.duration"), this.guiLeft + 65, this.guiTop + 48, 16777215, 1.0F, false, false);
      this.durationInput.func_73795_f();
      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.conditions"), this.guiLeft + 46, this.guiTop + 64, 0, 1.0F, false, false);
      ClientEventHandler.STYLE.bindTexture("faction_war_agreement_create");
      int infoX = this.guiLeft + 46 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.agreement.conditions")) + 3;
      ...
      for(Iterator it = this.conditions.entrySet().iterator(); it.hasNext(); yOffset += 21) {
         ...
         if(ClientProxy.flagsTexture.containsKey(country)) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(country)).func_110552_b());
         ...
         this.drawScaledString(((String)index.getValue()).split("#")[0] + " " + I18n.func_135053_a("faction.enemy.agreement.conditions." + index.getKey()), agreementType + 25, offsetY.intValue() + 6, 16777215, 1.0F, false, false);
         ClientEventHandler.STYLE.bindTexture("faction_war_agreement_create");
      ...
      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.new_condition"), this.guiLeft + 46, this.guiTop + 144, 0, 1.0F, false, false);
      if(!this.selectedSide.isEmpty()) {
         ...
         if(ClientProxy.flagsTexture.containsKey(this.selectedSide)) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(this.selectedSide)).func_110552_b());
            ...
            this.drawScaledString(this.selectedSide + " " + I18n.func_135053_a("faction.enemy.agreement.gives"), this.guiLeft + 73, this.guiTop + 161, 16777215, 1.0F, false, false);
         }
      }

      if(!this.selectedConditionType.isEmpty()) {
         this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.conditions." + this.selectedConditionType), this.guiLeft + 51, this.guiTop + 182, 16777215, 1.0F, false, false);
      }

      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.value"), this.guiLeft + 65, this.guiTop + 205, 16777215, 1.0F, false, false);
      ...
      this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.submit"), this.guiLeft + 131, this.guiTop + 224, 16777215, 1.0F, true, false);
      if(this.sidesExpanded) {
         ...
         if(ClientProxy.flagsTexture.containsKey(this.faction1)) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(this.faction1)).func_110552_b());
            ...
            this.drawScaledString(this.faction1 + " " + I18n.func_135053_a("faction.enemy.agreement.gives"), this.guiLeft + 73, this.guiTop + 180, 16777215, 1.0F, false, false);
         ...
         if(ClientProxy.flagsTexture.containsKey(this.faction2)) {
            GL11.glBindTexture(3553, ((DynamicTexture)ClientProxy.flagsTexture.get(this.faction2)).func_110552_b());
            ...
            this.drawScaledString(this.faction2 + " " + I18n.func_135053_a("faction.enemy.agreement.gives"), this.guiLeft + 73, this.guiTop + 199, 16777215, 1.0F, false, false);
      ...
      if(this.conditionTypeExpanded) {
         ...
         for(var13 = this.availableConditionTypes.iterator(); var13.hasNext(); ++var12) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.conditions." + var14), this.guiLeft + 49, this.guiTop + 201 + var12 * 19, 16777215, 1.0F, false, false);
      ...
      if(this.agreementTypeExpanded) {
         ...
         for(var13 = this.availableAgreementTypes.iterator(); var13.hasNext(); ++var12) {
            ...
            this.drawScaledString(I18n.func_135053_a("faction.enemy.agreement.type." + var14), this.guiLeft + 50, this.guiTop + 42 + var12 * 19, 16777215, 1.0F, false, false);
            ClientEventHandler.STYLE.bindTexture("faction_war_agreement_create");
            ModernGui.drawModalRectWithCustomSizedTexture((float)(this.guiLeft + 46 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.agreement.type." + var14)) + 6), (float)(this.guiTop + 40 + var12 * 19), 71, 251, 10, 11, 512.0F, 512.0F, false);
            if(mouseX >= this.guiLeft + 46 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.agreement.type." + var14)) + 6 && mouseX <= this.guiLeft + 46 + this.field_73886_k.func_78256_a(I18n.func_135053_a("faction.enemy.agreement.type." + var14)) + 6 + 10 && mouseY >= this.guiTop + 40 + var12 * 19 && mouseY <= this.guiTop + 40 + var12 * 19 + 11) {
               tooltipToDraw = Arrays.asList(I18n.func_135053_a("faction.enemy.agreement.type.desc." + var14).split("##"));
            }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      if(mouseButton == 0) {
         ...
         if(mouseX > this.guiLeft + 214 && mouseX < this.guiLeft + 214 + 9 && mouseY > this.guiTop - 8 && mouseY < this.guiTop - 8 + 10) {
            ...
            this.field_73882_e.func_71373_a(new WarAgreementListGui(this.player, this.warId, this.faction1, this.faction2));
         }
         ...
         if(!this.sidesExpanded && !this.conditionTypeExpanded && this.hoveredAction.equals("submit") && !this.selectedAgreementType.isEmpty() && this.isNumeric(this.durationInput.func_73781_b())) {
            ...
            PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new FactionEnemyAgreementCreatePacket(Integer.valueOf(this.warId), this.selectedAgreementType, Integer.parseInt(this.durationInput.func_73781_b()), conditionsString)));
            this.field_73882_e.func_71373_a(new WarAgreementListGui(this.player, this.warId, this.faction1, this.faction2));
         }
