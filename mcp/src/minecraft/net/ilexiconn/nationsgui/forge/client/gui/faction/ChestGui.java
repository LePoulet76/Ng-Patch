...
public class ChestGui extends GuiContainer
{
    ...
    public ChestGui(InventoryPlayer inventoryPlayer, FactionChestInventory factionChestInventory)
    {
        ...
        super.xSize = this.xSize;
        super.ySize = this.ySize;
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.drawScaledString(I18n.getString("faction.bank.chest_title") + " " + FactionGUI.factionInfos.get("name"), 50, 22, 5263440, 1.3F, false, false);
        this.drawScaledString(I18n.getString("container.inventory"), 70, 206, 16777215, 1.3F, false, true);
        ...
        if (this.chestLevel < 6)
        {
            ...
            {
                tooltipToDraw = I18n.getString("faction.bank.chest_level") + " 15";
            }
        }
        ...
        if (this.chestLevel < 5)
        {
            ...
            {
                tooltipToDraw = I18n.getString("faction.bank.chest_level") + " 13";
            }
        }
        ...
        if (this.chestLevel < 4)
        {
            ...
            {
                tooltipToDraw = I18n.getString("faction.bank.chest_level") + " 12";
            }
        }
        ...
        if (this.chestLevel < 3)
        {
            ...
            {
                tooltipToDraw = I18n.getString("faction.bank.chest_level") + " 9";
            }
        }
        ...
        if (this.chestLevel < 2)
        {
            ...
            {
                tooltipToDraw = I18n.getString("faction.bank.chest_level") + " 5";
            }
        }
        ...
        if (this.chestLogs != null)
        {
            ...
            for (int j = 0; j < this.chestLogs.size(); ++j)
            {
                ...
                this.itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), missile, offsetX + 13, offsetY.intValue());
                this.itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.getTextureManager(), missile, offsetX + 13, offsetY.intValue());
                ClientEventHandler.STYLE.bindTexture("faction_chest");
    ...
    public void drawTooltip(String text, int mouseX, int mouseY)
    {
        ...
        this.drawHoveringText(Arrays.asList(new String[] {text.substring(0, 1).toUpperCase() + text.substring(1)}), mouseXGui, mouseYGui + 15, this.fontRenderer);
    }
    ...
    public void drawTooltipLog(String stringToDraw, int mouseX, int mouseY)
    {
        ...
        this.drawHoveringText(Arrays.asList(new String[] {playerName + " - " + date}), mouseXGui, mouseYGui, this.fontRenderer);
    }
