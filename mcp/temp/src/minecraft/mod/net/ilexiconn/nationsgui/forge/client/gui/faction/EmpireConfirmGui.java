...
public class EmpireConfirmGui extends ModalGui {
   ...
   public void func_73866_w_() {
      super.func_73866_w_();
      this.yesButton = new GuiButton(0, this.guiLeft + 53, this.guiTop + 95, 118, 20, ((String)FactionGUI.factionInfos.get("name")).contains("Empire")?I18n.func_135053_a("faction.home.button.empire_down"):I18n.func_135053_a("faction.home.button.empire_up"));
   ...
   public void func_73863_a(int mouseX, int mouseY, float par3) {
      ...
      if(((String)FactionGUI.factionInfos.get("name")).contains("Empire")) {
         this.drawScaledString(I18n.func_135053_a("faction.empire_down.text_1"), this.guiLeft + 53, this.guiTop + 35, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_down.text_2"), this.guiLeft + 53, this.guiTop + 45, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_down.text_3"), this.guiLeft + 53, this.guiTop + 60, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_down.text_4"), this.guiLeft + 53, this.guiTop + 70, 1644825, 1.0F, false, false);
      } else {
         this.drawScaledString(I18n.func_135053_a("faction.empire_up.text_1"), this.guiLeft + 53, this.guiTop + 35, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_up.text_2"), this.guiLeft + 53, this.guiTop + 45, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_up.text_3"), this.guiLeft + 53, this.guiTop + 60, 1644825, 1.0F, false, false);
         this.drawScaledString(I18n.func_135053_a("faction.empire_up.text_4"), this.guiLeft + 53, this.guiTop + 70, 1644825, 1.0F, false, false);
      }
