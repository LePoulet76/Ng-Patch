...
public class CustomAxe extends ItemAxe {
   ...
   public CustomAxe(String name, ItemData data) {
      super(data.getId(), EnumHelper.addToolMaterial(name, data.getHarvestLevel(), data.getDurability(), data.getMiningSpeed(), data.getDamageVsEntities() - 3.0F, data.getEnchantability()));
