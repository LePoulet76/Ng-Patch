...
extends GuiScreen {
    ...
    public static Long savedClientTime = 0L;
    ...
    public void func_73874_b() {
        ...
        if (!actualUrl.equals(this.urlField.func_73781_b())) {
            ...
            PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new URLSavePacket(this.blockEntity)));
            savedClientURL = this.urlField.func_73781_b();
            savedClientTime = System.currentTimeMillis();
        }
    }
