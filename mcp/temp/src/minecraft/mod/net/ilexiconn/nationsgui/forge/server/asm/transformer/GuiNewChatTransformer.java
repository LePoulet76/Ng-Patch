...
public class GuiNewChatTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      while(var5.hasNext()) {
         ...
         if(method.name.equals("drawChat") || method.name.equals("func_73762_a")) {
            ...
            for(int insertBefore = 0; insertBefore < method.instructions.size(); ++insertBefore) {
               ...
               if(toRemove instanceof MethodInsnNode && toRemove.getOpcode() == 182 && (((MethodInsnNode)toRemove).name.equals("getChatLineString") || ((MethodInsnNode)toRemove).name.equals("func_74538_a"))) {
            ...
            if(insertAfter != null) {
               ...
               for(int i = 0; i < method.instructions.size(); ++i) {
                  ...
                  if(nod instanceof MethodInsnNode && nod.getOpcode() == 182 && (((MethodInsnNode)nod).name.equals("drawStringWithShadow") || ((MethodInsnNode)nod).name.equals("func_78261_a"))) {
                     var13 = nod;
                     break;
                  }
               }
