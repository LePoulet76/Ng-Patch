                ...
                if (!NotificationOverride.displaysNotification())
                {
                    if (ClientData.currentWarzone.isEmpty())
                    {
                        if (!ClientData.autelOverlayData.isEmpty() && System.currentTimeMillis() - EdoraAutelOverlayDataPacket.lastPacketReceived < 5000L)
                        {
                            ...
                            ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 136.0F, 0.0F, 0.0F, 1032.0F, 2040, 444, 272, 59, 5760.0F, 3099.0F, true);

                            for (int var6 = 0; var6 < 10; ++var6)
                            {
                                if (((Double)ClientData.autelOverlayData.get("countCapturedZones")).doubleValue() > (double)var6)
                                {
                                    ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 136.0F + 42.0F - 2.0F + (float)(var6 * 49) / 2.5F, 39.4F, 5535.0F, 132.0F, 120, 120, 16, 16, 5760.0F, 3099.0F, true);
                                }
                                else
                                {
                                    ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 136.0F + 42.0F - 2.0F + (float)(var6 * 49) / 2.5F, 39.4F, 5535.0F, 12.0F, 120, 120, 16, 16, 5760.0F, 3099.0F, true);
                                }
                            }

                            ModernGui.drawScaledStringCustomFont(I18n.getString("overlay.autel.title"), (float)(resolution.getScaledWidth() / 2), 16.0F, 10544870, 0.5F, "center", true, "minecraftDungeons", 21);
                            ModernGui.drawScaledStringCustomFont(ModernGui.chronoTimeToStr(Long.valueOf(3600000L - (((Double)ClientData.autelOverlayData.get("currentServerTime")).longValue() - ((Double)ClientData.autelOverlayData.get("oldestLastCapture")).longValue())), false), (float)(resolution.getScaledWidth() / 2), 23.0F, 16777215, 0.5F, "center", true, "minecraftDungeons", 27);
                        }
                        else if (!ClientData.bossOverlayData.isEmpty())
                        {
                            if (ClientData.bossOverlayData.containsKey("healthPercent"))
                            {
                                ...
                                ClientEventHandler.STYLE.bindTexture("overlay_edora");
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 136.0F, 0.0F, 0.0F, 2049.0F, 2040, 444, 272, 59, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - dg25.getStringWidth("BOSS EDORA") / 2.0F / 2.0F - 10.8F - 3.0F, 8.0F, 4644.0F, 219.0F, 81, 75, 10, 10, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) + dg25.getStringWidth("BOSS EDORA") / 2.0F / 2.0F + 3.0F, 8.0F, 4824.0F, 219.0F, 81, 75, 10, 10, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledStringCustomFont("BOSS EDORA", (float)(resolution.getScaledWidth() / 2), 8.0F, 16777215, 0.5F, "center", true, "minecraftDungeons", 25);
                                ClientEventHandler.STYLE.bindTexture("overlay_edora");
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 163.0F, 24.0F, 0.0F, 909.0F, 2445, 54, 326, 7, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 163.0F, 24.0F, 0.0F, 786.0F, (int)(((Double)ClientData.bossOverlayData.get("healthPercent")).doubleValue() * 815.0D * 3.0D), 54, (int)(((Double)ClientData.bossOverlayData.get("healthPercent")).doubleValue() * 815.0D / 2.5D), 7, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledStringCustomFont(ModernGui.chronoTimeToStr(Long.valueOf(((Double)ClientData.bossOverlayData.get("despawnTime")).longValue()), false), (float)(resolution.getScaledWidth() / 2), 35.0F, 16777215, 0.5F, "center", true, "minecraftDungeons", 23);
                            }
                            else
                            {
                                ...
                                ClientEventHandler.STYLE.bindTexture("overlay_edora");
                                ModernGui.drawScaledCustomSizeModalRect((float)(resolution.getScaledWidth() / 2) - 136.0F, 0.0F, 0.0F, 1545.0F, 2040, 444, 272, 59, 5760.0F, 3099.0F, true);
                                ModernGui.drawScaledStringCustomFont(I18n.getString("overlay.portal.closing"), (float)(resolution.getScaledWidth() / 2), 16.0F, 10544870, 0.5F, "center", true, "minecraftDungeons", 21);
                                ModernGui.drawScaledStringCustomFont(ModernGui.chronoTimeToStr(Long.valueOf(((Double)ClientData.bossOverlayData.get("endPortalTime")).longValue() - (((Double)ClientData.bossOverlayData.get("currentServerTime")).longValue() + delayFromPacketReceived)), false), (float)(resolution.getScaledWidth() / 2), 23.0F, 16777215, 0.5F, "center", true, "minecraftDungeons", 27);
                            }
                        }
                    }
                }
