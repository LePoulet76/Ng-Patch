...
public class ActionsGUI extends TabbedFactionGUI_OLD {
   ...
   public void drawScreen(int mouseX, int mouseY) {
      ...
      if(FactionGui_OLD.factionInfos != null && loaded) {
         ...
         this.drawScaledString(I18n.func_135053_a("faction.actions.title"), this.guiLeft + 131, this.guiTop + 16, 1644825, 1.4F, false, false);
         ...
         for(int actionsTotals = 0; actionsTotals < owners.size(); ++actionsTotals) {
            ...
            if(!this.isNumeric(l)) {
               ...
               if(this.flagTextures.containsKey(l)) {
                  GL11.glBindTexture(3553, ((DynamicTexture)this.flagTextures.get(l)).func_110552_b());
               ...
               if(this.flagTextures.containsKey((String)FactionGui_OLD.factionInfos.get("id"))) {
                  GL11.glBindTexture(3553, ((DynamicTexture)this.flagTextures.get((String)FactionGui_OLD.factionInfos.get("id"))).func_110552_b());
                  ModernGui.drawScaledCustomSizeModalRect((float)(this.guiLeft + offsetX), (float)(this.guiTop + offsetY), 0.0F, 0.0F, 156, 78, 17, 10, 156.0F, 78.0F, false);
               }
            }
            ...
            if(mouseX >= this.guiLeft + offsetX && mouseX <= this.guiLeft + offsetX + 17 && mouseY >= this.guiTop + offsetY && mouseY <= this.guiTop + offsetY + 10) {
               ...
               tooltipToDraw.add(I18n.func_135053_a("faction.actions.label.status") + ": " + I18n.func_135053_a("faction.actions.status." + (String)status.get(actionsTotals)));
               ...
               tooltipToDraw.add(I18n.func_135053_a("faction.actions.label.change." + (String)status.get(actionsTotals)));
               this.hoveredIndex = actionsTotals;
               this.hoveredOwnerFactionId = l;
         ...
         this.drawScaledString(I18n.func_135053_a("faction.actions.title.top"), this.guiLeft + 131, this.guiTop + 160, 3818599, 0.9F, false, false);
         ...
         if(this.cachedLogs.size() == 0) {
            ...
            for(offsetX = 0; offsetX < var28.size(); ++offsetX) {
               ...
               String var35 = "\u00a78" + I18n.func_135053_a("faction.bank.date_1");
               ...
               if(days == 0L) {
                  ...
                  if(hours == 0L) {
                     ...
                     if(minutes == 0L) {
                        seconds = diff / 1000L;
                        var35 = var35 + " " + seconds + " " + I18n.func_135053_a("faction.common.seconds") + " " + I18n.func_135053_a("faction.bank.date_2");
                     } else {
                        var35 = var35 + " " + minutes + " " + I18n.func_135053_a("faction.common.minutes") + " " + I18n.func_135053_a("faction.bank.date_2");
                     }
                  } else {
                     var35 = var35 + " " + hours + " " + I18n.func_135053_a("faction.common.hours") + " " + I18n.func_135053_a("faction.bank.date_2");
                  }
               } else {
                  var35 = var35 + " " + days + " " + I18n.func_135053_a("faction.common.days") + " " + I18n.func_135053_a("faction.bank.date_2");
               }
         ...
         this.drawScaledString(I18n.func_135053_a("faction.actions.title.logs"), this.guiLeft + 260, this.guiTop + 160, 3818599, 0.9F, false, false);
         ...
         this.drawScaledString(I18n.func_135053_a("faction.actions.button.all_1"), this.guiLeft + 10 + 50, this.guiTop + 165 + 5, 16777215, 1.0F, true, true);
         this.drawScaledString(I18n.func_135053_a("faction.actions.button.all_2"), this.guiLeft + 10 + 50, this.guiTop + 165 + 15, 16777215, 1.0F, true, true);
      }
   ...
   protected void func_73864_a(int mouseX, int mouseY, int mouseButton) {
      ...
      if(loaded && mouseButton == 0) {
         if(this.hoveredIndex != -1 && this.hoveredOwnerFactionId != null && this.hoveringFlag) {
            ...
            Minecraft.func_71410_x().func_71373_a(new LockActionConfirmGui(this, (String)FactionGui_OLD.factionInfos.get("id"), this.hoveredIndex, this.hoveredStatus));
         }
