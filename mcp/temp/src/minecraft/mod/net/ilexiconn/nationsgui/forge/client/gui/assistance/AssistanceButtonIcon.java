...
public class AssistanceButtonIcon extends GuiButton {
   ...
   public void func_73737_a(Minecraft par1Minecraft, int par2, int par3) {
      if(this.field_73748_h) {
         ...
         ModernGui.drawModalRectWithCustomSizedTexture((float)(this.field_73746_c + this.field_73747_a / 2 - fontrenderer.func_78256_a(this.field_73744_e) / 2 - 8), (float)(this.field_73743_d + (this.field_73745_b - 16) / 2), this.iconU, this.iconV, 16, 16, 512.0F, 512.0F, false);
