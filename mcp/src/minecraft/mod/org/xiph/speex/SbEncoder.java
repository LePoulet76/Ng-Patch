    ...
    public int encode(Bits var1, float[] var2)
    {
        ...
        if (var12 != this.lpcSize)
        {
            ...
            if (var12 != this.lpcSize)
            {
                ...
                {
                    this.lsp[var3] = (float)Math.cos(Math.PI * (double)((float)(var3 + 1)) / (double)(this.lpcSize + 1));
                }
            }
        }
        ...
        if ((this.vbr_enabled != 0 || this.vad_enabled != 0) && !var10)
        {
            ...
            if (this.abr_enabled != 0)
            {
                ...
                {
                    var6 = -1.0E-5F * this.abr_drift / (1.0F + this.abr_count);
            ...
            for (var3 = 0; var3 < this.frameSize; ++var3)
            {
                var4 += this.x0d[var3] * this.x0d[var3];
                var15 += this.high[var3] * this.high[var3];
            }

            var16 = (float)Math.log((double)((1.0F + var15) / (1.0F + var4)));
            ...
            if (this.vbr_enabled != 0)
            {
                ...
                while (var32 != 0)
                {
                    var331 = (int)Math.floor((double)this.vbr_quality);
                    float var5;

                    if (var331 == 10)
                    {
                        var5 = Vbr.hb_thresh[var32][var331];
                    }
                    else
                    {
                        var5 = (this.vbr_quality - (float)var331) * Vbr.hb_thresh[var32][var331 + 1] + ((float)(1 + var331) - this.vbr_quality) * Vbr.hb_thresh[var32][var331];
                    }

                    if (this.relative_quality >= var5)
                    {
                        break;
                    }
                ...
                if (this.abr_enabled != 0)
                {
                    var331 = this.getBitRate();
                    this.abr_drift += (float)(var331 - this.abr_enabled);
                    this.abr_drift2 = 0.95F * this.abr_drift2 + 0.05F * (float)(var331 - this.abr_enabled);
        ...
        if (!var10 && this.submodes[this.submodeID] != null)
        {
            ...
            float[] var311 = new float[this.lpcSize];
            float[] var341 = new float[this.subframeSize];
            ...
            for (int var31 = 0; var31 < this.nbSubframes; ++var31)
            {
                ...
                if (this.submodes[this.submodeID].innovation == null)
                {
                    ...
                    var27 *= var16;
                    var30 = (int)Math.floor(10.5D + 8.0D * Math.log((double)var27 + 1.0E-4D));
                    ...
                    var1.pack(var30, 5);
                    var27 = (float)(0.1D * Math.exp((double)var30 / 9.4D));
                ...
                else
                {
                    ...
                    var30 = (int)Math.floor(0.5D + 3.7D * (Math.log((double)var27) + 2.0D));
                    ...
                    Filters.syn_percep_zero(this.excBuf, var32, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, var341, this.subframeSize, this.lpcSize);
                    ...
                    for (var3 = 0; var3 < this.lpcSize; ++var3)
                    {
                        var311[var3] = this.mem_sp[var3];
                    }

                    Filters.iir_mem2(this.excBuf, var32, this.interp_qlpc, this.excBuf, var32, this.subframeSize, this.lpcSize, var311);

                    for (var3 = 0; var3 < this.lpcSize; ++var3)
                    {
                        var311[var3] = this.mem_sw[var3];
                    }

                    Filters.filter_mem2(this.excBuf, var32, this.bw_lpc1, this.bw_lpc2, this.res, var21, this.subframeSize, this.lpcSize, var311, 0);
                    ...
                    Filters.filter_mem2(this.high, var21, this.bw_lpc1, this.bw_lpc2, this.swBuf, var21, this.subframeSize, this.lpcSize, var311, 0);
                    ...
                    this.submodes[this.submodeID].innovation.quant(this.target, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.lpcSize, this.subframeSize, var321, 0, var341, var1, this.complexity + 1 >> 1);

                    for (var3 = 0; var3 < this.subframeSize; ++var3)
                    {
                        this.excBuf[var32 + var3] += var321[var3] * var34;
                    }
                    ...
                    if (this.submodes[this.submodeID].double_codebook != 0)
                    {
                        ...
                        this.submodes[this.submodeID].innovation.quant(this.target, this.interp_qlpc, this.bw_lpc1, this.bw_lpc2, this.lpcSize, this.subframeSize, var35, 0, var341, var1, this.complexity + 1 >> 1);
