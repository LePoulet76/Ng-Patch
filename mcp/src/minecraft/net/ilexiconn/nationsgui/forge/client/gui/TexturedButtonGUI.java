...
public class TexturedButtonGUI extends GuiButton
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.drawButton)
        {
            ...
            this.drawString(mc.fontRenderer, this.displayString, this.xPosition + this.width - mc.fontRenderer.getStringWidth(this.displayString) - 6, this.yPosition + (this.height - 8) / 2, 14737632);
        }
    }
