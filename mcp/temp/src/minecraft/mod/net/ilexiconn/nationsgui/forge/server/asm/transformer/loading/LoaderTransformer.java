...
public class LoaderTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      if(!NationsGUITransformer.isServer) {
         ...
         while(var3.hasNext()) {
            ...
            if(m.name.equalsIgnoreCase("identifyMods") && m.desc.equalsIgnoreCase("()Lcpw/mods/fml/common/discovery/ModDiscoverer;")) {
               ...
               for(int var8 = 0; var8 < var7; ++var8) {
                  ...
                  if(i instanceof FieldInsnNode) {
                     ...
                     if(insn.owner.equalsIgnoreCase("cpw/mods/fml/common/Loader") && insn.name.equalsIgnoreCase("mods") && insn.desc.equalsIgnoreCase("Ljava/util/List;")) {
