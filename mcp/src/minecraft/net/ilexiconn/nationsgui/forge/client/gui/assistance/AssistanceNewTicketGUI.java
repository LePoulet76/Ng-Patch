...
public class AssistanceNewTicketGUI
extends AbstractAssistanceListedGUI {
    ...
    private static List<String> categories = Arrays.asList("assistance.category.general", "assistance.category.bug", "assistance.category.rp", "assistance.category.sanction");

    public AssistanceNewTicketGUI() {
        PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new ScreenAuthorizationPacket()));
    }
    ...
    public void func_73866_w_() {
        ...
        this.screenshot = new CheckboxComponent(this.guiLeft + 202, this.guiTop + 183, I18n.func_135053_a((String)"nationsgui.assistance.takeScreenshot"));
        this.dropdownComponent = new DropdownComponent(this.guiLeft + 202, this.guiTop + 61, 157, I18n.func_135053_a((String)"nationsgui.assistance.categoryDropdown"));
        for (String key : categories) {
            this.dropdownComponent.getChoices().add(I18n.func_135053_a((String)key));
        }
        this.addComponent(this.textAreaComponent);
        this.addComponent(this.screenshot);
        this.addComponent(this.dropdownComponent);
        this.sendButton = new AssistanceButton(0, this.guiLeft + 202, this.guiTop + 197, 157, 20, I18n.func_135053_a((String)"nationsgui.assistance.sendTicket"));
    ...
    protected void drawGui(int mouseX, int mouseY, float partialTick) {
        ...
        this.field_73886_k.func_78276_b(I18n.func_135053_a((String)"nationsgui.assistance.createTicket"), this.guiLeft + 202, this.guiTop + 50, 0x181818);
    }
    ...
    protected void func_73875_a(GuiButton par1GuiButton) {
        if (par1GuiButton.field_73741_f == 0) {
            ...
            PacketDispatcher.sendPacketToServer((Packet)PacketRegistry.INSTANCE.generatePacket(new AssistanceNewTicketPacket(categories.get(this.dropdownComponent.getSelectionIndex()), this.textAreaComponent.getText(), screenshotUrl)));
            this.locked = true;
        }
    }
