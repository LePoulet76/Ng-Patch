...
public class EnterpriseContractForm_Pvp_Gui extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float par3)
    {
        ...
        if (loaded)
        {
            ...
            this.drawScaledString(I18n.getString("enterprise.contract.label.current_assault"), this.guiLeft + 197, this.guiTop + 53, 1644825, 1.0F, false, false);
            ...
            {
                this.drawScaledString(I18n.getString("enterprise.create.no_assault"), this.guiLeft + 280, this.guiTop + 77, 16777215, 1.0F, true, false);
            }

            this.drawScaledString(I18n.getString("enterprise.contract.label.price_pvp"), this.guiLeft + 197, this.guiTop + 151, 1644825, 1.0F, false, false);
            ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
            ...
            this.drawScaledString(I18n.getString("enterprise.contract.label.condition"), this.guiLeft + 282, this.guiTop + 151, 1644825, 1.0F, false, false);
            ClientEventHandler.STYLE.bindTexture("enterprise_contract_form");
            ...
            {
                this.drawScaledString(I18n.getString("enterprise.contract.condition." + this.selectedCondition), this.guiLeft + 285, this.guiTop + 166, 16777215, 1.0F, false, false);
            }
            ...
            if (this.conditionExpanded)
            {
                ...
                for (i = 0; i < this.conditions.size(); ++i)
                {
                    ...
                    this.drawScaledString(I18n.getString("enterprise.contract.condition." + (String)this.conditions.get(i)), offsetX + 2, var11.intValue() + 5, 16777215, 1.0F, false, false);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        if (mouseButton == 0)
        {
            ...
            if (this.validButton.enabled && !this.conditionExpanded && this.isNumeric(this.priceInput.getText()) && mouseX > this.guiLeft + 282 && mouseX < this.guiLeft + 282 + 80 && mouseY > this.guiTop + 197 && mouseY < this.guiTop + 197 + 20)
            {
                this.mc.sndManager.playSoundFX("random.click", 1.0F, 1.0F);
                String description = "PVP##" + (String)data.get("playerFaction") + "##" + (String)data.get("factionHelpers") + "##" + (String)data.get("opponentFaction") + "##" + (String)data.get("opponentHelpers") + "##" + this.priceInput.getText() + "##" + this.selectedCondition;
                EnterpriseGui.lastContractDemand = Long.valueOf(System.currentTimeMillis());
                PacketDispatcher.sendPacketToServer(PacketRegistry.INSTANCE.generatePacket(new EnterpriseContractCreate_Pvp_Packet((String)EnterpriseGui.enterpriseInfos.get("name"), description, Integer.valueOf(Integer.parseInt(this.priceInput.getText())), this.selectedCondition)));
