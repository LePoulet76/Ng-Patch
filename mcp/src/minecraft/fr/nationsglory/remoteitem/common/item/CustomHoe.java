...
extends ItemHoe {
    ...
    public CustomHoe(String name, ItemData data) {
        super(data.getId(), EnumHelper.addToolMaterial((String)name, (int)data.getHarvestLevel(), (int)data.getDurability(), (float)data.getMiningSpeed(), (float)data.getDamageVsEntities(), (int)data.getEnchantability()));
