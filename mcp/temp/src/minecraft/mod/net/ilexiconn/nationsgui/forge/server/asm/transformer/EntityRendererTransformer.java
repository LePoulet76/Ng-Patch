...
public class EntityRendererTransformer implements Transformer {
   ...
   public void transform(ClassNode node, boolean dev) {
      ...
      } while(!method.name.equals(dev?"updateLightmap":"func_78472_g") && (!method.name.equals("h") || !method.desc.equals("(F)V")));
      ...
      for(int var11 = 0; var11 < patch; ++var11) {
         ...
         if(abstractInsnNode.getOpcode() == 182) {
            ...
            if(methodInsnNode.owner.equals("net/minecraft/client/entity/EntityClientPlayerMP") && methodInsnNode.name.equals(dev?"isPotionActive":"func_70644_a") && methodInsnNode.desc.equals("(Lnet/minecraft/potion/Potion;)Z")) {
